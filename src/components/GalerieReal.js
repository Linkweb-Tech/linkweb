...
let dataArray = [
  ...
  { image: 'https://linkweb.fr/wp-content/uploads/2019/06/csd-menuiserie.jpg' },
  { image: 'https://linkweb.fr/wp-content/uploads/2019/06/faivre-creations.jpg' },
  { image: 'https://linkweb.fr/wp-content/uploads/2019/06/cypiere1.jpg' },
  { image: 'https://linkweb.fr/wp-content/uploads/2019/06/ledilimmo.jpg' },
        ...
        >
          ...
          >
            {isOpen && (
              ...
              >
                <span className="w-full bg-black text-white font-bold pb-1 px-1" onClick={e => this.onClose(e, i)}>x</span>
                <h1>{title}</h1>
                <em />
                <p>{content}</p>
              </div>
