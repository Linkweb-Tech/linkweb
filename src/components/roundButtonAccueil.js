...
class RoundButtonAccueil extends React.Component {
    ...
    render(){
        return (
            ...
            href={ this.props.url }     
            /*to={ this.props.url } */
                className={`font-light roundedButton bg-${this.props.color || 'bleu'} text-${this.props.colortext || 'white'} hover:text-white century flex justify-center font-normal mt-3 ml-0 mr-6 items-center text-center text-md lg:text-md rounded-huge px-8 py-4 mt-12`}
            >
