        ...
        return(
            <form onSubmit={() => this.handleSubmit} className="flex flex-wrap max-w-5xl px-6 mx-auto landing">
                ...
                <div className={`w-full flex justify-center mt-12 mb-2 ${ this.state.submitDisplay } `}>
                     <button onClick={e=>this.handleFormSubmit(e)} className="landing contactForm bg-black century text-white py-3 px-6 uppercase border-bottom-bleu" type="submit">Je veux être recontacté</button>
                </div>
            </form>
        );
    }
