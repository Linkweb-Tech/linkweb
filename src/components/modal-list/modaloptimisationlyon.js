...
class ModalOptimisationLyon extends Component {
            ...
            <section id="optimisation" className="popup flex flex-col xl:flex-row w-full justify-center mx-auto py-6">
                <div className="popup-inner flex justify-center xl:overflow-visible">
                    ...
                    <div className="blocref w-3/4 xl:w-1/3 px-12 pt-8 lg:pt-16 lg:mt-0 -mt-64 lg:my-0 order-last lg:order-first shadow-xl max-h-auto mx-10 lg:mx-0 py-6 lg:py-12 xl:px-12 text-white bg-grey flex flex-col justify-center" /*data-aos="fade-right"*/ style={{backgroundColor: 'rgba(62, 62, 62, 0.95)'}}>
                        ...
                        L’<strong className="font-normal">optimisation technique</strong> de chaque page web constitue un aspect fondamental du SEO. Les moteurs de recherche accordent une attention particulière à certaines parties spécifiques d'une page, notamment les balises d’en-tête, de titres, ou encore les attributs d'image.
                        <br/><br/>
                        Le rôle du SEO consiste donc également à encourager l'<strong className="font-normal">indexation des contenus par les moteurs de recherche</strong> afin qu’ils soient référencés correctement sur Google. Ce processus est également essentiel pour obtenir un meilleur classement lorsqu'il s'agit de requêtes importantes. 
                        </p>
...
export default ModalOptimisationLyon;