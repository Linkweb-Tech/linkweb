    ...
    render() {
        ...
        <section className="hero flex items-center justify-end ">
            <div className="max-w-6xl w-full mx-auto flex-col items-end">
                <Orbs className="orbs flex flex-1 justify-end" pose={this.state.isOpen ? 'open' : 'closed'}> 
                ...
                <BigTitle className="flex flex-1 bigtitle text-white justify-end century" pose={this.state.isOpen ? 'open' : 'closed'}>Agence web à Toulouse et Agen</BigTitle>
                <SmallTitle className="flex flex-1 smalltitle text-white justify-end century" pose={this.state.isOpen ? 'open' : 'closed'}>Connectez-vous avec le reste du monde</SmallTitle>
            </div>
        </section>
        )
    }
