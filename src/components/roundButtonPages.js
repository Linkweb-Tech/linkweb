...
class RoundButtonPages extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            url: '',
    ...
    render(){
        return (
            ...
            href={ this.props.url }     
            /*to={ this.props.url } */
                className={`font-light roundedButton bg-${this.props.color || 'bleu'} text-${this.props.colortext || 'white'} hover:text-white century flex justify-center font-normal mt-3 mx-auto block lg:mx-auto items-center text-center text-md lg:text-md rounded-huge px-8 py-4 mt-12`}
...
export default RoundButtonPages;