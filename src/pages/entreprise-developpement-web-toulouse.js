            ...
            <Layout location={this.props.location}>
                ...
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + siteinternet + ')' }}>
                        ...
                        <p className="text century lg:mt-0 text-lg lg:text-sm xl:text-lg">Notre entreprise développe votre <strong className="font-normal">site internet</strong> dans le parfait respect de votre identité de marque, mais aussi à partir de vos besoins pour un rendu sur-mesure.
                    ...
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + referencement + ')' }}>
                        ...
                        <p className="text century text-lg lg:text-sm xl:text-lg">La <strong className="font-normal">solution web</strong> à développer diffère selon les besoins de chaque <strong className="font-normal">client</strong>. Le travail de nos <strong className="font-normal">développeurs web</strong> consiste à choisir les meilleures <strong className="font-normal">technologies</strong> et <strong className="font-normal">applications</strong> (<strong className="font-normal">CMS</strong> comme <strong className="font-normal">Wordpress</strong>) pour la mise en place d'un <strong className="font-normal">support fonctionnel</strong>. Linkweb vous apporte des <strong className="font-normal">stratégies de développement</strong> adaptées à vos besoins. Notre <strong className="font-normal">agence</strong> vous fournit un accompagnement tout au long de votre <strong className="font-normal">projet</strong>.
                        <br /><br />Dès le lancement de votre projet, le choix des bons <strong className="font-normal">outils de création</strong> (CMS, application web, etc.), des <strong className="font-normal">technologies web</strong> (HTML, CSS, PHP, JavaScript, etc.), doivent permettre de faciliter la lecture du <strong className="font-normal">site</strong> pour les <strong className="font-normal">navigateurs</strong>, les <strong className="font-normal">moteurs de recherche</strong> et les utilisateurs. Notre savoir-faire assure une bonne gestion de ces actions dans la mise en place des projets qui nous sont confiés. Parmi le travail des <strong className="font-normal">agences web</strong> existantes, la polyvalence et la force d’initiative de notre <strong className="font-normal">entreprise de création</strong> garantissent une prestation globale et sur-mesure.
                        </p>
                    </div>
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + webdesign + ')' }}>
                        ...
                        <p className="text century text-lg lg:text-sm xl:text-lg">Au cours de la réalisation de votre <strong className="font-normal"><Link to="/agence-creation-site-web-toulouse/" className="font-bold text-bleu hover:text-black">projet de création de site internet</Link></strong>, nos développeurs mettent tout en oeuvre pour répondre à chaque critère de conformité essentiel à la bonne accessibilité de votre <strong className="font-normal">site web</strong>. Nos services professionnels et sur-mesure sont parfaitement conformes aux attentes des différents acteurs du web : respect du <strong className="font-normal">RGPD</strong>, critères <strong className="font-normal">W3C</strong>, protocole sécurisé. Ces notions concernent notamment la sécurisation des données de l’utilisateur et sont désormais indispensables dès le <strong className="font-normal">développement de votre projet web</strong>.
                            <br /><br />Avec la volonté de donner confiance aux utilisateurs de <strong className="font-normal">votre site</strong>, nos équipes veillent à la mise en place du protocole HTTPS qui protège la navigation sur les pages de votre site conçu par nos services. Les développeurs de notre <strong className="font-normal"><Link to="/agence-web-muret/" className="font-bold text-bleu hover:text-black">agence web-marketing</Link></strong> à Toulouse sont en mesure de tout mettre en oeuvre pour une lecture optimale de votre site par les navigateurs, les moteurs et les visiteurs.</p>
                    </div>
                </section>
