            ...
            <Layout location={this.props.location}>
                ...
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    ...
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + referencement + ')' }}>
                        ...
                        <p className="text century text-lg lg:text-sm xl:text-lg z-50">Chaque <strong className="font-normal">solution web</strong> diffère selon les besoins du <strong className="font-normal">client</strong>. Nos <strong className="font-normal">développeurs web</strong> choisissent les meilleures <strong className="font-normal">technologies</strong> et <strong className="font-normal">applications</strong> (<strong className="font-normal">CMS</strong> comme <strong className="font-normal">Wordpress</strong>) pour la mise en place d'un <strong className="font-normal">support fonctionnel</strong>. Linkweb vous apporte des <strong className="font-normal">stratégies de développement</strong> adaptées à vos besoins. Notre <strong className="font-normal">agence</strong> vous accompagne durant tout votre <strong className="font-normal">projet</strong>.
