            ...
            <Layout location={this.props.location}>
                ...
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + siteinternet + ')' }}>
                        ...
                        <p className="text century lg:mt-0 text-lg lg:text-sm xl:text-lg z-50">Notre entreprise développe votre <strong className="font-normal">site internet</strong> dans le parfait respect de votre identité de marque, mais aussi à partir de vos besoins pour un rendu sur-mesure.
                ...
                <section className="sidetitle w-10/12 text-center text-black text-2xl justify-center flex flex-col century mt-10 mb-10 mx-auto">
                    ...
                    <div className="line-title my-4">
                        <hr className="border-solid w-1/2 lg:w-1/12 border-bleu"></hr>
                        <br />
                        <h3 /*data-aos='fade-left'*/ className="max-w-6xl text-xl text-black text-center lg:text-justify century pb-0">Linkweb fait partie des agences qui mettent toute leur équipe expérimentée au service de vos <Link to="/agence-web-montauban/" className="font-bold text-bleu hover:text-black">projets web à Toulouse</Link>. Chacune de nos prestations de création comme de référencement est adaptée en fonction de votre projet.</h3>
                    </div>
                </section>
