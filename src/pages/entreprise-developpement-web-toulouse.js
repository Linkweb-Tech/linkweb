    ...
    render() {
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    title="Entreprise de développement web à Toulouse"
                    description="Notre entreprise de développement web à Toulouse mène tous vos projets digitaux pour un résultat sur-mesure."
                    url="https://linkweb.fr/entreprise-developpement-web-toulouse/"
                    nom="Entreprise de développement web à Toulouse"
                    slug="entreprise-developpement-web-toulouse/"
                />
                {/* <PageTransition
                    defaultStyle={{
                ...
                <section className="flex items-center justify-start w-full mx-auto pb-0 my-32 md:my-42 lg:my-42 xl:my-48 px-4 py-6 bg-black flex flex-col justify-center items-center" style={{ background: '#000000ad url(' + arriereplan + ')', backgroundBlendMode: 'overlay', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    <div className="max-w-6xl mx-auto lg:mx-56 py-2 w-full flex-col items-end">
                        <div className="w-full lg:w-3/5 flex justify-center lg:justify-start">
                            <h1 className="text-5xl my-10 font-bold text-center lg:text-left text-white century leading-tight">Entreprise de <span className="text-bleu">développement web</span> à Toulouse</h1>
                        </div>
                        <br />
                        <h2 className="flex mb-16 full lg:w-3/5 text-white justify-center lg:justify-start mx-auto lg:mx-0 text-xl  century text-center lg:text-left p-1 uppercase -mt-12">Agence web spécialisée dans la création de site internet sur le secteur de Toulouse : développement de sites adaptés à chaque type de projet. </h2>
                ...
                <section className="w-full flex justify-end -mt-0 lg:-mt-32">
                    <div className="w-11/12 lg:w-1/3 bg-bleu shadow-2xl -mt-0 lg:-mt-64 flex flex-col justify-end mx-12 lg:mx-24">
                        <h2 className="flex text-white justify-center text-3xl lg:text-4xl century text-center mt-12"><span className="font-bold">Vous souhaitez contacter une entreprise de développement web pour votre projet à Toulouse ?</span></h2>
                        <br />
                        <p className="px-8 lg:px-16 text-white text-center century text-md">Linkweb met toutes ses compétences au service de votre <strong>entreprise</strong>, pour la <strong>création de votre site internet professionnel</strong> et le développement de votre <strong>projet web</strong>.</p>
                        <br />
                ...
                <section className="w-full lg:w-3/5 px-10 mt-16 lg:-mt-48 mb-16 lg:mb-48">
                    ...
                    <h3 className="century text-xl text-center">
                        Donnez vie à tous vos projets en faisant le choix d'une entreprise de développement web compétente à Toulouse.
                    </h3>
                </section>
                <section className="sidetitle w-10/12 text-center text-black text-2xl justify-center flex flex-col century mt-10 mb-10 mx-auto">
                    <h2 className="century text-center lg:text-left text-black text-3xl md:text-5xl leading-tight">Entreprise de développement web à Toulouse : faites le choix de la compétence</h2>
                    <br />
                    <div className="line-title my-4">
                        <hr className="border-solid w-1/2 lg:w-1/12 border-bleu"></hr>
                        <br />
                        <h3 /*data-aos='fade-left'*/ className="max-w-7xl text-xl text-black text-center lg:text-justify century pb-0">Linkweb fait partie des agences de développement de sites web en France qui mettent tout en œuvre pour apporter une solution internet fonctionnelle et adaptée en fonction de chaque projet.</h3>
                    </div>
                </section>
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + siteinternet + ')' }}>
                        ...
                        <p className="text century lg:mt-0 text-lg lg:text-sm xl:text-lg z-50">Notre <Link to="/agence-creation-site-web-toulouse/" className="font-bold text-bleu hover:text-white">agence de création de site web</Link> développe votre <strong className="font-normal">site internet</strong> dans le parfait respect de votre identité de marque, mais aussi à partir de vos besoins pour un rendu sur-mesure.
                            Nos développeurs mobilisent des <strong className="font-normal">outils digitaux</strong> performants et adaptés à chaque activité. Notre objectif, à travers le <strong className="font-normal">développement de votre site professionnel</strong>, est de vous fournir un <strong className="font-normal">support de communication</strong> accessible sur tous supports (responsive pour être lu sur mobile, tablette ou ordinateur) et respectant votre <strong className="font-normal">identité visuelle</strong>.
                            <br /><br />Pour <strong className="font-normal">créer un site internet professionnel</strong> ergonomique et intuitif, nos développeurs appliquent les concepts d'UI et UX design au sein de notre méthodologie. Ces éléments sont essentiels pour apporter une expérience utilisateur irréprochable aux internautes et s’assurer d’un <strong className="font-normal">bon référencement SEO</strong> par la suite.</p>
                    </div>
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + referencement + ')' }}>
                        <h3 className="text-3xl titrehover text-center century leading-tight"><span>Solution </span><br /><span className="font-bold text-6xl">FONCTIONNELLE</span></h3>
                        <p className="text century text-lg lg:text-sm xl:text-lg z-50">Chaque <strong className="font-normal">solution web</strong> diffère selon les besoins du <strong className="font-normal">client</strong>. Nos <strong className="font-normal">développeurs web</strong> choisissent les meilleures <strong className="font-normal">technologies</strong> et <strong className="font-normal">applications</strong> (<strong className="font-normal">CMS</strong> comme <strong className="font-normal">Wordpress</strong>) pour la mise en place d'un <strong className="font-normal">support fonctionnel</strong>. Linkweb vous apporte des <strong className="font-normal">stratégies de développement</strong> adaptées à vos besoins. Notre <strong className="font-normal"><Link to="/agence-web-balma/" className="text-bleu hover:text-white font-bold">agence web à Balma</Link></strong> vous accompagne durant tout votre <strong className="font-normal">projet</strong>.
                        <br /><br />Dès le lancement de votre projet, le choix des bons <strong className="font-normal">outils de création</strong> (CMS, application web, etc.), des <strong className="font-normal">technologies web</strong> (HTML, CSS, PHP, JavaScript, etc.), doit faciliter la lecture du <strong className="font-normal">site</strong> pour les <strong className="font-normal">navigateurs</strong>, les <strong className="font-normal">moteurs de recherche</strong> et les utilisateurs. Notre savoir-faire assure la gestion de vos projets dès leur mise en place. Parmi les <strong className="font-normal">agences web</strong> existantes, la polyvalence et la force d’initiative de notre <strong className="font-normal">entreprise</strong> garantissent une prestation complète et sur-mesure.
                        </p>
                    </div>
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + webdesign + ')' }}>
                        <h3 className="text-3xl titrehover text-center century leading-tight"><span>Création </span><br /><span className="font-bold text-6xl">CONFORME</span></h3>
                        <p className="text century text-lg lg:text-sm xl:text-lg z-50">Au cours de la réalisation de votre <strong className="font-normal">projet de création de site internet</strong>, nos développeurs répondent à chaque critère de conformité essentiel à l'accessibilité de votre <strong className="font-normal">site web</strong>. Nos services professionnels et sur-mesure sont parfaitement conformes aux attentes des différents acteurs du web : respect du <strong className="font-normal">RGPD</strong>, critères <strong className="font-normal">W3C</strong>, protocole sécurisé. Ces notions concernent notamment la sécurisation des données de l’utilisateur et sont désormais indispensables dès le <strong className="font-normal">développement de votre projet web</strong>.
                            <br /><br />Pour donner confiance aux utilisateurs de <strong className="font-normal">votre site</strong>, nos équipes veillent à la mise en place du protocole HTTPS qui protège la navigation sur les pages de votre site. Les développeurs de notre <strong className="font-normal"><Link to="/agence-web-marmande/" className="font-bold text-bleu hover:text-white">agence web présente à Marmande</Link></strong> ainsi qu'à Toulouse sont en mesure de tout mettre en oeuvre pour une lecture optimale de votre site par les navigateurs, les moteurs et les visiteurs.</p>
                    </div>
                </section>
                <section className="bg-bleu sidetitle py-10">
                    <section className="w-full lg:w-2/3 flex flex-col justify-center century my-10 px-4 lg:px-32 md:mx-6 sm:mx-12 mt-2 lg:mx-64">
                        <h2 className="century text-center lg:text-left text-white text-3xl md:text-5xl leading-none">Production d'une solution de création de site internet fonctionnelle</h2>
                        <br />
                        <div className="line-title my-4 ">
                            <br />
                    ...
                    <section className="flex justify-center flex-col items-center">
                        <div className="w-full px-12 lg:px-0 flex justify-center flex-col md:flex-row lg:w-3/4 mt-5">
                            <div className="w-full svgtransform md:w-1/4 mx-auto px-2 mb-10 md:mb-0 text-white century text-center lg:text-left">
                                ...
                                <h4 className="font-bold century"><span className="font-bold">Accompagnement personnalisé</span></h4>
                                <p>Nous vous accompagnons dès le choix de votre solution d'<strong className="font-normal">hébergement web</strong> et de nom de domaine.</p>
                            </div>
                            <div className="w-full svgtransform text-white md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                ...
                                <h4 className="font-bold century -mt-4"><span className="font-bold">Maîtrise des technologies web</span></h4>
                                <p>Nos équipes mobilisent des <strong className="font-normal">outils web</strong> variés : CMS (type Wordpress), gestionnaires de bases de données, frameworks, langages (<strong className="font-normal">JavaScript, PHP, HTML</strong>, etc.), etc.</p>
                            </div>
                            <div className="w-full svgtransform text-white md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                ...
                                <h4 className="font-bold century"><span className="font-bold">Solution webmarketing sur-mesure</span></h4>
                                <p>Linkweb fait partie des <strong className="font-normal">agences en France</strong> qui sont à l’écoute de leurs <strong className="font-normal">clients</strong> et sont attentives à mettre en <strong className="font-normal">application une solution web marketing</strong> efficace en fonction de vos objectifs.</p>
                            </div>
                        </div>
                        <div className="w-full text-white flex flex-col md:flex-row justify-center lg:w-3/4 mt-5 md:mt-10 mb-12">
                            <div className="w-full svgtransform md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                ...
                                <h4 className="font-bold century"><span className="font-bold">Webdesign adaptatif<br /></span></h4>
                                <p>L’<strong className="font-normal">expérience utilisateur</strong> doit être optimale et offrir une facilité de <strong className="font-normal">navigation</strong> depuis n’importe où et via tous les <strong className="font-normal">supports</strong> (<strong className="font-normal">mobile</strong>, <strong className="font-normal">tablette</strong>, etc.)</p>
                            </div>
                            <div className="w-full svgtransform md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                ...
                                <h4 className="font-bold century"><span className="font-bold">Fiche Google My Buisness optimisée</span></h4>
                                <p>Linkweb paramètre les <strong className="font-normal">fiches entreprises</strong> Google My Business de ses <strong className="font-normal">clients</strong> pour une visibilité locale optimale à <strong className="font-normal">Toulouse</strong> comme à <strong className="font-normal">Agen</strong>.</p>
                            </div>
                            <div className="w-full svgtransform md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                ...
                                <h4 className="font-bold century"><span className="font-bold">Notoriété en ligne</span></h4>
                                <p>En tant qu'<strong className="font-normal"><Link to="/agence-site-web-toulouse/" className="text-darkgrey hover:text-white font-bold">agence de site web à Toulouse</Link></strong>, Linkweb vous accompagne dans votre recherche de <strong className="font-normal">visibilité</strong> grâce à une solution fonctionnelle et performante.</p>
                            </div>
                        </div>
                    </section>
                </section>
                <section className="sidetitle w-10/12 text-center text-black text-2xl justify-center flex flex-col century mt-10 mb-10 mx-auto">
                    <h2 className="century text-center lg:text-left text-black text-3xl md:text-5xl leading-tight">Des services web diversifiés en fonction de vos besoins</h2>
                    <br />
                    <div className="line-title my-4">
                        <hr className="border-solid w-1/2 lg:w-1/12 border-bleu"></hr>
                        <br />
                        <h3 /*data-aos='fade-left'*/ className="max-w-6xl text-xl text-black text-center lg:text-justify century pb-0">Linkweb fait partie des <Link to="/agence-web-montauban/" className="font-bold text-bleu hover:text-black">agences web à Montauban</Link> qui mettent toute leur équipe expérimentée au service de vos projets web. Chacune de nos prestations de création comme de référencement est adaptée en fonction de votre projet.</h3>
                    </div>
                </section>
                        ...
                        <div className="w-full lg:w-1/2 my-10  flex flex-col">
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full px-6 lg:px-6 flex flex-col justify-center">
                                    <h3 className="century uppercase text-3xl md:text-4xl tracking-wider pb-3 leading-tight text-center md:text-left" /*data-aos="zoom-in"*/>
                                        <span className="text-bleu">/</span>OBTENIR UN SITE À L'IMAGE DE VOTRE ENTREPRISE
                                </h3>
                                    <br />
                                    <h4 className="century"><span className="font-bold">Linkweb met toute son expertise à votre service pour vous proposer un site internet sur-mesure.</span></h4>
                                    <br />
                                    <p className="w-full century pb-4 text-justify"><p  /*data-aos='fade-left'*/ className="text-justify" >En fonction de vos besoins, nous sommes en mesure de vous fournir une prestation parfaitement adaptée. Qu'il s'agisse de mettre en place une <strong className="font-normal">boutique en ligne</strong> à partir d'un <strong className="font-normal">site ecommerce</strong> adapté, un <strong className="font-normal">site vitrine</strong> pour présenter vos prestations de services ou bien une solution sur-mesure, nous vous apportons des <strong className="font-normal">solutions concrètes et fonctionnelles</strong>. Il existe différents types de <strong className="font-normal">sites internet</strong>, nos développeurs conçoivent celui qui correspond le mieux à tous vos <strong className="font-normal">projets web</strong>.</p>
                                    </p>
                            ...
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full px-12 lg:px-6 flex flex-col justify-center">
                                    <h3 className="century uppercase text-3xl md:text-4xl tracking-wider pb-3 leading-tight text-center md:text-left" /*data-aos="zoom-in"*/>
                                        <span className="text-bleu">/</span>DÉVELOPPER UNE SOLUTION DIGITALE COMPLÈTE
                                    </h3>
                                    <br />
                                    <h4 className="century"><span className="font-bold">Nous sommes en mesure d’adapter notre méthodologie et nos services en fonction de chaque projet grâce à des applications web performantes.</span></h4>
                                    <br />
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify">Nos <strong className="font-normal">équipes</strong> vous accompagnent dès le choix de l’<strong className="font-normal">hébergement web</strong> de votre site. Nous disposons d’<strong className="font-normal">outils</strong> efficaces pour <strong className="font-normal">développer un site</strong> performant. Nous mettons tout à l'oeuvre pour <strong className="font-normal">développer votre site de vente en ligne</strong> aussi bien que votre <strong className="font-normal">site internet catalogue</strong> ou vitrine. C'est notamment grâce à la maîtrise de multiples <strong className="font-normal">technologies web</strong> (frameworks, CMS comme Wordpress, applications web, divers langages comme le HTML, CSS, PHP, Javascript, gestionnaire de base de données, etc.) que nous sommes en mesure de vous proposer une solution complète et personnalisée.</p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                                </div>
                            </div>
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full px-12 lg:px-6 flex flex-col justify-center">
                                    <h3 className="century uppercase text-3xl md:text-4xl tracking-wider pb-3 leading-tight text-center md:text-left" /*data-aos="zoom-in"*/>
                                        <span className="text-bleu">/</span>OPTIMISER LA GESTION DE VOTRE PROJET
                                    </h3>
                                    <br />
                                    <h4 className="century"><span className="font-bold">Linkweb fait partie des agences en France qui vous proposent un accompagnement complet.</span></h4>
                                    <br />
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify">Une des premières étapes lors de la <strong className="font-normal">conception d’un site internet</strong> est le choix de l’<strong className="font-normal">hébergement web</strong> ainsi que du <strong className="font-normal">nom de domaine</strong>. Lorsque l'on fait le <strong className="font-normal">choix d'un nom de domaine</strong>, il faut savoir qu'il doit être régulièrement renouvelé pour ne pas tomber dans le domaine public. Notre <strong className="font-normal"><Link to="/agence-web-albi/" className="text-bleu hover:text-black font-bold">agence web à Albi</Link></strong> se charge de la gestion de votre solution d'hébergement et du renouvellement de votre nom de domaine pour une prestation de gestion complète.</p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                                </div>
                            </div>
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full px-12 lg:px-6 flex flex-col justify-center">
                                    <h3 className="century uppercase text-3xl md:text-4xl tracking-wider pb-3 leading-tight text-center md:text-left" /*data-aos="zoom-in"*/>
                                        <span className="text-bleu">/</span>SUIVI RÉGULIER ET UNE MAINTENANCE TECHNIQUE
                                    </h3>
                                    <h4 className="century"><span className="font-bold">Nous intervenons en amont du projet, mais aussi tout au long de sa mise en place répondre à toute problématique rencontrée sur votre site. </span></h4>
                                    <br />
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify">Notre <strong className="font-normal">équipe technique</strong> vous accompagne tout au long du déroulement vos <strong className="font-normal">projets en ligne</strong> : en cas de modification de contenu, de changement de design, d'ajout ou de suppresion de fonctionnalité, nous vous apportons des solutions.
                                        Nous garantissons un suivi régulier grâce au travail de nos développeurs pour un point régulier au sujet de votre <strong className="font-normal">support de communication web</strong>. De plus, notre <strong className="font-normal">équipe de développement</strong> est à même de répondre aux potentiels dysfonctionnements sur votre site.</p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                                </div>
                            </div>
                        </div>
                ...
                <section className="sidetitle w-10/12 text-center text-black text-2xl justify-center flex flex-col century mt-10 mb-10 mx-auto">
                    <h2 className="century text-center lg:text-left text-black text-3xl md:text-5xl leading-tight">Notre priorité : fournir un site internet sur-mesure performant et pertinent</h2>
                    <br />
                    <div className="line-title my-4">
                        <hr className="border-solid w-1/2 lg:w-1/12 border-bleu"></hr>
                        <br />
                        <h3 /*data-aos='fade-left'*/ className="max-w-6xl text-xl text-black text-center lg:text-justify century pb-0">Vos objectifs marketing sont les nôtres : Linkweb met en application toute son expérience et ses compétences pour vous apporter le résultat escompté.</h3>
                    </div>
                </section>
                <section className="tabPanel flex flex-1 w-full justify-end ml-0 mb-24">
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            <div className="w-full" label="DÉVELOPPEMENT D'UN SUPPORT DE COMMUNICATION PERTINENT POUR VOTRE STRATÉGIE WEBMARKETING">
                                <p>Votre site est un <strong className="font-normal">outil de communication</strong> efficace pour votre <strong className="font-normal">stratégie webmarketing</strong> : la volonté de Linkweb sur le secteur de <strong className="font-normal">Toulouse</strong> est de vous apporter des solutions pertinentes grâce à des supports réfléchis.
                                    En effet, nos compétences et notre savoir-faire en gestion de projet accompagnent tous types d’organismes pour leur fournir la <strong className="font-normal">visibilité</strong> qu'ils recherchent.
                                    <br /><br />
                                    Apporter une <strong className="font-normal">ergonomie</strong> à votre interface web jouent un rôle pour une expérience utilisateur optimale sur votre <strong className="font-normal">site internet</strong>. L'intégration de contenu optimisé par notre équipe de référencement et de développement vise la <strong className="font-normal">génération d'un trafic</strong> intéressant sur votre site pour tirer profit d'une bonne <strong className="font-normal">communication web</strong>.
                                </p>
                            </div>
                            <div label="ACQUISITION DE VISIBILITÉ ET DE NOTORIÉTÉ GRÂCE AU RÉFÉRENCEMENT NATUREL">
                                <p>
                                    Gagner en visibilité grâce à un <strong className="font-normal">site internet bien construit</strong> va aider à <strong className="font-normal">affirmer sa notoriété sur le web</strong>. L’<strong className="font-normal">équipe de Linkweb</strong> met en place une prestation de <strong className="font-normal">référencement naturel</strong> performante ainsi qu'un suivi régulier pour vous tenir informé de l'évolution de votre <strong className="font-normal">application web</strong>.
                                Nôtre rôle consiste à vous apporter des <strong className="font-normal">solutions</strong> concrète en termes de <strong className="font-normal">visibilité et de notoriété sur le Web</strong> grâce à un travail soigné à partir de nos connaissances digitales. Nos compétences sur Internet se divisent entre le développement (usage de CMS comme Wordpress, maîtrise des langages tels que le Javascript, PHP, etc.) et le <strong className="font-normal">webmarketing</strong> (référencement naturel ou payant). Notre polyvalence vous assure un projet en ligne global.
                                </p>
                            </div>
                            <div label="RETOUR SUR INVESTISSEMENT ET DÉVELOPPEMENT DE VOTRE CHIFFRE D'AFFAIRES">
                                <p>
                                    Grâce à un <strong className="font-normal">webdesign intuitif</strong> et ergonomique ainsi qu'à des <strong className="font-normal">techniques de référencement</strong> optimales, notre objectif est de vous permettre d’exploiter la totalité du potentiel de votre <strong className="font-normal">marché en ligne</strong>. Que votre <strong className="font-normal">site web</strong> soit un site ecommerce, un site vitrine, catalogue ou administrable, nos équipes choisissent la solution la plus adaptée en vue d'obtenir des retombées intéressantes.
                                <br /><br />
                                Linkweb fait partie des <strong className="font-normal">entreprises de France</strong> qui mettent un point d’honneur à générer une fréquentation constamment en progression ainsi qu'un trafic qualitatif sur les sites de ses <strong className="font-normal">clients</strong>. Nous menons une relation de collaboration optimale pour atteindre tous vos objectifs et répondre à vos ambitions.
                            </p>
                            </div>
                        </Accordion>
                    </div>
...
query lastsThreePostsQuelleEntrepriseDeveloppementWebToulouse {
    allWpPost(limit: 3) {
      edges {
        node {
          id
...
`
export default EntrepriseDeveloppementWebToulouse;
