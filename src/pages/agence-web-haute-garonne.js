            ...
            <Layout location={this.props.location}>
                ...
                <section className="flex flex-col lg:flex-row mx-8 lg:mx-24 my-0 items-center lg:justify-center">
                    <div data-aos="fade-in" className=" w-full lg:w-3/12 md:w-1/2 bg-white my-4 border border-darkgrey mx-10 hover:shadow-xl py-6 century" style={{ borderRadius: '15px', borderColor: '#d4d4d4', transform: 'translateZ(0) scale(1)', transition: '0.3s' }}>
                        ...
                        <p className="text-center px-6 text-md">Notre <strong className="font-normal"><Link to="/agence-internet-toulouse/" className="text-bleu hover:text-black font-bold">agence internet</Link></strong> réalise votre site internet en fonction de vos besoins : <strong className="font-normal">site vitrine</strong>, <strong className="font-normal">e-commerce</strong> ou administrable.</p>
                        <br />
