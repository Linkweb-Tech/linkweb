...
class AgenceWebHauteGaronne extends React.Component {
            ...
            <Layout location={this.props.location}>
                ...
                > */}
                    ...
                    <section className="flex flex-col lg:flex-row mx-8 lg:mx-24 my-0 items-center lg:justify-center">
                        ...
                        <p className="text-center px-6 text-md">Notre <strong className="font-normal">agence web</strong> réalise votre <Link to="/agence-creation-site-web-toulouse/" className="text-bleu hover:text-black font-bold">site internet</Link> en fonction de vos besoins : <strong className="font-normal">site vitrine</strong>, <strong className="font-normal">e-commerce</strong> ou administrable.</p>
                        <br />
            ...
            <section className="max-w-5xl w-full mx-auto px-4 pt-12 pb-0 my-2">
                ...
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    ...
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + webdesign + ')' }}>
                        ...
                        <br/><br/>
                        De plus, cette veille mensuelle permet de constater l’<strong className="font-normal">évolution du site</strong> dans les <strong className="font-normal">résultats de recherche</strong> et de définir en suivant, les critères à prioriser pour atteindre le haut de la <strong className="font-normal">page de résultat des moteurs</strong>. Ainsi, notre <strong className="font-normal">agence webmarketing</strong> opte pour la transparence et les explications claires. Nous faisons preuve de pédagogie pour aider notre clientèle à constater le travail de création et les avancées concrètes réalisées sur le <strong className="font-normal">site</strong>.</p>
                    </div>
                </section>
