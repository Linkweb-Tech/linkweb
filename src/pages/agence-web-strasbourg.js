    ...
    render() {
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    title="Agence Web Strasbourg - Création site internet - Linkweb"
                ...
                <section className="flex items-center justify-start w-full mx-auto pb-0 my-32 md:my-42 lg:my-42 xl:my-48 px-4 py-6 bg-black flex flex-col justify-center items-center" style={{ background: '#000000ad url(' + arriereplan + ')', backgroundBlendMode: 'overlay', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    <div className="max-w-6xl mx-auto lg:mx-56 py-2 w-full flex-col items-end">
                        <div className="w-full lg:w-2/3 flex justify-center lg:justify-start">
                            <h1 className="text-5xl my-10 font-bold text-center lg:text-left text-white century leading-tight">Agence web Strasbourg - Création site internet</h1>
                        </div>
                        <br />
                ...
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + siteinternet + ')' }}>
                        ...
                        <p className="text century lg:mt-0 text-lg lg:text-sm xl:text-lg z-50">Notre <strong className="font-normal"><a href="/" className="text-bleu hover:text-white font-bold">agence web de Toulouse</a></strong> vous propose des solutions de création adaptées à vos attentes dans le respect de votre <strong className="font-normal">identité visuelle</strong> : nos équipes vous accompagnent dans le <strong className="font-normal">projet de développement</strong> (site vitrine, site e-commerce, sur-mesure). La multitude d'outils maîtrisés par notre <strong className="font-normal"><a href="/agence-web-montpellier/" className="text-bleu hover:text-white font-bold">agence web à Montpellier</a></strong> (Wordpress, Prestashop, etc.) apporte une réponse pertinente à vos besoins en termes de navigation entre les <strong className="font-normal">pages web</strong> notamment.<br/><br/>
                        Pour donner vie à votre <strong className="font-normal">projet en ligne</strong>, définissez vos objectifs et l'équipe de développeurs de l’agence se charge de <strong className="font-normal">concevoir le site</strong> qui vous correspond. Bénéficiez de nos conseils tout au long de la <strong className="font-normal">réalisation du site</strong> pour gagner en visibilité.</p>
                    </div>
                    ...
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + webdesign + ')' }}>
                        ...
                        <p className="text century text-lg lg:text-sm xl:text-lg z-50">
                        Opter pour le <strong className="font-normal">référencement Ads</strong> permet à votre entreprise de bénéficier d’un <strong className="font-normal">retour sur investissement</strong> rapide. Linkweb fait partie des <strong className="font-normal">agences</strong> qui mettent tout œuvre pour répondre à vos objectifs à travers divers <strong className="font-normal">outils du web</strong>. Générez de l’activité grâce au <strong className="font-normal">référencement payant</strong> en vous plaçant en tête de première page des résultats de recherche sur Google grâce au conseil des <strong className="font-normal">experts de notre <a href="/agence-web-bordeaux/" className="text-bleu hover:text-white font-bold">agence web spécialisée à Bordeaux</a></strong>.
                            <br /><br />Grâce à l’expérience et au savoir-faire de notre <strong className="font-normal"><Link to="/agence-web-agen/" className="text-bleu hover:text-white font-bold">agence web à Agen</Link></strong>, l’activité de <strong className="font-normal">votre site</strong> est boostée et vous permet de développer votre communication en vue d’attirer l'œil de <strong className="font-normal">nouveaux clients</strong>.</p>
                    </div>
                </section>
