            ...
            <Layout location={this.props.location}>
                ...
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    ...
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + referencement + ')' }}>
                        ...
                        En définissant vos objectifs et votre <strong className="font-normal">stratégie de webmarketing</strong> avec l’agence Linkweb sur le secteur de <strong className="font-normal">Strasbourg</strong> mais également partout en Alsace et en France, positionnez-vous stratégiquement au sein des <strong className="font-normal">résultats de recherche</strong> des moteurs comme Google. 
                    ...
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + webdesign + ')' }}>
                        ...
                        <p className="text century text-lg lg:text-sm xl:text-lg">
                        Opter pour le <strong className="font-normal">référencement Ads</strong> permet à votre entreprise de bénéficier d’un <strong className="font-normal">retour sur investissement</strong> rapide. Linkweb fait partie des <strong className="font-normal">agences</strong> qui mettent tout œuvre pour répondre à vos objectifs à travers divers <strong className="font-normal">outils du web</strong>. Générez de l’activité grâce au <strong className="font-normal">référencement payant</strong> en vous plaçant en tête de première page des résultats de recherche sur Google grâce au conseil des <strong className="font-normal">experts de notre agence spécialisée</strong>.
                            <br /><br />Grâce à l’expérience et au savoir-faire de notre <strong className="font-normal">agence</strong>, l’activité de <strong className="font-normal">votre site</strong> est boostée et vous permet de développer votre communication en vue d’attirer l'œil de <strong className="font-normal">nouveaux clients</strong>.</p>
                    </div>
                </section>
