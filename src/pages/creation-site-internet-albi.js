...
import Bg from "../images/creation-site-internet-albi.jpg";
...
class CreationSiteInternetAlbiPage extends React.Component {
    ...
    render(){
        ...
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    title="Création Site Internet Albi (81) - Agence Web Linkweb"
                    description="Création de site internet sur-mesure, e-commerce ou vitrine à Albi. Devis gratuit – Accompagnement professionnel - Suivi régulier et personnalisé."
                    keywords={[`Création site internet Agen`, `Création site internet Albi`, `Création site web Agen`, `Création site web Albi`]}
                    url="https://linkweb.fr/creation-site-internet-albi/"
                    nom="Création de site internet à Albi"
                    slug="creation-site-internet-albi/"
                /> 
                {/* <PageTransition
                    defaultStyle={{
                ...
                > */}
                    ...
                    <section className="w-full bloctitrescreen mx-auto px-10 sm:px-4 py-6 bg-no-repeat bg-cover flex flex-col justify-center items-center" style={{ background:'rgba(0,0,0,.65) url(' + Bg + ')', backgroundBlendMode:'multiply', backgroundPosition:'center', backgroundSize:'cover' }}>
                        <h1 /*data-aos="fade-up" data-aos-delay="500"*/ className="century text-4xl sm:text-6xl text-center text-white">
                        Création site internet Albi <span className="text-bleu">(81)</span>
                        </h1>
                    ...
                    <section className="max-w-5xl w-full mx-auto px-12 py-6 my-4 century">
                        <h2 className="text-justify text-xl font-bold" style={{textAlignLast:'center'}}>
                            Depuis 2008, Linkweb est à l'origine de la création de sites internet pour des entreprises issues d'horizons différents. Notre rôle, en tant qu'agence web à Albi, est de vous accompagner pour atteindre vos objectifs de visibilité sur le Web.
                        </h2>
                    ...
                    {/* <section className="flex-wrap flex flex-col justify-center md:flex-row w-full mx-auto py-0 mt-2 ">
                        <div className=" font-bold	w-full md:w-1/3 px-6 flex justify-center items-center flex-col min-h-400 text-center text-white" style={{background:'#00cfffe0 url( '+ blocBg +')', backgroundBlendMode: 'multiply', backgroundSize: 'cover'}}>
                            ...
                            <RoundButton color="bleu" url="/creation-site-internet-vitrine/" text="Création de site vitrine" />
                        </div>
                        ...
                        <div className="font-bold w-full md:w-1/3 px-6 flex justify-center items-center flex-col min-h-400 text-center text-white" style={{background:'#00b1e2 url( '+ blocBg +')', backgroundBlendMode: 'multiply', backgroundSize: 'cover'}}>
                            ...
                            <RoundButton color="bleu" url="/creation-site-internet-sur-mesure/" text="Créer un site internet sur-mesure" />
                        </div>
                    </section> */}
                    <section className="flex w-full flex-col lg:flex-row mx-auto px-4 py-6 my-4">
                        <div className="w-full lg:w-1/2">
                            <img src={imac} alt="Création site internet Albi"/>
                        </div>
                    ...
                    <section className="max-w-5xl w-full mx-auto px-4 pt-12 pb-0 my-2">
                        ...
                        <hr className="blue"></hr>
                        <h3 /*data-aos="fade-in"*/ className="text-center font-normal italic century text-sm">Création de site internet à Albi</h3>
                    </section>
                    ...
                    <section className="flex w-full flex-col lg:flex-row mx-auto px-4 md:py-6 md:my-4">
                        <div className="w-full flex flex-col justify-center lg:w-1/2 pt-6">
                            <img 
                                src={mac}
                                alt="Création site internet Albi"
                                /*data-aos="fade-right"*/
                            />
                        </div>
                    ...
                    <section className="max-w-6xl mx-auto flex flex-col align-center justify-center text-center mt-12 mb-3">
                        <h2 className="century text-center text-2xl tracking-wider pb-3 leading-tight" /*data-aos="zoom-in"*/>
                            <span className="text-bleu">/</span>Vous souhaitez en savoir plus sur la création de site internet à Albi ?
                        </h2>
                        <hr className="blue"></hr>
                    ...
                    <section  className="tabPanel flex flex-1 w-full justify-end ml-0 mb-12">
                        <div className="w-full md:w-3/4 py-0 flex justify-end">
                            <Accordion>
                                ...
                                <div label="COMMENT CRÉER UN SITE WEB DESTINÉ À LA POPULATION ALBIGEOISE (OCCITANIE) ?">
...
`
export default CreationSiteInternetAlbiPage;
