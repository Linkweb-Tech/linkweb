...
class AgenceWebRamonville extends Component {
    ...
    render() {
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    title="Agence Web Ramonville - Projets Web sur-mesure - Linkweb"
                    description="L'agence web Linkweb à Ramonville vous accompagne dans le développements de vos projets web sur-mesure : création de site internet, référencement SEO, campagnes sponsorisées Ads."
                    keywords={[`Agence Web Ramonville`, `Agence Web Toulouse`, `Agence digitale Toulouse`, `Agence digitale Ramonville`]}
                    url="https://linkweb.fr/agence-web-ramonville/"
                    nom="Agence Web Ramonville"
                    slug="agence-web-ramonville/"
                />
                {/* <PageTransition
                    defaultStyle={{
                ...
                <section className="w-full bloctitrescreen mx-auto px-4 py-6 bg-no-repeat bg-bottom bg-cover flex flex-col justify-center items-center" style={{ background: 'rgba(0,0,0,.65) url(' + Bg + ')', backgroundPosition: 'center', backgroundSize: 'cover', backgroundBlendMode: 'multiply' }}>
                    <h1 /*data-aos="fade-up" data-aos-delay="500"*/ className="century text-4xl sm:text-6xl text-center text-white">
                        Agence web Ramonville Saint Agne
                        </h1>
                    <h3 className="italic text-center text-lg sm:text-2xl text-white mt-3">Développez votre projet web à Ramonville Saint Agne, dans le secteur de Toulouse.</h3>
                ...
                <section className="flex flex-col lg:flex-row mx-8 lg:mx-24 my-0 items-center lg:justify-center">
                    <div data-aos="fade-in" className=" w-full lg:w-3/12 md:w-1/2 bg-white my-4 border border-darkgrey mx-10 hover:shadow-xl py-6 century" style={{ borderRadius: '15px', borderColor: '#d4d4d4', transform: 'translateZ(0) scale(1)', transition: '0.3s' }}>
                        ...
                        <p className="text-center px-6 text-md">Une solution de création digitale pour tout type de site internet : <strong>site vitrine</strong>, <strong>e-commerce</strong> ou <strong>administrable</strong>.</p>
                        <br />
                        <ul className="text-bold text-center py-2">
                            <li className="py-2 flex flex-row justify-center">
                                ...
                                <div className="w-9/12 text-left">Ergonomie et design sur-mesure</div>
                            </li>
                            <li className="py-2 flex flex-row justify-center">
                                <div className="w-3/12 text-center text-bleu">✔</div>
                            ...
                            <li className="py-2 flex flex-row justify-center">
                                <div className="w-3/12 text-center text-bleu">✔</div>
                                <div className="w-9/12 text-left">Hébergement web et nom de domaine</div>
                            </li>
                            <li className="py-2 flex flex-row justify-center">
                                <div className="w-3/12 text-center text-bleu">✔</div>
                                <div className="w-9/12 text-left">Navigation en toute sécurité (protocole HTTPS)</div>
                            </li>
                            <li className="py-2 flex flex-row justify-center">
                                <div className="w-3/12 text-center text-bleu">✔</div>
                                <div className="w-9/12 text-left">Respect du cadre RGPD</div>
                            </li>
                            <li className="py-2 flex flex-row justify-center">
                                <div className="w-3/12 text-center text-bleu">✔</div>
                    ...
                    <div data-aos="fade-in" data-aos-delay="300" className=" w-full md:w-1/2 lg:w-3/12 bg-white my-12 border border-darkgrey mx-8 hover:shadow-xl py-6 century" style={{ borderRadius: '15px', borderColor: '#d4d4d4', transform: 'translateZ(0) scale(1)', transition: '0.3s' }}>
                        ...
                        <h3 className="text-center text-2xl font-bold century">Référencement Naturel et Ads</h3>
                        <hr className="blue"></hr>
                        <p className="text-center px-6">Après une étude de la concurrence et de vos besoins, nous vous proposons des <strong>stratégies de communication et de référencement</strong> adaptées.</p>
                        <br />
                        <ul className="text-bold text-center py-2">
                            <li className="py-2 flex flex-row justify-center">
                                <div className="w-3/12 text-center text-bleu">✔</div>
                                <div className="w-9/12 text-left">Sélection des mots-clés</div>
                            </li>
                            <li className="py-2 flex flex-row justify-center">
                                <div className="w-3/12 text-center text-bleu">✔</div>
                                <div className="w-9/12 text-left">Optimisation SEO on-site</div>
                            </li>
                            <li className="py-2 flex flex-row justify-center">
                                <div className="w-3/12 text-center text-bleu">✔</div>
                                <div className="w-9/12 text-left">Rédaction et création de contenu</div>
                            </li>
                            <li className="py-2 flex flex-row justify-center">
                                <div className="w-3/12 text-center text-bleu">✔</div>
                            ...
                            <li className="py-2 flex flex-row justify-center">
                                <div className="w-3/12 text-center text-bleu">✔</div>
                                <div className="w-9/12 text-left">Accompagnement et audit personnalisé</div>
                            </li>
                            <li className="py-2 flex flex-row justify-center">
                                <div className="w-3/12 text-center text-bleu">✔</div>
                    ...
                    <div data-aos="fade-in" data-aos-delay="700" className=" w-full md:w-1/2 lg:w-3/12 bg-white my-12 border border-grey mx-8 hover:shadow-xl py-6 century" style={{ borderRadius: '15px', borderColor: '#d4d4d4', transform: 'translateZ(0) scale(1)', transition: '0.3s' }}>
                        ...
                        <h3 className="text-center text-2xl font-bold century">Solution digitale sur-mesure</h3>
                        <hr className="blue"></hr>
                        <p className="text-center px-6">Linkweb est à votre écoute pour la définition de votre projet sur-mesure à partir de vos besoins.</p>
                        <br />
                        <ul className="text-bold text-center py-2">
                            <li className="py-2 flex flex-row justify-center">
                                <div className="w-3/12 text-center text-bleu">✔</div>
                        ...
                        <div className="flex items-center xl:items-center flex-col xl:flex-row flex-1">
                            ...
                            <section className="w-full lg:w-1/2 absolute z-10 px-auto lg:w-1/2 absolute px-12 lg:px-24 pt-24">
                                ...
                                <div className="century content pb-6 text-justify" style={{ textAlignLast: 'center' }}>
                                    Informer les administrés est votre priorité ? En tant que mairie, conseil départemental, établissement culturel, notre <strong><Link to="/agence-web-muret/" className="text-bleu hover:text-black font-bold">agence web présente à Muret</Link></strong> vous propose des solutions adaptées pour y parvenir. Nous activons tous les leviers pour mener une campagne de <strong>communication web</strong> réussie.
                                </div>
                ...
                <section className="flex w-full flex-col xl:flex-row mx-auto px-0 py-6 my-4">
                    ...
                    <div className="w-full lg:w-1/2 max-w-3xl px-12 py-12" >
                        <h2 className="century capitalize text-2xl tracking-wider pb-6" /*data-aos="zoom-in"*/>
                            <span className="text-bleu">/</span>AGENCE WEB À RAMONVILLE : NOTRE SAVOIR-FAIRE ET NOTRE POLYVALENCE AU SERVICE DE VOTRE EFFICACITÉ
                            </h2>
                ...
                <section className="max-w-5xl w-full mx-auto px-4 pt-12 lg:pt-2 pb-0 my-2">
                    <h2 /*data-aos='fade-right'*/ className="text-center text-3xl century">
                        <span className="text-bleu">/</span>AGENCE WEB À RAMONVILLE : QUI SOMMES-NOUS ?
                        </h2>
                    <hr className="blue"></hr>
                    <h3 /*data-aos="fade-in"*/ className="text-center font-normal italic century text-sm">Agence Web Ramonville</h3>
                </section>
                    ...
                    <ul className="mt-6 pl-1 sm:pl-6">
                        <li className="operatoire flex justify-start items-center pb-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 1024 1792"><path fill="#37c5ee" d="M595 960q0 13-10 23l-466 466q-10 10-23 10t-23-10l-50-50q-10-10-10-23t10-23l393-393-393-393q-10-10-10-23t10-23l50-50q10-10 23-10t23 10l466 466q10 10 10 23zm384 0q0 13-10 23l-466 466q-10 10-23 10t-23-10l-50-50q-10-10-10-23t10-23l393-393-393-393q-10-10-10-23t10-23l50-50q10-10 23-10t23 10l466 466q10 10 10 23z"></path></svg>&nbsp;
                                <p>Une équipe de <strong>développeurs web</strong> qualifiés pour le développement de votre <strong>site internet</strong>.</p>
                        </li>
                        <li className="operatoire flex justify-start items-center pb-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 1024 1792"><path fill="#37c5ee" d="M595 960q0 13-10 23l-466 466q-10 10-23 10t-23-10l-50-50q-10-10-10-23t10-23l393-393-393-393q-10-10-10-23t10-23l50-50q10-10 23-10t23 10l466 466q10 10 10 23zm384 0q0 13-10 23l-466 466q-10 10-23 10t-23-10l-50-50q-10-10-10-23t10-23l393-393-393-393q-10-10-10-23t10-23l50-50q10-10 23-10t23 10l466 466q10 10 10 23z"></path></svg>&nbsp;
                                <p>Des <strong>consultants SEO</strong> expérimentés pour déployer votre <strong>visibilité sur Google</strong>.</p>
                        </li>
                        <li className="operatoire flex justify-start items-center pb-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 1024 1792"><path fill="#37c5ee" d="M595 960q0 13-10 23l-466 466q-10 10-23 10t-23-10l-50-50q-10-10-10-23t10-23l393-393-393-393q-10-10-10-23t10-23l50-50q10-10 23-10t23 10l466 466q10 10 10 23zm384 0q0 13-10 23l-466 466q-10 10-23 10t-23-10l-50-50q-10-10-10-23t10-23l393-393-393-393q-10-10-10-23t10-23l50-50q10-10 23-10t23 10l466 466q10 10 10 23z"></path></svg>&nbsp;
                                <p>Une veille technique et statistique pour opter pour la bonne stratégie et les meilleures <strong>solutions digitales</strong>.</p>
                        </li>
                        <li className="operatoire flex justify-start items-center pb-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 1024 1792"><path fill="#37c5ee" d="M595 960q0 13-10 23l-466 466q-10 10-23 10t-23-10l-50-50q-10-10-10-23t10-23l393-393-393-393q-10-10-10-23t10-23l50-50q10-10 23-10t23 10l466 466q10 10 10 23zm384 0q0 13-10 23l-466 466q-10 10-23 10t-23-10l-50-50q-10-10-10-23t10-23l393-393-393-393q-10-10-10-23t10-23l50-50q10-10 23-10t23 10l466 466q10 10 10 23z"></path></svg>&nbsp;
                               <p>Une relation de collaboration pour connaître votre ressenti et être force de proposition.</p>
                        </li>
                    </ul>
                ...
                <section className="max-w-6xl mx-auto flex flex-col align-center justify-center text-center mt-12 mb-3">
                    <h2 className="century text-center text-2xl tracking-wider pb-3 leading-tight" /*data-aos="zoom-in"*/>
                        <span className="text-bleu">/</span>Notre priorité : votre satisfaction
                        </h2>
                    <hr className="blue"></hr>
                ...
                <section className="max-w-6xl mx-auto flex flex-col align-center justify-center text-center mt-12 mb-3">
                    <h2 className="century text-center text-xl md:text-2xl tracking-wider pb-3 leading-tight" /*data-aos="zoom-in"*/>
                        <span className="text-bleu">/</span>Agence Web Ramonville : que gagner à se lancer dans un projet web ?
                        </h2>
                    <hr className="blue"></hr>
                    <h4 /*data-aos='fade-left'*/ className="text-lg md:text-xl text-grey text-center century italic px-6 pb-6">Tout ou presque ! Décider d’investir dans un projet web apporte de multiples avantages pour développer son entreprise. Cela commence par multiplier sa présence via les canaux du Web et concevoir son image de marque.</h4>
                </section>
                <section className="tabPanel flex flex-1 w-full justify-end ml-0 mb-12">
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            <div className="w-full" label="OBTENIR UNE MEILLEURE VISIBILITÉ GRÂCE AU RÉFÉRENCEMENT NATUREL">
                                <p>Dès la <strong>conception des sites internet</strong>, nous effectuons un travail de réflexion <strong>stratégique</strong>. Lors de l’élaboration de <strong>votre site internet</strong>, notre <strong>agence de communication</strong> dédie à chaque page et chaque élément de contenu, une fonction particulière.<br /><br />

                                        En fonction de vos prestations et de vos <strong>objectifs de communication</strong>, nous travaillons pour vous apporter une solution concrète. Selon vos besoins, votre marché et votre concurrence, nous mettons toutes les chances de votre côté pour vous permettre de <strong>gagner en visibilité</strong>. Ce travail joue un rôle essentiel dans le cadre du <strong>référencement de site internet</strong> lors de la recherche sur le Web.<br /><br />

                                        Au sein de notre <strong>agence</strong>, les <strong>spécialistes du référencement</strong> définissent les expressions clés qui composent votre <strong>stratégie de référencement naturel</strong> en vue de la développer à l'avenir. Le <strong>plan d’actions</strong> que nous fixons est construit en fonction de vos attentes ainsi que des moyens destinés à vos <strong>outils digitaux</strong>.<br /><br />

                                        Néanmoins, si vous souhaitez <strong>être visible</strong> rapidement sur les <strong>résultats des moteurs de recherche</strong>, vous aurez la possibilité d’opter pour une <strong>campagne Ads</strong> depuis la plateforme <strong>Google AdWords</strong>. Être <strong>référencé</strong> via des <strong>annonces payantes</strong> vous offre une forte visibilité et ce, de manière immédiate.<br /><br />

                                        Vous l’aurez compris, notre rôle en tant qu’<strong>agence spécialisée dans de la création de sites</strong>, est de vous offrir un panel de solutions performantes et adaptées à tous vos besoins.</p>
                            </div>
                            <div label="DÉFINIR VOS CIBLES POUR OPTIMISER VOTRE COMMUNICATION">
                                <p><strong>Être visible</strong> permet à chaque entreprise de toucher un large public sur <strong>Internet</strong>. En effet, le <strong>Web</strong> offre à tous les utilisateurs un accès à l’information recherchée rapidement. La <strong>création de votre site internet</strong> doit prendre en compte tous ces enjeux. De la même façon, instaurer une <strong>arborescence</strong> claire et limpide répondant bien aux besoins des internautes est primordial.<br /><br />
                                        ...
                                        En effet, à partir de votre <strong>charte graphique</strong> et votre <strong>identité visuelle</strong>, les spécialistes de notre <Link to="/agence-web-design-toulouse/" className="text-bleu hover:text-black font-bold">agence de web design à Toulouse</Link> créent un <strong>outil digital</strong> à votre image. Grâce à un <strong>web design</strong> conçu spécialement pour vous, il est un outil indispensable de votre <strong>stratégie de communication digitale</strong>. En somme, il est indispensable en vue de dynamiser votre <strong>image de marque</strong>.<br /><br />
                                        ...
                                        Nous tenons à définir la meilleure stratégie pour votre site en utilisant des outils performants (<strong>CMS</strong> comme <strong>Prestashop</strong>, <strong>Joomla</strong>, <strong>Wordpress</strong> ou <strong>Drupal</strong>) pour atteindre vos cibles.
                                        </p>
                            </div>
                            <div label="CHAQUE PROJET EST UNIQUE ET POSSÈDE SES PROPRES SPÉCIFICITÉS">
                                <p>Si un un <strong>site e-commerce</strong> aura pour objectif la vente de produits en ligne, un site vitrine proposera surtout des interactions simples pour contacter le professionnel et découvrir les prestations qu’il propose.<br /><br />
                                        Ce sont ces singularités qui nous amènent à mettre en place diverses <strong>solutions web</strong> variées et appropriées à chacune de vos ambitions pour votre <strong>entreprise</strong>. Le <strong>site internet</strong> tient une place de choix parmi les différents <strong>supports de communication</strong> existants, aujourd’hui.<br /><br />
                                        En effet, en terme de <strong>webmarketing</strong>, le trafic généré via les <strong>moteurs</strong> de recherche augmentera vos chances d'obtenir un <strong>retour sur investissement</strong>.<br /><br />
                                        La <Link to="/creation-de-site-internet-a-agen/" className="text-bleu hover:text-black font-bold">création de <strong>votre site internet</strong> à Agen</Link> possède un but unique : atteindre de <strong>nouveaux clients</strong> pour <strong>développer votre chiffre d’affaires</strong> et vous donner la possibilité de convertir un maximum de contacts grâce à votre site.</p>
                            </div>
                        </Accordion>
                    </div>
                </section>
...
query lastsThreePostsAgenceRamonville {
    allWpPost(limit: 3) {
      edges {
        node {
          id
...
`
export default AgenceWebRamonville;
