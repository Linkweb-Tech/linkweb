...
class AgenceSEAToulouse extends Component {
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            <div className="w-full" label="GESTION DE PROJET PUBLICITAIRE">
                                <p>Lorsque vous faites appel à l’<strong className="font-normal"><Link to="/agence-web-marketing-toulouse/" className="text-bleu hover:text-black font-bold">agence digitale Linkweb</Link></strong> pour gérer votre <strong className="font-normal">projet publicitaire</strong>, un <strong className="font-normal">consultant SEA</strong> gère votre compte publicitaire. Selon des objectifs et cibles de votre projet, ainsi que de votre <strong className="font-normal">investissement</strong>, le <strong className="font-normal">consultant</strong> sera en mesure d’identifier les meilleures opportunités pour vous.
                                    <br /><br />
