                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            <div className="w-full" label="GESTION DE PROJET PUBLICITAIRE">
                                <p>Lorsque vous faites appel à l’<strong className="font-normal">agence web Linkweb</strong> pour gérer votre <strong className="font-normal">projet publicitaire</strong>, un <strong className="font-normal">consultant SEA</strong> gère votre compte publicitaire. Selon des objectifs et cibles de votre projet, ainsi que de votre <strong className="font-normal">investissement</strong>, le <strong className="font-normal">consultant</strong> sera en mesure d’identifier les meilleures opportunités pour vous.
                                    <br/><br/>
                                    Notre <strong className="font-normal">agence</strong> met en place une prestation d’accompagnement pour <strong className="font-normal">accroître votre présence sur Google</strong> en vue d’obtenir des <strong className="font-normal">résultats pertinents</strong> relativement à votre investissement. Nous proposons une <strong className="font-normal">prestation de référencement</strong> globale pour vous permettre de profiter de toute la complémentarité du <strong className="font-normal">référencement naturel (SEO)</strong> et de la <strong className="font-normal">publicité sur le web</strong>.
                                    <br/><br/>
                                    Tout ceci s’inscrit dans une volonté de <strong className="font-normal">dynamiser votre communication web d’entreprise</strong> grâce à des <strong className="font-normal">techniques marketing</strong> appropriées (via les <strong className="font-normal">moteurs de recherche</strong>).
                                </p>
                            </div>  
                            <div label="PERTINENCE ET QUALITÉ DES PUBLICITÉS">
                                ...
                                <br/><br/>
                                Nos <strong className="font-normal">services</strong> misent sur la conception et le <strong className="font-normal">développement de publicités optimales</strong> pour les <strong className="font-normal">algorithmes des moteurs</strong>, comme pour les utilisateurs. La qualité portée sur le travail effectué (autant en <strong className="font-normal">marketing</strong> qu’en <strong className="font-normal">communication</strong>) fait partie de nos priorités pour proposer à nos clients une prestation en total accord avec leurs attentes (sur les sites en <strong className="font-normal">SEO</strong> comme pour les publicités).
                                </p>
                            </div>
                            <div label="CONSEIL ET ACCOMPAGNEMENT DANS LA PRISE DE DÉCISION">
                                <p>
                                <strong className="font-normal">Linkweb</strong> fait partie des <strong className="font-normal">agences</strong> qui met tout en oeuvre pour apporter des solutions concrètes aux entreprises souhaitant obtenir un <strong className="font-normal">retour sur investissement</strong>. C’est pourquoi, l’activité de notre équipe d’experts et de consultants est basée sur une étude de marché, une <strong className="font-normal">étude de la concurrence</strong> ainsi qu’une étude des opportunités en vue de la conception d’un modèle gagnant.
                                <br/><br/>
