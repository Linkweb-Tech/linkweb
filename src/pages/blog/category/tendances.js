...
class CatTrends extends React.Component {
...
query lastsThreePostsCatTrends {
    ...
    tendances: allWordpressPost(limit: 6, filter: {categories: {elemMatch: {slug: {eq: "tendances"}}}}) {
        edges {
            node {
            id
            title
