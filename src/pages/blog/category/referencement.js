...
class CatReferencement extends React.Component {
...
render() {
    return (
        <Layout location={this.props.location}>
            ...
            <SEO
                title="Agence Référencement Naturel/Ads - Blog - Linkweb Agen"
                ...
                url="https://linkweb.fr/category/referencement/"
            />
            {/* <PageTransition
                defaultStyle={{
...
query lastsThreePostsCatReferencement {
    ...
    ref: allWordpressPost(limit: 6, filter: {categories: {elemMatch: {slug: {eq: "referencement"}}}}) {
        edges {
            node {
            id
            title
...
`
export default CatReferencement;
