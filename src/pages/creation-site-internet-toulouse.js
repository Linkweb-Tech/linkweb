                    ...
                    <div className="w-full flex-col md:flex-row flex px-auto">
                        ...
                        <div className="w-full flex-col md:flex-row flex px-auto">
                            ...
                            <div className="w-full px-12 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <h4 className="century">La conception d'un <Link to="/creation-site-internet-toulouse/webdesign/" className="text-bleu hover:text-black">webdesign</Link> intuitif offre une ergonomie parfaite et une expérience utilisateur optimale.</h4>
                                    <br/>
                        ...
                        <section className="flex justify-center flex-col items-center">
                            <div className="w-full px-12 lg:px-0 flex justify-center flex-col md:flex-row lg:w-3/4 mt-5">
                                ...
                                <div className="w-full svgtransform text-white md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                    ...
                                    <p>Nous créons des sites internet adaptés à chaque <strong>support de navigation</strong> et à sa taille d'écran (<Link to="/creation-site-internet-toulouse/responsive-design/" className="text-white hover:text-black">responsive design</Link>).</p>
                                </div>
                                <div className="w-full svgtransform text-white md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                            ...
                            <div className="w-full svgtransform -mt-2 md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                    ...
                                    <p>Nous utilisons un <Link to="/creation-site-internet-toulouse/cms/" className="text-white hover:text-black">CMS</Link> adapté en fonction des besoins techniques de votre interface (<strong>Wordpress</strong>, <strong>Prestashop</strong>, <strong>Joomla</strong>, etc.).</p>
                                </div>
