                ...
                > */}
                    ...
                    <section className="flex flex-col xl:flex-row mx-8 lg:mx-24 my-0 items-center lg:justify-center">
                        <section className="flex flex-col justify-center md:flex-row w-full mx-auto py-0 mt-2 ">
                            <div data-aos="fade-in" className="blocliens w-full lg:w-1/2 xl:w-6/12 bg-white my-4 border border-darkgrey mx-auto md:mx-4 hover:shadow-xl py-6 century" style={{background:'#37cfee94 url( '+ blocBg +')', backgroundBlendMode: 'multiply', backgroundSize: 'cover', borderRadius: '15px', borderColor: '#d4d4d4' }}>
                            ...
                            <div data-aos="fade-in" className="blocliens w-full lg:w-1/2 xl:w-6/12 bg-darkgrey my-4 border border-darkgrey mx-auto md:mx-4 hover:shadow-xl py-6 century" style={{background:'#00cfffe0 url( '+ blocBg +')', borderRadius: '15px', borderColor: '#d4d4d4', backgroundBlendMode: 'multiply', backgroundSize: 'cover' }}>
                        ...
                        <section className="flex flex-col justify-center md:flex-row w-full mx-auto py-0 mt-2 ">
                            <div data-aos="fade-in" className="blocliens w-full lg:w-1/2 xl:w-6/12 bg-white my-4 border border-darkgrey mx-auto md:mx-4 hover:shadow-xl py-6 century" style={{background:'#00b1e2 url( '+ blocBg +')', backgroundBlendMode: 'multiply', backgroundSize: 'cover', borderRadius: '15px', borderColor: '#d4d4d4' }}>
                            ...
                            <div data-aos="fade-in" className="blocliens w-full lg:w-1/2 xl:w-6/12 bg-white my-4 border border-darkgrey mx-auto md:mx-4 hover:shadow-xl py-6 century" style={{background:'#057898 url( '+ blocBg +')', backgroundBlendMode: 'multiply', backgroundSize: 'cover', borderRadius: '15px', borderColor: '#d4d4d4' }}>
