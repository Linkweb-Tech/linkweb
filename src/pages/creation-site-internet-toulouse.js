                ...
                > */}
                    ...
                    <section className="max-w-5xl w-full mx-auto px-12 py-6 my-4 century">
                        <h2 className="text-justify text-xl font-bold" style={{textAlignLast:'center'}}>
                            Depuis 2008, Linkweb est à l'origine de la création de solutions internet pour des entreprises issues d'horizons différents. Notre rôle, en tant qu'agence web à Toulouse, est de vous accompagner pour atteindre vos objectifs de visibilité sur le Web.
                        </h2>
                    <ul className="px-16 list-disc mt-10 max-w-5xl text-xl">
                        ...
                        <li>Vous souhaitez <strong>présenter votre entreprise</strong> ou les <strong>produits que vous fabriquez</strong> ?</li><br/>
                        <li>Vous souhaitez effectuer <strong>une refonte totale ou partielle</strong> ?</li><br/>
                    </ul>
                    ...
                    <div className="w-full max-w-5xl" /*data-aos='zoom-in'*/>
                            <p className="text-md text-center pt-4 century">Vous souhaitez une création de site internet à Toulouse ? Avoir un site internet professionnel est indispensable pour chaque entreprise de nos jours. <br/><br/>Notre agence web Linkweb répond à vos attentes en vous proposant une solution qui s’adapte à vos besoins.</p>
                        </div>
                    </section>
                    ...
                    <section className="max-w-6xl mx-auto flex flex-col align-center justify-center text-center mt-12 mb-3">
                        ...
                        Nous répondons à vos interrogations sur la mise en place de votre projet web professionnel et sur-mesure.</h4>
                    </section>
