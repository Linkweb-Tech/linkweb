    ...
    render() {
        ...
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    title="Agence de webmarketing à Toulouse - Confiez nous votre projet web - Linkweb"
                ...
                <section className="flex items-center w-full mx-auto pb-0 mt-40 mb-24 px-4 py-6 bg-black flex flex-col justify-center items-center" style={{ background: '#000000ad url(' + Bg + ')', backgroundBlendMode: 'overlay', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    <div className="max-w-6xl mx-auto lg:mx-56 pt-2 lg:w-2/5 w-full flex-col items-end">
                        ...
                        <div className="w-full lg:w-full flex justify-center lg:justify-center">
                            <h1 className="text-4xl md:text-6xl my-10 font-bold text-center text-white century leading-none">Agence de Webmarketing à Toulouse</h1>
                        </div>
                        <br />
                        <h2 className="flex full lg:w-full text-white justify-center lg:justify-center mx-auto lg:mx-0 text-xl  century text-center p-1 -mt-12">Depuis plus de 10 ans, notre agence webmarketing accompagne les professionnels dans le développement de projet web : création de site internet, référencement SEO et SEA, solutions de communication.</h2>
                        ...
                        <div className="w-full lg:w-1/2 my-10  flex flex-col">
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full px-6 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <br />
                                    <h4 className="century">Vous souhaitez obtenir une meilleure visibilité que vos concurrents sur les moteurs de recherche ?</h4>
                                    <br />
                                    <p className="w-full century pb-4 text-justify"><p  /*data-aos='fade-left'*/ className="text-justify" >Le <strong>trafic organique</strong> est une source de trafic importante sur un <strong>site internet e-commerce</strong> souhaitant vendre des produits, un <strong>site vitrine</strong> qui va présenter une société ou fournir des coordonnées de contacts. Globalement, il va offrir à toute société, la chance de déployer une <strong>stratégie de communication digitale</strong> fondée sur le potentiel qu’offrent les <strong>outils de recherche</strong> en termes de <strong>notoriété</strong>.</p>
                                    </p>
                            ...
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full px-12 lg:px-6 flex flex-col justify-center">
                                    <h3 className="century uppercase text-3xl md:text-4xl tracking-wider pb-3 leading-tight text-center md:text-left" /*data-aos="zoom-in"*/>
                                        <span className="text-bleu">/</span>RÉFÉRENCEMENT SEA ADS
                                    </h3>
                                    <br />
                                    ...
                                    <br />
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify">La régie <strong>Google Adwords</strong> propose une solution payante pour <strong>référencer son site</strong> à travers le sponsoring. Cette <strong>stratégie de communication</strong> permet de créer une <strong>campagne publicitaire</strong> très visible dans les <strong>résultats de recherche</strong>. Il s'agit d'une <strong>solution digitale</strong> chaudement recommandée aux professionnels optant pour un <strong>retour sur investissement</strong> rapide.</p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                                </div>
                            </div>
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full px-12 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <br />
                                    <h4 className="century">Travailler sa ligne éditoriale n’est plus suffisant pour répondre aux attentes des algorithmes et des robots. Votre site internet doit proposer sur une expérience utilisateur parfaite.</h4>
                                    <br />
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify">Le <strong>SXO</strong> est né d’une rencontre entre le <strong>référencement naturel</strong> et l’<strong>UX Design</strong> : il consiste à développer une <strong>interface</strong> adaptée au comportement des <strong>utilisateurs</strong>. Que ce soit en termes de compatibilité sur la totalité des <strong>supports</strong> de lecture, temps de chargement au plus court, tout doit être pris en compte. Ceci est, aujourd’hui, indispensable aux yeux des <strong>robots</strong>, mais surtout de vos visiteurs.</p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                                </div>
                            </div>
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full px-12 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <br />
                                    <h4 className="century">L'e-réputation s’intègre aux piliers du référencement et d’une représentation parfaite de son image de marque sur le Web.</h4>
                                    <br />
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify">La <strong>réputation et la popularité en ligne</strong> sont des éléments à considérer lors du lancement d'une <strong>stratégie de web marketing</strong> axée sur le <strong>référencement SEO</strong> ou les réseaux sociaux, pour un professionnel. Les avis sont des paramètres déclencheurs qui vont aller jusque’à être des moteurs vers la <strong>conversion</strong>. Pour dynamiser son <strong>projet</strong>, il sera nécessaire d’associer de bonnes références sur le <strong>web</strong> à une bonne <strong>e-réputation</strong>.</p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                                </div>
                            </div>
                        </div>
                ...
                <section className="bg-black">
                    <section className="max-w-5xl w-full mx-auto px-4 pt-12 pb-0 my-2">
                        <h2 /*data-aos='fade-right'*/ className="century text-center text-white text-3xl md:text-5xl leading-none">
                            Dynamisez <span className="text-bleu">votre activité sur le Web</span>
                        </h2>
                        ...
                        <div className="w-full xl:w-1/3 two px-auto">
                            <div className="flex items-center xl:items-start flex-col xl:flex-row flex-1">
                                ...
                                <section className="w-full lg:w-1/3 absolute z-10 px-auto lg:w-1/3 absolute px-12 lg:px-6 xl:px-24 pt-24">
                                    ...
                                    <div className="century content pb-6 text-justify" style={{ textAlignLast: 'center' }}>
                                        Il existe diverses <strong>techniques de référencement payant ou naturel</strong> pour offrir une position intéressante à son <strong>site dans les résultats de recherche</strong>. Pour se faire une place parmi les <strong>premières positions des SERP</strong>, nous vous accompagnons de façon personnalisée pour définir la formule <strong>webmarketing</strong> qui vous convient le mieux.
                                            </div>
                                    <br />
                                    <button
                ...
                {/*<section className="flex w-full flex-col mx-auto px-0 py-6 my-4">
                    <section className="text-center text-black text-2xl mx-auto lg:mx-0 century mt-16 mb-10">
                        <h2 className="century text-3xl md:text-5xl text-black leading-tight">Faire confiance à <span className="text-bleu">Linkweb </span>à Toulouse</h2>
                        <br />
                ...
                <section className="bg-bleu sidetitle py-10">
                    <section className="w-full lg:w-2/3 flex flex-col justify-center century my-10 px-4 lg:px-32 md:mx-6 sm:mx-12 mt-2 lg:mx-64">
                        <h2 className="century text-center lg:text-left text-black text-3xl md:text-5xl leading-tight">Ce que notre agence réalise pour votre entreprise</h2>
                        <br />
                        <div className="line-title my-4 ">
                            <br />
                            <hr className="w-1/2 border-black lg:w-1/12" />
                            <br />
                            <h3 /*data-aos='fade-left'*/ className="text-xl text-black century pb-0">En tant que spécialiste des techniques de communication web, Linkweb produit un travail soigné et de qualité pour vous apporter un positionnement optimal via votre site internet en vue d'atteindre un taux de conversion maximal.</h3>
                        </div>
                    </section>
                    <section className="flex justify-center text-black flex-col items-center">
                        ...
                        <div className="w-full text-black flex flex-col md:flex-row justify-center lg:w-3/4 mt-5 md:mt-10 mb-12">
                            ...
                            <div className="w-full svgtransform md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                ...
                                <p>Notre agence web à Lyon crée et paramètre votre <strong>profil d'entreprise Google My Business</strong> en vue d'atteindre des utilisateurs à proximité de chez vous.</p>
                            </div>
                            <div className="w-full svgtransform md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                ...
                <section className="flex w-full flex-col mx-auto px-0 py-6 my-4 lg:my-0">
                    <section className="text-center text-black text-2xl mx-auto lg:mx-0 century mt-16 mb-10 lg:mb-2">
                        ...
                        <hr className="border-solid w-1/6 border-bleu"></hr>
                        <br />
                        <h3 className="text-black text-xl text-center century">Donner une nouvelle dynamique à sa communication en recherchant de la visibilité est extrêmement avantageux. <br />Cependant cela demande du temps ainsi que beaucoup de rigueur. <br />Ainsi, voici quelques subtilités à connaître et liées à ce savoir-faire livré par notre agence de communication web à Toulouse.</h3>
                    </section>
                </section>
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            <div className="w-full" label="ATTEINDRE LA PREMIÈRE PAGE DE GOOGLE : QUELS LEVIERS ACTIVER ?">
                                <p>Les professionnels de notre <strong>agence</strong> web à Montpellier concentrent leur énergie afin de satisfaire les <strong>critères des moteurs</strong> afin de vous apporter un <strong>référencement</strong> aux effets bénéfiques pour vous et votre <strong>site web</strong>.</p>
                                <br />
                                <p>Pour ce faire, il est important de réunir de nombreux critères qui apportent de la <strong>crédibilité et de l’autorité à votre site</strong>. Votre présence sera porteuse de <strong>trafic organique</strong> et de retombées financières grâce à <strong>votre projet</strong>. Pour cela, la <strong>qualité des pages proposées sur votre site</strong> joue un rôle important.</p>
                                <br />
                                <p>De la même façon, aux yeux des <strong>moteurs</strong>, l'<strong>e-réputation</strong> et la <strong>popularité du site</strong> vont apporter un poids important à l’entité digitale créée, tout comme son ancienneté et son <strong>ergonomie (webdesign)</strong>.</p>
                                <br />
                                <p>Enfin, l’<strong>agence Linkweb</strong> va favoriser l’<strong>expérience utilisateur</strong> et la mise en place d'un circuit de <strong>navigation</strong> fluide sur votre site web. Il s'agit d'éléments indispensables pour séduire les <strong>robots de recherche</strong> et les utilisateurs. Nos réalisations s'inscrivent dans la logique de ces principes fondamentaux.</p>
                            </div>
                            <div label="COMMENT ME TENIR INFORMÉ DU POSITIONNEMENT ET DE L'OPTIMISATION DE MON SITE ?">
                                <p>L’<strong>index</strong> tenu par les différents outils de recherche peut nécessiter du temps avant de tenir compte des <strong>contenus de votre site</strong>. Cependant notre <strong>agence web spécialisée à Nice</strong> vous apporte un <strong>conseil</strong> précis et vous propose un <strong>rapport de positionnement</strong> mensuel autour de la stratégie sur-mesure adoptée pour votre <strong>projet web</strong> pour mesurer l'application des actions effectuées. Elle vous permet de constater les avancées et de déterminer les éléments à approfondir pour vous apporter une gestion du projet fluide et définir de nouveaux objectifs.</p>
                                <br />
                                <p>Les <strong>référenceurs de l’agence web de Bordeaux Linkweb</strong> s’appuient sur des <strong>outils professionnels</strong> et réalisent une analyse du comportement des utilisateurs poussée pour vous apporter les informations les plus <strong>pertinentes</strong> vis-à-vis de votre site. Les mots-clés qui aideront à fixer la <strong>position du site</strong> au coeur des <strong>premières pages SERP</strong> sont régulièrement évalués en vue d'être reconsidérés. </p>
                                <br />
                                <p>Enfin, sans la <strong>mise à jour régulière des contenus</strong> liés à vos <strong>expressions clés</strong>, votre <strong>site web</strong> risque de ne pas se démarquer du reste de la sphère digitale et de passer à côté de nombreux <strong>clients</strong> cibles. En tant qu’<strong>agence web à Marseille</strong>, nous vous assurons une <strong>optimisation</strong> durable. Nous sommes également en mesure de vous dispenser une formation pour une plus grande autonomie sur votre site.</p>
                            </div>
                            <div label="COMMENT COMMUNIQUER EFFICACEMENT ENVERS MES CIBLES ?">
                                <p>La stratégie choisie pour vous permettre d'<strong>être visible en ligne</strong> va faciliter une bonne transmission de l'information. Le but étant de faciliter l’accès aux éléments recherchés par l’utilisateur sur les sites, ce n'est plus vous qui recherchez vos contacts prospects, mais bien eux qui vous trouvent.</p>
                                <br />
                                <p>Avec le <strong>référencement naturel</strong>, la donne change. Notre équipe <strong>webmarketing</strong> s'appuie sur votre <strong>identité visuelle</strong> et votre <strong>charte graphique</strong> pour vous rendre reconnaissable en plus de textes sur-mesure pour enrichir les pages de votre <strong>site internet</strong>.</p>
                                <br />
                                <p>Grâce à la maîtrise technique de nos <strong>développeurs</strong>, vous disposerez d'une interface à votre image, d’un projet au <strong>webdesign</strong> taillé pour votre entreprise dans le total respect des règles de graphisme. Mettre à votre disposition un outil performant, utile, unique et ergonomique est notre priorité. En effet, les solutions mises en application par des <strong>agences de création de sites web comme Linkweb</strong> en France doivent vous permettre de trouver la méthode la plus efficace pour atteindre vos cibles et atteindre de nouveaux clients. Nos réalisations sont conçues dans cet unique but au sein de notre agence web à Strasbourg.</p>
                            </div>
                        </Accordion>
                    </div>
                </section>
