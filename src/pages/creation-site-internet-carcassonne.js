...
class CreationSiteInternetCarcassonnePage extends Component {
    ...
    render() {
        ...
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    title="Création Site Internet à Carcassonne - Agence Web Linkweb"
                    ...
                    keywords={[`Création site internet Carcassonne`, `Création site internet Toulouse`, `Création site web Carcassonne`, `Création site web Toulouse`]}
                    url="https://linkweb.fr/creation-site-internet-carcassonne/"
                    nom="Création de site internet à Carcassonne"
                    slug="creation-site-internet-carcassonne/"
                />
                {/* <PageTransition
                    defaultStyle={{
                ...
                <section className="w-full bloctitrescreen mx-auto px-10 sm:px-4 py-6 bg-no-repeat bg-cover flex flex-col justify-center items-center" style={{ background: 'rgba(0,0,0,.65) url(' + Bg + ')', backgroundBlendMode: 'multiply', backgroundPosition: 'center', backgroundSize: 'cover' }}>
                    <h1 /*data-aos="fade-up" data-aos-delay="500"*/ className="century text-4xl sm:text-6xl text-center text-white">
                        Création site internet Carcassonne
                        </h1>
                ...
                <section className="max-w-5xl w-full mx-auto px-12 py-6 my-4 century">
                    <h2 className="text-justify text-xl font-bold" style={{ textAlignLast: 'center' }}>
                        Depuis 2008, Linkweb est à l'origine de la création de sites internet pour des entreprises issues d'horizons différents. Notre rôle, en tant qu'agence web à Carcassonne, est de vous accompagner pour atteindre vos objectifs de visibilité sur le Web.
                        </h2>
                ...
                <section className="flex w-full flex-col lg:flex-row mx-auto px-4 py-6 my-4">
                    <div className="w-full lg:w-1/2">
                        <img src={imac} alt="Création site internet Carcassonne" />
                    </div>
                ...
                <section className="max-w-5xl w-full mx-auto px-4 pt-12 pb-0 my-2">
                    ...
                    <hr className="blue"></hr>
                    <h3 /*data-aos="fade-in"*/ className="text-center font-normal italic century text-sm">Création de site internet à Carcassonne</h3>
                </section>
                ...
                <section className="flex w-full flex-col lg:flex-row mx-auto px-4 md:py-6 md:my-4">
                    <div className="w-full flex flex-col justify-center lg:w-1/2 pt-6">
                        <img
                            src={mac}
                            alt="Création site internet Carcassonne"
                        /*data-aos="fade-right"*/
                        />
                    </div>
                ...
                <section className="max-w-6xl mx-auto flex flex-col align-center justify-center text-center mt-12 mb-3">
                    <h2 className="century text-center text-2xl tracking-wider pb-3 leading-tight" /*data-aos="zoom-in"*/>
                        <span className="text-bleu">/</span>Vous souhaitez en savoir plus sur la création de site internet à Carcassonne ?
                        </h2>
                    <hr className="blue"></hr>
...
query lastsThreePostsCarcassonne {
    allWpPost(limit: 3) {
      edges {
        node {
          id
...
`
export default CreationSiteInternetCarcassonnePage;
