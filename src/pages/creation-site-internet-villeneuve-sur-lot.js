...
import Bg from "../images/creation-site-internet-villeneuve-sur-lot.jpg";
...
class CreationSiteInternetVilleneuvePage extends React.Component {
        ...
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    ...
                    slug="creation-site-internet-villeneuve-sur-lot/"
                /> 
                {/* <PageTransition
                    defaultStyle={{
                ...
                > */}
                    ...
                    <section className="w-full h-screen mx-auto px-10 sm:px-4 py-6 bg-no-repeat bg-cover flex flex-col justify-center items-center" style={{ background:'#00000084 url(' + Bg + ')', backgroundBlendMode:'multiply', backgroundPosition:'bottom', backgroundSize:'cover' }}>
                        ...
                        Création de site internet à Villeneuve-sur-Lot
                        </h1>
                    ...
                    <section className="max-w-5xl flex-wrap jusitfy-center flex w-full mx-auto px-4 py-2 my-2 ">
                        ...
                        <img 
                            src={peugeot}
                            alt="Création site internet Villeneuve-sur-Lot"
                        />
                        </div>
                        <div className="w-1/3 md:w-1/6" /*data-aos='fade-up' data-aos-delay='200'*/>
                        <img
                            alt="Création de site internet à Villeneuve-sur-Lot" 
                            src={normand}
                        />
                        </div>
                        ...
                        <img 
                            className="mx-12"
                            src={hg}
                            alt="Réalisations Site Web Villeneuve-sur-Lot"
                            width="65px"
                        />
                        </div>
                    </section>
                    ...
                    <section className="flex w-full flex-col lg:flex-row mx-auto px-4 py-6 my-4">
                        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center">
                            <img src={imac} className="mx-auto flex my-6" alt="Création site internet Villeneuve-sur-Lot"/>
                        </div>
                    ...
                    <section className="max-w-5xl w-full mx-auto px-4 pt-12 pb-0 my-2">
                        ...
                        <hr className="blue"></hr>
                        <h3 /*data-aos="fade-in"*/ className="text-center font-normal italic century text-sm">Création de site internet à Villeneuve-sur-Lot</h3>
                    </section>
                    ...
                    <section className="max-w-6xl mx-auto flex flex-col align-center justify-center text-center mt-12 mb-3">
                        <h2 className="century text-center text-2xl tracking-wider pb-3 leading-tight" /*data-aos="zoom-in"*/>
                            <span className="text-bleu">/</span>Vous souhaitez en savoir plus sur la création de site internet à Villeneuve-sur-Lot ?
                        </h2>
                        <hr className="blue"></hr>
                    ...
                    <section  className="tabPanel flex flex-1 w-full justify-end ml-0 mb-12">
                        <div className="w-full md:w-3/4 py-0 flex justify-end">
                            <Accordion>
                                ...
                                <div label="COMMENT CRÉER UN SITE WEB DESTINÉ À LA POPULATION VILLENEUVOISE (LOT-ET-GARONNE) ?">
...
query lastsThreePostsVilleneuve {
...
`
export default CreationSiteInternetVilleneuvePage;
