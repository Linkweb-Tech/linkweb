...
import ModalRefLyon from "../components/modalreflyon";
...
import fanny from "../images/fanny-coiffure-avis.png";

import "../scss/info.scss";
import '../scss/global.scss';

class AgenceSEOLyon extends Component {
    ...
    render() {
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    title="Agence SEO Lyon - Faites appel à nos Experts SEO - Linkweb"
                    description="Vous êtes à la recherche d'une agence SEO à Lyon ? Linkweb vous accompagne pour développer et mettre en oeuvre votre stratégie de référencement naturel."
                    url="https://linkweb.fr/agence-seo-lyon/"
                    nom="Agence SEO à Lyon"
                ...
                <section className="flex items-center w-full mx-auto pb-0 mt-40 px-4 py-6 bg-black flex flex-col justify-center items-center" style={{ background: '#000000ad url(' + Bg + ')', backgroundBlendMode: 'overlay', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center center' }}>
                    <div className="max-w-6xl mx-auto lg:mx-56 pt-2 lg:w-2/5 w-full flex-col items-end">
                        ...
                        <div className="w-full lg:w-full flex justify-center lg:justify-center">
                            <h1 className="text-4xl md:text-6xl my-10 font-bold text-center text-white century leading-none">Agence SEO Lyon<br/> Référencement</h1>
                        </div>
                        <br />
                        <h2 className="flex full lg:w-full text-white justify-center lg:justify-center mx-auto lg:mx-0 text-xl  century text-center p-1 -mt-12">Linkweb, agence de référencement naturel SEO à Lyon.</h2>
                ...
                <nav aria-label="breadcrumbs" className="w-full bg-bleu century py-2 pl-0 md:pl-48">
                        <Link to="/agence-web-lyon/" className="px-4 text-md lg:text-lg text-white hover:text-black">Agence web Lyon</Link> <span className=" text-lg text-black"> / </span>
                        <span className="px-4 text-md lg:text-lg text-white"> Agence SEO Lyon</span>
                ...
                <section className="phototext">
                    <section className="bg-white sidetitle mt-16 mb-10">
                        <section className="w-full lg:w-3/4 flex flex-col justify-center century my-10 px-4 lg:px-32 md:mx-6 sm:mx-12 mt-2 lg:mx-48">
                                <h2 className="century text-center lg:text-left text-black text-3xl md:text-5xl leading-none">Optimisez votre visibilité sur le Web avec une stratégie de référencement SEO sur-mesure</h2>
                                <br />
                                <div className="line-title my-4 ">
                                    <br />
                                    <hr className="w-1/2 border-bleu lg:w-1/12" style={{marginRight:'40px'}}/>
                                    <br />
                                    <h3 /*data-aos='fade-left'*/ className="text-md text-black century pb-0">Soyez visibles dans les premiers résultats des moteurs de recherche pour atteindre de nouveaux clients grâce au référencement naturel.</h3>
                                </div>
                        </section>
                    </section>
                        ...
                        <div className="w-full flex flex-col lg:flex-row ">
                            <div className="w-full flex-col md:flex-row flex px-auto century">
                                ...
                                <div className="w-full px-6 lg:px-6 flex flex-col century justify-center" style={{ maxWidth: '1000px' }}>
                                    <h3 className="century capitalize text-2xl tracking-wider pb-3 leading-tight text-justify" /*data-aos="zoom-in"*/>
                                        <span className="text-bleu">/</span>DEVENEZ COMPÉTITIF GRÂCE À LINKWEB
                                            </h3>
                                    <p className="w-full text-md century pb-4 text-justify">L'<strong className="font-normal">optimisation pour les moteurs de recherche (SEO)</strong> permet aux entreprises d'accroître leur présence en ligne. En mettant en place une stratégie SEO efficace avec notre <Link to="/agence-web-lyon/" className="text-bleu hover:text-black font-bold">agence web à Lyon</Link>, vous maximisez vos possibilités d’<strong className="font-normal">être visible sur le Web</strong>, en tirant pleinement parti du potentiel offert par un moteur tel que Google.
                                    </p>                                
                                </div>
                            </div>
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full px-12 lg:px-6 flex flex-col century justify-center">
                                    <h3 className="century capitalize text-2xl tracking-wider pb-3 leading-tight text-justify" /*data-aos="zoom-in"*/>
                                        <span className="text-bleu">/</span>ATTIREZ UN TRAFIC QUALIFIÉ
                                                </h3>
                                    <p className="w-full century pb-4 text-justify"><strong className="font-normal">Générer du trafic</strong> pertinent sur votre site web est essentiel afin d’en tirer profit. Pour cela, vous devez être présent parmi les <strong className="font-normal">premiers résultats des moteurs de recherche</strong> pour des requêtes à haut potentiel de visibilité. Notre <strong className="font-normal">agence de référencement lyonnaise</strong> identifie, pour vous, les mots-clés les plus pertinents pour cibler des prospects qualifiés en fonction de vos ambitions.</p>
                                </div>
                            </div>
                            </div>
                            <div className="w-full flex flex-col lg:flex-row">
                                ...
                                <div className="w-full px-12 lg:px-6 flex flex-col century justify-center">
                                    <h3 className="century capitalize text-2xl tracking-wider pb-3 leading-tight text-justify" /*data-aos="zoom-in"*/>
                                        <span className="text-bleu">/</span>RENFORCEZ VOTRE AUTORITÉ EN LIGNE
                                                </h3>
                                    <p className="century pb-4 text-justify">Renforcez votre autorité dans votre secteur à travers la <strong className="font-normal">réation de contenu pertinent et riche</strong>c. Répondez aux attentes de vos clients potentiels et établissez-vous comme une source fiable dans votre domaine sur Internet. Notre équipe met tout en oeuvre pour vous permettre de gagner en autorité aux yeux des moteurs de recherche afin d’<strong className="font-normal">optimiser votre classement sur Google</strong>.</p>
                            ...
                            <div className="w-full my-10 flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full px-12 lg:px-6 flex flex-col justify-center century">
                                    <h3 className="century capitalize text-2xl tracking-wider pb-3 leading-tight text-justify" /*data-aos="zoom-in"*/>
                                        <span className="text-bleu">/</span>AJUSTEZ VOTRE STRATÉGIE SEO SUR LE LONG TERME
                                                </h3>
                                    <p className="century pb-4 text-justify">Bénéficiez d'un accompagnement personnalisé et adapté à vos objectifs commerciaux. Linkweb met en place des solutions efficaces pour optimiser durablement votre présence en ligne. Nous ajustons continuellement votre <strong className="font-normal">stratégie SEO</strong> afin de maximiser l'impact de vos actions marketing et d'accroître significativement leur portée.</p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                                </div>
                            </div>
                        </div>
                ...
                <section className="bg-white sidetitle mt-16 mb-10">
                        <section className="w-full lg:w-3/4 flex flex-col justify-center century my-10 px-4 lg:px-32 md:mx-6 sm:mx-12 mt-2 lg:mx-48">
                                <h2 className="century text-center lg:text-left text-black text-3xl md:text-5xl leading-none">Notre agence est spécialiste du référencement naturel SEO</h2>
                                <br />
                                <div className="line-title my-4 ">
                                    <br />
                                    <hr className="w-1/2 border-bleu lg:w-1/12" />
                        ...
                        <section className="w-full my-10 flex flex-col lg:flex-row justify-center">
                            <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/2 text-white" style={{ backgroundImage: 'url(' + referencement + ')' }}>
                                <h3 className="text-3xl titrehover text-center century leading-tight px-6">Le référencement SEO, une opportunité de développement efficace <hr className="border-solid mt-3 mx-auto border-2 w-1/6 border-bleu" style={{marginLeft:'auto', marginRight:'auto'}}/></h3>
                                <p className="text century text-lg lg:text-sm xl:text-lg z-50">
                                        L'<strong className="font-normal">optimisation pour les moteurs de recherche (SEO)</strong> est un processus qui vise à améliorer la position d'un site web dans les résultats des moteurs de recherche en se concentrant sur trois facteurs clés :
                                    <br/><br/>
                                    <ul>
                                    <li><a href="#contenu" className="text-center text-base hover:text-white font-bold text-bleu"><h4>➜ Contenu pertinent et de qualité</h4></a></li>
                                    <li><a href="#optimisation" className="text-center text-base hover:text-white font-bold text-bleu"><h4>➜ Optimisation technique</h4></a></li>
                                    <li><a href="#netlinking" className="text-center text-base hover:text-white font-bold text-bleu"><h4>➜ Netlinking performant</h4></a></li>
                                    </ul>
                            ...
                            <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/2 text-white" style={{ backgroundImage: 'url(' + agencereferencement + ')' }}>
                                <h3 className="text-3xl titrehover text-center century leading-tight px-6">Linkweb optimise votre visibilité en ligne grâce à une stratégie de référencement naturel adaptée à votre secteur d'activité et à vos objectifs <hr className="border-solid mt-3 mx-auto border-2 w-1/6 border-bleu" style={{marginLeft:'auto', marginRight:'auto'}}/></h3>
                                <p className="text century text-lg lg:text-sm xl:text-lg z-50">
                                Linkweb est une <strong className="font-normal">agence de référencement spécialisée dans le SEO</strong> depuis 15 ans. Nous analysons votre site web, votre marché et vos concurrents pour vous proposer la <strong className="font-normal">stratégie de SEO</strong> la plus adaptée à vos besoins et à vos ambitions. Avec Linkweb, vous bénéficiez d'un accompagnement personnalisé et d'un suivi régulier de vos performances SEO.
                                    <br/><br/>
                                    <ul>
                                        <li><a href="#concurrence" className="text-center text-base hover:text-white font-bold text-bleu"><h4>➜ Nous étudions le travail effectué par vos concurrents.</h4></a></li>
                                        <li><a href="#production" className="text-center text-base hover:text-white font-bold text-bleu"><h4>➜ Nous sommes spécialisés dans la production de contenus SEO.</h4></a></li>
                                        <li><a href="#popularite" className="text-center text-base hover:text-white font-bold text-bleu"><h4>➜ Nous développons la popularité de votre site de manière maîtrisée.</h4></a></li>
                                    </ul>
                                </p>
                            </div>
                        </section>
                ...
                <section className="bg-white sidetitle mt-16 mb-10">
                        <section className="w-full lg:w-3/4 flex flex-col justify-center century my-10 px-4 lg:px-32 md:mx-6 sm:mx-12 mt-2 lg:mx-48">
                                <h2 className="century text-center lg:text-left text-black text-3xl md:text-5xl leading-none">Vous recherchez une agence SEO à Lyon pour mener à bien votre projet ?</h2>
                                <br />
                                <div className="line-title my-4 ">
                                    <br />
                                    <hr className="w-1/2 border-bleu lg:w-1/12" />
                                    <br />
                                    <h3 /*data-aos='fade-left'*/ className="text-md text-black century pb-0">Ils ont fait appel aux services de notre agence de référencement Google à Lyon et sont satisfaits.</h3>
                                </div>
                        </section>
                    <section className="flex flex-col md:flex-row flex-wrap justify-center">
                            ...
                            <div className="w-full sm:w-1/2 lg:w-1/4 mx-0 md:mx-3 border-bleu border-solid border-2 px-12 century bg-bleu text-black py-10">
                                        <div className="flex flex-row">
                                            <img width="50px" height="50px" src={fanny} alt="Avis Google" style={{height:'100%'}}/>
                                            <svg className="-my-6" width="100px" viewBox="0 0 100 125">
                                                <path fill="#000000" d="M19.3,47.7l-5.4-0.8l-2.4-4.9c-0.1-0.2-0.3-0.3-0.4-0.3c-0.2,0-0.4,0.1-0.4,0.3l-2.4,4.9l-5.4,0.8c-0.2,0-0.3,0.2-0.4,0.3  c-0.1,0.2,0,0.4,0.1,0.5l3.9,3.8l-0.9,5.4c0,0.2,0,0.4,0.2,0.5c0.2,0.1,0.4,0.1,0.5,0l4.8-2.5l4.9,2.5c0.1,0,0.1,0.1,0.2,0.1  c0.1,0,0.2,0,0.3-0.1c0.1-0.1,0.2-0.3,0.2-0.5l-0.9-5.4l3.9-3.8c0.1-0.1,0.2-0.3,0.1-0.5C19.6,47.8,19.5,47.7,19.3,47.7z"/>
                                                <path fill="#000000" d="M38.8,47.7l-5.4-0.8L31,42c-0.1-0.2-0.4-0.3-0.7-0.2c-0.1,0-0.2,0.1-0.2,0.2l-2.4,4.9l-5.4,0.8c-0.2,0-0.3,0.2-0.4,0.3  c-0.1,0.2,0,0.4,0.1,0.5l3.9,3.8L25,57.8c0,0.2,0,0.4,0.2,0.5c0.2,0.1,0.4,0.1,0.5,0l4.9-2.5l4.9,2.5c0.2,0.1,0.4,0.1,0.5,0  c0.2-0.1,0.2-0.3,0.2-0.5l-0.9-5.4l3.9-3.8c0.1-0.1,0.2-0.3,0.1-0.5C39.2,47.8,39,47.7,38.8,47.7z"/>
                                                <path fill="#000000" d="M58.3,47.7l-5.4-0.8l-2.4-4.9c-0.1-0.2-0.3-0.3-0.4-0.3c-0.2,0-0.4,0.1-0.4,0.3l-2.4,4.9l-5.4,0.8c-0.2,0-0.3,0.2-0.4,0.3  c-0.1,0.2,0,0.4,0.1,0.5l3.9,3.8l-0.9,5.4c0,0.2,0,0.4,0.2,0.5c0.2,0.1,0.4,0.1,0.5,0l4.9-2.5l4.9,2.5c0.1,0,0.1,0.1,0.2,0.1  c0.1,0,0.2,0,0.3-0.1c0.2-0.1,0.2-0.3,0.2-0.5l-0.9-5.4l3.9-3.8c0.1-0.1,0.2-0.3,0.1-0.5C58.6,47.8,58.5,47.7,58.3,47.7z"/>
                                ...
                                <h4>FANNY COIFFURE</h4>
                                <br/>
                                <p>
                                Ils sont de très bons conseils, le suivi est régulier, si vous voulez changer des choses avant qu’ils ne vous rappellent, c’est toujours possible avec un mail. Je recommande vivement toute l'équipe.
                                </p>
                            </div>
                        </section>
                    </section>                
                ...
                <section className="bg-white sidetitle mt-16">
                        <section className="w-full lg:w-3/4 flex flex-col justify-center century px-4 lg:px-32 md:mx-6 sm:mx-12 mt-2 lg:mx-48">
                                <h2 className="century text-center lg:text-left text-black text-3xl md:text-5xl leading-none">Ils ont fait confiance à notre agence SEO à Lyon. Vous souhaitez en faire de même ?</h2>
                                <br />
                                <div className="line-title my-4 ">
                                    <br />
                                    <hr className="w-1/2 border-bleu lg:w-1/12" />
                ...
                <section className="tabPanel flex flex-1 w-full justify-end ml-0 mb-12">
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            <div className="w-full" label="POURQUOI CHOISIR UNE AGENCE SEO À LYON ?">
                                <p>En tant qu'<strong className="font-normal">agence SEO à Lyon</strong>, nous nous engageons pour vous aider à maximiser votre visibilité en ligne et à atteindre vos objectifs de croissance sur la métropole lyonnaise. La compréhension du marché local nous permet de créer des <strong className="font-normal">stratégies de référencement naturel</strong> qui sont non seulement efficaces, mais aussi entièrement adaptées à votre public cible. Tout ceci a pour but de vous permettre de bénéficier de résultats pertinents à partir de la mise en place d’une stratégie parfaitement adaptée à vos problématiques. Notre expérience et notre <strong className="font-normal">expertise en référencement naturel</strong> vous offriront un gain de temps majeur en vue d’obtenir des résultats visibles.</p>
                            </div>
                            <div label="QUEL EST LE RÔLE D'UNE AGENCE SEO ?">
                                <p>Une <strong className="font-normal">agence de référencement naturel</strong> est une agence de communication web spécialisée dans les enjeux du SEO, avec des fonctions diverses. Effectivement, elle dispose essentiellement de trois fonctions, à savoir :
                                    <br/>
                                    <ul className="list-disc">
                                        <li><strong className="font-normal">une fonction de consultation</strong> : en tant qu’agence de référencement, nous dirigeons nos clients vers la stratégie SEO la plus appropriée vis-à-vis de leurs objectifs et de leur domaine professionnel.</li>
                                        <li><strong className="font-normal">une fonction d'expert</strong> : notre rôle est aussi de fournir toute la compétence nécessaire en matière d’optimisation pour les moteurs de recherche afin de faciliter la prise de décision pour définir les actions qui vous aideront à <strong className="font-normal">augmenter votre présence en ligne</strong>.</li>
                                        <li><strong className="font-normal">une fonction d'opérant</strong> : notre rôle consiste également à mettre en œuvre votre plan d'actions en élaborant vos contenus, en optimisant votre site, ainsi qu'en effectuant vos <strong className="font-normal">actions de netlinking</strong> à partir de la réalisation d’un <strong className="font-normal">audit SEO</strong>.</li>
                                    </ul>
                                </p>
                            </div>
                            <div label="COMBIEN COÛTE UNE PRESTATION DE RÉFÉRENCEMENT NATUREL AVEC UNE AGENCE SEO ?">
                                <p>Le référencement est une discipline qui s’établit sur le long terme. Il faut parfois quelques mois, voire des années pour atteindre une visibilité significative. Cependant, l'obtention de résultats à moyen ou même à court terme demeure tout à fait réalisable. Notre rôle est d'<strong className="font-normal">identifier les opportunités propices à vous fournir un gain rapide de résultats</strong>, tout en établissant votre stratégie pour le futur en combinant l'usage de mots-clés à longue et à courte traîne. Un suivi est effectué par le biais d'un appel mensuel et un rapport de positionnement régulier afin de vous tenir au courant des nouvelles opportunités qui s’offrent à vous et des actions menées par nos services.</p>
                            </div>
                        </Accordion>
                    </div>
                </section>
                <section className="bg-white sidetitle mt-0 lg:mt-16 mb-10">
                        <section className="w-full lg:w-3/4 flex flex-col justify-center century my-10 px-4 lg:px-32 md:mx-6 sm:mx-12 mt-2 lg:mx-48">
                                <h2 className="century text-center lg:text-left text-black text-3xl md:text-5xl leading-none">Les expertises de notre agence SEO à Lyon</h2>
                                <br />
                                <div className="line-title my-4 ">
                                    <br />
                                    <hr className="w-1/2 border-bleu lg:w-1/12" />
                                    <br />
                                    <h3 /*data-aos='fade-left'*/ className="text-md text-black century pb-0">Linkweb vous propose de nombreuses solutions pour développer votre projet web à Lyon.</h3>
                                </div>
                        </section>
                    <section className="w-full">
                        <div className="w-full px-4 md:px-0 lg:px-0 flex justify-center mx-auto flex-col md:flex-row lg:w-full mt-5 flex-wrap">
                            <div className="w-full md:w-1/2 lg:w-1/4 svgtransform mx-auto lg:mx-4 px-2 mb-10 text-black century text-center  border-bleu border-solid border py-4">
                                ...
                                <p className="text-md">Création de site internet professionnel et développement web.</p>
                                <Button url="/creation-site-internet-toulouse/" text="Création site internet" size="md" position="center"/>
                            </div>
                            <div className="w-full md:w-1/2 lg:w-1/4 svgtransform text-black mx-auto lg:mx-4 px-2 mb-10 century text-center border-bleu border-solid border py-4">
                                ...
                                <p className="text-md">Création de campagnes Google Ads et stratégies de ROI (retour sur investissement).</p>
                                <Button url="/agence-adwords-47-31/" text="Agence Adwords" size="md" position="center"/>
                            </div>
                        {/* </div>
                        <div className="w-full text-black flex flex-col md:flex-row mx-auto justify-center lg:w-full mt-5 px-4 md:px-0 lg:px-0 md:mt-10 mb-12"> */}
                            <div className="w-full md:w-1/2 lg:w-1/4 svgtransform justify-center text-black px-2 mb-10 mx-auto lg:mx-4 century text-center border-bleu border-solid border py-4">
                                ...
                                <p className="text-md">Stratégies de notoriété, création de contenus et community management</p>
                                <Button url="/agence-community-management/" text="Agence social media" size="md" position="center"/>
                            </div>
                    ...
                    <ul className="flex flex-col md:flex-row">
                        ...
                        <li><Link to="/referencement-agen/" className="text-bleu hover:text-black font-bold px-4">Agence de référencement Agen</Link></li>
                    </ul>
                </section>
...
query lastsThreePostsAgenceSEOLyon {
    allWpPost(limit: 3) {
      edges {
        node {
          id
