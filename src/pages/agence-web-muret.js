                ...
                <section className="w-full flex flex-1 mt-6 equipe min-h-0 lg:min-h-600">
                    ...
                    <div className="w-3/4 ">
                        <div className="content">
                            ...
                            <p /*data-aos='fade-left'*/ className="century"><span className="text-bleu text-4xl">3</span>  spécialistes UI & <strong>UX design</strong> et professionnels du <strong><Link to="/agence-developpement-web-toulouse/" className="text-bleu hover:text-black font-bold">développement web</Link></strong></p>
                    ...
                    <div className="w-full lg:w-1/2 max-w-3xl px-12 py-12" >
                        ...
                        <p /*data-aos='fade-bottom'*/ className="text-justify">
                            Depuis plus de 10 ans, notre expérience dans la <strong><Link to="/agence-internet-toulouse/" className="hover:text-bleu">création de sites internet</Link></strong> nous a permis de développer nos compétences<strong> en tant qu'agence de conseil en communication</strong> pour d’envisager les <strong>projets web</strong> comme des solutions uniques répondant aux besoins de chaque <strong>client</strong>.<br /><br />
                                ...
                                De part son savoir-faire en tant qu’<strong>agence digitale</strong>, Linkweb met en place votre <strong>site internet</strong> grâce à des solutions de <strong><Link to="/agence-web-ramonville/" className="font-bold text-bleu hover:text-black">développement web</Link></strong> récentes et optimise votre <strong>référencement naturel</strong> grâce à une veille permanente en <strong>web marketing</strong>. Quelle que soit la nature de votre activité, nous avons le savoir-faire  et les <strong>expertises</strong> pour vous permettre d’atteindre vos objectifs.<br />
                        </p>
