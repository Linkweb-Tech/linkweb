                    ...
                    <section className="flex w-full flex-col lg:flex-row mx-auto px-0 py-6 my-4">
                        ...
                        <div className="w-full lg:w-1/2 max-w-3xl px-12 py-12" >
                            ...
                            <p /*data-aos='fade-bottom'*/ className="text-justify">
                                ...
                                De part son savoir-faire en tant qu’<strong>agence digitale</strong>, Linkweb met en place votre <strong>site internet</strong> grâce à des solutions de <strong><Link to="/entreprise-developpement-web-toulouse/" className="font-bold text-bleu hover:text-white">développement web</Link></strong> récentes et optimise votre <strong>référencement naturel</strong> grâce à une veille permanente en <strong>web marketing</strong>. Quelle que soit la nature de votre activité, nous avons le savoir-faire  et les <strong>expertises</strong> pour vous permettre d’atteindre vos objectifs.<br />
                            </p>
