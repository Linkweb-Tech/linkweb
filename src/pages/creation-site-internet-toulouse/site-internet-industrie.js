...
class CreationSitePourIndustrie extends Component {
            ...
            <Layout location={this.props.location}>
                ...
                <section className="flex items-center justify-start w-full mx-auto pb-0 my-32 md:my-42 lg:my-42 xl:my-48 py-6 bg-black flex flex-col justify-center items-center" style={{ background: '#00000085 url(' + arriereplan + ')', backgroundBlendMode: 'overlay', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    ...
                    <div className="w-full bg-bleu century py-2 pl-0 md:pl-48">
                        ...
                        <span className="px-4 text-md lg:text-lg text-white"> Industriel</span>
                    </div>
                </section>
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            ...
                            <br /><br />
                                    ...
                                    Le site internet va donc être destiné à donner de la <strong className="font-normal">visibilité</strong> à votre entreprise, mais également à <strong className="font-normal">travailler son image</strong>. <strong className="font-normal">La <Link to="/creation-de-site-internet-a-agen/" className="text-bleu hover:text-black font-bold">création de site internet à Agen</Link></strong> ouvre la porte à de nouvelles opportunités en termes de <strong className="font-normal">communication</strong> et de développement.
                            <br /><br />
