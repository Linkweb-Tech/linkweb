...
class SiteInternetCharpentier extends Component {
            ...
            <Layout location={this.props.location}>
                ...
                <section className="flex items-center justify-start w-full mx-auto pb-0 my-32 md:my-42 lg:my-42 xl:my-48 py-6 bg-black flex flex-col justify-center items-center" style={{ background: '#000000ad url(' + arriereplan + ')', backgroundBlendMode: 'overlay', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    ...
                    <Link to="/creation-site-internet-toulouse/" className="px-4 text-md lg:text-lg text-white hover:text-black">Création site internet</Link> <span className=" text-lg text-black"> - </span>
                        ...
                        <span className="px-4 text-md lg:text-lg text-white"> Charpentier</span>
                        </div>
                </section>
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            <div className="w-full" label="CRÉER UNE PLATEFORME POUR DYNAMISER SA COMMUNICATION WEB">
                                <p>Le <strong>développement d’un site internet vitrine</strong> est indispensable pour <strong className="font-bold">dynamiser la communication de son entreprise et investir le web</strong>. <strong>Avoir un site internet</strong> permet de présenter son activité dans des <strong className="font-bold">pages web détaillées</strong>, mais ce n’est pas tout. <strong>La <Link to="/creation-de-site-internet-a-agen/" className="text-bleu hover:text-black font-bold">création d'un site internet internet à Agen</Link></strong> est essentielle pour <strong className="font-bold">gagner en notoriété et en visibilité</strong>.
                                <br /><br />
