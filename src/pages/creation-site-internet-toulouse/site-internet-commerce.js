...
class SiteInternetCommercant extends Component {
            ...
            <Layout location={this.props.location}>
                ...
                <section className="flex items-center justify-start w-full mx-auto pb-0 my-32 md:my-42 lg:my-42 xl:my-48 py-6 bg-black flex flex-col justify-center items-center" style={{ background: '#000000ad url(' + arriereplan + ')', backgroundBlendMode: 'overlay', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    ...
                    <div className="w-full bg-bleu century py-2 pl-0 md:pl-48">
                        ...
                        <span className="px-4 text-md lg:text-lg text-white"> Commerçants</span>
                    </div>
                </section>
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            ...
                            <div label="DÉVELOPPER SON CHIFFRE D'AFFAIRES AVEC UN SITE DE VENTE EN LIGNE">
                                <p>La mise en place d’une <strong>stratégie de webmarketing</strong> sur son <strong>site internet e-commerce</strong> est importante <strong>développer votre chiffre d’affaires</strong>. Grâce à la <strong>visibilité obtenue via les moteurs de recherche</strong>, notre <Link to="/" className="text-bleu hover:text-black font-bold">agence web à Agen</Link> cible des utilisateurs de façon pertinente pour faire d’eux vos futurs clients. La mise en place d'un <strong>site e-commerce</strong> efficace va vous permettre d'<strong>accroître votre chiffre d'affaires</strong> tout en <strong>gérant vos stocks</strong>.
                            <br /><br />
