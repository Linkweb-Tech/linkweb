...
class CreationSiteRestaurant extends Component {
            ...
            <Layout location={this.props.location}>
                ...
                <section className="flex items-center justify-start w-full mx-auto pb-0 my-32 md:my-42 lg:my-42 xl:my-48 py-6 bg-black flex flex-col justify-center items-center" style={{ background: '#000000ad url(' + arriereplan + ')', backgroundBlendMode: 'overlay', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    ...
                    <div className="w-full bg-bleu century py-2 pl-0 md:pl-48">
                        ...
                        <span className="px-4 text-md lg:text-lg text-white"> Restaurant</span>
                    </div>
                </section>
                ...
                <section className="tabPanel flex flex-1 w-full justify-end ml-0 mb-24">
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            ...
                            <br/><br/>
                                Grâce à une version responsive design et au soin prêté à l’UI et l’UX design, une agence web vous offre un <strong>bon référencement naturel</strong> pour vous apporter un trafic conséquent qui fera grandir vos conversions de manière durable. En quelques clics, rendez vos offres visibles, choisir de développer un site avec des <strong>spécialistes de la création de site internet</strong> vous aide à déployer votre influence sur le web.
                            <br/><br/>
                                Vous vous êtes sûrement demandé comment <strong>créer un site gratuit</strong> pour votre établissement, en toute autonomie et sans aucune connaissance, il est certain que cela représente un pari risqué. C’est pour cela que les consultants en agence vous proposent un accompagnement complet avec des solutions personnalisées pour mener à bien <strong>votre projet web</strong> et atteindre vos objectifs. La stratégie digitale et les solutions pour créer votre support sont pensées à partir de vos ambitions et de vos objectifs. Les équipes possèdent les compétences pour <strong>réaliser le site internet vitrine</strong> qui présentera votre travail sous son meilleur jour.
                            </p>
                            </div>
                            ...
                            <br/><br/>
                                Développer un site internet avec une agence web vous permet de reprendre votre identité visuelle, échanger sur les performances de celui-ci tous les mois en s'appuyant sur des données Google Analytics notamment, <strong>proposer un support intuitif aux utilisateurs</strong> pour qu'ils trouvent toutes les informations dont ils ont besoin et en accès illimité.
                            <br/><br/>
                                Votre site internet peut comporter des extensions particulières en fonction de votre secteur d'activité, de vos offres. L'outil de création qui est choisi par les spécialistes de la création de sites fonctionnels est idéal pour avoir un <strong>site répondant aux critères des moteurs de recherche</strong> qui se chargeront de l'indexer et de le positionner dans les SERP. Créer un site internet personnalisé et profiter d'un accompagnement dans la gestion de contenu vous aide à gagner du temps et de l'argent, vous capterez vos cibles de clientèles sans perdre de vue votre principale activité qui reste la restauration.
                            <br/><br/>
                                Créer votre propre site internet au <strong>parcours de navigation intuitif</strong>, aux plugins et fonctionnalités personnalisées, au responsive design travaillé (accès depuis les tablettes ou les mobiles) et aux contenus pertinents sur des mots-clés stratégiques vous permettra de décupler les résultats. Les experts qui se chargent de concevoir des sites sur-mesure peuvent assurer leur maintenance, aider à faire le choix du bon hébergeur de site, soigner la construction de chacune des pages de votre site pour qu'il soit régulièrement à jour. <strong>Créer votre site internet avec des professionnels</strong> s'intègre dans une stratégie de communication digitale et de webmarketing des plus efficaces de nos jours.
                                </p>
                            </div>
                            ...
                            <br /><br />
                                Enfin, il existe la possibilité de mettre en place un <strong className="font-normal">module de réservation</strong> directement <strong className="font-normal">sur le site web</strong> et qui va vous permettre d’enregistrer ces dernières directement <strong className="font-normal">en ligne</strong>. Il est important de mettre en place toutes les commodités possibles pour proposer une <strong className="font-normal">expérience utilisateur</strong> optimale et pratique. Pour cela, être accompagné par une <Link to="/" className="text-bleu hover:text-black font-bold">agence web à agen</Link> est recommandé.
                            <br/><br/>
                                Les experts de l'agence apporteront les fonctionnalités qui vous conviennent pour que vous puissiez, par exemple, proposer de la <strong>vente à emporter, de la réservation en ligne, de la livraison</strong> également, depuis un site alliant ergonomie et webdesign. Le site internet que vous propose une agence est clé-en-main, il est réalisé à partir du <strong>cahier des charges</strong> étudié soigneusement par les équipes chargées de <strong>concevoir un site internet sur-mesure</strong>. Les spécialistes vous permettent de choisir le bon hébergement web parmi les hébergeurs disponibles, d’obtenir un nom de domaine qui correspond à votre entreprise, les contenus sont personnalisables, rédigés spécialement pour vous en fonction également de la concurrence et des mots clés qui sont régulièrement recherchés par les utilisateurs.
                            <br/><br/>
                                Développer un site web professionnel c’est penser à son aspect technique mais également à son <strong>optimisation SEO</strong>. Selon le type de site web choisi, les développeurs réalisent des supports avec des CMS comme Wordpress ou Prestashop, Drupal, Woocommerce ou l'outil CMS Joomla ainsi que les multiples templates disponibles. Ils ont pour but d’assurer la meilleure navigation possible sur les pages web afin d’encourager leur référencement dans les <strong>pages de résultats de recherche de moteurs comme Google</strong>. Maniant le langage HTML et employant les meilleurs outils digitaux du marché, ils garantissent une création de site vitrine comme de site e-commerce pour répondre aux besoins de votre entreprise et fournir une solution adaptée.
                            <br/><br/>
                                Pour créer un site qui répond à vos besoins et qui se démarque des sites internet concurrents, les équipes de l'agence web maîtrisent des <strong>outils indispensables conçus pour créer une interface ergonomique et interactive</strong>. Pour une refonte comme pour créer un site web tout neuf, les spécialistes du code HTML et des CSS ainsi que des outils dédiés à la création web vous permettent d'être visible. Optez pour le travail d'une équipe expérimentée et attentive et choisissez de <strong>créer un site internet répondant à chacune de vos attentes</strong>.
                                </p>
                            </div>
                        </Accordion>
                    </div>
