...
class SiteInternetPsychologue extends React.Component {
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                          <div className="w-full" label="PROMOUVOIR VOS EXPERTISES">
                            <p>La <strong>création d’un site internet</strong> est un moyen pertinent de <strong>faire connaître son activité</strong> professionnelle. Au-delà de présenter votre activité, le <strong>site internet</strong> vous permet de mettre en avant vos <strong>domaines d'expertise'</strong> pour faciliter la mise en relation entre les utilisateurs et un <strong>psychologue</strong> comme vous. Ceci est important en vue de <strong>proposer un contenu pertinent</strong> vis-à-vis des <strong>requêtes des utilisateurs sur les moteurs de recherche</strong>. 
                            <br/><br/>
