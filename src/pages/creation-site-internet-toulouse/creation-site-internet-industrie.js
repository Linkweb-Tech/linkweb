...
<section className="flex items-center justify-start w-full mx-auto pb-0 my-24 px-4 py-6 bg-black flex flex-col justify-center items-center" style={{background:'#00000085 url('+ arriereplan +')', backgroundBlendMode:'overlay', backgroundRepeat:'no-repeat', backgroundSize:'cover', backgroundPosition:'center'}}>
        ...
        <section className="w-full my-10 flex flex-col lg:flex-row">
            <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{backgroundImage:'url('+ siteinternet +')'}}>
                ...
                <p className="text century -mt-5 lg:mt-0 text-lg lg:text-sm xl:text-lg">Pour un industriel, créer un site internet doit servir à promouvoir son savoir-faire et ses produits en vue de mettre en avant la qualité de ces derniers. En plus des avantages du site vitrine, le site catalogue permet de créer des fiches sur-mesure adaptées à chaque produit. <br/><br/>Le site internet catalogue n’est pas destiné à la vente (il est différent du site e-commerce consacré à la vente en ligne), mais conserve tous les avantages des sites vitrines et e-commerce. Le catalogue est parfaitement adapté pour les industriels souhaitant promouvoir leurs procédés.</p>
            </div>
            <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{backgroundImage:'url('+ referencement +')'}}>
                ...
                <p className="text century text-lg lg:text-sm xl:text-lg">Acquérir de la visibilité pour son site web va permettre de générer du trafic ayant pour finalité d'obtenir des contacts. Ceci est vrai pour tous les sites web. Afin de répondre à ces objectifs de visibilité, nous misons sur le référencement naturel. <br/><br/>Le référencement naturel est une discipline qui a pour principe d’optimiser des pages web pour faciliter leur lecture ainsi que leur compréhension par les moteurs de recherche. Son intérêt réside dans le fait d’améliorer le positionnement d’une page dans les résultats des moteurs de recherche en vue de maximiser sa visibilité.</p>
            </div>
            <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{backgroundImage:'url('+ webdesign +')'}}>
                <h3 className="text-3xl titre text-center century leading-none"><span>Design</span><br/><span className="font-bold text-6xl">ACTUEL</span></h3>
