...
class SiteInternetRamoneur extends Component {
            ...
            <Layout location={this.props.location}>
                ...
                <section className="flex items-center justify-start w-full mx-auto pb-0 my-32 md:my-42 lg:my-42 xl:my-48 py-6 bg-black flex flex-col justify-center items-center" style={{ background: '#000000ad url(' + arriereplan + ')', backgroundBlendMode: 'overlay', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    ...
                    <div className="w-full bg-bleu century py-2 pl-0 md:pl-48">
                        ...
                        <span className="px-4 text-md lg:text-lg text-white"> Ramoneur</span>
                    </div>
                </section>
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            ...
                            <div label="DYNAMISER SON ACTIVITÉ GRÂCE À UN SITE WEB PERFORMANT">
                                ...
                                <br /><br />
                                À ce niveau, la mise en place d’un <strong>site web professionnel</strong> doit résulter d’un travail autour de la <strong className="font-bold">création d’une interface intuitive</strong> et d’une <strong className="font-bold">expérience utilisateur</strong> soignée réalisées par les professionnels d'une <Link to="/" className="text-bleu hover:text-black font-bold">agence web à Toulouse</Link>. Ceci est indispensable pour amener les utilisateurs où vous souhaitez qu’ils aillent.
                                <br /><br />
