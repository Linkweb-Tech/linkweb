            ...
            <Layout location={this.props.location}>
                ...
                <section className="w-full mt-10 text-justify century font-normal flex flex-col lg:flex-row lg:justify-end" data-aos="fade-right">
                    <div className="w-full lg:w-2/3 px-16 md:px-24 lg:px-24 xl:pl-40 xl:ml-64 mb-24">
                        ...
                        <br />
                        <p>
                            Dans le cadre du <strong className="font-normal">développement web</strong>, la notion de <strong>« back-end »</strong> se réfère au travail effectué sur des <strong className="font-normal">applications web</strong>, <strong className="font-normal">applications mobiles</strong> ou <strong className="font-normal">sites web</strong> au même titre que le <strong className="font-normal">développeur front-end</strong>. Toutefois, à la différence du développeur front-end, le <strong className="font-normal">développeur back-end</strong> maîtrise toute la partie invisible pour l’utilisateur, mais qui va permettre le bon fonctionnement d’un site internet comme cela est le cas au sein de notre <Link to="/agence-web-marketing-toulouse/" className="text-bleu hover:text-black font-bold">agence web à Toulouse</Link>.<br />
                            <br />
