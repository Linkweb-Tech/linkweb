            ...
            <Layout location={this.props.location}>
                ...
                <br /><br />
                    ...
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + webdesign + ')' }}>
                        <h3 className="text-3xl titre text-center century leading-none"><span>Design</span><br /><span className="font-bold text-6xl">PROÉMINENT</span></h3>
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            ...
                            <div label="OBTENIR DE LA VISIBILITÉ POUR DÉVELOPPER SON CHIFFRE D'AFFAIRES">
                                <p><strong>Développer sa visibilité sur les moteurs de recherche</strong> va permettre de <strong>générer du trafic</strong>. En ciblant les utilisateurs de façon pertinente (<strong>ciblage géographique</strong> ou ciblage de l’<strong>intention de recherche</strong>, par exemple), nous vous permettrons de transformer le trafic généré en <strong>trafic qualifié</strong>.
                            <br /><br />
