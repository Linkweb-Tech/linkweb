            ...
            <Layout location={this.props.location}>
                ...
                <section className="flex items-center justify-start w-full mx-auto pb-0 my-32 md:my-42 lg:my-42 xl:my-48 py-6 bg-black flex flex-col justify-center items-center" style={{ background: '#000000ad url(' + arriereplan + ')', backgroundBlendMode: 'overlay', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    ...
                    <div className="w-full bg-bleu century py-2 pl-0 md:pl-48">
                        ...
                        <span className="px-4 text-md lg:text-lg text-white"> Chauffage & Climatisation</span>
                    </div>
                </section>
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            <div className="w-full" label="UN SITE WEB POUR PROMOUVOIR SES PRODUITS ET SERVICES">
                                <p>Lorsque l’on souhaite donner de la visibilité et <strong>promouvoir son entreprise de chauffage et/ou de climatisation</strong>, la <strong><Link to="/creation-de-site-internet-a-agen/" className="text-bleu hover:text-black font-bold">création d’un site internet à Agen</Link></strong> est un moyen pertinent d’atteindre ses objectifs. En effet, <strong>créer un site internet</strong>, c’est permettre aux utilisateurs de vous trouver et de vous contacter. De nos jours, le <strong>site web est un gage de confiance et de crédibilité</strong> pour un professionnel.
                            <br /><br />
                            ...
                            <div label="UNE STRATÉGIE DE RÉFÉRENCEMENT NATUREL TOURNÉE VERS LE LOCAL">
                                <p><strong>Développer une stratégie de visibilité</strong> est important pour <strong>rendre votre site accessible</strong> dans les <strong>pages de résultats des moteurs de recherche</strong>. <strong>Opter pour le référencement local avec notre <Link to="/" className="text-bleu hover:text-black font-bold">agence web à Agen</Link></strong> vous permettra de délimiter votre <strong>visibilité</strong> en rapport avec vos secteurs d’intervention pour un <strong>référencement sur-mesure</strong>.
                            <br /><br />
