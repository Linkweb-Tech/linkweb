...
class SiteInternetAvocat extends React.Component {
      ...
      <div className="w-full md:w-1/3 px-3 flex flex-col align-center justify-center" /*data-aos="fade-up"*/>
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                          ...
                          <div label="UN SITE WEB ACCESSIBLE 24H/24 POUR ÊTRE ACCESSIBLE EN LIGNE">
                            <p>De nos jours, <strong>avoir un site internet</strong> est indispensable pour les professionnels souhaitant développer leur activité. En effet, <strong>créer votre site web</strong> peut vous permettre d’augmenter votre <strong>notoriété</strong> en boostant votre <strong>visibilit</strong>é, mais également de soigner <strong>votre image</strong>.
                            <br/><br/>
