...
class TechnoWeb extends Component {
            ...
            > */}
                ...
                <section className="w-full  flex flex-col xl:flex-row flex justify-center">
                    <div className="bloctextpages w-full lg:w-1/2 flex flex-col justify-center century text-justify">
                        ...
                        <br />
                        <p>La <a href="https://www.data-projekt.fr/agence-web/developpement/creation-site-web/" target="_blank" rel="noopener noreferer" className="text-bleu hover:text-black font-bold"><strong>création de site internet</strong></a> est une discipline qui fait appel à une certaine technicité et donc à des compétences spécifiques. Pour <strong>créer un site web</strong> parfaitement fonctionnel, en <strong>HTML/CSS</strong>, comme sur <strong>Wordpress</strong>, il est important de maîtriser les différentes technologies existantes. En effet, ceci est indispensable pour effectuer des choix selon le <strong>type de site</strong> à créer, mais également les besoins du client et la teneur du <strong>projet web</strong> dans sa globalité.</p>

                        <p>Le travail préparatoire du <strong>développeur</strong> va être double. Non seulement, il va devoir effectuer une étude du <strong>besoin du client</strong> en réunissant l’ensemble des paramètres qui influeront sur sa prise de décision : <strong>type de site web</strong>, <strong>visuel souhaité</strong>, <strong>arborescence SEO</strong> ou non, <strong>parcours client</strong> et surtout service ou produit à mettre en valeur.</p>
