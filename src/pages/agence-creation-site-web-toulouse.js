            ...
            <Layout location={this.props.location}>
                ...
                <section className="sidetitle w-10/12 text-center text-black text-2xl justify-center flex flex-col century mt-10 mb-10 mx-auto">
                    ...
                    <div className="line-title my-4">
                        <hr className="border-solid w-1/2 lg:w-1/12 border-bleu"></hr>
                        <br />
                        <h3 /*data-aos='fade-left'*/ className="max-w-6xl text-xl text-black text-center lg:text-justify century pb-0">Linkweb fait partie des <Link to="/agence-web-marmande/" className="text-bleu hover:text-black font-bold">agences web proches de Marmande</Link> qui s’attachent à cerner les besoins de ses clients avant d’envisager les solutions les plus pertinentes par rapport à leur activité ainsi qu’à leurs opportunités en ligne.</h3>
                    </div>
                </section>
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            ...
                            <div label="UN SITE INTERNET POUR DYNAMISER VOTRE STRATÉGIE DE MARKETING DIGITAL">
                                <p>
                                    Lorsque vous faites le choix d’une <strong className="font-normal"><Link to="/agence-web-albi/" className="font-bold text-bleu hover:text-black">agence à Albi</Link>, à l'image de Linkweb</strong> vous optez également pour la mise en place d’une réelle de <strong className="font-normal">stratégie marketing</strong>. En ce sens votre site est un support et non un objectif. En effet, nous pensons que le <strong className="font-normal">site internet</strong> est un véritable moteur pour développer la visibilité et la <strong className="font-normal">notoriété d’une entreprise</strong> sur le net.
                                <br /><br />
