...
class AgenceCreaSiteWeb extends React.Component {
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            ...
                            <div label="UN SITE INTERNET POUR DYNAMISER VOTRE STRATÉGIE DE MARKETING DIGITAL">
                                <p>
                                Lorsque vous faites le choix d’une <strong className="font-normal">agence comme Linkweb</strong>, vous optez également pour la mise en place d’une réelle de <strong className="font-normal">stratégie marketing</strong>. En ce sens votre site est un support et non un objectif. En effet, nous pensons que le <strong className="font-normal">site internet</strong> est un véritable moteur pour développer la visibilité et la <strong className="font-normal">notoriété d’une entreprise</strong> sur le net.
                                <br/><br/>
