    ...
    render() {
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    title="Agence Web Montpellier - Création site internet - Linkweb"
                ...
                <section className="flex items-center justify-start w-full mx-auto pb-0 my-32 md:my-42 lg:my-42 xl:my-48 px-4 py-6 bg-black flex flex-col justify-center items-center" style={{ background: '#000000ad url(' + arriereplan + ')', backgroundBlendMode: 'overlay', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    <div className="max-w-6xl mx-auto lg:mx-56 py-2 w-full flex-col items-end">
                        <div className="w-full lg:w-2/3 flex justify-center lg:justify-start">
                            <h1 className="text-5xl my-10 font-bold text-center lg:text-left text-white century leading-tight">Agence web Montpellier - Création site internet</h1>
                        </div>
                        <br />
                ...
                <section className="w-full flex justify-end -mt-0 lg:-mt-32">
                    <div className="w-11/12 lg:w-1/3 bg-bleu shadow-2xl -mt-0 lg:-mt-64 flex flex-col justify-end mx-12 lg:mx-24">
                        ...
                        <br />
                        <p className="px-8 lg:px-16 text-white text-center century text-md">Notre <strong className="font-normal"><a href="/" className="text-black hover:text-white font-bold">agence web Toulouse</a></strong> vous propose des services de <strong className="font-normal">développement web sur-mesure</strong> pour répondre à tous vos besoins en termes de <strong className="font-normal">communication digitale</strong>.</p>
                        <br />
                ...
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + siteinternet + ')' }}>
                        ...
                        <p className="text century lg:mt-0 text-lg lg:text-sm xl:text-lg z-50">Les <strong className="font-normal">équipes de Linkweb, <a href="/agence-web-strasbourg/" className="text-bleu hover:text-white font-bold">agence web à Strasbourg</a></strong> vous accompagnent pour donner vie à votre <strong className="font-normal">projet sur le web</strong>. Site vitrine ou e-commerce, vous disposez d’un site performant et pensé pour vous grâce au travail de l’<strong className="font-normal">équipe de développement</strong> et à la <strong className="font-normal">stratégie de référencement</strong> qui vous est ensuite proposée par les référenceurs de l’agence. Votre <strong className="font-normal">site en ligne</strong> reprend votre identité visuelle, il présente une <strong className="font-normal">image de marque</strong> qui vous est propre et qui se démarque des autres.<br/><br/>
                    ...
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + referencement + ')' }}>
                        ...
                        <br /><br />La conception de <strong className="font-normal">contenus optimisés</strong> est une des solutions les plus pertinentes pour un référencement SEO durable dans le temps et qui portera ses fruits de manière pérenne.
                        </p>
                    </div>
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + webdesign + ')' }}>
                        ...
                        <p className="text century text-lg lg:text-sm xl:text-lg z-50">
                        Le <strong className="font-normal">référencement payant</strong> que permet Adwords est une solution créative qui vous est proposée lorsque votre <strong className="font-normal">retour sur investissement</strong> se veut urgent. Cette campagne de communication publicitaire vous permet de vous faire une place ponctuelle en tête de <strong className="font-normal">première page des résultats des moteurs comme Google</strong>. Notre <strong className="font-normal"><a href="/agence-web-agen/" className="text-bleu hover:text-white font-bold">agence web à Agen</a></strong> vous apporte son conseil et son expertise pour utiliser stratégiquement ce type de référencement.
        ...
        <div className="w-full xl:w-1/3 three px-auto">
          <div className="flex items-center xl:items-start flex-col xl:flex-row flex-1">
            ...
            <section className="w-full lg:w-1/3 absolute z-10 px-auto lg:w-1/3 absolute px-12 lg:px-6 xl:px-24 pt-24">
              ...
              <div className="century content pb-6 text-justify" style={{ textAlignLast: 'center' }}>
                Refonte du site ou création, la <strong className="font-normal">réalisation de votre projet</strong> est étudiée pour mener à une solution performante grâce à la collaboration entre le <strong className="font-normal">service de développement</strong> et le <strong className="font-normal">service de référencement</strong> de Linkweb. Tous les leviers de la <strong className="font-normal">communication digitale</strong> sont activés pour votre support de communication grâce à un expert du web. La mise en place de votre <strong className="font-normal">stratégie web-marketing</strong> est réalisée dans l’écoute et le conseil pour vous apporter tous les résultats escomptés. Identité visuelle, ergonomie, service de gestion de contenu, design de site web (webdesign), Linkweb fait partie des <strong className="font-normal"><a href="/agence-web-marseille/" className="text-bleu hover:text-black font-bold">agences web à Marseille</a> et dans toute la France</strong> qui ne laissent rien au hasard.
                </div>
              ...
              <button
                ...
                <section className="sidetitle w-10/12 text-center text-black text-2xl justify-center flex flex-col century mt-10 mb-10 mx-auto">
                    <h2 className="century text-center lg:text-left text-black text-3xl md:text-5xl leading-tight">Agence web Montpellier : notre agence web donne vie à vos projets de création de site internet à Montpellier</h2>
                    <br />
                    <div className="line-title my-4">
                        <hr className="border-solid w-1/2 lg:w-1/12 border-bleu"></hr>
                        <br />
                        <h3 className="max-w-7xl text-xl text-black text-center lg:text-justify century pb-0">Sur le marché des agences de France, Linkweb se démarque de par son expérience, son savoir-faire et son professionnalisme. Les équipes de l’agence sont à votre écoute pour vous mener, à travers leurs réalisations, à la réussite de tous vos projets web.</h3>
                    </div>
                </section>
                        ...
                        <div className="w-full lg:w-1/2 my-10  flex flex-col">
                            ...
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full century px-12 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <br />
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify">La note attribuée à notre <strong className="font-normal"><a href="/agence-web-nice/" className="text-bleu hover:text-black font-bold">agence web à Nice</a></strong> sur Google est basée sur 118 avis reçus. Nos clients sont satisfaits de nos services et ils le montrent !</p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                                </div>
                            </div>
                        </div>
                ...
                <section className="sidetitle w-10/12 text-center text-black text-2xl justify-center flex flex-col century mt-10 mb-10 mx-auto">
                    ...
                    <div className="line-title my-4">
                        <hr className="border-solid w-1/2 lg:w-1/12 border-bleu"></hr>
                        <br />
                        <h3 /*data-aos='fade-left'*/ className="max-w-6xl text-xl text-black text-center lg:text-justify century pb-0">Grâce aux compétences des développeurs Linkweb et à leur maîtrise des outils comme Wordpress ou du code HTML, choisissez de disposer d’un support performant. Bénéficiez de services complets pour profiter de services complets, d'un consulting et de solutions digitales performantes pour profiter d’un retour sur investissement intéressant et rentabiliser votre site web.</h3>
                    </div>
                </section>
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            <div className="w-full" label="DEVENEZ PLUS VISIBLE : CHOISISSEZ LE RÉFÉRENCEMENT QUI VOUS CORRESPOND">
                                <p>En favorisant l’<strong className="font-normal">expérience utilisateur</strong> grâce au web-design lors de la <Link to="/creation-de-site-internet-a-agen/" className="text-bleu hover:text-black font-bold">création de votre site internet à Agen</Link>, qu'il s'agisse d'ue site vitrine, e-commerce ou sur-mesure, vous optimisez vos chances d’apparaître en tête des <strong className="font-normal">SERP</strong>. Les entreprises qui se démarquent sur le web par leur identité graphique et éditoriale possèdent toutes leurs chances d’acquérir un <strong className="font-normal">trafic pertinent</strong> et de profiter d’un <strong className="font-normal">taux de conversion</strong> optimal.</p>
                            </div>
                            ...
                            <div label="BOOSTER VOTRE CHIFFRE D'AFFAIRES : RENTABILISEZ VOTRE SITE GRÂCE À VOTRE STRATÉGIE DE MARKETING">
                                <p>Apportez à votre entreprise une <strong className="font-normal">notoriété</strong> nouvelle pour maximiser votre <strong className="font-normal">taux de conversion</strong> lors des visites des internautes sur vos pages. L’interface que vous proposez est un <strong className="font-normal">levier webmarketing</strong> des plus efficaces si elle est confectionnée par des <strong className="font-normal">experts</strong> comme ceux de notre <a href="/agence-web-bordeaux/" className="text-bleu hover:text-black font-bold">agence web à Bordeaux</a>. Faites confiance à Linkweb partout en France pour faire en sorte que vos <strong className="font-normal">projets</strong> contribuent à augmenter votre chiffre d’affaires et à dynamiser l’activité de votre société.</p>
                            </div>
                        </Accordion>
                    </div>
                </section>
