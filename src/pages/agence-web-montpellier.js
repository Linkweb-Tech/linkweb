                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            <div className="w-full" label="DEVENEZ PLUS VISIBLE : CHOISISSEZ LE RÉFÉRENCEMENT QUI VOUS CORRESPOND">
                                <p>En favorisant l’<strong className="font-normal">expérience utilisateur</strong> grâce au web-design de votre site vitrine, e-commerce ou sur-mesure, vous optimisez vos chances d’apparaître en tête des <strong className="font-normal">SERP</strong>. Les entreprises qui se démarquent sur le web par leur identité graphique et éditoriale possèdent toutes leurs chances d’acquérir un <strong className="font-normal">trafic pertinent</strong> et de profiter d’un <strong className="font-normal">taux de conversion</strong> optimal.</p>
                            </div>
