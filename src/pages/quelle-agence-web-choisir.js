            ...
            <Layout location={this.props.location}>
                ...
                <section className="w-full flex justify-end -mt-0 lg:-mt-32">
                    <div className="w-11/12 lg:w-1/3 bg-bleu shadow-2xl -mt-0 lg:-mt-64 flex flex-col justify-end mx-12 lg:mx-24">
                        ...
                        <br />
                        <p className="px-8 lg:px-16 text-white text-center century text-md">Vous êtes un prestataire désirant établir une <Link to="/agence-de-communication-digitale/" className="text-white hover:text-black font-bold">stratégie de communication digitale</Link> pour faire connaître votre entreprise ? Nous mettons nos compétences au service de votre projet.</p>
                        <br />
                            ...
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full px-12 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify">Grâce au suivi effectué, nos <strong className="font-normal">clients</strong> sont informés de l’activité et des résultats du <strong className="font-normal">référencement naturel de leur site</strong> par nos consultants qualifiés.
                                        Faire appel à notre <strong className="font-normal">agence</strong>, c’est <Link to="/comment-choisir-son-agence-de-communication-web/" className="text-bleu hover:text-black font-bold">choisir une expertise et des stratégies évolutives</Link> viables pour <strong className="font-normal">votre site internet</strong>. Nous travaillons à répondre ensemble à votre cahier des charges performants tout en améliorant votre <strong className="font-normal">positionnement dans les résultats de Google</strong> (utilisation de CMS, contenus éditoriaux, design, budget, etc.).</p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            ...
                            <div label="DU SUIVI DE PROJET DE L'ENTREPRISE">
                                <p>Une <Link to="/pourquoi-travailler-dans-une-agence-web/" className="text-bleu hover:text-black font-bold">entreprise <strong className="font-bold">Web</strong></Link> doit faire preuve de pédagogie et afficher une méthode claire pour rendre son domaine de compétence accessible à ses <strong className="font-normal">clients</strong>.
