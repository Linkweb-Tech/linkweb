...
class CreationSiteInternetColomiersPage extends Component {
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            <div className="w-full" label="EST-CE POSSIBLE DE METTRE EN PLACE DES FONCTIONNALITÉS SUR-MESURE POUR MON SITE ?">
                                ...
                                <br /><br /> Par ailleurs, le <strong>site internet</strong> peut aussi constituer un <strong>outil de gestion</strong> pour une entreprise souhaitant mettre le <strong>digital</strong> au centre même de leur fonctionnement. L’<Link to="/" className="text-bleu hover:text-black font-bold"><strong>agence web</strong> Linkweb à Agen</Link> <strong>crée un site internet</strong> adapté à vos besoins et qui vous correspond. Nous nous attachons à répondre à vos attentes, dès la <strong>conception du site</strong>, jusqu'à la <strong>définition des espaces d'administration</strong> et la <strong>répartition des rôles et permissions</strong>. En effet, nous développons votre <strong>CRM</strong> ou <strong>intranet</strong> avec le souci de répondre à vos besoins.
                                <br /><br />
