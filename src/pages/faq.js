    ...
    render() {
        return (
            <Layout location={this.props.location}>
                ...
                transitionTime={200}
            > */}
                <section className="w-full bloctitrescreen mx-auto pb-0 px-4 pt-6 bg-blackflex flex-col justify-center items-center" style={{ background: '#00000094 url(' + background + ')', backgroundBlendMode: 'multiply', backgroundSize: 'cover', backgroundPosition: 'center', height: '450px' }}>
                ...
                <section className="w-full flex flex-col lg:flex-row mx-auto block flex justify-center justify-content-center">
                    ...
                    <FaqBtn setNext={this.setNext} setPrec={this.setPrec} responseId={this.state.active} />
                        ...
                        <Answer id={3} activeId={this.state.active}>
                            ...
                            <h3>Il existe des entreprises spécialisées dans la création de sites internet, mais il est également possible de se tourner vers des free-lances indépendants.</h3>
                            <p>Les solutions pour <strong>créer un site internet</strong> ne manquent pas. Des plateformes de <strong>création de site internet gratuit</strong> aux <strong>agences spécialisée</strong>s, il existe une infinité de possibilités. Toutefois, que valent-elles ? En faisant le choix de la <strong>création d'un site internet via un outil gratuit en ligne</strong>, vous développez un <strong>support de communication</strong> qui sera limité en terme de <strong>visibilité, de notoriété et d'obtention de nouveaux clients</strong> potentiels pour votre entreprise.</p>
                        ...
                        <Answer id={13} activeId={this.state.active}>
                            ...
                            <h4>Lire la suite de <Link to="/creation-site-internet-toulouse/comment-sont-crees-nos-sites-internet/" className="text-bleu hover:text-black">« Comment sont créés les sites internet ? »</Link>.</h4>
                        </Answer>
                ...
                <div className="w-full flex justify-end flex-row clictop">
