                ...
                <section className="w-full  flex flex-col lg:flex-row flex justify-content-start">
                                ...
                                <ul>
                                    ...
                                    <li><p className="soustitre">Développement du site</p>
                                        <ul className="bastitre">
                                            ...
                                            <Question responseId={15} setActive={this.setActive} active={this.state.active}>Combien de temps pour créer unsite internet ?</Question>
                    ...
                    <div className="bloctext w-full lg:w-3/4 century text-justify order-first lg:order-last">
                        <Answer id={1} activeId={this.state.active} >
                            ...
                            <p>Le site internet est un outil de communication qui coche toutes les cases pour une entreprise souhaitant se développer. Que ce soit en termes de visibilité, de notoriété, de réputation ou même pour acquérir de nouveaux clients, le site internet possède un poids considérable dans le développement de sa stratégie.</p>
                            <p>À ce titre, la création d’un site internet procure plusieurs avantages et répond à plusieurs objectifs :</p>
                            <ul>
                                <li><span className="text-bleu">></span> Disposer d’un outil pour maîtriser sa communication</li>
                                <li><span className="text-bleu">></span> Accroître sa visibilité et sa notoriété</li>
                                <li><span className="text-bleu">></span> Obtenir de nouveaux clients</li>
                                <li><span className="text-bleu">></span> Fidéliser ses clients</li>
                        ...
                        <Answer id={2} activeId={this.state.active}>
                            ...
                            <h3>De l’artisan à la PME, en passant par les multinationales, tous les professionnels postulent à la création d’un site internet pour leur entreprise.</h3>
                            <p>La création d’un site internet répond aux besoins de très nombreux acteurs de notre société. En effet, il existe des sites web de toutes les tailles et pour tous les secteurs d’activités. Faire connaître localement son entreprise, mettre en place un outil de réservation de tables pour son restaurant, définir un outil interne d’entreprise : les besoins auxquels répond le site web sont vastes.</p>
                            <p>Il existe des solutions pour tous les professionnels, quelle que soit la taille de votre entreprise, vos objectifs ainsi que votre budget.</p>
                        </Answer>
                        <Answer id={3} activeId={this.state.active}>
                            ...
                            <p>Les solutions pour créer un site internet ne manquent pas. Des plateformes de création de site internet gratuit aux agences spécialisées, il existe une infinité de possibilités. Toutefois, que valent-elles ? En faisant le choix de la création d’un site internet sur un outil gratuit en ligne, vous développez un outil qui pourra être limité afin d’atteindre certains objectifs.</p>
                            <p>Il reste conseillé de contacter un Freelance ou une agence web spécialisée dans la création de site internet. En faisant ce choix, vous faites appel à des professionnels qualifiés qui sauront répondre précisément à vos besoins. De plus, la collaboration est un aspect indispensable à la mise en place d’un projet web réussi. Pour cela, faire appel à un interlocuteur qualifié est très fortement recommandé.</p>
                        </Answer>
                        ...
                        <Answer id={5} activeId={this.state.active}>
                            ...
                            <p>En somme, le référencement naturel va permettre d’accroître la visibilité de son entreprise sur le Web grâce à la mise en place de procédés stratégiques :</p>
                            <ul>
                                <li><span className="text-bleu">></span> l’optimisation de son site web pour le respect de critères imposés par les algorithmes des moteurs de recherche,</li>
                                <li><span className="text-bleu">></span> L’optimisation de son site web en fonction des habitudes et du comportement des utilisateurs.</li>
                                <p>Selon les objectifs définis, le référencement naturel est utile pour développer sa visibilité auprès d’une cible définie et dans un secteur géographique donné. Il permet également d’élargir ses zones de prospection simplement et rapidement grâce au référencement local.</p>
                        ...
                        <Answer id={7} activeId={this.state.active}>
                            ...
                            <h3>Le site internet est un outil de communication incontournable dans le cadre du développement stratégique d’une entreprise. Non seulement, il constitue une base pour communiquer, mais peut également contribuer à votre développement.</h3>
                            <p>Le site internet est devenu un outil indispensable pour les entreprises. Envisager la création d’un site web professionnel et adapté à ses besoins peut être porteur de succès. En effet, de la visibilité obtenue à la notoriété développée, en passant par la possibilité de fidéliser ses clients en définissant un parcours pertinent, la création d’un site internet répond à des objectifs de tous types.</p>
                            <p>Il faut également savoir que le site internet peut être utilisé comme plateforme web interne à une entreprise et destinée à optimiser son fonctionnement. De part la praticité qu’il apporte, l’intranet ou le CRM d’entreprise joue un rôle particulier dans le fonctionnement des organisations. Ouvrant à de nouvelles perspectives, il permet de faciliter bon nombre de tâches comme la réservation de salles de réunion, la gestion de ses stocks, la consultation de documents communs en ligne.</p>
                            <p>La création d’un site internet répond à des objectifs de communication aussi bien externes qu’internes.</p>
                        </Answer>
                        <Answer id={8} activeId={this.state.active}>
                            ...
                            <p>Présenter son entreprise, vendre ses produits, promouvoir son savoir-faire, optimiser la gestion de son entreprise ou développer des fonctionnalités sur-mesure : il existe des solutions web pour tous les professionnels. Pour cela, différents types de sites internet existent pour répondre aux besoins les plus particuliers. Parmi eux, nous retrouvons :</p>
                            <ul>
                                <li><span className="text-bleu">></span> Le site internet vitrine,</li>
                                <li><span className="text-bleu">></span> Le site internet e-commerce,</li>
                                <li><span className="text-bleu">></span> Le site internet administrable,</li>
                        ...
                        <Answer id={9} activeId={this.state.active}>
                            ...
                            <h3>La mise en place d’une refonte de site internet intervient lors d’un changement de stratégie, lorsqu’une société a connu de larges transformations ou bien lorsque sont site web est désuet.</h3>
                            <p>La réalisation d’une refonte de site internet est un moment particulièrement important dans la vie d’un site web. En effet, celle-ci intervient à un moment-clé pour une entreprise : redéfinition stratégique, nouvel élan donné à sa communication, changements majeurs au sein de l’organigramme, etc. Tout le défi va être de développer une nouvelle plateforme en ligne en suivant de nouveaux objectifs, tout en tenant compte du contenu déjà existant et présent sur le web depuis, parfois, des années.</p>
                            <p>La refonte d’un site internet est donc un travail délicat qui demande de bien faire mûrir son projet avant de se lancer sur une nouvelle ligne directrice. Dans tous les cas, la refonte de site web est une opportunité à saisir pour les entreprises souhaitant dynamiser leur communication sur le web.</p>
                        ...
                        <Answer id={10} activeId={this.state.active}>
                            ...
                            <p>La mise en place de fonctionnalités spécifiques est totalement possible sur un site web. Il faudra vous dirigez vers un projet de création de site web sur-mesure afin de définir très précisément vos besoins. Ceci est important pour que nous soyons en mesure de répondre à vos attentes de la manière la plus précise possible.</p>
                            <p>Qu’il s’agisse de mettre en place un système de réservations de tables pour son restaurant, un espace d’administration ou encore des comptes clients, il existe des solutions pratiques pour votre entreprise. Celles-ci peuvent vous permettre d’optimiser vos processus de travail. C’est pourquoi, l’ajout de fonctionnalités à votre site internet peut vous procurer de très nombreux avantages.</p>
                        </Answer>
                        ...
                        <Answer id={11} activeId={this.state.active}>
                            ...
                            <p>Le choix de l’hébergement web de votre futur site internet va être lié à de nombreux critères. La qualité des serveurs, l’espace de stockage qui vous est dédié où encore les fonctionnalités proposées sont autant d’éléments sur lesquels votre choix devra s’appuyer. En somme, il est indispensable de déterminer une solution en totale cohérence avec vos ambitions sur le Web. Un expert en création de site internet vous conseillera sur cette question.</p>
                            <p>En ce qui concerne le choix du nom de domaine, celui-ci doit être réalisé selon plusieurs principes. Il peut contenir le nom de votre entreprise, mais ce n’est pas une obligation. Toutefois, il est important de veiller à ce que le nom de domaine choisi soit bien disponible et non protégé par un dépôt de marque. Enfin, pour un nom de domaine de qualité, il est important de choisir un nom facilement identifiable, mémorable, accessible avec une extension adaptée.</p>
                        ...
                        <Answer id={12} activeId={this.state.active}>
                            ...
                            <p>Si vous avez souscris à un nom de domaine et que sa propriété est toujours en cours de validité, il est totalement possible de l’utiliser pour votre nouveau site internet. Conserver votre nom de domaine vous permettra de créer un repère pour les utilisateurs ayant l’habitude de visiter votre site web.</p>
                        </Answer>
                        ...
                        <Answer id={13} activeId={this.state.active}>
                            ...
                            <p>C’est pourquoi, c’est une fois après vous avoir rencontré que nous démarrons la définition de votre stratégie digitale. En fonction de vos besoins, nous déterminons la solution la mieux adaptée à vos besoins, en termes de plateforme web, mais également pour développer votre visibilité. Nous choisissons les mots-clés sur lesquels nous développerons votre visibilité grâce au référencement naturel ainsi que l’arborescence de votre site internet.</p>
                            <p>Parallèlement, nos équipes de développeurs web se chargent de définir le web design de votre site internet à travers la création d’une maquette, ainsi que de développer les fonctionnalités sélectionnées. Une fois le site prêt à être mis en ligne, nos référenceurs se chargent, en post-production, de l’optimisation technique de votre site pour les moteurs de recherche.</p>
                        ...
                        <Answer id={14} activeId={this.state.active}>
                            ...
                            <p>Qu’ils s’agissent des langages web, des gestionnaires de bases de données, de systèmes de gestion de contenus (CMS) ou de frameworks, nos développeurs sont polyvalents et maîtrisent des technologies diverses et variées. Du HTML/CSS au JavaScript, de Wordpress à Prestashop ou encore de Symfony à Gatsby JS, nos équipes définiront la solution la plus adaptée pour votre création de site internet.</p>
                        ...
                        <Answer id={15} activeId={this.state.active}>
                            ...
                            <p>Il n’existe pas de réponse précise à cette question. De nombreux paramètres entrent en jeu lorsqu’il s’agit de mettre en place un projet web. Ainsi, la définition des besoins, la réalisation technique, la création des contenus et les différents allers/retours sont autant d’éléments qui vont nécessairement jouer sur la durée du processus de création du site.</p>
                            <p>Selon les spécificités techniques de votre projet, le délai de mise en ligne peut être d’une durée plus ou moins importante. C’est pourquoi une création de site internet peut se compter en nombre de semaines comme en nombre de mois pour mettre en place une solution parfaitement au point et prête pour un lancement. Nous serons toutefois en mesure de vous communiquer une estimation du délai de création et de lancement une fois le cadrage du projet effectué.</p>
                        </Answer>
                        <Answer id={16} activeId={this.state.active}>
                            ...
                            <p>Non. Nos équipes de référenceurs se chargent de la rédaction des contenus de votre site internet. Ces derniers sont rédigés en fonction des informations que vous nous communiquerez, en fonction du type de réponse qu’ils apportent aux utilisateurs, mais également en fonction des moteurs de recherche. Ainsi, les contenus que nous mettons en ligne sont uniques et rédigés spécifiquement pour votre site web et vous seront soumis à validation.</p>
                            <p>En revanche, il est conseillé de nous fournir le maximum d’informations, de photographies et d’éléments constituant votre identité visuelle dans la mesure du possible. Ceci est particulièrement utile pour développer un site internet à votre image et fidèle à vos valeurs.</p>
                        </Answer>
                        ...
                        <Answer id={17} activeId={this.state.active}>
                            ...
                            <h3>Le travail de référencement mené sur les sites internet de nos clients est un travail de longue haleine et qui fait appel à beaucoup de rigueur.</h3>
                            <p>Travailler le référencement d’un site web est essentiel pour développer sa visibilité dans les résultats des moteurs de recherche. Ce travail consiste à développer un contenu à destination des algorithmes des moteurs de recherche comme Google, mais également à destination des utilisateurs. Plus que les contenus, l’ensemble des pages web sont optimisées pour être sélectionnées dans l’index de Google et être proposées pour des requêtes stratégiques. Ceci a pour but de générer du trafic sur votre site internet.</p>
                            <p>Le travail de mise à jour est régulier et conséquent en termes de référencement naturel. Il est important d’envoyer des signaux positifs à destinations des robots d’indexation des moteurs de recherche. De la création de nouveaux contenus à l’optimisation des pages existantes et en passant par la création de liens externes pour affirmer la popularité du site, le travail de référencement naturel est un travail continu, régulier et qui demande énormément de rigueur.</p>
                        </Answer>
                        <Answer id={18} activeId={this.state.active}>
                            <h2>Comment sont définis les mots-clés de ma stratégie de référencement ?</h2>
                            <h3>Le choix des mots-clés est une étape fondamentale dans la définition d’une stratégie de référencement. C’est sur eux que la pérennité de la stratégie va être appuyée.</h3>
                            <p>Le choix des mots-clés est un moment crucial dans la définition d’une stratégie de référencement naturel. Il faut savoir qu’il en existe plusieurs types. Nous pouvons par exemple citer les mots-clés génériques ou encore les mots-clés de longue traine. Le fait de recourir à un mot-clé plutôt qu’un autre durant une stratégie se base sur plusieurs éléments :</p>
                            <ul>
                                <li><span className="text-bleu">></span> Les habitudes de recherche des utilisateurs : plus un mot-clé sera recherché, plus son volume de recherche sera élevé et donc porteur pour le site web à positionner.</li>
                                <li><span className="text-bleu">></span> L’intention de recherche des utilisateurs : le type de mot-clé peut dépendre de l’intention de recherche de l’utilisateur. Autrement dit, lorsqu’un utilisateur effectue une recherche, il s’attend à une certaine réponse, ceci est important pour définir le contenu de la page à positionner.</li>
                                <li><span className="text-bleu">></span> La concurrence : il s’agit du nombre de pages web déjà positionnée. Plus la concurrence est élevée, plus difficile il sera de positionner sa page web dans les résultats les plus visibles et donc plus cela prendra de temps.</li>
                                <li><span className="text-bleu">></span> Le taux de conversion : en fonction du type de requête et de l’intention de recherche de l’utilisateur, certains mots-clés vont être porteurs de clics alors que d’autres possèderont un taux de conversion faible. Par exemple, un utilisateur effectuant une requête très précise sait déjà ce qu’il cherche et sera plus à même de convertir par la suite.</li>
                            ...
                            <p>Nous disposons d’outils professionnels nous permettant d’obtenir des données précises à ce sujet. C’est seulement à la suite de l’étude de ces différents éléments que nous choisissons les mots-clés qui seront liés à votre stratégie.</p>
                        </Answer>
                        <Answer id={19} activeId={this.state.active}>
                            ...
                            <p>Le référencement national est un secteur particulièrement concurrentiel et qui demande beaucoup de temps avant d’apporter des résultats satisfaisants. C’est pourquoi, nous orientons principalement nos stratégies de référencement sur le référencement local. Cela consiste à rendre votre site web visible auprès d’un public géographiquement ciblé. Le référencement local présente l’avantage de vous rendre visible auprès d’utilisateurs potentiellement plus réceptifs à vos produits et service.</p>
                            <p>C’est ce qui vous permet d’obtenir un trafic qualifié en vue d’obtenir des contacts près de chez vous ainsi que dans des secteurs que vous couvrez. Votre site apparaît donc comme pertinent pour les utilisateurs et les contacts obtenus sont cohérents avec vos objectifs.</p>
                        </Answer>
                        <Answer id={20} activeId={this.state.active}>
                            ...
                            <p>L’agence web Linkweb met à disposition ses compétences dans la création de site internet du point de vue technique (responsive design, ergonomie web, UX design, etc.) comme du point de vue éditorial (rédaction web optimisée, définition des contenus, navigation intuitive, etc.). Nos spécialistes formés aux problématiques du développement web et du référencement naturel mettent en oeuvre vos stratégies en fonction de vos objectifs.</p>
                            <p>Pour ce faire, nous disposons d’outils permettant de réaliser des audits de site web, mais également de suivre les performances de votre site à travers l’analyse du comportement des utilisateurs. Nous disposons également d’outils permettant de monitorer le positionnement des pages web de votre site internet professionnel dans les pages de résultats de recherche.</p>
                            <p>Par ailleurs, nous collaborons avec nos clients pour adapter nos stratégies en fonction des résultats, mais également effectuer un suivi de performances visant à définir la mise en place de nouvelles actions.</p>
                        </Answer>
                        <Answer id={21} activeId={this.state.active}>
                            <h2>Je ne trouve pas mon site sur les moteurs de recherche. Que dois-je faire ?</h2>
                            <p>Il n’est pas impossible qu’en essayant de recherche votre site web sur Google, vous ne le trouviez pas. Si c’est le cas pour vous, nous vous invitons à nous contacter en vue d’éclaircir cette situation.</p>
                            <p>Avant toute chose, il sera nécessaire de vérifier plusieurs éléments : le mot-clé recherché est-il un mot-clé travaillé par nos services ? Est-ce que le secteur géographique a bien été indiqué lors de la demande de référencement ? Effectuez-vous la recherche sur le bon moteur de recherche ?</p>
                            <p>Dans tous les cas, n’hésitez pas à nous contacter afin d’obtenir une réponse précise à votre interrogation.</p>
                        </Answer>
                        {/** SUIVI DU SITE **/}

                        <Answer id={22} activeId={this.state.active}><h2>En quoi consiste le suivi de référencement effectué ?</h2>
                            <p>Afin d’évaluer les stratégies de référencement mises en place sur les sites internet de nos clients, nos référenceurs web effectuent un suivi régulier de performances. Ce suivi nous permet d’évaluer si les moyens mis en place sont en adéquation avec les objectifs de la stratégie.</p>
                            <p>Pour ce faire, nous disposons d’outils professionnels nous permettant de suivre les statistiques relatives au comportement des utilisateurs. Il est également de suivre le positionnement des pages web référencées dans les pages recherche de Google et pour les mots-clés ciblés.</p>
                            <p>Le suivi est effectué de manière régulière afin d’ajuster la stratégie en fonction des résultats. Enfin, le suivi est exposé à nos clients au cours des appels mensuels en vue de toujours garder une certaine proximité avec vos besoins.</p>
                        </Answer>
                        <Answer id={23} activeId={this.state.active}><h2>À quelle fréquence est effectué le suivi de référencement ?</h2>
                            <p>Afin de nous assurer que la prestation effectuée correspond bien à vos attentes, nous effectuons un point mensuel pour vous tenir informés de l’activité de votre site web. Ressentez-vous les effets du travail mis en place ? Le contenu créé sur votre site est-il cohérent par rapport à vos attentes ? Y a-t-il des nouveautés au sujet de votre entreprise à mettre en avant ?</p>

                            <p>Nous vous tenons informés et nous tenons informés de votre actualité afin de vous proposer de nouveaux contenus en accord vos besoins.</p>
                        </Answer>
                        <Answer id={24} activeId={this.state.active}>
                            <h2>Un problème est survenu sur mon site, que dois-je faire ?</h2>
                            <p>Un problème de nature inconnue affecte le fonctionnement de votre site web ? Une mauvaise manipulation a été réalisée sur votre site et vous ne savez pas comment y remédier ? Notre service technique assure la maintenance de votre site : n’hésitez à nous contacter en cas de problème concernant l’accès à votre site internet.</p>
                        </Answer>
                        ...
                        <Answer id={25} activeId={this.state.active}>
                            ...
                            <p>L’investissement lié à la mise en place d’un projet web nécessite une relation de confiance et de collaboration entre les différents acteurs du projet. À ce titre, il est important de bien choisir ses interlocuteurs pour maximiser ses chances de réussite.</p>
                            <h3>Travailler avec une agence web de proximité à Toulouse et Agen</h3>
                            <p>Linkweb est une agence web à taille humaine. Présente à Agen (47) et Toulouse (31), notre est agence est une agence de proximité. Nous misons sur une relation de confiance avec nos clients pour maximiser la réussite de nos projets web.</p>
                            <p>Que ce soit lors de la création de votre site internet ou bien durant son référencement, nos professionnels sont accessibles pour répondre à vos attentes, ainsi que vous accompagner dans la définition de votre projet.</p>
                            <h3>Travailler avec des professionnels du développement et référencement de sites web</h3>
                            <p>Les équipes de notre agence web sont composées de professionnels compétents en développement web et en référencement naturel. Ainsi, nous sommes en mesure de répondre à vos demandes que ce soit d’un point de vue technique, mais également éditorial.</p>
                            <p>Nous vous donnons accès à une plateforme optimale d’un point de vue technique et adaptée pour acquérir de la visibilité grâce aux moteurs de recherche comme Google.</p>
                            <h3>Travailler avec un interlocuteur privilégié pour un suivi régulier</h3>
                            <p>Une fois le projet lancé, un professionnel dédié à votre projet est chargé de mettre en place un suivi régulier. Ce suivi de projet vous permettra d’être tenu(e) informé(e) de l’activité de votre site web à travers : le travail effectué durant le mois écoulé, les performances (trafic, entrées, objectifs, etc.) ainsi que les perspectives d’évolution.</p>
                            <p>Travailler avec un interlocuteur privilégié est à la base d’une bonne collaboration. C’est pourquoi, vous profiterez d’une gestion de projet sur-mesure de la création au référencement de votre site internet.</p>
                        </Answer>
                        <Answer id={26} activeId={this.state.active}>
                            <h2>Comment se déroule mon projet de création de site web ?</h2>
                            <p>Lorsque vous décidez de créer votre site internet avec Linkweb, nous vous accompagnons, étape par étape, dans la mise en oeuvre de votre projet. En effet, la première étape consiste à définir le cadre de votre projet de site internet, à savoir vos objectifs, cibles, mais également le contexte dans lequel va s’inscrire votre site web (vis-à-vis de la concurrence, vis-à-vis de votre stratégie de communication globale.</p>
                            <p>Dès lors que la stratégie de votre site internet est fixée, nos services développement et référencement se chargent de réaliser l’aspect visuel et fonctionnalités d’une part et l’aspect éditorial d’autre part.</p>
                            <p>Une fois les contenus produits et mis en page, le site est soumis à votre validation. Si la proposition vous convient, alors le processus de mise en ligne peut-être lancé. Si vous avez des remarques à effectuer, nos équipes se chargeront des ajustements.</p>
                            <p>Enfin, la mise en ligne de votre site internet n’est pas la dernière étape puisqu’un collaborateur sera chargé, chaque mois, de travailler sur votre site afin de l’optimiser pour le référencement naturel. Un suivi sera alors effectué pour vous permettre d’être au courant des actions menées sur votre site web et des performances qui en découlent.</p>
                        </Answer>
                        <Answer id={27} activeId={this.state.active}>
                            <h2>Suis-je propriétaire de mon site web ?</h2>
                            <p>Lorsque vous souscrivez à un projet de site web avec Linkweb, il faut savoir que le site internet créé vous appartient. Vous en êtes donc propriétaire.</p>
                        </Answer>
                        <Answer id={28} activeId={this.state.active}>
                            <h2>Combien coûte un site web ?</h2>
                            <p>Il est difficile de chiffrer le prix d’un site internet car il n’existe pas un type de site internet. Ainsi, le prix de la création va varier en fonction de différents postes qui composeront le tarif de votre projet web. En fonction du type de site internet, la mise en place de certaines fonctionnalités demande plus de temps et de compétences.</p>
                            <p>Ceci est également valable en ce qui concerne la stratégie à mettre en oeuvre. En fonction de vos objectifs ou encore de votre concurrence, les actions à mettre en place pourront être plus ou moins conséquentes.</p>
                            <p>Ainsi, il n’existe pas de tarif exact pour un site internet. Celui-ci est déterminé en fonction des spécificités de votre projet. C’est pourquoi, Linkweb réalise votre devis sur-mesure.</p>
                        </Answer>
                        <Answer id={29} activeId={this.state.active}>
                            <h2>Existe-t-il des facilités de paiement ?</h2>
                            <p>Oui. Chaque projet de création et référencement naturel est porté sur une année. Ainsi, nous vous donnons la possibilité de régler le montant de votre projet sous forme de mensualités.</p>
                            <p>De plus, en fonction de votre demande, nous avons la possibilité d’adapter les modalités de paiement au cas par cas pour vous permettre de disposer d’un site internet avec une méthode de paiement qui vous convient.</p>
                        </Answer>
                        <Answer id={30} activeId={this.state.active}>
                            <h2>Que pensent nos clients de nos services ?</h2>
                            <h4>Découvrir ce que pensent nos clients de nos services de création et référencement de sites internet.</h4>
                        </Answer>
                        <Answer id={31} activeId={this.state.active}>
                            <h2>Où découvrir des sites internet créés par Linkweb ?</h2>
                            <p>Vous pourrez retrouver un échantillon de nos créations sur la page de présentation de nos réalisations sur notre site internet.</p>
                            ...
                            <p>C’est en cela que nous sommes en mesure d’adapter nos créations en fonction de vos cibles et et de vos spécificités en construisant chaque site web pour apporter une réponse claire et précise aux requêtes des utilisateurs.</p>
                            <h4>Nous vous invitons à jeter un oeil à nos réalisations.</h4>
                        </Answer>
                    </div>
                </section>
