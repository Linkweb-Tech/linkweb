...
import Bg from "../images/creation-site-internet-blagnac.jpg";
    ...
    render(){
        ...
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    title="Création de Site Internet à Blagnac (31) - Agence Web Linkweb"
                    description="Création de site internet à Blagnac (31). Devis gratuit – Accompagnement professionnel - Suivi régulier et personnalisé."
                    keywords={[`Création site internet Blagnac`, `Création site internet Blagnac`, `Création site web Blagnac`, `Création site web Blagnac`]}
                    url="https://linkweb.fr/creation-site-internet-blagnac/"
                    nom="Création de site internet à Blagnac"
                    slug="creation-site-internet-blagnac/"
                /> 
                {/* <PageTransition
                    defaultStyle={{
                ...
                > */}
                    ...
                    <section className="w-full h-screen mx-auto px-10 sm:px-4 py-6 bg-no-repeat bg-cover flex flex-col justify-center items-center" style={{ background:'#00000084 url(' + Bg + ')', backgroundBlendMode:'multiply', backgroundPosition:'bottom', backgroundSize:'cover' }}>
                        ...
                        Création de site internet à Blagnac (31)
                        </h1>
                    ...
                    <section className="flex w-full flex-col lg:flex-row mx-auto px-4 py-6 my-4">
                        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center">
                            <img src={imac} className="mx-auto flex my-6" alt="Création site internet Blagnac"/>
                        </div>
                    ...
                    <section className="max-w-5xl w-full mx-auto px-4 pt-12 pb-0 my-2">
                        ...
                        <hr className="blue"></hr>
                        <h3 /*data-aos="fade-in"*/ className="text-center font-normal italic century text-sm">Création de site internet à Blagnac</h3>
                    </section>
                    ...
                    <section className="flex w-full flex-col lg:flex-row mx-auto px-4 md:py-6 md:my-4">
                        <div className="w-full lg:w-1/2 pt-6">
                            <img 
                                src={mac}
                                alt="Création site internet Blagnac"
                                /*data-aos="fade-right"*/
                            />
                        </div>
                    ...
                    <section className="max-w-6xl mx-auto flex flex-col align-center justify-center text-center mt-12 mb-3">
                        <h2 className="century text-center text-2xl tracking-wider pb-3 leading-tight" /*data-aos="zoom-in"*/>
                            <span className="text-bleu">/</span>Vous souhaitez en savoir plus sur la création de site internet à Blagnac ?
                        </h2>
                        <hr className="blue"></hr>
...
`
export default CreationSiteInternetBlagnacPage;
