            ...
            <Layout location={this.props.location}>
                ...
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + siteinternet + ')' }}>
                        ...
                        <p className="text century lg:mt-0 text-lg lg:text-sm xl:text-lg">Donnez vie à votre projet en faisant appel à Linkweb sur le secteur de <strong className="font-normal">Lyon</strong> mais également partout en France. Site e-commerce, catalogue ou vitrine, nous répondons à vos attentes pour vous fournir un <strong className="font-normal">outil digital</strong> des plus performants, web-design et intuitif. Grâce aux solutions apportées par ses <strong className="font-normal">experts du web</strong>, notre <a href="/agence-digitale-toulouse/" className="text-bleu hover:text-black font-bold">agence web de Toulouse</a> comme celle de Lyon, vous propose une réalisation adaptée à vos besoins pour obtenir des performances élevées. <br/><br/>
                    ...
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + referencement + ')' }}>
                        ...
                        Pour vous accompagner dans la mise en application de votre <strong className="font-normal">stratégie de référencement naturel</strong>, Linkweb fait partie des agences qui se montrent à votre écoute. Selon vos ambitions et vos besoins, nous vous apportons un conseil pertinent. Notre objectif est de proposer une <strong className="font-normal">expérience utilisateur</strong> optimale sur les pages de votre site et vous positionner sur la <strong className="font-normal">première page dans les résultats de recherche</strong> des moteurs pour des mots-clés opportuns.   
                        <br /><br />Les compétences et le professionnalisme de <a href="/agence-web-marseille/" className="text-bleu hover:text-black font-bold">Linkweb</a> vous permettent de bénéficier d’une <strong className="font-normal">stratégie de communication digitale</strong> adaptée et durable.
                        </p>
                    </div>
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + webdesign + ')' }}>
                        ...
                        Apportez un <strong className="font-normal">retour sur investissement</strong> rapide à votre entreprise en optant pour la création d'une <strong className="font-normal">campagne Adwords</strong> pour votre projet. Hissez-vous en tête de page de résultats des moteurs de recherche rapidement : bénéficiez d’une transformation boostée grâce à la <strong className="font-normal">régie publicitaire de Google</strong>. Le <strong className="font-normal">référencement payant SEA</strong> est proposé aux entreprises en quête d’une performance rapide et rentable.
                            <br /><br />Linkweb se démarque des autres <strong className="font-normal">agences</strong> de par sa capacité à apporter des solutions sur-mesure et un conseil adapté à tous les <a href="/agence-web-strasbourg/" className="text-bleu hover:text-black font-bold">projets de <strong className="font-normal">communication</strong></a> et de <strong className="font-normal">webmarketing</strong>.</p>
                    </div>
                </section>
        ...
        <div className="w-full xl:w-1/3 one px-auto">
          <div className="flex items-center xl:items-start flex-col xl:flex-row flex-1">
            ...
            <section className="w-full lg:w-1/3 absolute z-10 px-auto lg:w-1/3 absolute px-12 lg:px-6 xl:px-24 pt-24">
              ...
              Pour tout profil d’<strong className="font-normal">entreprise</strong> (PME, TPE, indépendants), Linkweb met à votre disposition, son savoir-faire. Les services qui vous sont proposés en agence pour votre <strong className="font-normal">site en ligne</strong> sont adaptés à chacune de vos attentes pour vous fournir un outil adapté. Design graphique et <strong className="font-normal">responsive</strong> (tous supports : <strong className="font-normal">mobile</strong>, tablette, ordinateur), réalisations de <strong className="font-normal">contenus optimisés</strong> pour les moteurs comme pour les utilisateurs : la <strong className="font-normal"><a href="/agence-web-montpellier/" className="text-bleu hover:text-black font-bold">stratégie de communication web</a></strong> qui vous est proposée est pensée spécialement pour vous.
                </div>
        ...
        <div className="w-full xl:w-1/3 two px-auto">
          <div className="flex items-center xl:items-start flex-col xl:flex-row flex-1">
            ...
            <section className="w-full lg:w-1/3 absolute z-10 px-auto lg:w-1/3 absolute px-12 lg:px-6 xl:px-24 pt-24">
              ...
              <div className="century content pb-6 text-justify" style={{ textAlignLast: 'center' }}>
              Définissez votre <strong className="font-normal">stratégie de développement et de communication</strong> grâce au conseil de l’agence. Linkweb fait partie des <strong className="font-normal">agences</strong> qui maîtrisent parfaitement les outils web pour apporter toute la visibilité nécessaire aux entreprises sur <strong className="font-normal">Internet</strong>. En apportant une <a href="/agence-web-nice/" className="text-bleu hover:text-black font-bold">formule webmarketing</a> adaptée à votre <strong className="font-normal">support digital</strong>, vous devenez <strong className="font-normal">visible sur le web</strong>. Pour un projet de refonte comme pour les créations de sites, la réalisation de vos supports se fait en toute transparence avec notre <strong className="font-normal">agence</strong>.
                </div>
                        ...
                        <div className="w-full lg:w-1/2 my-10  flex flex-col">
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full century px-6 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <br />
                                    <p className="w-full century pb-4 text-justify"><p  /*data-aos='fade-left'*/ className="text-justify" >Nous accompagnons nos <strong className="font-normal">clients</strong> dans leurs projets depuis 2008, pour répondre à leurs besoins en matière de conception et <strong className="font-normal"><a href="/agence-web-bordeaux/" className="text-bleu hover:text-black font-bold">communication digitale</a></strong>.</p>
                                    </p>
                            ...
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full century px-12 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <br />
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify">Notre <strong className="font-normal">agence</strong> reçoit une note basée sur 108 avis laissés par nos clients sur sa fiche <strong className="font-normal">Google</strong> : celle-ci témoigne de leur satisfaction.</p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                                </div>
                            </div>
                        </div>
