        ...
        <div className="w-full xl:w-1/3 two px-auto">
          <div className="flex items-center xl:items-start flex-col xl:flex-row flex-1">
            ...
            <section className="w-full lg:w-1/3 absolute z-10 px-auto lg:w-1/3 absolute px-12 lg:px-6 xl:px-24 pt-24">
              ...
              <div className="century content pb-6 text-justify" style={{ textAlignLast: 'center' }}>
              Définissez votre <strong className="font-normal">stratégie de développement et de communication</strong> grâce au conseil de notre <a href="/agence-web-nice/" className="text-bleu hover:text-black font-bold">agence web près de Nice</a>. Linkweb fait partie des <strong className="font-normal">agences</strong> qui maîtrisent parfaitement les outils web pour apporter toute la visibilité nécessaire aux entreprises sur <strong className="font-normal">Internet</strong>. En apportant une formule webmarketing adaptée à votre <strong className="font-normal">support digital</strong>, vous devenez <strong className="font-normal">visible sur le web</strong>. Pour un projet de refonte comme pour les créations de sites, la réalisation de vos supports se fait en toute transparence avec notre <strong className="font-normal">agence</strong>.
                </div>
                        ...
                        <div className="w-full lg:w-1/2 my-10  flex flex-col">
                            ...
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full century px-12 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <br />
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify">Notre <strong className="font-normal"><Link to="/agence-web-agen/" className="text-bleu hover:text-black font-bold">agence web à Agen</Link></strong> reçoit une note basée sur 117 avis laissés par nos clients sur sa fiche <strong className="font-normal">Google</strong> : celle-ci témoigne de leur satisfaction.</p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                                </div>
                            </div>
                        </div>
