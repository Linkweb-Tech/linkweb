            ...
            <Layout location={this.props.location}>
                ...
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    ...
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + referencement + ')' }}>
                        ...
                        <br /><br />Les compétences et le professionnalisme de <a href="/agence-web-marseille/" className="text-bleu hover:text-white font-bold">Linkweb</a> vous permettent de bénéficier d’une <strong className="font-normal">stratégie de communication digitale</strong> adaptée et durable.
                        </p>
                    </div>
