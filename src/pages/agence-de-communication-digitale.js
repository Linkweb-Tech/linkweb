            ...
            <Layout location={this.props.location}>
                ...
                <section className="sidetitle w-10/12 text-center text-black text-2xl justify-center flex flex-col century mt-10 mb-10 mx-auto">
                    ...
                    <div className="line-title my-4">
                        ...
                        <br />
                        <h3 /*data-aos='fade-left'*/ className="max-w-6xl text-xl text-black text-center lg:text-justify century pb-0">Miser sur la communication web et le <Link to="/agence-web-marketing-toulouse/" className="text-bleu hover:text-black font-bold">web marketing</Link> est important pour le développement de votre entreprise et de son identité en tant que marque. Pour atteindre vos objectifs de développement, les solutions sont nombreuses en vue de construire votre projet digital sur-mesure.</h3>
                    </div>
                </section>
                        ...
                        <div className="w-full lg:w-1/2 my-10  flex flex-col">
                            ...
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full px-12 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify">Vos services, vos prestations, vos produits seront au cœur de l’élaboration de votre projet, auttant sur la partie graphique et ergonomique que fonctionnelle.<br /> L’élaboration d’un cahier des charges détaillé nous permettra de <strong>créer un site web</strong> qui vous correspondra.</p>
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify" >Nous prenons en compte votre positionnement, votre charte graphique ainsi que votre <strong>image de marque</strong>, tout en étudiant votre concurrence pour une <strong>création web</strong> qui colle à votre entreprise, que ce soit à Agen, Toulouse, Tonneins, Villeneuve-sur-Lot ou Marmande.</p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                                </div>
                            </div>
                            <div className="w-full flex-col md:flex-row flex px-auto">
                    ...
                    <section className="flex justify-center flex-col items-center">
                        ...
                        <div className="w-full text-white flex flex-col md:flex-row justify-center lg:w-3/4 mt-5 md:mt-10 mb-12">
                            <div className="w-full svgtransform -mt-2 md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                ...
                                <p>Notre équipe de spécialistes de <strong>communication web</strong> réalise un suivi des <strong>performances de votre site internet</strong> pour vous proposer des solutions pertinentes.</p>
                            </div>
                        ...
                        <div className="flex items-center xl:items-start flex-col xl:flex-row flex-1">
                            ...
                            <section className="w-full lg:w-1/3 absolute z-10 px-auto lg:w-1/3 absolute px-12 lg:px-6 xl:px-24 pt-24">
                                <h3 className="century capitalize text-2xl tracking-wider pb-3 leading-tight text-center" /*data-aos="zoom-in"*/>
                                    <span className="text-bleu">/</span>JE SOUHAITE DÉCOUVRIR LA COMMUNICATION WEB
                </h3>
                ...
                <section className="flex w-full flex-col mx-auto px-0 py-6 my-4 lg:my-0">
                    <section className="text-center text-black text-2xl mx-auto lg:mx-0 century mt-16 mb-10 lg:mb-2">
                        <h2 className="century text-3xl md:text-5xl text-black leading-none">Qu’est-ce que la communication web peut vous apporter ?</h2>
                        <br />
                        <hr className="border-solid w-1/6 border-bleu"></hr>
                        <br />
