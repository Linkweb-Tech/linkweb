            ...
            <Layout location={this.props.location}>
                ...
                <section className="bg-black sidetitle py-10">
                    <section className="w-full lg:w-2/3 flex flex-col justify-center century my-10 px-4 lg:px-32 md:mx-6 sm:mx-12 mt-2 lg:mx-64">
                        <h2 className="century text-center lg:text-left text-white text-3xl md:text-5xl leading-tight">Que proposons-nous pour concevoir <span className="text-bleu">votre stratégie de communication</span> à Toulouse ?</h2>
                        <br />
                        <div className="line-title my-4 ">
                            <br />
                            <hr className="w-1/2 border-bleu lg:w-1/12" />
                            <br />
                            <h3 /*data-aos='fade-left'*/ className="text-xl text-white century pb-0">Linkweb, agence de communication digitale à Toulouse met son savoir-faire à profit pour vous proposer un service performant.</h3>
                        </div>
                    </section>
                    <section className="flex justify-center flex-col items-center">
                        <div className="w-full px-12 lg:px-0 flex justify-center flex-col md:flex-row lg:w-3/4 mt-5">
                            <div className="w-full svgtransform md:w-1/4 mx-auto px-2 mb-10 md:mb-0 text-white century text-center lg:text-left">
                                ...
                                <h4 className="font-bold century text-bleu"><span className="font-bold">Création sites internet sur-mesure</span></h4>
                                <p>Linkweb fait partie des <strong>agences</strong> qui proposent des <Link className="text-bleu hover:text-white font-bold" to="/comment-choisir-son-agence-de-communication-web/">prestations complètes</Link> de l’élaboration à la <strong>gestion de votre site internet</strong>.</p>
                            </div>
                        ...
                        <div className="w-full text-white flex flex-col md:flex-row justify-center lg:w-3/4 mt-5 md:mt-10 mb-12">
                            <div className="w-full svgtransform -mt-2 md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                ...
                                <p>Notre équipe de spécialistes de <strong>communication digitale</strong> réalise un suivi des <strong>performances de votre site internet</strong> pour vous proposer des solutions pertinentes.</p>
                            </div>
                            <div className="w-full svgtransform md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                ...
                                <p>Nous travaillons à la mise en place d’un éco-système autour de votre site pour développer sa <strong>popularité vis-à-vis des moteurs de recherche</strong>.</p>
                            </div>
                            <div className="w-full svgtransform md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                ...
                <section className="flex flex-col lg:flex-row flex-1 home-step my-3 px-4 xl:my-12 xl:px-24">
                    ...
                    <div className="w-full xl:w-1/3 three px-auto">
                        <div className="flex items-center xl:items-start flex-col xl:flex-row flex-1">
                            ...
                            <section className="w-full lg:w-1/3 absolute z-10 px-auto lg:w-1/3 absolute px-12 lg:px-6 xl:px-24 pt-24">
                                <h3 className="century capitalize text-2xl tracking-wider pb-3 leading-tight text-center" /*data-aos="zoom-in"*/>
                                    <span className="text-bleu">/</span>JE SOUHAITE LA MISE EN PLACE D’UN PROJET SUR-MESURE
                </h3>
                                <div className="century content pb-6 text-justify" style={{ textAlignLast: 'center' }}>
                                    En faisant appel à nos services, vous faites le choix d’un projet qui vous ressemble, mais également d’un <strong><Link to="/agence-marketing-toulouse/" className="text-bleu hover:text-black font-bold">conseil en marketing digital</Link></strong> pour déterminer vos facteurs de succès. De plus, nous disposons de tous les outils nécessaires à l’élaboration d’un plan d’actions efficaces en fonction de vos besoins.
                </div>
                            </section>
                ...
                <section className="flex w-full flex-col mx-auto px-0 py-6 my-4">
                    <section className="text-center text-black text-2xl mx-auto lg:mx-0 century mt-16 mb-10">
                        <h2 className="century text-3xl md:text-5xl text-black leading-tight">Linkweb, avant tout une équipe de <br />spécialistes du <span className="text-bleu">Marketing digital</span> et de la <span className="text-bleu">Communication en ligne</span></h2>
                        <br />
                ...
                <section className="bloctextimg w-full md:w-10/12 mx-auto lg:block lg:mx-auto xl:w-full flex flex-col lg:flex-row justify-center">
                    ...
                    <div className="text century w-full text-justify mr-16 lg:w-3/5 xl:w-2/5 md:p-20 lg:pl-32 p-10 lg:py-10 text-black text-sm xl:text-md" style={{ backgroundColor: '#d3d3d352' }}>
                        ...
                        <p style={{ fontSize: '16px' }}>
                            ...
                            <br />
                            <strong>Internet</strong> est un vaste terrain de jeu au potentiel infini. Il peut-être une source de développement particulièrement importante pour des entreprises de tous secteurs et présentes dans toute la <strong>France</strong>. La mise en place d’une <strong>solution digitale</strong> est pertinente pour faire connaître sa marque et étendre sa <strong>visibilité</strong>.<br />
                        </p>
                    </div>
                ...
                <section className="flex w-full flex-col mx-auto px-0 py-6 my-4 lg:my-0">
                    <section className="text-center text-black text-2xl mx-auto lg:mx-0 century mt-16 mb-10 lg:mb-2">
                        ...
                        <hr className="border-solid w-1/6 border-bleu"></hr>
                        <br />
                        <h3 className="text-black text-xl text-center century">Vous souhaitez faire connaître votre société, développer votre votre identité de marque pour atteindre vos objectifs de développement ? <br />La mise en place d’une stratégie digitale est la première étape.</h3>
                    </section>
                </section>
                <section className="tabPanel flex flex-1 w-full justify-end ml-0 mb-12">
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            ...
                            <div label="DES BÉNÉFICES EN TERMES D’IMAGE, MAIS AUSSI POUR BOOSTER VOTRE ACTIVITÉ">
                                <p>Mettre en avant votre <strong>profil d’expert</strong> dans votre domaine de compétences grâce à la <strong>création de contenu</strong> pertinent pour les utilisateurs vous sera grandement bénéfique en termes d’<strong>image</strong>. Par ailleurs, il s’agit également d’un moyen pour promouvoir votre <strong>identité visuelle</strong> et ainsi <strong>développer la notoriété de votre société</strong>.</p>
                                <br />
