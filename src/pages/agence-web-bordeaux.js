            ...
            <Layout location={this.props.location}>
                ...
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    ...
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + referencement + ')' }}>
                        ...
                        Notre <strong className="font-normal"><a href="/agence-web-lyon/" className="text-bleu hover:text-white font-bold">agence web à Lyon</a></strong> vous accompagne dans la <strong className="font-normal">conception de sites ergonomiques</strong> mais également dans votre <strong className="font-normal">stratégie de communication digitale</strong>. En définissant vos objectifs avec un spécialiste du digital, mettez en application la solution la plus appropriée pour votre <strong className="font-normal">visibilité sur le web</strong>. Votre <strong className="font-normal">site en ligne</strong> est pertinent, il propose un contenu optimisé qui répond aux questions que se posent les utilisateurs. Ces éléments influencent le positionnement des pages de vos supports de communication digitale dans les <strong className="font-normal">pages de résultats (SERP) des moteurs</strong>. 
                        <br /><br />Grâce à notre solution de référencement personnalisée, atteignez la <strong className="font-normal">première page des suggestions des moteurs</strong>. L’expertise Linkweb vous aide à atteindre vos objectifs durablement.
                        </p>
                    </div>
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + webdesign + ')' }}>
                        ...
                        <p className="text century text-lg lg:text-sm xl:text-lg z-50">
                        Linkweb se démarque des autres <strong className="font-normal">agences</strong> par sa grande capacité d’écoute et sa réactivité. Chacun de vos besoins en matière de stratégie digitale est une priorité pour l’<strong className="font-normal">équipe de notre agence</strong>. De ce fait, la <strong className="font-normal">régie publicitaire Ads (SEA)</strong> est une formule proposée aux entreprises recherchant un <strong className="font-normal">retour sur investissement</strong> rapide et ponctuel. Ces services sur-mesure positionnent temporairement votre site en tête de page des résultats des moteurs pour <strong className="font-normal">générer un trafic pertinent</strong>.
                        <br /><br />Site vitrine, site e-commerce, votre site personnalisé s’intègre dans une <strong className="font-normal">stratégie adaptée à vos projets</strong>. Notre <a href="/" className="text-bleu hover:text-white font-bold">agence web Toulouse</a> maîtrise les outils les plus performants pour vous apporter toutes les retombées souhaitées.</p>
                    </div>
                </section>
          ...
          <div className="flex items-center xl:items-start flex-col xl:flex-row flex-1">
            ...
            <section className="w-full lg:w-1/3 absolute z-10 px-auto lg:w-1/3 absolute px-12 lg:px-6 xl:px-24 pt-24">
              ...
              <div className="century content pb-6 text-justify" style={{ textAlignLast: 'center' }}>
                Linkweb s’adresse aux sociétés présentes sur le secteur de <strong className="font-normal">Bordeaux</strong>, mais également sur toute la France pour apporter la <strong className="font-normal">meilleure visibilité à chaque projet</strong>. Les services proposés par notre équipe, au sein de notre <a href="/agence-web-marseille/" className="text-bleu hover:text-black font-bold">agence web à Marseille</a>, ont pour but de vous permettre d’atteindre vos objectifs. Pour une refonte, une création, votre communication, une <strong className="font-normal">solution de marketing digital créative</strong> (référencement naturel SEO ou payant SEA avec Google Adwords), les outils et la méthodologie sont adaptés à vos besoins. Identité visuelle, responsive design, gestion de contenu, les <strong className="font-normal">réalisations</strong> sont multiples et personnalisées.
                </div>
              ...
              <button
                    ...
                    <section className="w-full  my-10 flex flex-col lg:flex-row items-center justify-start">
                        ...
                        <div className="w-full lg:w-1/2 my-10  flex flex-col">
                            ...
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full century px-12 lg:px-6 flex flex-col justify-center">
                                    <h3 className="century uppercase text-3xl md:text-4xl tracking-wider pb-3 leading-tight text-center md:text-left" /*data-aos="zoom-in"*/>
                                        <span className="text-bleu">/</span>L'agence est notée 4,6/5 sur Google
                                    </h3>
                                    <br />
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify">Nos <strong className="font-normal">clients</strong> sont ravis des prestations de notre <strong className="font-normal"><a href="/agence-web-montpellier/" className="text-bleu hover:text-black font-bold">agence web à Montpellier</a></strong> et ils le montrent, notre note Google est calculée à partir de 118 avis sur notre fiche.</p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                                </div>
                            </div>
                        </div>
                ...
                <section className="sidetitle w-10/12 text-center text-black text-2xl justify-center flex flex-col century mt-10 mb-10 mx-auto">
                    ...
                    <div className="line-title my-4">
                        <hr className="border-solid w-1/2 lg:w-1/12 border-bleu"></hr>
                        <br />
                        <h3 /*data-aos='fade-left'*/ className="max-w-6xl text-xl text-black text-center lg:text-justify century pb-0">Digitaliser votre société : un atout conséquent pour générer du trafic et atteindre une notoriété intéressante.</h3>
                    </div>
                </section>
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            <div className="w-full" label="DÉPLOYEZ VOTRE INFLUENCE ET ATTIREZ LA CURIOSITÉ DES UTILISATEURS">
                                <p>L'élaboration d’une stratégie personnalisée est essentielle pour se faire une place intéressante dans les <strong className="font-normal">pages de résultats des moteurs de recherche</strong>. De ce fait, les consultants de notre <a href="/agence-web-strasbourg/" className="text-bleu hover:text-black font-bold">agence web à Strasbourg</a> travaillent à mettre en place la meilleure <strong className="font-normal">stratégie de communication</strong> pour votre projet digital. Grâce à la conception d’une arborescence complète et stratégique, chaque <strong className="font-normal">page web</strong> possède une fonction qui lui est propre. 
                                <br/><br/>
                                Les référenceurs de Linkweb déterminent les <strong className="font-normal">leviers</strong> à activer pour permettre à votre site d’atteindre le positionnement escompté dans les <strong className="font-normal">SERP des moteurs de recherche</strong>.</p>
                            </div>
                            <div label="GÉNÉREZ UN TRAFIC PERTINENT ET QUALIFIÉ GRÂCE À VOTRE SITE">
                                <p>
                                <strong className="font-normal">Être visible</strong> est essentiel pour transmettre plus efficacement l’information aux potentiels prospects. L'objectif du <strong className="font-normal">référencement</strong> et de la <Link to="/creation-de-site-internet-a-agen/" className="text-bleu hover:text-black font-bold">création de site internet à Agen</Link> est de simplifier l’accès aux informations recherchées par les utilisateurs. C’est pour cette raison qu’il est important d’inclure la question du besoin et de l’<strong className="font-normal">intention de l’utilisateur</strong> dès la réalisation de votre site. 
                                <br/><br/>
