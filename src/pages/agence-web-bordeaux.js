          ...
          <div className="flex items-center xl:items-start flex-col xl:flex-row flex-1">
            ...
            <section className="w-full lg:w-1/3 absolute z-10 px-auto lg:w-1/3 absolute px-12 lg:px-6 xl:px-24 pt-24">
              ...
              <div className="century content pb-6 text-justify" style={{ textAlignLast: 'center' }}>
                Linkweb s’adresse aux sociétés présentes sur le secteur de <strong className="font-normal">Bordeaux</strong>, mais également sur toute la France pour apporter la <strong className="font-normal">meilleure visibilité à chaque projet</strong>. Les services proposés par notre équipe, au sein notre <a href="/agence-web-marseille/" className="text-bleu hover:text-black font-bold">agence web à Marseille</a>, ont pour but de vous permettre d’atteindre vos objectifs. Pour une refonte, une création, votre communication, une <strong className="font-normal">solution de web-marketing</strong> (SEO ou SEA), les outils et la méthodologie sont adaptés à vos besoins. Identité visuelle, responsive design, gestion de contenu, les <strong className="font-normal">réalisations</strong> sont multiples et personnalisées.
                </div>
