            ...
            <Layout location={this.props.location}>
                ...
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    ...
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + webdesign + ')' }}>
                        ...
                        <br /><br />Site vitrine, site e-commerce, votre site personnalisé s’intègre dans une <strong className="font-normal">stratégie adaptée à vos projets</strong>. Notre <a href="/agence-digitale-toulouse/" className="text-bleu hover:text-black font-bold">agence web Toulouse</a> maîtrise les outils les plus performants pour vous apporter toutes les retombées souhaitées.</p>
                    </div>
                </section>
