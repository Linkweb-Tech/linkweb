                ...
                >
                    ...
                    <section className="w-full flex  flex-row justify-end" style={{fontWeight:'500', height: '35px'}}>
                        ...
                        <section className="w-2/5 flex" style={{backgroundColor:'#3c3c3c', borderBottomLeftRadius:'27px', fontSize:'15px'}}>
                            ...
                            <div className="w-1/3 text-bleu" style={{padding:'5px'}}><ButtonMenu url="/creer-une-boutique-en-ligne" text="Site e-commerce" position="center" /></div>
                            <div className="w-1/3" style={{padding:'5px', color:'white'}}><ButtonMenu url="/creation-de-site-internet-47-31" text="Site sur-mesure" position="center" /></div>
                        </section>
                    </section>
                    ...
                    <section className="w-full h-screen bg-bleu flex flex-col justify-center items-center px-4 pt-12 pb-0 my-2 bg-cover my-24" style={{color:'white'}}>
