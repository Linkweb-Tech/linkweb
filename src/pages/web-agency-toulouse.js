...
class WebAgencyToulouse extends Component {
            ...
            <Layout location={this.props.location}>
                ...
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + siteinternet + ')' }}>
                        ...
                        <p className="text century lg:mt-0 text-lg lg:text-sm xl:text-lg z-50">Notre <strong className="font-normal">service de création de sites</strong> définit une ergonomie et un design uniques pour <strong className="font-normal">votre site</strong>. Les <strong className="font-normal">développeurs de Linkweb</strong> favorisent l'accessibilité des interfaces et apportent une <strong className="font-normal">expérience utilisateur optimale</strong> (<strong className="font-normal">UX et UI design</strong>, <strong className="font-normal">responsive design</strong>, etc.). De plus, ils mobilisent les outils les plus performants pour répondre à toutes vos attentes.
                            Nous avons un rôle de <strong className="font-normal">conseil</strong> sur la création des différents <strong className="font-normal">types de sites</strong>. 
                            <br /><br />Que vous soyez un professionnel proposant de la <strong className="font-normal">vente en ligne</strong> (<strong className="font-normal">CMS</strong> comme <strong className="font-normal">Prestashop</strong>), ou un prestataire de service (<strong className="font-normal">CMS</strong> type <strong className="font-normal">Wordpress</strong>), il existe autant de solutions que de projets.
                            Nos réalisations sont pensées pour offrir la meilleure <strong className="font-normal">expérience utilisateur</strong>ainsi qu'une identité visuelle respectant votre <strong className="font-normal">charte graphique</strong>. Du choix de l’<strong className="font-normal">hébergement</strong> à la maintenance régulière du site en passant par le choix et la gestion de votre <strong className="font-normal">nom de domaine</strong>, Linkweb vous accompagne.</p>
                    </div>
                    ...
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + webdesign + ')' }}>
                        ...
                        <p className="text century text-lg lg:text-sm xl:text-lg z-50">L'<strong className="font-normal">E-réputation</strong> est un facteur clé pour le <strong className="font-normal">référencement naturel d’un site</strong>. Quel que soit le type de site (par exemple avec Wordpress), il est utile de travailler son <strong className="font-normal">image de marque</strong> et son autorité sur <strong className="font-normal">Internet</strong>. Les avis clients sont des éléments déclencheurs dans une stratégie. Ils sont de vrais moteurs pour la <strong className="font-normal">conversion</strong>. <strong className="font-normal">Linkweb</strong> vous aide à parfaire votre image sur le Web pour obtenir des retombées <strong className="font-normal">en ligne</strong>.
                            <br /><br />L'E-réputation est essentielle dans le cadre de <strong className="font-normal">Google Ads</strong>, mais aussi pour un <strong className="font-normal">site e-commerce</strong> (Prestashop ou WooCommerce). La sponsorisation permet de placer des annonces en tête des <strong className="font-normal">résultats de recherche de moteurs comme Google</strong>. Notre <strong className="font-normal">agence</strong> met ses compétences au profit de votre réputation : il s'agit d'un des <strong className="font-normal">leviers de communication et webmarketing</strong> nécessaires pour atteindre ses cibles de clientèle.
                            </p>
                    </div>
                </section>
                <section className="sidetitle w-10/12 text-center text-black text-2xl justify-center flex flex-col century mt-10 mb-10 mx-auto">
