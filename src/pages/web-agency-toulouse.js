        ...
        return (
                    ...
                    <div className="w-full flex-col md:flex-row flex px-auto">
                        ...
                        <div className="w-full flex-col md:flex-row flex px-auto">
                            ...
                            <div className="w-full px-12 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <br/>
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify"><strong className="font-normal">Linkweb</strong> est en capacité de manipuler tous les outils efficaces (des <strong className="font-normal">CMS</strong> comme <strong className="font-normal">Wordpress</strong>, <strong className="font-normal">Prestashop</strong>, des régies publicitaires comme <strong className="font-normal">Google Ads</strong>) en vue de la conception et à la gestion de votre <strong className="font-normal">projet</strong>. Nos équipes sont qualifiées pour la production d’une <strong className="font-normal">interface visuelle</strong> et graphique fonctionnelle, ainsi que dans la mise en place et le développement d’une <strong className="font-normal">stratégie webmarketing</strong> performante.</p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                            </div>
                        </div>
                        <div className="w-full flex-col md:flex-row flex px-auto">
            ...
            <section className="sidetitle w-10/12 text-center text-black text-2xl justify-center flex flex-col century mt-10 mb-10 mx-auto">
                        ...
                        <div className="line-title my-4">
                            <hr className="border-solid w-1/2 lg:w-1/12 border-bleu"></hr>
                            <br/>
                            <h3 /*data-aos='fade-left'*/ className="max-w-6xl text-xl text-black text-center lg:text-justify century pb-0">L'administration de vos projets vise un maximum de performance dans des délais des plus brefs. Notre agence spécialisée consacre tout son temps et son efficacité à la réalisation de vos projets professionnels.</h3>
                        </div>
                </section>
