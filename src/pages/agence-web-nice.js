                        ...
                        <div className="w-full lg:w-1/2 my-10  flex flex-col">
                            ...
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full century px-12 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <br />
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify">Sur 117 avis, la note que nous avons reçue sur Google témoigne de la satisfaction de nos <strong className="font-normal">clients</strong> quant au travail réalisé sur leurs sites.</p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            ...
                            <div label="DÉVELOPPEZ UNE ACTIVITÉ DIGITALE GRÂCE À VOTRE SITE INTERNET">
                                ...
                                <br/><br/>
                                Après définition de vos cibles, vous adaptez les méthodes à employer avec les professionnels de notre <strong className="font-normal"><a href="/agence-web-montpellier/" className="text-bleu hover:text-black font-bold">agence web à Montpellier</a></strong>. Accédez à une transformation intéressante et fidélisez l’internaute pour bénéficier d’un projet pérenne.
                                </p>
                            </div>
