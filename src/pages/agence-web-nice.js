            ...
            <Layout location={this.props.location}>
                ...
                <section className="flex items-center justify-start w-full mx-auto pb-0 my-32 md:my-42 lg:my-42 xl:my-48 px-4 py-6 bg-black flex flex-col justify-center items-center" style={{ background: '#000000ad url(' + arriereplan + ')', backgroundBlendMode: 'overlay', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    <div className="max-w-6xl mx-auto lg:mx-56 py-2 w-full flex-col items-end">
                        ...
                        <br />
                        <h2 className="flex mb-16 full lg:w-3/5 text-white justify-center lg:justify-start mx-auto lg:mx-0 text-xl  century text-center lg:text-left p-1 uppercase -mt-12">Agence web spécialisée dans la création de sites et le référencement de site web à Nice</h2>
                ...
                <section className="w-full lg:w-3/5 px-10 mt-16 lg:-mt-48 mb-16 lg:mb-48">
                    ...
                    <h3 className="century text-xl text-center">
                        Agence Web Nice : Faites confiance à l’équipe de Linkweb à Nice pour mettre en application votre stratégie de développement et de référencement SEO. 
                    </h3>
                </section>
                ...
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + siteinternet + ')' }}>
                        ...
                        <p className="text century lg:mt-0 text-lg lg:text-sm xl:text-lg z-50">L’équipe de <a href="/agence-web-strasbourg/" className="text-bleu hover:text-white font-bold">notre agence web à Strasbourg</a> vous accompagne dans la <strong className="font-normal">création de supports de communication web-design (identité visuelle) et responsive-design</strong> (ergonomie sur mobile, tablette, tous supports) pour une navigation en toute ergonomie. Les experts en <strong className="font-normal">développement du site web</strong> (chef de projet, développeurs créatifs et référenceurs) à l'écoute vous apportent leur expertise et vous accompagnent du choix de l’hébergement à l’intégration de contenus optimisés pour <strong className="font-normal">être visible sur Google</strong>. Que vous choisissiez de créer un site vitrine ou e-commerce, voire un site sur-mesure, apparaissez en première page dans les résultats proposés par les <strong className="font-normal">moteurs comme Google</strong>.<br/><br/>
                        Les services que vous propose Linkweb vous permettent d’<strong className="font-normal">acquérir un trafic pertinent</strong>. Notre <a href="/" className="text-bleu hover:text-white font-bold">agence web à Toulouse</a> fait partie des <strong className="font-normal">agences web</strong> qui activent tous les leviers de la communication digitale pour permettre à leurs clients d’atteindre leurs objectifs.</p>
                    </div>
                    ...
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + webdesign + ')' }}>
                        ...
                        <p className="text century text-lg lg:text-sm xl:text-lg z-50">
                        Linkweb vous propose un <strong className="font-normal">service de référencement payant</strong> qui vous permet de vous placer en tête de suggestions de recherche sur les moteurs comme Google. Ainsi, votre site génère plus facilement des retombées et bénéficie d’une <strong className="font-normal">visibilité importante</strong>. En fonction de vos besoins, créer un site qui répond à vos attentes est notre priroité : votre site en ligne génère rapidement un <strong className="font-normal">retour sur investissement</strong> conséquent grâce au <strong className="font-normal">référencement Ads</strong>.
                            <br /><br />Cette stratégie est définie par notre <strong className="font-normal"><a href="/agence-web-bordeaux/" className="text-bleu hover:text-white font-bold">agence web à Bordeaux</a></strong> grâce à une écoute et un conseil adapté à chaque projet. Nous mettons un point d’honneur à vous apporter un service des plus pertinents.</p>
                    </div>
                </section>
          ...
          <div className="flex items-center xl:items-start flex-col xl:flex-row flex-1">
            ...
            <section className="w-full lg:w-1/3 absolute z-10 px-auto lg:w-1/3 absolute px-12 lg:px-6 xl:px-24 pt-24">
              ...
              <div className="century content pb-6 text-justify" style={{ textAlignLast: 'center' }}>
                Pour disposer d’un <strong className="font-normal">site internet performant</strong> et clé-en-main, il est indispensable de définir des paramètres à exploiter pour obtenir un maximum de résultats. Le public cible, l’<strong className="font-normal">expérience utilisateur</strong> qui répond aux attentes de celui-ci comme à celles des moteurs de recherche, le travail de <strong className="font-normal">référencement</strong>, tous ces éléments ne laissent pas de place au hasard. Pour permettre à votre <strong className="font-normal">site en ligne</strong> de générer la performance que vous recherchez, Linkweb à <strong className="font-normal">Nice</strong>, à Monaco et partout en France vous apporte ses connaissances pour la mise en place d'une stratégie personnalisée.
                </div>
              ...
              <button
                        ...
                        <div className="w-full lg:w-1/2 my-10  flex flex-col">
                            ...
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full century px-12 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <br />
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify">Tous les jours, plus de 20 spécialistes de notre <Link to="/agence-web-agen/" className="text-bleu hover:text-black font-bold">agence web à Agen</Link> mettent tout en place pour rendre les <strong className="font-normal">sites web</strong> toujours plus performants.</p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                                </div>
                            </div>
                            <div className="w-full flex-col md:flex-row flex px-auto">
                            ...
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full century px-12 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <br />
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify">Sur 118 avis, la note que nous avons reçue sur Google témoigne de la satisfaction de nos <strong className="font-normal">clients</strong> quant au travail réalisé sur leurs sites.</p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            <div className="w-full" label="DEVENEZ VISIBLE SUR LE WEB GRÂCE À VOTRE SUPPORT DE COMMUNICATION">
                                <p>Mettez en application votre <strong className="font-normal">stratégie de marketing digital</strong> grâce à l’accompagnement de votre prestataire digital pour obtenir du trafic puis cibler la fidélisation. Ainsi, atteignez de nouvelles cibles de clientèle en vous positionnant en tête des <strong className="font-normal">résultats de recherche sur les moteurs</strong> grâce à la réalisation d'un site sur-mesure. Nous œuvrons pour la réussite de vos projets et vous apportons un conseil en communication adapté à votre recherche de visibilité. 
                                <br/><br/>
                                Référencement naturel, référencement Ads, la <strong className="font-normal">définition de vos besoins</strong> détermine la stratégie marketing à adopter. Vos objectifs sont ceux de notre agence, où que vous soyez en <strong className="font-normal">France</strong>.</p>
                            </div>
                            <div label="DÉVELOPPEZ UNE ACTIVITÉ DIGITALE GRÂCE À VOTRE SITE INTERNET">
                                <p>
                                Grâce à du contenu pertinent ainsi qu'au <strong className="font-normal">webdesign unique de votre site</strong> et adapté au responsive design, chacune des pages est conçue pour apporter un <strong className="font-normal">tunnel de navigation</strong> fluide à l’utilisateur. En mettant en application la stratégie définie pour vous, votre site acquiert un <strong className="font-normal">trafic pertinent</strong> et réalise un taux de conversion performant. Ainsi, générer du trafic n'est possible que si vous portez votre <strong className="font-normal">support de communication web</strong> au sommet des résultats des moteurs comme Google. 
                                <br/><br/>
                                Après la définition de vos cibles, vous adaptez les méthodes à employer avec les professionnels de notre <strong className="font-normal"><a href="/agence-web-montpellier/" className="text-bleu hover:text-black font-bold">agence web à Montpellier</a></strong>. Accédez à une transformation intéressante et fidélisez l’internaute pour un projet pérenne.
                                </p>
                            </div>
                            <div label="AUGMENTEZ VOTRE CHIFFRE D'AFFAIRES">
                                <p>L’importance de la <strong className="font-normal">rentabilité de votre site</strong> est un paramètre important pour votre société. La maîtrise des outils digitaux indispensables adaptés à la création de site vitrine ou ecommerce (CMS, code HTML) par les experts du web vous permet d'obtenir un <strong className="font-normal">retour sur investissement</strong> pertinent. Faire appel à la compétence de notre agence est un moyen sûr, de <strong className="font-normal">disposer d’un site fonctionnel</strong> et de qualité ainsi que d’un travail stratégique régulièrement réévalué et réadapté. 
                                <br/><br/>
                                Boostez votre activité professionnelle et augmentez efficacement votre <strong className="font-normal">chiffre d’affaires</strong> grâce à un spécialiste du <strong className="font-normal">marketing digital</strong>. Affichez une image de marque et un professionnalisme qui se démarquent de la concurrence pour parvenir aux retombées attendues.</p>
                            </div>
                        </Accordion>
                    </div>
                </section>
                <section className="text-center flex flex-col justify-center items-center text-black text-2xl mx-auto lg:mx-0 century mt-6 mb-24" style={{zIndex:'100'}}>
                    ...
                    <ul className="flex flex-col md:flex-row">
                        ...
                        <li><Link to="/agence-web-lyon/" className="text-bleu hover:text-black font-bold px-4">Lyon</Link></li>
