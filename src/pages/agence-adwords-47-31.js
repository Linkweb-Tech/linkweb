                ...
                > */}
                    ...
                    <section className="max-w-6xl w-full mx-auto px-4 pt-12 pb-0 my-2 mb-24">
                        ...
                        <div className="w-full flex flex-col sm:flex-row text-center my-6">
                            ...
                            <div className="w-full sm:w-1/3 flex flex-col items-center justify-center pt-6" data-aos='zoom-in' data-aos-delay="400">
                                <svg className="svg-bleu" height="80px" viewBox="-63 0 510 510.656" width="80px">
                                    <path d="m200.328125 414.65625h-16c-4.417969 0-8-3.582031-8-8s3.582031-8 8-8h32v-16h-16v-16h-16v16c-13.253906 0-24 10.746094-24 24s10.746094 24 24 24h16c4.417969 0 8 3.582031 8 8s-3.582031 8-8 8h-32v16h16v16h16v-16c13.253906 0 24-10.746094 24-24s-10.746094-24-24-24zm0 0"/>
                                    <path d="m221.984375 196.3125-11.3125-11.3125-10.34375 10.34375v-52.6875h-16v52.6875l-10.34375-10.34375-11.3125 11.3125 29.65625 29.65625zm0 0"/>
                                    <path d="m192.328125 334.65625c-48.601563 0-88 39.398438-88 88s39.398437 88 88 88 88-39.398438 88-88c-.058594-48.578125-39.421875-87.941406-88-88zm0 160c-39.765625 0-72-32.234375-72-72s32.234375-72 72-72 72 32.234375 72 72c-.046875 39.746094-32.253906 71.953125-72 72zm0 0"/>
                                    <path d="m220.769531 13.3125-8.882812-13.3125-19.558594 13.039062-19.558594-13.039062-8.882812 13.3125 28.441406 18.960938zm0 0"/>
                                    <path d="m220.769531 57.3125-8.882812-13.3125-19.558594 13.039062-19.558594-13.039062-8.882812 13.3125 28.441406 18.960938zm0 0"/>
                                    <path d="m324.769531 13.3125-8.882812-13.3125-19.558594 13.039062-19.558594-13.039062-8.882812 13.3125 28.441406 18.960938zm0 0"/>
                                    <path d="m324.769531 57.3125-8.882812-13.3125-19.558594 13.039062-19.558594-13.039062-8.882812 13.3125 28.441406 18.960938zm0 0"/>
                                    <path d="m116.769531 13.3125-8.882812-13.3125-19.558594 13.039062-19.558594-13.039062-8.882812 13.3125 28.441406 18.960938zm0 0"/>
                                    <path d="m116.769531 57.3125-8.882812-13.3125-19.558594 13.039062-19.558594-13.039062-8.882812 13.3125 28.441406 18.960938zm0 0"/>
                                    <path d="m152.328125 320.902344 80-20v-50.933594l104-104v-51.3125h-288v51.3125l104 104zm-88-181.558594v-28.6875h256v28.6875l-104 104v45.0625l-48 12v-57.0625zm0 0"/>
                                    <path d="m368.328125 318.65625h16v192h-16zm0 0"/>
                                    <path d="m336.328125 350.65625h16v160h-16zm0 0"/>
                                    <path d="m.328125 318.65625h16v192h-16zm0 0"/>
                                    <path d="m32.328125 350.65625h16v160h-16zm0 0"/>
                                    <path d="m304.328125 382.65625h16v128h-16zm0 0"/>
                                    <path d="m64.328125 382.65625h16v128h-16zm0 0"/>
                                    <path d="m64.328125 350.65625h16v16h-16zm0 0"/>
                                    <path d="m32.328125 318.65625h16v16h-16zm0 0"/>
                                    <path d="m.328125 286.65625h16v16h-16zm0 0"/>
                                    <path d="m304.328125 350.65625h16v16h-16zm0 0"/>
                                    <path d="m336.328125 318.65625h16v16h-16zm0 0"/>
                                    <path d="m368.328125 286.65625h16v16h-16zm0 0"/>
                                </svg>
                    ...
                    <section  className="tabPanel flex flex-1 w-full justify-end ml-0 mb-12">
                        <div className="w-full md:w-3/4 py-0 flex justify-end">
                            <Accordion>
                                ...
                                <p><span className="font-bold">Si vous désirez une <strong>visibilité rapide sur les pages de recherche</strong>, nous sommes en mesure de vous proposer des solutions concrètes.</span> <br/><br/>En effet, <span className="font-bold"><strong>les experts Ads de Linkweb</strong> se chargent de la <strong>création de vos annonces</strong></span> visant à mettre en avant vos produits ou services à travers une visibilité privilégiée. <br/><br/>
                                Si vous êtes à la recherche de <strong>trafic</strong>, de <strong>contacts</strong> ou de <strong>ventes</strong>, il existe des solutions pour atteindre vos objectifs. <br/><br/><span className="font-bold">Nous définissons les paramètres de <strong>votre campagne sur-mesure</strong> pour faciliter et maximiser les interactions avec votre <strong>audience ciblée</strong>.</span></p>
                                </div>
                                <div label="OPTIMISATION DE VOS CAMPAGNES GOOGLE ADWORDS AJUSTÉES SELON VOS CIBLES">
                                <p><strong>Google Ads</strong> est une plateforme qui vous permet de <span className="font-bold">cibler très précisément votre audience</span>. <br/><br/>Nous mettons en place des <strong>campagnes</strong> qui s'adressent à un public ciblé en fonction de plusieurs critères paramétrables: l'âge ou le secteur géographique en font partie. <br/><br/>Par ailleurs, <span className="font-bold">les <strong>campagnes Google Ads</strong>, que nous mettons en place, s’adaptent aux terminaux, pour vous permettre de maximiser l’efficacité de votre <strong>présence en ligne</strong>.</span></p>
                                </div>
                                <div label="CRÉATION DE VOTRE CAMPAGNE ADS COHÉRENTE AVEC LE CONTENU DE VOTRE SITE INTERNET">
                                <p><span className="font-bold">Chaque <strong>annonce</strong> créée nécessite la <strong>création d’une page adaptée</strong> que l'on appelle "<strong>landing page</strong>".</span> Cette page doit être construite en vue d'obtenir des <strong>conversions</strong> sur <strong>votre site internet</strong>. <br/><br/>Nous nous chargeons de la <strong>création d’une page optimisée</strong> pour <span className="font-bold">répondre aux <strong>besoins des utilisateurs</strong></span> : de la définition d'une <strong>proposition de valeur attractive</strong> à un contenu synthétique et en passant par la mise en place de <strong>call-to-action</strong> ainsi que d’un circuit de <strong>remplissage des objectifs</strong> optimisé, etc. <br/><br/><span className="font-bold">Les objectifs disponibles sont totalement adaptés en fonction de votre objectif défini : <strong>appel, demande de devis, contacts, vente de produits</strong> (dans le cas d’un <strong>site e-commerce</strong>), etc.</span></p>
                                </div>
                            </Accordion>
                        </div>
                    </section>
