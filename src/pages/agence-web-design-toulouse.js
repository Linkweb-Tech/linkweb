...
class AgencenWebDesignToulouse extends Component {
                    ...
                    <section className="flex justify-center flex-col items-center">
                        ...
                        <div className="w-full text-white flex flex-col md:flex-row justify-center lg:w-3/4 mt-5 md:mt-10 mb-12">
                            ...
                            <div className="w-full svgtransform md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                ...
                                <p>Notre <Link to="/agence-internet-toulouse/" className="font-bold text-bleu hover:text-white">agence internet</Link> met en place un <strong>certificat SSL</strong> pour garantir une navigation en parfaite sécurité pour vos utilisateurs.</p>
                            </div>
                            <div className="w-full svgtransform md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
