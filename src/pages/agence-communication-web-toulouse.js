...
class AgenceCommunicationWebToulouse extends React.Component {
        ...
        <section className="w-full  my-10 flex flex-col lg:flex-row items-center justify-start">
                    ...
                    <div className="w-full flex-col md:flex-row flex px-auto">
                        ...
                        <div className="w-full flex-col md:flex-row flex px-auto">
                            ...
                            <div className="w-full px-12 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify">Vos services, vos prestations, vos produits seront au cœur de l’élaboration de votre projet, auttant sur la partie graphique et ergonomique que fonctionnelle.<br /> L’élaboration d’un cahier des charges détaillé nous permettra de <strong><Link to="/agence-site-web-toulouse/" className="text-bleu hover:text-black font-bold">créer un site web</Link></strong> qui vous correspondra.</p>
            ...
            <section className="bg-black sidetitle py-10">
                        <section className="w-full lg:w-2/3 flex flex-col justify-center century my-10 px-4 lg:px-32 md:mx-6 sm:mx-12 mt-2 lg:mx-64">
                            <h2 className="century text-center lg:text-left text-white text-3xl md:text-5xl leading-tight">Que proposons-nous pour concevoir <span className="text-bleu">votre stratégie de communication web</span> à Toulouse ?</h2>
                            <br/>
                            <div className="line-title my-4 ">
                                <br/>
                        ...
                        <section className="flex justify-center flex-col items-center">
                            <div className="w-full px-12 lg:px-0 flex justify-center flex-col md:flex-row lg:w-3/4 mt-5">
                                <div className="w-full svgtransform md:w-1/4 mx-auto px-2 mb-10 md:mb-0 text-white century text-center lg:text-left">
                                    ...
                                    <p>Linkweb fait partie des <strong>agences</strong> qui proposent des prestations complètes de l’élaboration à la <strong>gestion de votre site internet</strong>.</p>
                                </div>
          ...
          <div className="w-full xl:w-1/3 three px-auto">
            ...
            <div className="chiffres century text-bleu -mt-64 mb-6" /*data-aos="fade-up"*/>3</div>
              <section className="w-full lg:w-1/3 absolute z-10 px-auto lg:w-1/3 absolute px-12 lg:px-6 xl:px-24 pt-24">
                ...
                <div className="century content pb-6 text-justify" style={{textAlignLast:'center'}}>
                En faisant appel à nos services, vous faites le choix d’un projet qui vous ressemble, mais également d’un <strong>conseil en marketing digital</strong> pour déterminer vos facteurs de succès. De plus, nous disposons de tous les outils nécessaires à l’élaboration d’un plan d’actions efficaces en fonction de vos besoins.
                </div>
              </section>
