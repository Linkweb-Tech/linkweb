            ...
            <Layout location={this.props.location}>
                ...
                >
                    <section className="w-full h-screen mx-auto px-4 pb-6 pt-24 bg-no-repeat bg-bottom bg-cover flex flex-col justify-center items-center" style={{ background: '#6e6e6e url(' + Bg + ')', backgroundBlendMode: "multiply" }}>
                        ...
                        <h3 className="italic text-2xl text-white">Contactez-nous, un spécialiste de notre agence web reviendra vers vous.</h3>
                    ...
                    <section className="flex-wrap flex w-full mx-auto py-2 my-2 ">
                        <div className=" font-bold	w-1/2 px-12 py-24 flex justify-center items-center flex-col min-h-400 text-center text-white bg-bleu" data-aos="zoom-in">
                        ...
                        <div className="font-bold	w-1/2 px-6 py-24 flex justify-center items-center flex-col min-h-400 text-center text-white bg-black" data-aos="zoom-in" data-aos-delay="200">
