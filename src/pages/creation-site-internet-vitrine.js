...
class CreationSiteVitrine extends Component {
        ...
        return (
            <Layout location={this.props.location}>
                ...
                {/* <PageTransition
                    ...
                    transitionTime={200}
                > */}
                <section className="w-full mt-24 bloctitrescreen mx-auto px-2 md:px-4 py-6 bg-no-repeat bg-cover bg-center flex md:flex-row flex-col justify-center items-center" style={{ background: '#00000094 url(' + Bg + ')', backgroundBlendMode: 'multiply', backgroundPosition: 'bottom', backgroundSize: 'cover', height: '650px' }}>
                ...
                <section className="max-w-6xl mx-auto flex flex-col align-center justify-center text-center px-4 mt-12 mb-3">
                    ...
                    <h4 data-aos='fade-left' className="text-xl text-grey text-center century italic pb-6">
                        Vous souhaitez en savoir plus sur nos prestations d’<Link to="/" className="font-bold text-bleu hover:text-black">agence web à Agen</Link> (47) et Toulouse (31) ? Découvrez nos autres prestations, ainsi que nos différentes réalisations.</h4>
                    <br />
