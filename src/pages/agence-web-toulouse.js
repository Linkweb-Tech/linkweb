...
import accompagnement from "../images/agence-web-accompagnement.jpg";
import actionpiscines from "../images/action-piscines47.png";
import agendiesel from "../images/agen-diesel-avis.png";
import ettr from "../images/ettr31.png";
                    ...
                    <section className="max-w-5xl w-full mx-auto px-4 text-lg pb-0 my-2">
                        <div className="w-full" /*data-aos='zoom-in'*/>
                            <p className="text-md text-center py-12 century">
                                Vous êtes un organisme public ou privé à la recherche d’une <strong>agence web à Toulouse</strong> ou <Link to="/agence-web-agen/" className="text-bleu hover:text-black font-bold">Agen</Link> pour la mise en place d’une stratégie digitale ? <strong>Linkweb</strong> est à l’écoute de vos besoins pour vous proposer une solution taillée pour vous.</p>
                        </div>
                    </section>
                        ...
                        <div className="w-full md:w-3/4 py-0 flex justify-end">
                            <Accordion>
                                ...
                                <div label="OBTENIR UN RETOUR SUR INVESTISSEMENT">
                                    <p>Chaque projet a ses spécificités : un <strong>site e-commerce</strong> cible la <strong>vente en ligne de produits</strong>, un <strong>site vitrine</strong> est plus adapté pour <strong>obtenir des contacts prospects qualifiés</strong>. Nous choisissons la formule adaptée pour permettre à <strong>votre société</strong> d’<strong className="font-bold">exploiter tout le potentiel de son marché sur le net</strong>.<br/>
                                    <br/>
                                    ...
                                    <br/>
                                    Chez <strong>Linkweb</strong>, nous privilégions la qualité. La <strong>création de votre site internet</strong> n’a qu’un seul but : <strong className="font-bold">vous permettre d'atteindre de nouveaux prospects en vue de maximiser vos chances de convertir vos contacts et ainsi augmenter votre chiffre d’affaires.</strong><br/>
                                    </p>
                                </div>
                            </Accordion>
                        </div>
