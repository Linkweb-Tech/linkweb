        ...
        return (
            <Layout location={this.props.location}>
                ...
                <section className="max-w-5xl w-full mx-auto px-4 py-6 my-4">
                    <h2 className="text-center text-lg sm:text-2xl text-black century mt-3">Linkweb est l'<Link to="/agence-web-montauban/" className="font-bold text-bleu hover:text-black">agence web marketing</Link> qui vous accompagne dans la conception, la mise en oeuvre et le suivi de votre projet web ainsi que de votre communication digitale.</h2>
                    <br />
