...
class AgenceWebMarmande extends Component {
        ...
        return (
            <Layout location={this.props.location}>
                ...
                <section className="max-w-5xl w-full mx-auto px-4 py-6 my-4">
                    <h2 className="text-center text-lg sm:text-2xl text-black century mt-3">Linkweb est l'<Link to="/agence-creation-site-web-toulouse/" className="font-bold text-bleu hover:text-black">agence de création de site web</Link> qui vous accompagne dans la conception, la mise en oeuvre et le suivi de votre projet web ainsi que de votre communication digitale.</h2>
                    <br />
                ...
                <section className="w-full flex flex-1 mt-6 equipe min-h-0 lg:min-h-600">
                    ...
                    <div className="w-3/4 ">
                        <div className="content">
                            ...
                            <p /*data-aos='fade-left'*/><span className="century text-bleu text-4xl">8</span>  développeurs Front-End & Back-End</p>
                            <p /*data-aos='fade-left'*/><span className="century text-bleu text-4xl">3</span>  spécialistes UI & <strong>UX design</strong> et professionnels du <strong>développement web</strong></p>
                            <p /*data-aos='fade-left'*/><span className="century text-bleu text-4xl">6</span>  professionnels du <strong>référencement web</strong> SEO & SEA pour l'optimisation des <strong>pages</strong> web.</p>
                            <p /*data-aos='fade-left'*/><span className="century text-bleu text-4xl">3</span>  rédacteurs web spécialisés dans la rédaction et la <strong>gestion de contenu</strong> optimisé</p>
                        </div>
                ...
                <section className="max-w-5xl mx-auto flex flex-col align-center justify-center text-center mt-12 mb-3 bg-gris p-10">
                    ...
                    <div className="max-w-sm mx-auto block">
                        ...
                        >
                            ...
                            Faire appel à l'agence web à Agen
                            </button>
                    </div>
                </section>
                {/* <section className="max-w-6xl mx-auto flex flex-col align-center justify-center text-center mt-12 mb-3">
