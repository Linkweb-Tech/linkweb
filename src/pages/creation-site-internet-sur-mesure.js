...
class CreationSiteInternetSurMesure extends Component {
                    ...
                    <div className="w-full xl:w-1/3 two px-auto">
                        <div className="flex items-center xl:items-start flex-col xl:flex-row flex-1">
                            ...
                            <section className="w-full lg:w-1/3 absolute z-10 px-auto lg:w-1/3 absolute px-12 lg:px-6 xl:px-24 pt-24">
                                ...
                                <div className="century content pb-6 text-justify" style={{ textAlignLast: 'center' }}>
                                    Une fois les contours de votre projet définis, nous vous accompagnons pour faire de votre idée, une projection technique concrète en corrélation avec votre demande. C’est à partir d’ici que votre <strong>projet web</strong> se concrétise avec le travail de notre <Link to="/" className="text-bleu hover:text-black font-bold">agence web à Agen</Link>.
                                </div>
                                <Button url="/contact-agence-web-toulouse/" text="Prendre contact" position="center" />
                            </section>
                        </div>
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            <div className="w-full" label="QUELS SONT LES CRITÈRES POUR DÉFINIR MES BESOINS ?">
                                <p>Pour bien définir vos besoins relatifs à votre <strong>communication web</strong>, nous devons avoir connaissance de plusieurs éléments : <span className="font-bold">l’existence (ou non) de votre <strong>site internet</strong> est le premier.</span> <br /><br />Il est essentiel également de savoir si vous souhaitez <span className="font-bold"><strong>vendre vos produits ou promouvoir vos services</strong></span>. <br /><br />Pour un <strong>site internet sur-mesure</strong>, il va être nécessaire de <span className="font-bold">définir les fonctionnalités que vous souhaitez proposer à vos utilisateurs</span>. Ceci peut répondre à un besoin en termes de d'organisation pour votre entreprise ou bien en termes d'<strong>expérience utilisateur</strong>. <br /><br />C’est ce qui va nous permettre de <span className="font-bold">bien comprendre la problématique globale afin d’envisager très précisément les solutions qui pourraient être adaptées à vos besoins</span> d’un point de vue graphique, mais aussi technique.</p>
                            </div>
                            <div label="QU'EST-CE QUI DIFFÉRENCIE UN SITE VITRINE D'UN SITE SUR-MESURE ?">
                                <p>Un <strong>site internet vitrine</strong>, de façon générale, se cantonne à la <span className="font-bold">présentation des services ou produits d’une entreprise et permet de travailler principalement des objectifs relevant de l’image ou de la visibilité de l’entreprise.</span> Il est pertinent lorsqu'il s'agit d’<span className="font-bold"><strong>obtenir des prospects</strong></span> qui pourraient se transformer en clients puis en clients selon le tunnel de conversion. <br /><br />

                                Le <strong>site sur-mesure</strong> va plus loin. Ce qui les différencie se situe au niveau de la <span className="font-bold">mise en place de fonctionnalités propres</span> qui vont vous permettre de distinguer les simples contacts des prospects très intéressés ou encore de vous apporter un gain de praticité d'un point de vue organisationnel, par exemple. <br /><br />De plus, qu’il s’agisse de <strong>fonctionnalités destinées aux utilisateurs</strong> ou bien destinées à la gestion interne de votre entreprise, <strong>la <strong>création d’un site internet sur-mesure</strong> peut vous permettre d’optimiser le fonctionnement et l’organisation de votre entreprise</strong> : réservations en ligne, simulateur de devis, etc. <br /><br />
                                    <span className="font-bold">Le sur-mesure apporte une plus-value en comparaison à un <strong>site internet</strong> de type vitrine ou e-commerce.</span></p>
                            </div>
                            <div label="QUEL AVANTAGE À METTRE EN PLACE UN SITE INTERNET SUR-MESURE ?">
                                <p><span className="font-bold">La <strong><Link to="/creation-de-site-internet-a-agen/" className="text-bleu hover:text-black font-bold">création d’un site internet sur-mesure à Agen</Link></strong> permet à tout un chacun de <strong>développer une solution web</strong> qui lui correspondra de façon exacte.</span> <br /><br />En effet, selon votre secteur d’activité, l’ajout de fonctionnalités additionnelles peut-être fortement recommandé. C’est notamment le cas pour un fleuriste ou un restaurateur en ce qui concerne la <strong>création d'un outil de réservations en ligne</strong>. Toutefois, cela ne se limite pas à certains secteurs, <span className="font-bold">les fonctionnalités peuvent être déclinées en fonction des besoins de chacun.</span><br /><br /> De plus, il est également possible de rendre le <strong>site internet administrable</strong> afin de <span className="font-bold">vous faire profiter pleinement de vos fonctionnalités et de leurs facilités de gestion.</span> Contrôlez vos réservations, vos demandes de contacts ou enocre l’ajout d’actualités sur <strong>votre site internet</strong>. <br /><br /><span className="font-bold">Nous vous formerons pour vous offrir la possibilité de travailler en totale autonomie de ce point de vue.</span></p>
                            </div>
                        </Accordion>
                    </div>
                </section>
