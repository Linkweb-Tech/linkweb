            ...
            <Layout location={this.props.location}>
                ...
                <section className="w-full flex justify-end -mt-0 lg:-mt-32">
                    <div className="w-11/12 lg:w-1/3 bg-bleu shadow-2xl -mt-0 lg:-mt-64 flex flex-col justify-end mx-12 lg:mx-24">
                        ...
                        <br />
                        <p className="px-8 lg:px-16 text-white text-center century text-md">Linkweb fait partie des <strong className="font-normal"><Link to="/agence-web-marmande/" className="text-white hover:text-black font-bold">agences en France</Link></strong>, à l’écoute de vos besoins : nous proposons des services pertinents et sur-mesure. Notre entreprise répond à votre <Link to="/agence-creation-site-web-toulouse/" className="text-white hover:text-black font-bold"><strong className="font-normal">projet de création</strong> ou de <strong className="font-normal">refonte de site internet</strong></Link>.</p>
                        <br />
