                ...
                <section className="bg-white sidetitle mt-16 mb-10">
                    ...
                    <section className="w-full">
                        <div className="w-full px-4 md:px-0 lg:px-0 flex justify-center mx-auto flex-col md:flex-row lg:w-full mt-5 flex-wrap">
                            <div className="w-full md:w-1/2 lg:w-1/4 svgtransform mx-auto lg:mx-4 px-2 mb-10 md:mb-0 text-black century text-center  border-bleu border-solid border py-4">
                            ...
                            <div className="w-full md:w-1/2 lg:w-1/4 svgtransform text-black mx-auto lg:mx-4 px-2 mb-10 md:mb-0 century text-center border-bleu border-solid border py-4">
                        ...
                        <div className="w-full text-black flex flex-col md:flex-row mx-auto justify-center lg:w-full mt-5 px-4 md:px-0 lg:px-0 md:mt-10 mb-12"> */}
                            <div className="w-full md:w-1/2 lg:w-1/4 svgtransform justify-center text-black px-2 mb-10 mx-auto lg:mx-4 md:mb-0 century text-center border-bleu border-solid border py-4">
                            ...
                            <div className="w-full md:w-1/2 lg:w-1/4 svgtransform justify-center px-2 mb-10 mx-auto lg:mx-4 md:mb-0 century text-center border-bleu border-solid border py-4">
