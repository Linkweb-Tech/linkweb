    ...
    render(){
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    title="Agence Référencement Toulouse / Agen - Agence SEO Linkweb"
                ...
                {/* <PageTransition
                    ...
                    transitionTime={200}
                > */}
                    <section className="w-full mt-24 bloctitrescreen mx-auto px-2 md:px-4 py-6 bg-no-repeat bg-cover bg-center flex md:flex-row flex-col justify-center items-center" style={{backgroundImage:'url(' + Bg +')', backgroundColor:'rgba(0,0,0,0.2)', backgroundBlendMode:'overlay', backgroundPosition:'center', height:'650px'}}>
                    ...
                    <section className="flex flex-col xl:flex-row w-full mx-auto px-4 py-6 my-4">
                        <div className="w-full xl:w-1/2 px-12 xl:px-24 py-12" >
                            ...
                            <p data-aos='fade-bottom' className="text-justify">Le <strong>référencement naturel SEO</strong> de votre <strong>site internet</strong> est travaillé de manière régulière et constante pour obtenir le meilleur classement. Il se distingue du <strong><Link className="hover:text-bleu" to="/agence-adwords-47-31/">référencement payant Google Adwords</Link></strong> qui fait également partie des <strong>leviers</strong> du <strong>marketing digital</strong> (<strong>webmarketing</strong>). Pour développer une <strong>stratégie digitale</strong> efficace, un <strong>consultant SEO</strong> tiendra compte des objectifs de développement de votre entreprise durant l'établissement de votre <strong>stratégie de référencement naturel</strong>.
                            <br/><br/>
                            Nous maintenons une <strong>mise à jour régulière des pages web de votre site internet</strong>, de la conception technique à la gestion de votre <strong>référencement naturel</strong>. De ce point de vue, un <strong>expert SEO</strong> sera chargé d'éliminer tous les facteurs <strong>bloquants</strong> de votre site en commençant par mettre en place les <strong>optimisations de balises</strong> et autres <strong>techniques de référencement</strong> (<strong>maillage interne</strong>, <strong>liens entrants</strong>, <strong>balise meta</strong>, contenu de qualité). <br/><br/>Ce travail doit vous permettre de <strong>positionner durablement les pages de votre site dans les premiers résultats naturels des pages de résultats des moteurs de recherche</strong>. Nous mènerons un <strong>audit SEO</strong> en vue de déterminer votre stratégie et faire le <strong>choix de mots-clés</strong> (<strong>requêtes</strong>) qui vous permettront une <strong>acquisition de trafic</strong> satsifaisante en vue de maximiser votre <strong>taux de conversion</strong> grâce au <strong>trafic organique</strong> généré sur le <strong>moteur de recherche Google</strong>.</p>
                        </div>
                        <div className="w-full xl:w-1/2 py-12 flex flex-col justify-center order-first xl:order-last">
                    ...
                    <section className="w-full h-full flex flex-col justify-center items-center px-4 pt-12 pb-0 mt-2 bg-darkgrey text-white">
                        ...
                        <div className="w-full lg:w-1/2 mb-12 mb-24 mr-16">
                            ...
                            <p>Nous mettons en place une <strong>stratégie de référencement naturel</strong> basée sur vos besoins en termes de <strong>visibilité</strong>. C’est pourquoi il est important de les définir le plus précisément possible, et ce, dès le départ. Le <strong>référencement naturel</strong> est un travail de longue haleine, c’est pourquoi il est nécessaire de s’appuyer sur des bases pérennes, que ce soit en <strong>refonte</strong> ou en <strong>création de site internet</strong>.</p>
                        </div>
                        ...
                        <div className="w-full lg:w-1/2 mb-12 mb-24 mr-16">
                            ...
                            <br/>
                            <h4 className="century text-lg tracking-wider pb-6" data-aos='fade-left'>
                                <strong className="font-bold">Maîtriser son SEO, c’est vous permettre de connaître le potentiel de votre site internet en termes de retour sur investissement et de conversions.</strong>
                            </h4>
                            <p>Votre <strong>référencement Google</strong> doit être pertinent, il est étudié en fonction d’indicateurs de performance. Notre objectif est de vous apporter un maximum de contacts pour vous permettre d’obtenir un <strong>retour sur investissement</strong> sur le long terme grâce à votre présence dans les <strong>premiers résultats des moteurs de recherches</strong>. Nous tenons compte de ces indicateurs lors de la mise en place d'un <strong>audit de référencement</strong> notammment.</p>
                        </div>
                        <div className="w-full lg:w-1/2">
                            <h3 data-aos='fade-right' className="text-left text-2xl century">
                            ...
                            <p>Nous élaborons une <strong>stratégie de référencement naturel</strong> cohérente avec vos objectifs. Grâce à une collaboration constante et régulière avec votre <strong>référenceur</strong>, le <strong>référencement d’un site</strong> se fait selon le développement de votre entreprise, son activité et les attentes des visiteurs grâce à une <strong>expérience utilisateur</strong> sans faille.</p>
                        </div>
                        </div>
                    </section>
                    ...
                    <section className="max-w-6xl mx-auto flex flex-col align-center justify-center text-center px-4 mt-12 mb-3">
                        ...
                        <hr className="blue"></hr>
                        <h4 data-aos='fade-left' className="text-xl text-grey text-center century italic pb-6">Pour gagner en visibilité, nous devons rendre les contenus de votre site internet pertinents pour répondre aux attentes de vos utilisateurs, mais aussi de Google par le biais de l’optimisation SEO pour ses algorithmes :</h4>
                    </section>
                            ...
                            <Accordion>
                                ...
                                <div label="GOOGLE PINGOUIN">
                                  <svg width="30px" className="mx-auto block" viewBox="0 0 100 125"><g><g><path d="M85.774,67.693c-3.098-10.841-17.553-23.748-22.2-34.589c-1.38-2.601-3.248-7.922-3.613-10.842    c-0.517-4.13,1.238-9.499,2.064-10.325c1.549-1.548,8.262-5.162,8.777-6.195c0.245-0.49-1.048-1.329-1.549-1.549    c-1.539-0.673-5.163,0-6.712-0.258C56.863,1.096,52.733,0.58,49.12,2.128c-5.679,2.582-6.711,9.292-6.711,11.874    c0,2.328-0.131,6.999-0.517,9.292c-0.156,0.927-0.666,2.75-1.032,3.615c-1.033,3.614-3.615,7.228-5.68,9.809    c-1.486,1.859-13.939,16.005-16.004,20.135c-1.854,3.593-6.711,11.874-4.646,14.971c2.106,0.302,2.581-6.711,12.927-14.971    c5.141-4.646,5.141-6.194,6.045-9.293c-0.904,15.489,1.521,23.777,2.968,31.493c0.774,4.13,0.808,5.611,0,7.228    c-2.324,4.646-6.454,4.646-7.486,6.454c1.549,2.322,9.83-0.971,12.907,0c0,2.839,6.195,2.839,8.776,3.354    c0.532,0.208,1.033,0.517,1.548,1.033c0.517,0,0.517-0.517,1.549-0.517c1.033,0,1.033,0.646,2.065,0.646    c0.517,0,0.302-0.645,1.033-0.645c0.517,0,1.032,0.258,1.549,0.258c0.517-0.258,0
    c0.516-0.518,0.516-1.549,0-2.066c-0.517-0.517-5.164-2.065-7.745-2.581c-0.717-0.485,3.82-9.533,4.646-11.874    c3.099-8.777,3.099-26.329,3.099-26.329c1.032,3.098,5.306,6.3,7.227,8.26c2.893,2.95,9.809,13.422,11.357,11.873    C-71.742,75.308-70.94,72.694-71.226,71.693z M-93.426,71.693c-0.516,6.195-5.678,23.232-8.775,20.651    c-1.122-0.936-0.517-3.614-1.549-8.26c-0.517,3.613-0.517,7.743-2.065,9.292c-1.486,1.486-6.636-0.215-8.26-1.549    c-3.222-2.647-5.736-11.343-6.196-15.488c-1.032-9.292,3.099-17.036,3.615-19.101c0.751-3.005-0.517-9.294-0.775-11.875    c-0.396-3.963,1.808-11.357,3.727-15.487c1.02-2.194,1.179-8.777,2.695-9.293c1.797-0.611,3.729,4.466,6.743,4.13    c4.646-0.516,4.646-4.13,5.55-4.13c0.129,0.516-0.137,5.438,0.129,7.227c0.667,4.484,4.936,12.567,5.679,17.037    C-91.808,51.471-92.868,65.005-93.426,71.693z"/><path fill="#000000" d="M-98.588,27.811c-0.266-1.79,0-6.711-0.129-7.227c-0.904,0-0.904,3.614-5.55,4.13    c-3.015,0.336-4.946-4.741-6.743-4.13c-1.517,0.516-1.676,7.099-2.695,9.293c-1.919,4.13-4.123,11.524-3.727,15.487    c0.259,2.581,1.526,8.87,0.775,11.875c-0.517,2.064-4.647,9.809-3.615,19.101c0.46,4.146,2.974,12.841,6.196,15.488    c1.624,1.334,6.774,3.035,8.26,1.549c1.549-1.549,1.549-5.679,2.065-9.292c1.032,4.646,0.427,7.324,1.549,8.26    c3.098,2.581,8.26-14.456,8.775-20.651c0.558-6.688,1.618-20.223,0.517-26.846C-93.652,40.377-97.921,32.294-98.588,27.811z"/></g></g></svg>  
                                    <br/>
                                    <p><span className="font-bold"><strong>Google Pingouin (ou Penguin)</strong> est une <strong>mise à jour majeure de l'algorithme de Google</strong> déployée en 2012.</span> Cette mise à jour concerne l'analyse les <strong>liens externes</strong> (ou <strong>backlinks</strong>), c’est à dire les <span className="font-bold">liens présents sur le Web qui renvoient vers <strong>votre site internet</strong>.</span> <br/><br/>Ces <strong>backlinks</strong> (liens retours) doivent être qualitatifs : s’ils sont de mauvaises qualités (pratiques dites "<strong>black hat</strong>" ou "chapeau noir"), <strong>Penguin</strong> est en mesure de <strong>pénaliser votre nom de domaine</strong> avec une <strong>pénalité manuelle</strong>. En effet, <span className="font-bold">les <strong>liens externes</strong> apportent de la popularité et de la force à <strong>votre site internet</strong> par l'intermédiaire de son <strong>nom de domaine</strong>.</span> <br/><br/><span className="font-bold">Google est donc intransigeant avec les <strong>sites web</strong> tentant de tromper son algorithme.</span> Un <strong>bon référencement</strong> s'appuie avant tout sur le respect des règles imposées par Google. C'est notre rôle en tant qu'<strong>agence de référencement naturel</strong> de vous apporter des <strong>services SEO</strong> fiables et pérennes.
