...
class CreationSiteInternetPortetPage extends React.Component {
                    ...
                    <section className="flex w-full flex-col lg:flex-row mx-auto px-4 py-6 my-4">
                        ...
                        <div className="w-full lg:w-1/2 max-w-3xl px-12 py-12" >
                            ...
                            <h4 className="century text-lg tracking-wider pb-6 text-justify" /*data-aos='fade-left'*/>
                                <span className="font-bold">La <strong>création de sites internet</strong> est un vecteur de développement pour une entreprise. <strong>Linkweb</strong> met en place le site web qu’il vous faut à Portet-sur-Garonne.</span>
                            </h4>
