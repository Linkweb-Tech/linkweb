...
import Bg from "../images/creation-site-internet-portet-sur-garonne.jpg";
...
class CreationSiteInternetPortetPage extends Component {
    ...
    render() {
        ...
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    title="Création de Site Internet à Portet-sur-Garonne (31) - Agence Web Linkweb"
                    description="Création de site internet à Portet-sur-Garonne (31). Devis gratuit – Accompagnement professionnel - Suivi régulier et personnalisé."
                    keywords={[`Création site internet Portet-sur-Garonne`, `Création site internet Toulouse`, `Création site web Portet-sur-Garonne`, `Création site web Toulouse`]}
                    url="https://linkweb.fr/creation-site-internet-portet-sur-garonne/"
                    nom="Création de site internet à Portet-sur-Garonne"
                    slug="creation-site-internet-portet-sur-garonne/"
                />
                {/* <PageTransition
                    defaultStyle={{
                ...
                <section className="w-full bloctitrescreen mx-auto px-10 sm:px-4 py-6 bg-no-repeat bg-cover flex flex-col justify-center items-center" style={{ background: '#00000084 url(' + Bg + ')', backgroundBlendMode: 'multiply', backgroundPosition: 'bottom', backgroundSize: 'cover' }}>
                    <h1 /*data-aos="fade-up" data-aos-delay="500"*/ className="century text-4xl sm:text-6xl text-center text-white">
                        Création de site internet à Portet-sur-Garonne (31)
                        </h1>
                ...
                <section className="max-w-5xl w-full mx-auto px-4 py-6 my-4">
                    <h2 /*data-aos='fade-right'*/ className="text-center text-4xl century">
                        Nous travaillons main dans la main pour mettre en place la  site qui vous ressemble.
                        </h2>
                ...
                <section className="flex w-full flex-col lg:flex-row mx-auto px-4 py-6 my-4">
                    <div className="w-full lg:w-1/2 flex flex-col justify-center items-center">
                        <img src={imac} className="mx-auto flex my-6" alt="Création site internet Portet-sur-Garonne" />
                    </div>
                ...
                <section className="max-w-5xl w-full mx-auto px-4 pt-12 pb-0 my-2">
                    ...
                    <hr className="blue"></hr>
                    <h3 /*data-aos="fade-in"*/ className="text-center font-normal italic century text-sm">Création de site internet à Portet-sur-Garonne</h3>
                </section>
                ...
                <section className="flex w-full flex-col lg:flex-row mx-auto px-4 md:py-6 md:my-4">
                    <div className="w-full lg:w-1/2 pt-6">
                        <img
                            src={mac}
                            alt="Création site internet Portet-sur-Garonne"
                        /*data-aos="fade-right"*/
                        />
                    </div>
                ...
                <section className="max-w-6xl mx-auto flex flex-col align-center justify-center text-center mt-12 mb-3">
                    <h2 className="century text-center text-2xl tracking-wider pb-3 leading-tight" /*data-aos="zoom-in"*/>
                        <span className="text-bleu">/</span>Vous souhaitez en savoir plus sur la création de site internet à Portet-sur-Garonne ?
                        </h2>
                    <hr className="blue"></hr>
                ...
                <section className="tabPanel flex flex-1 w-full justify-end ml-0 mb-12">
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            ...
                            <div label="COMMENT CRÉER UN SITE WEB DESTINÉ À LA POPULATION HAUT-GARONNAISE (31) ?">
...
`
export default CreationSiteInternetPortetPage;
