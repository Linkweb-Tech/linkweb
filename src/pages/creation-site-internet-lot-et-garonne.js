...
import Bg from "../images/creation-site-internet-lot-et-garonne.jpg";
...
class CreationSiteInternetLotetGaronnePage extends React.Component {
    ...
    render(){
        ...
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    title="Création de Site Internet en Lot-et-Garonne (47) - Agence Web Linkweb"
                    description="Création de site internet en Lot-et-Garonne (47). Devis gratuit – Accompagnement professionnel - Suivi régulier et personnalisé."
                    keywords={[`Création site internet Lot-et-Garonne`, `Création site internet Lot-et-Garonne`, `Création site web Lot-et-Garonne`, `Création site web Lot-et-Garonne`]}
                    url="https://linkweb.fr/creation-site-internet-lot-et-garonne/"
                    nom="Création de site internet à Lot-et-Garonne"
                    slug="creation-site-internet-lot-et-garonne/"
                /> 
                {/* <PageTransition
                    defaultStyle={{
                ...
                > */}
                    ...
                    <section className="w-full h-screen mx-auto px-10 sm:px-4 py-6 bg-no-repeat bg-cover flex flex-col justify-center items-center" style={{ background:'#00000084 url(' + Bg + ')', backgroundBlendMode:'multiply', backgroundPosition:'bottom', backgroundSize:'cover' }}>
                        ...
                        Création de site internet en Lot-et-Garonne (47)
                        </h1>
                    ...
                    <section className="max-w-5xl flex-wrap jusitfy-center flex w-full mx-auto px-4 py-2 my-2 ">
                        ...
                        <img 
                            src={peugeot}
                            alt="Création site internet Lot-et-Garonne"
                        />
                        </div>
                        <div className="w-1/3 md:w-1/6" /*data-aos='fade-up' data-aos-delay='200'*/>
                        <img
                            alt="Création de site internet en Lot-et-Garonne" 
                            src={normand}
                        />
                        </div>
                        ...
                        <img 
                            className="mx-12"
                            src={hg}
                            alt="Réalisations Site WebLot-et-Garonne"
                            width="65px"
                        />
                        </div>
                    </section>
                    <section className="max-w-5xl w-full mx-auto px-12 py-6 my-4 century">
                        <h2 className="text-justify text-xl font-bold" style={{textAlignLast:'center'}}>
                            Depuis 2008, Linkweb est à l'origine de la création de sites internet pour des entreprises du Lot-et-Garonne (47) issues d'horizons différents. Notre rôle est de vous accompagner pour atteindre vos objectifs de visibilité sur le Web.
                        </h2>
                    ...
                    <section className="flex w-full flex-col lg:flex-row mx-auto px-4 py-6 my-4">
                        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center">
                            <img src={imac} className="mx-auto flex my-6" alt="Création site internet Lot-et-Garonne"/>
                        </div>
                    ...
                    <section className="max-w-6xl mx-auto flex flex-col align-center justify-center text-center mt-12 mb-3">
                        <h2 className="century text-center text-2xl tracking-wider pb-3 leading-tight" /*data-aos="zoom-in"*/>
                            <span className="text-bleu">/</span>Vous souhaitez en savoir plus sur la création de site internet dans le 47 ?
                        </h2>
                        <hr className="blue"></hr>
                    ...
                    <section  className="tabPanel flex flex-1 w-full justify-end ml-0 mb-12">
                        <div className="w-full md:w-3/4 py-0 flex justify-end">
                            <Accordion>
                                ...
                                <div label="COMMENT CRÉER UN SITE WEB DESTINÉ À LA POPULATION LOT-ET-GARONNAISE (47) ?">
...
query lastsThreePostsLotetGaronne {
...
`
export default CreationSiteInternetLotetGaronnePage;
