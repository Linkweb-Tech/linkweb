    ...
    render() {
        return (
            <Layout location={this.props.location}>
                    ...
                    <section className="flex justify-center flex-col items-center">
                        <div className="w-full px-12 lg:px-0 flex justify-center flex-col md:flex-row lg:w-3/4 mt-5">
                            <div className="w-full svgtransform md:w-1/4 mx-auto px-2 mb-10 md:mb-0 text-white century text-center lg:text-left">
                                ...
                                <p>Linkweb fait partie des <strong><Link to="/agence-internet-toulouse/" className="font-bold text-bleu hover:text-white">agences internet à Toulouse</Link></strong> qui proposent la mise en place d'un <strong>projet sur-mesure</strong> pour la <strong>création de son site internet</strong>.</p>
                            </div>
                        ...
                        <div className="w-full text-white flex flex-col md:flex-row justify-center lg:w-3/4 mt-5 md:mt-10 mb-12">
                            <div className="w-full svgtransform -mt-2 md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                ...
                                <p>Les développeurs de notre <Link to="/agence-web-design-toulouse/" className="font-bold text-bleu hover:text-white">agence de web design à Toulouse</Link> optimisent la <strong>structure des pages web de votre site</strong> pour offrir une <strong>expérience utilisateur</strong> idéale à vos visiteurs.</p>
                            </div>
                ...
                Vous pouvez également choisir un site taillé sur-mesure, pensé pour vous par les <strong>développeurs de <Link to="/agence-web-muret/" className="text-bleu hover:text-black font-bold">notre agence à Muret</Link></strong> spécialisée. Nous vous accompagnons pour prendre les meilleures décisions.
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            ...
                            <div label="MON SITE EST-IL CONFORME AUX ATTENTES DES UTILISATEURS ET DES RÉGLEMENTATIONS ?">
                                <p>Nous concevons des <strong>sites performants</strong> et permettons de protéger vos utilisateurs grâce à des outils variés. Pour chaque stratégie, notre <strong><Link to="/agence-web-ramonville/" className="text-bleu hover:text-black font-bold">agence web à Ramonville</Link></strong> réalise des prestations soignées et respectent les conformités nécessaires pour une <strong>navigation sur le site web</strong> en toute sécurité.</p><br />
