    ...
    render() {
        return (
            <Layout location={this.props.location}>
                    ...
                    <section className="flex justify-center flex-col items-center">
                        <div className="w-full px-12 lg:px-0 flex justify-center flex-col md:flex-row lg:w-3/4 mt-5">
                            <div className="w-full svgtransform md:w-1/4 mx-auto px-2 mb-10 md:mb-0 text-white century text-center lg:text-left">
                                ...
                                <p>Linkweb fait partie des <strong>agences</strong> qui proposent la mise en place d'un <strong>projet sur-mesure</strong> pour la <strong><Link to="/agence-creation-site-web-toulouse/" className="font-bold text-white hover:text-black">création de son site internet</Link></strong>.</p>
                            </div>
                        ...
                        <div className="w-full text-white flex flex-col md:flex-row justify-center lg:w-3/4 mt-5 md:mt-10 mb-12">
                            <div className="w-full svgtransform -mt-2 md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                ...
                                <p>Nos <Link to="/entreprise-developpement-web-toulouse/" className="font-bold text-bleu hover:text-white">développeurs</Link> optimisent la <strong>structure des pages web de votre site</strong> pour offrir une <strong>expérience utilisateur</strong> idéale à vos visiteurs.</p>
                            </div>
                ...
                Vous pouvez également choisir un site taillé sur-mesure, pensé pour vous par les <strong>développeurs de <Link to="/agence-web-muret/" className="text-bleu hover:text-blackfont-bold">notre agence</Link></strong> spécialisée. Nous vous accompagnons pour prendre les meilleures décisions.
