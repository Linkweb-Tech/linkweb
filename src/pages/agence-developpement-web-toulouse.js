    ...
    render() {
        return (
            <Layout location={this.props.location}>
                    ...
                    <section className="flex justify-center flex-col items-center">
                        <div className="w-full px-12 lg:px-0 flex justify-center flex-col md:flex-row lg:w-3/4 mt-5">
                            <div className="w-full svgtransform md:w-1/4 mx-auto px-2 mb-10 md:mb-0 text-white century text-center lg:text-left">
                                ...
                                <p>Linkweb fait partie des <strong>agences</strong> qui proposent la mise en place d'un <strong>projet sur-mesure</strong> pour la <strong><Link to="/agence-internet-toulouse/" className="font-bold text-white hover:text-black">création de son site internet</Link></strong>.</p>
                            </div>
                        ...
                        <div className="w-full text-white flex flex-col md:flex-row justify-center lg:w-3/4 mt-5 md:mt-10 mb-12">
                            <div className="w-full svgtransform -mt-2 md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                ...
                                <p>Nos <Link to="/agence-web-design-toulouse/" className="font-bold text-bleu hover:text-white">développeurs</Link> optimisent la <strong>structure des pages web de votre site</strong> pour offrir une <strong>expérience utilisateur</strong> idéale à vos visiteurs.</p>
                            </div>
                ...
                Vous pouvez également choisir un site taillé sur-mesure, pensé pour vous par les <strong>développeurs de <Link to="/agence-web-muret/" className="text-bleu hover:text-black font-bold">notre agence</Link></strong> spécialisée. Nous vous accompagnons pour prendre les meilleures décisions.
                ...
                <section className="flex w-full flex-col mx-auto px-0 py-6 my-4">
                    <section className="text-center text-black text-2xl mx-auto lg:mx-0 century mt-16 mb-10">
                        <h2 className="century text-3xl md:text-5xl text-black leading-tight">Linkweb, avant tout une équipe de <br />spécialistes du <span className="text-bleu"><Link to="/agence-marketing-toulouse/" classname="text-bleu hover:text-black font-bold">Marketing digital</Link></span> et de la <span className="text-bleu">Communication Web</span></h2>
                        <br />
                ...
                <section className="w-full bg-black flex flex-col md:flex-row">
                    ...
                    <div className="w-full order-first md:order-last md:w-3/4 my-6 text-white p-6 lg:px-24">
                        ...
                        <div className="flex items-end my-10 justify-end flex-col">
                            <p className="w-full lg:w-3/4 century text-center md:text-right text-lg md:text-sm lg:text-lg"><strong>Linkweb impulse votre site internet</strong> et votre <strong>communication web</strong> dans le sud de la <strong>France</strong>. Les spécialistes de notre établissement sont à votre écoute et vous orienteront vers une mise en route technique et une définition stratégique pertinentes.</p>
