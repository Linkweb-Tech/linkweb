            ...
            > */}
                ...
                <section className="w-full  flex flex-col lg:flex-row flex justify-center">
                    ...
                    <div className="bloctext w-full lg:w-1/2 flex flex-col justify-center century text-justify order-first lg:order-last">
                        ...
                        <br/>
                        <p>Lorsqu’un site internet est créé, ce dernier n’est pas encore répertorié par les différents moteurs de recherche. Cela signifie qu’il n’est pas accessible, hormis par voie directe. Le référencement naturel consiste à faire connaître votre site internet aux moteurs de recherche, mais pas seulement.</p>

                        <p>Une fois votre site inscrit dans la base de données des moteurs, aussi appelée « index », il est important de mettre en place des actions qui vont permettre à votre site de ressortir lorsque des requêtes pertinentes sont effectuées. Ceci a pour objectif d’augmenter sa visibilité afin de générer du trafic vers votre site.</p>
                        <br/>
                        <hr style={{width:'100%'}}/>
                        <br/>
                        <h2>Référencement naturel : définition</h2>
                        <br/>
                        <p>Au sens strict du terme, le référencement naturel consiste uniquement à répertorier un site internet sur Google, Bing, et autres moteurs de recherche. En effet, si le site internet n’est pas présent dans, ce que l’on appelle l’index des moteurs de recherche, ces derniers ne peuvent le restituer lorsqu’une recherche est effectuée.</p>
                        <p>Toutefois, le de référencement naturel ne se limite pas à cela. Le référencement naturel est directement lié à la notion de SEO : Search Engine Optimization, à savoir, optimisation pour les moteurs de recherche.</p>
                        <p>Ainsi, sous « référencement naturel » ou « SEO », est englobé l’ensemble des actions effectuées sur un site internet pour faire évaluer sa position dans les pages de résultats de recherche pour un mot-clé donné.</p>
                        <br/>
                        <hr style={{width:'100%'}}/>
                        <br/>
                        ...
                        <br/>
                        <p>Il faut savoir que le référencement naturel est l’une des portes d’entrée principales pour un site web. Il consiste à apporter de la visibilité à un site internet via sa mise en avant dans les résultats de recherche des moteurs.</p>
                        <p>S’il est important de miser sur le référencement naturel, c’est tout simplement parce qu’il représente l’une des voies royales pour apporter du trafic à son site internet. En effet, <a href="https://www.abondance.com/20171224-18757-infographie-33-chiffres-autour-seo.html" target="_blank" rel="noopener noreferrer" className="text-bleu hover:text-black">97% des expériences web commencent par un moteur de recherche</a>. Négliger ce facteur pourrait être dommageable pour la visibilité d’un site web.</p>
                        <p>Une stratégie de référencement naturel peut-être orientée pour répondre à une problématique spécifique. Par exemple, une entreprise de services de proximité pourra bénéficier d’une stratégie de référencement local pour être visible dans sa zone de chalandise et ainsi générer de potentiels contacts.</p>
                        <p>La réussite d’une stratégie de référencement repose en partie sur le choix des mots-clés. En effet,  il est indispensable de choisir des mots-clés pertinents et fréquemment recherchés pour obtenir une visibilité ciblée et conséquente dans les pages de recherche d’un moteur.</p>
                        <br/>
                        <h3 className="intertitre3">Typologie de mots-clés</h3>
                        <br/>
                        <p>Le mot-clé a toujours constitué une question centrale en termes de référencement naturel. En effet, bien choisir ses mots-clés est décisif dans la mise en route d’une stratégie de référencement naturel. Aujourd’hui, le choix des mots-clés ne dépend plus seulement de facteurs statistiques. Il va également prendre en compte la notion d’intention de recherche.</p>
                        <p>Afin de proposer des résultats de recherche toujours plus pertinents, Google va interpréter la requête de l’utilisateur pour déterminer son intention de recherche. Est-ce qu’il cherche à acheter un produit ou un service ? Est-ce qu’il cherche simplement une information ? Google va interpréter la recherche pour lui fournir des résultats adaptés. C’est un critère dont il va falloir tenir compte.</p>
                        <p>Par ailleurs, il faut savoir qu’il existe une typologie de mots-clés en fonction de plusieurs paramètres : leur volume de recherche sur le moteur, le potentiel de conversion qu’il présente, ou encore le nombre de sites concurrents déjà positionnés. Parmi les mieux connus, nous pouvons citer :</p>
                        <br/>
                        <ul>
                            <li><span className="text-bleu">></span> Les mots-clés de courte traîne : ils sont composés de peu de termes et correspondent à une requête générique qui va drainer un fort volume de recherche, mais également une forte concurrence.</li>
                            <li><span className="text-bleu">></span> Les mots-clés de longue traîne : ils sont composés, en général, de plus de trois termes, correspondent à des requêtes spécifiques qui vont générer un volume de recherche plus faible, mais avec une concurrence moins importante.</li>
                            <li><span className="text-bleu">></span> Les mots-clés locaux : il s’agit d’expressions clés qui contiennent le nom d’une ville, d’un département ou encore d’une région.</li>
                            <li><span className="text-bleu">></span> Les mots-clés événementiels : ce sont des mots-clés qui vont obtenir un fort volume de recherche sur une période de temps définie.</li>
                        </ul>
                        <br/>
                        <h3 className="intertitre3">Comprendre une page de résultat de recherche (SERP)</h3>
                        <br/>
                        <p>Les pages de résultats des moteurs de recherche, appelées aussi SERP (de l’anglais Search Engine Results Page), vont être au coeur de l’évaluation de sa stratégie de référencement naturel. Toutefois, évaluer sa stratégie de référencement uniquement sur ce critère est insuffisant. Néanmoins, comprendre la composition d’une page de résultats est important pour partir sur de bonnes bases.</p>
                        <p>Tout d’abord, il faut savoir qu’il n’existe pas un seul modèle de page de résultats. Si l’on s’attèle à l’exemple de Google, il faut savoir que la composition des SERP va varier en fonction de l’intention de recherche. En interprétant la requête d’un utilisateur, le moteur va renvoyer une page de résultat qu’il va juger adaptée.</p>
                        <p>Par exemple, si la requête est de type « informationnel », alors que le moteur va identifier que la réponse la plus adaptée sera une définition. En revanche, si la requête a pour finalité un achat, alors le moteur va proposer des pages web d’entreprises, ainsi que des annonces.</p>
                        <br/>
                        <h4>Composition classqie d'une page de résultat</h4>
                        <br/>
                        <p>Généralement, une page de résultat va être composée par des liens sponsorisés en haut et bas de page, marqués par la mention « Annonce », ainsi que 10 liens naturels classés par page en fonction de leur pertinence par rapport à la requête. Les liens sponsorisés sont directement liés à des annonces rémunérées via l’outil Google Ads. Les liens naturels sont « gratuits ».</p>
                        <p>Chacun des 10 liens naturels va présenter différents éléments : </p>
                        <br/>
                        <ul>
                            <li><span className="text-bleu">></span> Le chemin de l’URL (qui a remplacé l’adresse URL),</li>
                            <li><span className="text-bleu">></span> Le contenu de la balise « title » de la page,</li>
                            <li><span className="text-bleu">></span> Le contenu de la balise meta-description de la page,</li>
                        </ul>
                        <br/>
                        <img className="mx-auto block" src={affichage} alt="Référencement Toulouse"/>
                        <br/>
                        <p>Si le travail d’optimisation n’est pas effectué, Google se chargera lui-même de définir les informations à afficher aux yeux des utilisateurs, d’où l’importance d’avoir la main sur ces éléments.</p>
                        <br/>
                        <h4>Autres éléments</h4>
                        <br/>
                        <p>En fonction de la recherche, Google va être en mesure d’afficher des éléments qui vont viser à apporter une information directement sur la page de recherche et ainsi permettre à l’utilisateur de gagner du temps. Cela peut avoir un impact négatif sur le trafic des sites web dans la mesure où l’internaute obtient sa réponse directement dans les résultats de recherche.</p>
                        <p>Parmi les éléments que Google est en mesure d’afficher directement dans les pages de résultats de recherche, nous pouvons trouver :</p>
                        <br/>
                        <ul>
                            <li><span className="text-bleu">></span> <strong className="font-bold">Des informations liées à la notion de recherche universelle :</strong> Google va afficher des éléments issus de ses différentes catégories de recherche à savoir : des résultats en provenance de Google Images, de Google Actualités, de Google Vidéos, etc.</li>
                            <li><span className="text-bleu">></span> <strong className="font-bold">Des featured snippets :</strong> ils correspondent à la position 0 sur Google et constituent un encadré présentant une succincte à la requête d’un internaute. Son contenu provient de l’une des pages web répertoriées par l’index.</li>
                            <li><span className="text-bleu">></span> <strong className="font-bold">Des rich snippets :</strong> les données enrichies vont être directement liées à la notion de données structurées. Elles vont permettre d’afficher des informations complémentaires pour chaque lien. Il en existe de tous types : afficher le prix d’un produit, afficher les étoiles de notation d’un article de blog, afficher des recettes de cuisine.</li>
                            <li><span className="text-bleu">></span> <strong className="font-bold">Le local pack :</strong> le local pack est un encart qui se trouve généralement en haut d’une page de résultat. Il apparaît notamment lorsque la requête effectuée est de type local. Il va donc restituer trois entreprises inscrites sur l’outil Google My Business en fonction de plusieurs critères comme par exemple la géolocalisation.</li>
                        </ul>
                        <br/>
                        <p>Il faut savoir que Google met à jour régulièrement ses pages de résultats de recherche, ce qui peut amener à ce que de nouveaux éléments apparaissent.</p>
                        <br/>
                        <hr style={{width:'100%'}}/>
                        <br/>
                        ...
                        <br/>
                        <p>Le travail de référencement naturel est un travail qui demande des compétences techniques, une vision d’ensemble et ne peut s’évaluer que sur la durée. Appelé aussi « référencement gratuit » en opposition au « référencement payant » mené via Google Ads, il se mesure en main d’œuvre et en heures de travail.</p>
                        <p>S’il demande une vision d’ensemble, c’est tout simplement car il est pluridisciplinaire. Travailler le référencement naturel d’un site internet s’effectue sur le site web, mais également en dehors de ce site internet. C’est aussi car il demande une certaine polyvalence et un certain équilibre entre réalisation technique et éditoriale.</p>
                        <br/>
                        <h3 className="intertitre3">Des compétences techniques</h3>
                        <br/>
                        <p>S’il n’est pas obligatoire d’avoir une formation dans le développement web pour travailler le référencement naturel d’un site, il faut en revanche en avoir des notions. Le référencement naturel est bien souvent une question de détails, c’est pourquoi il va être nécessaire de construire ses pages web de manière structurée.</p>
                        <p>Optimiser la structure d’une page, mettre en place des données structurées, optimiser ses images, ou encore créer des contenus sur-mesure pour que le site réponde à la fois aux utilisateurs et aux robots des moteurs de recherche n’est pas une mince affaire.</p>
                        <p>Par ailleurs, avoir une vision stratégique est, d’emblée, indispensable pour mettre en œuvre une stratégie de référencement naturel qui s’avérera efficace à l’avenir. Ceci est élémentaire, car le référencement est une affaire de longue durée.</p>
                        <br/>
                        <h3 className="intertitre3">Un travail de longue haleine</h3>
                        <br/>
                        <p>Bien positionner un site web sur une requête à succès demande du temps. Cela s’explique par le fait que la concurrence peut y être rude, mais également parce que Google a besoin d’indices pour faire confiance à un site web. Pour acquérir ces indices, cela va demander du temps. Non seulement le contenu présenté doit être irréprochable, mais il va falloir prouver que votre site web est digne de confiance et se trouve donc légitime à être partagé.</p>
                        <p>Pour cela, il existe la notion d’autorité. En effet, Google se base sur des critères qui vont être liés à l’expertise, l’autorité et à la crédibilité du détenteur du site web en question dans son domaine de prédilection.</p>
                        <p>Ces indices, Google va aller les chercher partout sur le Web. En référencement naturel, ce qui se trouve sur le site internet est aussi important que ce qui se trouve en dehors. En fonction des requêtes ciblées, il va donc être plus ou moins compliqué de se positionner dans les meilleures places. C’est pourquoi le travail de référencement naturel est un travail qui s’évalue sur la durée.</p>
                        <br/>
                        <hr style={{width:'100%'}}/>
                        <br/>
                        ...
                        <br/>
                        <p>Avant de se lancer dans la mise en place d’une stratégie de référencement naturel, il est important de bien connaître le marché sur lequel on souhaite s’installer :</p>
                        <br/>
                        <ul>
                            <li><span className="text-bleu">></span> Quelles sont les attentes des utilisateurs ?</li>
                            <li><span className="text-bleu">></span> Quels sont les mots-clés les plus performants ?</li>
                        ...
                        <br/>
                        <p>Ceci est valable que vous possédiez déjà un site internet ou non. Il faut savoir qu’il existe des outils professionnels qui vont vous permettre d’obtenir des réponses à ces questions. Définir le cadre de son projet en amont de sa stratégie est important pour se lancer dans la bonne direction et ainsi saisir les bonnes opportunités.</p>
                        ...
                        <p>Une stratégie de référencement naturel nécessite du temps avant de générer des résultats satisfaisants. Il est donc important de se lancer dans la bonne direction, et ce, dès le départ.</p>
                        <p>Si vous souhaitez mener un projet de référencement naturel, Linkweb est en mesure de vous apporter une réponse qualifiée et fonctionnelle.</p>
                    </div>
                </section>
