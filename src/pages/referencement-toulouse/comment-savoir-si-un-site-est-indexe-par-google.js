            ...
            > */}
                ...
                <section className="w-full  flex flex-col xl:flex-row flex justify-center">
                    ...
                    <div className="bloctextpages w-full lg:w-1/2 flex flex-col justify-center century text-justify">
                        ...
                        <br/>
                        <p>Chaque URL peut être <strong className="font-bold">soumise à l'indexation de Google pour donner un accès rapide et simple aux robots</strong>. L'objectif est de <strong>figurer rapidement dans les SERP (Search Engine Results Pages)</strong> en vue de proposer des informations sur son service aux internautes par la suite. <strong>Google</strong> emploie de plus en plus l'intelligence artificielle dans son mode de classement et d'<strong>exploration des données de sites</strong>, ainsi que de chaque sitemap à indexer. Il arrive régulièrement que les propriétaires de sites rencontrent des <strong>problèmes d'indexation sur le Web</strong>.</p>
