    ...
    render() {
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    title="Optimisation SEO interne : Définition - Référencement Toulouse - Linkweb"
                ...
                <section className="w-full mt-10 text-justify century font-normal flex flex-col lg:flex-row lg:justify-end" data-aos="fade-right">
                    <div className="w-full lg:w-2/3 px-16 md:px-24 lg:px-24 xl:pl-40 xl:ml-64 mb-24">
                        <p>
                                L'<strong className="font-normal">optimisation SEO</strong> est indispensable pour référencer votre site internet sur un <strong className="font-normal">moteur de recherche</strong> comme Google. Améliorez votre popularité en figurant parmi les premiers résultats naturels et <strong className="font-normal">générez plus de trafic vers votre site internet</strong> sur le long terme. Optimiser le référencement local vous permet de capter de <strong className="font-normal">nouveaux clients</strong> notamment dans votre zone de chalandise, un atout stratégique important pour augmenter votre chiffre d'affaires.<br/>
                        <br/>
                                Réaliser l'<strong className="font-normal">optimisation pour le référencement de son site</strong>, c'est choisir de se développer, d'évoluer et de maintenir sa compétitivité face à la concurrence.
                        </p>
                        <br />
                        <h2 className="text-3xl text-bleu font-bold">Optimisation SEO : qu'est-ce que l'optimisation interne ?</h2>
                        <br />
                        <p>
