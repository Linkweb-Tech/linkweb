                        ...
                        <div className="w-full lg:w-1/2 my-10  flex flex-col">
                            ...
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full px-12 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <br />
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify">Pour une bonne <strong className="font-normal">gestion de projet en ligne</strong>, le professionnel travaillant au sein d'une <strong className="font-normal"><Link to="/" className="text-bleu hover:text-black font-bold">agence web comme Linkweb à Agen</Link>,</strong> se tient informé des nouveautés du Web. Les fonctionnalités et les <strong className="font-normal">outils</strong> évoluent constamment et peuvent voir le jour à tout moment dans le <strong className="font-normal">développement et la création de sites</strong> comme dans leur <strong className="font-normal">design</strong>.<br /><br />
