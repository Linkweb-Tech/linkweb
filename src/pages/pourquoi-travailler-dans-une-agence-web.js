...
class PourquoiTravaillerdansuneAgenceWeb extends Component {
            ...
            <Layout location={this.props.location}>
                ...
                <section className="w-full flex justify-end -mt-0 lg:-mt-32">
                    <div className="w-11/12 lg:w-1/3 bg-bleu shadow-2xl -mt-0 lg:-mt-64 flex flex-col justify-end mx-12 lg:mx-24">
                        ...
                        <br />
                        <p className="px-8 lg:px-16 text-white text-center century text-md">En postulant auprès de l’<Link to="/agence-web-cahors/" className="text-white hover:text-black font-bold">agence Linkweb</Link>, découvrez les enjeux du web et le travail en équipe. Nous étudions tous les profils.</p>
                        <br />
                ...
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + siteinternet + ')' }}>
                        ...
                        <p className="text century lg:mt-0 text-lg lg:text-sm xl:text-lg z-50">Pour une entreprise, le Web est un terrain de jeu qui regorge d'<strong className="font-normal">outils de communication</strong> pour sa <strong className="font-normal">stratégie marketing</strong>. Pour obtenir de la <strong className="font-normal">visibilité</strong>, l’<strong className="font-normal"><Link to="/web-agency-toulouse/" className="text-bleu hover:text-white font-bold">agence Linkweb</Link></strong> accompagne les professionnels dans leur <strong className="font-normal">référencement naturel SEO et SEA</strong> sur les <strong className="font-normal">moteurs de recherche</strong> (tels que )<strong className="font-normal">Google</strong>). Les <strong className="font-normal">spécialistes du digital</strong> mettente en place des solutions pérennes pour générer du <strong className="font-normal">trafic qualifié sur les sites internet</strong>.
                        <br /><br />Le <strong className="font-normal">Web</strong> est mobilisé au quotidien. Il permet de répondre à tous les besoins l’internaute. Le développement d'un <strong className="font-normal">support de communication</strong> comportant des fonctionnalités est devenu indispensable. Bien figurer dans les <strong className="font-normal">résultats de recherche</strong> grâce à l’expertise de l’<Link to="/agence-web-marketing-toulouse/" className="text-bleu hover:text-white font-bold"><strong>agence de webmarketing</strong></Link> offre une visibilité auprès d'un public qualifié.</p>
                    </div>
                ...
                <section className="sidetitle w-10/12 text-center text-black text-2xl justify-center flex flex-col century mt-10 mb-10 mx-auto">
                    ...
                    <div className="line-title my-4">
                        <hr className="border-solid w-1/2 lg:w-1/12 border-bleu"></hr>
                        <br />
                        <h3 /*data-aos='fade-left'*/ className="max-w-6xl text-xl text-black text-center lg:text-justify century pb-0">Le domaine du webmarketing et de <Link to="/agence-de-communication-digitale/" className="text-bleu hover:text-black font-bold">la communication web</Link> font appel à des savoirs et des compétences bien spécifiques. Intégrer l'équipe de spécialistes d’une agence et être sollicité sur de la création et du développement de site nécessitent la mobilisation de certains pré-requis.</h3>
                    </div>
                </section>
