...
import Bg from "../images/agence-web-montauban.jpg";
...
class AgenceWebMontauban extends Component {
    ...
    render() {
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    title="Agence Web Montauban - Projets Web sur-mesure - Linkweb"
                    description="L'agence web Linkweb à Montauban vous accompagne dans le développements de vos projets web sur-mesure : création de site internet, référencement SEO, campagnes sponsorisées Ads."
                    keywords={[`Agence Web Montauban`, `Agence Web Toulouse`, `Agence digitale Toulouse`, `Agence digitale Montauban`]}
                    url="https://linkweb.fr/agence-web-montauban/"
                    nom="Agence Web Montauban"
                    slug="agence-web-montauban/"
                />
                {/* <PageTransition
                    defaultStyle={{
                    ...
                    transitionTime={200}
                > */}
                <section className="w-full bloctitrescreen mx-auto px-4 py-6 bg-no-repeat bg-bottom bg-cover flex flex-col justify-center items-center" style={{ background: 'rgba(0,0,0,.65) url(' + Bg + ')', backgroundPosition: 'top', backgroundSize: 'cover', backgroundBlendMode: 'multiply' }}>
                ...
                <section className="flex flex-col lg:flex-row mx-8 lg:mx-24 my-0 items-center lg:justify-center">
                    <div data-aos="fade-in" className=" w-full lg:w-3/12 md:w-1/2 bg-white my-4 border border-darkgrey mx-10 hover:shadow-xl py-6 century" style={{ borderRadius: '15px', borderColor: '#d4d4d4', transform: 'translateZ(0) scale(1)', transition: '0.3s' }}>
                        ...
                        <p className="text-center px-6 text-md">Site internet <strong>vitrine</strong>, <strong>e-commerce</strong> ou <strong>administrable</strong>, Linkweb crée votre site internet à Montauban.</p>
                        <br />
                ...
                <section className="max-w-5xl w-full mx-auto px-4 pt-12 pb-0 my-2">
                    ...
                    <div className="w-full" /*data-aos='zoom-in'*/>
                        <p className="text-md text-center py-12 century">
                            Vous êtes un organisme public ou privé à la recherche d’une <strong>agence web à Montauban</strong> pour la mise en place d’une stratégie digitale ? <strong>Linkweb</strong> est à l’écoute de vos besoins pour vos proposer une solution taillée pour vous.</p>
                    </div>
                </section>
                ...
                <section className="flex w-full flex-col lg:flex-row mx-auto px-0 py-6 my-4">
                    <div className="w-full lg:w-1/2 ">
                        <img src={imac} alt="Agence Web Montauban" />
                    </div>
                    <div className="w-full lg:w-1/2 max-w-3xl px-12 py-12" >
                        <h2 className="century capitalize text-2xl tracking-wider pb-6" /*data-aos="zoom-in"*/>
                            <span className="text-bleu">/</span>AGENCE WEB À MONTAUBAN : NOTRE CRÉATIVITÉ AU SERVICE DE VOTRE EFFICACITÉ
                            </h2>
                        ...
                        <p /*data-aos='fade-bottom'*/ className="century text-justify">
                            Depuis plus de 10 ans, notre expérience dans la <strong><Link to="/creation-de-site-internet-a-agen/" className="text-bleu hover:text-black">création de sites internet à Agen</Link></strong> nous a permis de développer nos compétences<strong> en tant qu'<Link to="/agence-web-albi/" className="text-bleu hover:text-black font-bold">agence web près d'Albi</Link></strong> pour envisager les <strong>projets web</strong> comme des solutions uniques répondant aux besoins de chaque <strong>client</strong>.<br /><br />

                                Présente à <strong>Montauban</strong> en <strong>Tarn-et-Garonne (82)</strong>, Linkweb, <strong><Link to="/agence-web-marmande/" className="font-bold text-bleu hover:text-black">agence web également présente à Marmande</Link></strong>, développe sa filiale <strong>toulousaine</strong>. Spécialisée dans le secteur des <strong>marchés publics</strong> comme dans les <strong>marchés privés</strong>, notre <strong><Link to="/agence-web-balma/" className="text-bleu hover:text-black font-bold">agence web de Balma</Link></strong> est particulièrement active pour répondre aux demandes émanant de tous types d’organismes en faisant du <strong>marketing digital</strong>, un atout considérable. <strong>Linkweb</strong> déploie son offre de <strong>création de site web</strong>, <strong>refonte de site internet</strong> et de <strong>référencement web</strong> à la <strong>Montauban</strong> et ses alentours.<br /><br />

                                De part son savoir-faire en tant qu’<strong>agence digitale</strong>, Linkweb met en place votre <strong>site internet</strong> grâce aux solutions de <Link to="/entreprise-developpement-web-toulouse/" className="text-bleu hover:text-black font-bold"> <strong>entreprise de développement web</strong></Link> et optimise votre <strong>référencement naturel</strong> grâce à une veille permanente en <strong>web marketing</strong>. Quelle que soit la nature de votre activité, nous avons le savoir-faire  et les <strong>expertises</strong> pour vous permettre d’atteindre vos objectifs.<br />
                        </p>
                ...
                <section className=" w-full lg:h-screen flex flex-col justify-center items-end px-4 pt-12 pb-0 my-2 bg-cover my-24" style={{ background: '#6a6a6a url( ' + bgDev + ')', backgroundBlendMode: 'multiply', backgroundSize: 'cover' }}>
                    ...
                    <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-start text-center my-12">
                        ...
                        <div className="w-full my-6 sm:w-1/3 px-6 sm:px-12 flex flex-col items-center justify-center" /*data-aos='zoom-in' data-aos-delay="400"*/>
                            ...
                            <img src={web} alt="Agence Web Montauban" width="80px" />
                        ...
                        <div className="w-full my-6 sm:w-1/3 px-6 sm:px-12 flex flex-col items-center justify-center" /*data-aos='zoom-in' data-aos-delay="600"*/>
                            <img src={bullhorn} alt="Agence Web Montauban" width="80px" />
                ...
                <section className="max-w-5xl w-full mx-auto px-4 pt-12 lg:pt-2 pb-0 my-2">
                    <h2 /*data-aos='fade-right'*/ className="text-center text-3xl century">
                        <span className="text-bleu">/</span>AGENCE WEB À MONTAUBAN : QUI SOMMES-NOUS ?
                        </h2>
                    <hr className="blue"></hr>
                    <h3 /*data-aos="fade-in"*/ className="text-center font-normal italic century text-sm">Agence Web Montauban</h3>
                </section>
                ...
                <section className="max-w-6xl mx-auto flex flex-col align-center justify-center text-center mt-12 mb-3">
                    <h2 className="century text-center text-xl md:text-2xl tracking-wider pb-3 leading-tight" /*data-aos="zoom-in"*/>
                        <span className="text-bleu">/</span>Agence Web Montauban : que gagner à se lancer dans un projet web ?
                        </h2>
                    <hr className="blue"></hr>
...
query lastsThreePostsAgenceMontauban {
    allWpPost(limit: 3) {
      edges {
        node {
          id
...
`
export default AgenceWebMontauban;
