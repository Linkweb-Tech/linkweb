            ...
            >
                ...
                <section className="flex w-full  mx-auto px-0 py-6 my-4" style={{marginTop:'0px', marginBottom:'0px'}}>
                        ...
                        <div className="w-1/2 bg-black" style={{backgroundColor: 'rgb(0, 0, 0,0.4)', backgroundBlendMode:'multiply', backgroundImage: 'url(' + sea + ')', padding:'130px', color:'white' }} data-aos="zoom-in" data-aos-delay="200">
                            ...
                            <br/>
                            <p style={{fontSize:'1em'}}>Nous vous accompagnons dans le <strong>référencement Google Ads</strong> de votre <strong>site vitrine</strong> ou <strong>e-commerce</strong>. <strong>Référencer son site</strong> et apparaître en <strong>première position sur Google</strong> mérite un investissement conséquent en temps, mais aussi en argent. Mener une campagne, définir une annonce, ajuster la stratégie, sont autant de tâches qui incombent au <strong>référencement payant</strong> pour obtenir un <strong>retour sur investissement</strong>.<br/>
                            <br/>
