        ...
        return (
            <Layout location={this.props.location}>
                ...
                {/* <PageTransition
                    ...
                    transitionTime={200}
                > */}
                    <section className="w-full bloctitrescreen mx-auto px-4 py-6 bg-no-repeat bg-bottom flex flex-col justify-center items-center" style={{ background: '#000000a6 url(' + Bg + ')', backgroundPosition:'center', backgroundBlendMode: 'multiply', backgroundSize:'cover' }}>
