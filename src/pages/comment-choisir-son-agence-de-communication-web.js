                        ...
                        <div className="w-full lg:w-1/2 my-10  flex flex-col">
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full px-6 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <br />
                                    <p className="w-full century pb-4 text-justify"><p  /*data-aos='fade-left'*/ className="text-justify" >Le domaine du <strong>marketing digital</strong> demande un <strong className="font-normal">savoir-faire</strong> exigeant aux <strong className="font-normal">consultants</strong>, ainsi qu'une grande précision et enfin de la rigueur. Que cela concerne l’<strong className="font-normal">élaboration de site internet</strong>, la <strong className="font-normal">stratégie de communication pour gagner en visibilité</strong>, ainsi que les nombreux autres <strong className="font-normal">leviers du webmarketing</strong>, les <strong className="font-normal">professionnels de notre <Link to="/agence-web-cahors/" className="text-bleu hover:text-black font-bold">agence web à Cahors</Link></strong> répondent à une méthodologie très précise.</p>
                                    </p>
                    ...
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            ...
                            <div label="DES PROFESSIONNELS COMPÉTENTS ET EXPÉRIMENTÉS">
                                <p>Concernant la <Link to="/comment-notre-agence-de-conception-de-site-internet-realise-votre-projet/" className="text-bleu hover:text-black font-bold"><strong className="font-bold">conception de votre site</strong></Link>, de votre <strong className="font-normal">webdesign</strong>, le <strong className="font-normal">référencement SEO ou SEA</strong>, les <strong className="font-normal">consultants</strong> mettent tout en œuvre pour vous permettre d’atteindre les <strong className="font-normal">objectifs</strong> que vous vous êtes fixé.
                                <br /><br />
                                ...
                                <br /><br />
                                Les collaborateurs savent appréhender les spécificités techniques d’<strong className="font-normal">Internet</strong> et de l’<strong className="font-normal">activité en ligne</strong> pour un résultat cohérent avec toutes vos attentes. De plus, <Link to="/pourquoi-travailler-dans-une-agence-web/" className="text-bleu hover:text-black font-bold"><strong>travailler dans une agence web</strong></Link> nécessite d'effectuer une veille permanente relativement aux mouvements ayant lieu sur le Web.
                                </p>
                            </div>
