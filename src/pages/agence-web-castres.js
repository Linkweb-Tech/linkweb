...
class AgenceWebCastres extends Component {
    ...
    render() {
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    title="Agence Web Castres - Projets Web sur-mesure - Linkweb"
                    description="L'agence web Linkweb à Castres vous accompagne dans le développements de vos projets web sur-mesure : création de site internet, référencement SEO, campagnes sponsorisées Ads."
                    keywords={[`Agence Web Castres`, `Agence Web Toulouse`, `Agence digitale Toulouse`, `Agence digitale Castres`]}
                    url="https://linkweb.fr/agence-web-castres/"
                    nom="Agence Web Castres"
                    slug="agence-web-castres/"
                />
                {/* <PageTransition
                    defaultStyle={{
                ...
                <section className="max-w-5xl w-full mx-auto px-4 pt-12 pb-0 my-2">
                    ...
                    <div className="w-full" /*data-aos='zoom-in'*/>
                        <p className="text-md text-center py-12 century">
                            Vous êtes un organisme public ou privé à la recherche d’une <strong>agence web à Castres</strong> pour la mise en place d’une stratégie digitale ? <strong>Linkweb</strong> est à l’écoute de vos besoins pour vos proposer une solution taillée pour vous.</p>
                    </div>
                </section>
                ...
                <section className="flex w-full flex-col lg:flex-row mx-auto px-0 py-6 my-4">
                    <div className="w-full lg:w-1/2 ">
                        <img src={imac} alt="Agence Web Castres" />
                    </div>
                    <div className="w-full lg:w-1/2 max-w-3xl px-12 py-12" >
                        <h2 className="century capitalize text-2xl tracking-wider pb-6" /*data-aos="zoom-in"*/>
                            <span className="text-bleu">/</span>AGENCE WEB À CASTRES : NOTRE CRÉATIVITÉ AU SERVICE DE VOTRE EFFICACITÉ
                            </h2>
                ...
                <section className=" w-full lg:h-screen flex flex-col justify-center items-end px-4 pt-12 pb-0 my-2 bg-cover my-24" style={{ background: '#6a6a6a url( ' + bgDev + ')', backgroundBlendMode: 'multiply', backgroundSize: 'cover' }}>
                    ...
                    <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-start text-center my-12">
                        ...
                        <div className="w-full my-6 sm:w-1/3 px-6 sm:px-12 flex flex-col items-center justify-center" /*data-aos='zoom-in' data-aos-delay="400"*/>
                            ...
                            <img src={web} alt="Agence Web Castres" width="80px" />
                        ...
                        <div className="w-full my-6 sm:w-1/3 px-6 sm:px-12 flex flex-col items-center justify-center" /*data-aos='zoom-in' data-aos-delay="600"*/>
                            <img src={bullhorn} alt="Agence Web Castres" width="80px" />
                ...
                <section className="max-w-5xl w-full mx-auto px-4 pt-12 lg:pt-2 pb-0 my-2">
                    <h2 /*data-aos='fade-right'*/ className="text-center text-3xl century">
                        <span className="text-bleu">/</span>AGENCE WEB À CASTRES : QUI SOMMES-NOUS ?
                        </h2>
                    <hr className="blue"></hr>
                    <h3 /*data-aos="fade-in"*/ className="text-center font-normal italic century text-sm">Agence Web Castres</h3>
                </section>
                ...
                <section className="max-w-6xl mx-auto flex flex-col align-center justify-center text-center mt-12 mb-3">
                    <h2 className="century text-center text-xl md:text-2xl tracking-wider pb-3 leading-tight" /*data-aos="zoom-in"*/>
                        <span className="text-bleu">/</span>Agence Web Castres : que gagner à se lancer dans un projet web ?
                        </h2>
                    <hr className="blue"></hr>
...
query lastsThreePostsAgenceCastres {
    allWpPost(limit: 3) {
      edges {
        node {
          id
...
`
export default AgenceWebCastres;
