...
class AgenceMarketingToulouse extends React.Component {
    ...
    render() {
            ...
            <Layout location={this.props.location}>
                ...
                <section className="w-full flex justify-end -mt-0 lg:-mt-32">
                    <div className="w-11/12 lg:w-1/3 bg-bleu shadow-2xl -mt-0 lg:-mt-64 flex flex-col justify-end mx-12 lg:mx-24">
                        ...
                        <br />
                        <p className="px-8 lg:px-16 text-white text-center century text-md">Linkweb vous accompagne de la conception à la mise en application de votre <strong className="font-normal">stratégie de marketing digital</strong>. Dès la <strong className="font-normal">création de votre site web</strong>, notre équipe d’experts est à votre écoute pour mettre en place un <strong className="font-normal">projet</strong> qui vous ressemble.</p>
                        <br />
                ...
                <section className="sidetitle w-10/12 text-center text-black text-2xl justify-center flex flex-col century mt-10 mb-10 mx-auto">
                        ...
                        <div className="line-title my-4">
                            ...
                            <br/>
                            <h3 /*data-aos='fade-left'*/ className="max-w-7xl text-xl text-black text-center lg:text-justify century pb-0">Notre rôle, en tant qu’agence marketing, consiste à mettre en place une stratégie de webmarketing parfaitement adaptée en fonction de vos attentes et de vos besoins.</h3>
                        </div>
                </section>
        ...
        <div data-aos="fade-in" data-aos-delay="300" className=" w-full md:w-1/2 lg:w-3/12 bg-white my-12 border border-darkgrey mx-8 hover:shadow-xl py-6 century" style={{ borderRadius: '15px', borderColor: '#d4d4d4', transform: 'translateZ(0) scale(1)', transition: '0.3s' }}>
          ...
          <ul className="text-bold text-center py-2">
            ...
            <li className="py-2 flex flex-row justify-center">
              <div className="w-3/12 text-center text-bleu">✔</div>
              <div className="w-9/12 text-left">Rédaction de contenuSEO</div>
            </li>
            <li className="py-2 flex flex-row justify-center">
              <div className="w-3/12 text-center text-bleu">✔</div>
                    ...
                    <div className="w-full flex-col md:flex-row flex px-auto">
                        ...
                        <div className="w-full flex-col md:flex-row flex px-auto">
                            ...
                            <div className="w-full px-12 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <br/>
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify">Il peut être difficile de trouver une formule adaptée à ses besoins compte tenu de la diversité de l’<strong className="font-normal">offre d’hébergement</strong>. Nous vous aidons à faire le <strong className="font-normal">choix d’un hébergement</strong> et d’un <strong className="font-normal">nom de domaine</strong> en parfaite adéquation avec vos ambitions ainsi que votre <strong className="font-normal">image de marque</strong>.</p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                            </div>
                        </div>
                        <div className="w-full flex-col md:flex-row flex px-auto">
        ...
        <div className="w-full xl:w-1/3 two px-auto">
          <div className="flex items-center xl:items-start flex-col xl:flex-row flex-1">
            ...
            <section className="w-full lg:w-1/3 absolute z-10 px-auto lg:w-1/3 absolute px-12 lg:px-6 xl:px-24 pt-24">
              ...
              <div className="century content pb-6 text-justify" style={{ textAlignLast: 'center' }}>
                En fonction de votre secteur d’activité, du marché sur lequel vous vous insérez ou encore un bon nombre de critères inhérents à votre entreprise, il existe une formule qui vous correspond. Il n’existe pas une seule façon de mettre à profit la <strong className="font-normal">communication</strong> et le <strong className="font-normal">webmarketing</strong> pour une <strong className="font-normal">société</strong>. Nous déterminons le modèle qui correspond au mieux à vos besoins.
                </div>
            ...
            <section className="bg-bleu sidetitle py-10">
                        <section className="w-full lg:w-2/3 flex flex-col justify-center century my-10 px-4 lg:px-32 md:mx-6 sm:mx-12 mt-2 lg:mx-64">
                            ...
                            <div className="line-title my-4 ">
                                ...
                                <br/>
                                <h3 /*data-aos='fade-left'*/ className="text-xl text-white century pb-0">De part sa compétence ainsi que son expérience de plus de dix ans dans le secteur de la communication en ligne, notre agence est en mesure de traduire vos besoins en solutions parfaitement fonctionnelles, répondant à vos attentes ainsi qu’à celles des utilisateurs.</h3>
                            </div>
                        </section>
