      ...
      <Layout location={this.props.location}>
        ...
        <section className="w-full lg:w-3/5 px-10 mt-16 lg:-mt-48 mb-16 lg:mb-48">
          ...
          <h3 className="century text-xl text-center">
            Linkweb fait partie des <Link to="/agence-web-haute-garonne/" className="text-bleu hover:text-black font-bold">agences de communication web</Link> qui ont un rôle de conseil en stratégie marketing et apportent des solutions concrètes pour votre entreprise.
                    </h3>
        </section>
            ...
            <div className="w-full lg:w-1/2 my-10  flex flex-col">
              <div className="w-full flex-col md:flex-row flex px-auto">
                ...
                <div className="w-full px-6 lg:px-6 flex flex-col justify-center">
                  ...
                  <br />
                  <h4 className="century"><span className="font-bold">Le <Link to="/agence-web-design-toulouse/" className="text-bleu hover:text-black">développement d’un site</Link> web n’est pas un objectif : il est un moyen. Il est indispensable de prévoir une stratégie d’accompagnement en vue d’acquérir de la visibilité.</span></h4>
                  <br />
                  <p className="w-full century pb-4 text-justify"><p  /*data-aos='fade-left'*/ className="text-justify" ><strong className="font-normal"><Link to="/agence-internet-toulouse/" className="text-bleu hover:text-black font-bold">Avoir un site internet</Link></strong> est indispensable. Toutefois, ce dernier doit impérativement être visible pour vous permettre de tirer tout le potentiel et exploiter toute la puissance d’un tel outil. Il constitue un moteur au sein de votre <strong className="font-normal">projet de web marketing</strong>.</p>
                  </p>
