...
class ConsultantSocialMedia extends Component {
...
render() {
    return (
        <Layout location={this.props.location}>
            ...
            <SEO
                title="Consultant Social Media : faire vivre votre stratégie digitale - Linkweb"
                description="Un consultant social media est une personne qui vous aide à développer et mettre en œuvre votre stratégie digitale."
                url="https://linkweb.fr/social-media/consultant-social-media/"
                nom="Consultant Social Media"
                slug="social-media/consultant-social-media/"
            />
            {/* <PageTransition
                defaultStyle={{
            ...
            > */}
                <section className="w-full bloctitrespages mx-auto pb-0 px-4 pt-6 bg-blackflex flex-col justify-center items-center" style={{background:'#00000094 url(' + background +')', backgroundBlendMode:'multiply', backgroundSize:'cover', backgroundPosition:'center', height:'450px'}}>
                    ...
                    Consultant Social Media : <br/><span className="text-3xl">Faire vivre votre stratégie digitale</span>
                    </h1>
                    <br/>
                    {/* Réseaux Sociaux */}
                ...
                <section className="w-full  flex flex-col  xl:flex-row flex justify-center">
                    ...
                    <p style={{marginBottom:'50px'}}><Link to="/" className="text-bleu hover:text-black">Agence web</Link> <span className="text-bleu">></span> <Link to="/agence-community-management/" className="text-bleu hover:text-black">Agence Social Media</Link> <span className="text-bleu">></span> Consultant Social Media : faire vivre votre stratégie digitale</p>
                        <p className="font-bold">Un consultant social media est une personne qui vous aide à développer et mettre en œuvre votre stratégie digitale.</p>
                        <p>Il vous aidera à identifier les canaux de médias sociaux les plus appropriés pour votre entreprise, à créer du contenu engageant et à interagir avec vos clients. Le consultant social media est un expert des médias sociaux et sait comment les utiliser pour atteindre vos objectifs commerciaux.</p>
                        <p>Il comprend également comment fonctionnent les différentes plateformes et peut vous aider à naviguer dans leurs complexités. Votre consultant social media sera un atout précieux dans la construction de votre marque en ligne et la promotion de vos produits ou services. Il vous aidera également à générer des leads qualifiés, augmenter le trafic sur votre site web et améliorer votre visibilité en ligne.</p>
                        <br/>
                        <h2>Quels sont les objectifs d’un consultant social media ?</h2>
                        <br/>
                        <p>Le consultant social media est chargé de la gestion des médias sociaux d’une entreprise dans le cadre du <Link to="/social-media/social-media-marketing/" className="text-bleu hover:text-black font-bold">social media marketing</Link>. Il s’agit d’un poste stratégique au sein d’une entreprise, car il permet de générer du trafic et des leads qualifiés.</p>
                        <p>Les objectifs d'un consultant social media sont multiples :</p>
                        <ul>
                            <li>Attirer l'attention sur les produits ou services de l'entreprise ;</li>
                            <li>Générer du trafic vers le site web de l'entreprise ;</li>
                            <li>Engager la communauté autour de la marque ;</li>
                            <li>Fidéliser les clients existants ;</li>
                            <li>Prospecter de nouveaux clients.</li>
                        </ul>
                        <br/>
                        <h2>Comment trouver un consultant social media ?</h2>
                        <br/>
                        <p>De nos jours, il est de plus en plus important d’être présent sur les réseaux sociaux. En effet, c’est là que se trouve la majorité de votre audience. Il est donc crucial d’avoir une présence active et de savoir comment vous y prendre. C’est là qu’intervient un consultant social media.</p>
                        <p>Mais comment trouver le bon consultant social media ? Vous pouvez faire des recherches sur Google ou sur les réseaux sociaux eux-mêmes pour trouver une <Link to="/agence-community-management/" className="text-bleu hover:text-black font-bold">agence social media</Link>. Les plateformes comme Linked In ou Viadeo regorgent également de profils de consultants.</p>
                        <p>Une fois que vous avez trouvé quelques candidats potentiels, prenez le temps de consulter leur site web et leurs profils sociaux pour voir si leur approche correspond à ce que vous recherchez.</p>
                        <p>N'hésitez pas à contacter plusieurs consultants avant de faire votre choix final afin d'avoir un aperçu des différentes prestations proposées et des tarifs appliqués.</p>
                        <br/>
                        <h2>Comment devenir consultant social media ?</h2>
                        <br/>
                        <p>Devenir consultant social media est une excellente façon de se lancer dans cette industrie passionnante. En tant que consultant social media, vous aurez la possibilité de travailler avec une variété de clients et d’aider à améliorer leur présence en ligne.</p>
                        <p>Pour réussir en tant que consultant social media, il y a quelques choses que vous devrez faire. Tout d’abord, vous devrez bien comprendre les différents médias sociaux et comment ils fonctionnent. Vous devrez également avoir une bonne connaissance des différentes plateformes sociales et savoir comment utiliser chacune d’elles à bon escient.</p>
                        <p>Ensuite, vous devrez développer un solide réseau de contacts professionnels afin que vous puissiez travailler efficacement avec les clients potentiels. Une fois que vous avez maîtrisé ces éléments clés, il est temps de commencer à chercher des clients potentiels.</p>
                        <p>Il y a plusieurs façons de trouver des clients potentiels, notamment par le biais de sites Web, via le référencement naturel ou la prospection commerciale. Vous pouvez également participer à des salons professionnels ou des conférences sur le marketing numérique pour rencontrer d’autres professionnels du même secteur qui pourraient avoir besoin de votre expertise.</p>
                        <br/>
                        <h2>Quel est le salaire d'un consultant social media ?</h2>
                        <br/>
                        <p>Au même titre qu'un <Link to="/social-media/social-media-manager/" className="text-bleu hover:text-black font-bold">social media manager</Link>, Le salaire d'un consultant social media est très variable. En fonction de l'expérience, de la région et du type de poste, les tarifs et salaires des consultants peuvent varier de plusieurs centaines d'euros.</p>
                        <p>La plupart des consultants social media travaillent à leur compte, mais certains sont employés par des agences spécialisées dans le marketing digital ou par des cabinets de conseil en communication corporate. Les salaires varient donc considérablement selon le mode de travail choisi ou encore le profil du consultant (junior ou senior).</p>
                        <br/>
                        <h2>En bref : le métier de consultant social media</h2>
                        <br/>
                        <h3 className="intertitre3">Compétences :</h3>
                        <br/>
                        <ul>
                            <li><span className="text-bleu">></span> Community management ;</li>
                            <li><span className="text-bleu">></span> Web-marketing ;</li>
                            <li><span className="text-bleu">></span> Image de marque ;</li>
                            <li><span className="text-bleu">></span> Relation-client ;</li>
                            <li><span className="text-bleu">></span> Ligne éditoriale ;</li>
                            <li><span className="text-bleu">></span> Brand content ;</li>
                            <li><span className="text-bleu">></span> Content marketing ;</li>
...
export default ConsultantSocialMedia;
