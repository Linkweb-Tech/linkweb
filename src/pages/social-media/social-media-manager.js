...
render() {
    return (
        <Layout location={this.props.location}>
            ...
            <SEO
                title="Social Media Manager : découvrir le métier - Linkweb"
                description="Le social media manager est un métier relativement nouveau qui consiste à gérer les différents comptes sociaux d'une entreprise."
                url="https://linkweb.fr/social-media/social-media-manager/"
                nom="Social Media Manager"
                slug="social-media/social-media-manager/"
            />
            {/* <PageTransition
                defaultStyle={{
            ...
            > */}
                <section className="w-full bloctitrespages mx-auto pb-0 px-4 pt-6 bg-blackflex flex-col justify-center items-center" style={{background:'#00000094 url(' + background +')', backgroundBlendMode:'multiply', backgroundSize:'cover', backgroundPosition:'center', height:'450px'}}>
                    ...
                    Social Media Manager : <br/><span className="text-3xl">Découvrir le métier</span>
                    </h1>
                    <br/>
                    {/* Réseaux Sociaux */}
                ...
                <section className="w-full  flex flex-col  xl:flex-row flex justify-center">
                    ...
                    <p style={{marginBottom:'50px'}}><Link to="/" className="text-bleu hover:text-black">Agence web</Link> <span className="text-bleu">></span> <Link to="/agence-community-management/" className="text-bleu hover:text-black">Agence Social Media</Link> <span className="text-bleu">></span> Social Media Manager : découvrir le métier</p>
                        <p className="font-bold">Le social media manager est un métier relativement nouveau qui consiste à gérer les différents comptes sociaux d'une entreprise.</p>
                        <p>Il s'agit donc de la personne chargée de l'image de marque sur les réseaux sociaux. Cela implique de connaître parfaitement les outils et les fonctionnalités des différents réseaux sociaux, ainsi que leurs spécificités. Le social media manager doit être capable de créer du contenu attrayant et pertinent, tout en respectant les objectifs fixés par l'entreprise. Il doit également être à l'aise avec les outils de gestion des médias sociaux, comme Hootsuite, par exemple.</p>
                        <br/>
                        <h2>Quel est le rôle d’un social media manager ?</h2>
                        <br/>
                        <p>Le social media manager est une personne qui gère les comptes de médias sociaux d’une entreprise. Son rôle est de créer du contenu, d’engager la communauté et de promouvoir les produits ou services de l’entreprise.</p>
                        <p>Un social media manager doit avoir une bonne connaissance des différents réseaux sociaux et savoir comment fonctionnent leurs algorithmes. Il doit également être capable de créer du contenu attrayant et engageant. Enfin, il doit savoir comment promouvoir les produits ou services de l’entreprise sans être trop commercial.</p>
                        <p>Les social media manager sont souvent chargés de gérer plusieurs comptes à la fois. Ils doivent donc être organisés et avoir une bonne gestion du temps.</p>
                        <br/>
                        <h2>Qu’est-ce que le social media marketing ?</h2>
                        <br/>
                        <p>Le <Link to="/social-media/social-media-marketing/" className="text-bleu hover:text-black font-bold">social media marketing</Link>, ou SMM, est une stratégie de marketing numérique qui utilise les plateformes de médias sociaux pour promouvoir une entreprise, un produit ou un service. Les professionnels du SMM créent des contenus attrayants et engageants que les internautes peuvent partager avec leurs amis et leur famille.</p>
                        <p>Ils travaillent également à construire des communautés en ligne autour d'une marque ou d'un produit afin de générer plus de trafic vers le site Web de l'entreprise. Le social media manager est la personne chargée de mettre en œuvre la stratégie social media marketing.</p>
                        <p>Il doit posséder une solide compréhension des plateformes de médias sociaux, des outils numériques et des techniques de marketing en ligne.</p>
                        <p>De plus, il doit être capable de communiquer efficacement avec les clients et les prospects, tout en gérant efficacement son temps et ses ressources.</p>
                        <br/>
                        <h2>Quels sont les objectifs d’un social media manager ?</h2>
                        <br/>
                        <p>Le social media manager gère les comptes de plusieurs entreprises et organisations sur les différents réseaux sociaux, directement chez l'annonceur ou en <Link to="/agence-community-management/" className="text-bleu hover:text-black font-bold">agence social media</Link>. Ses objectifs sont :</p>
                        <ul>
                            <li><span className="text-bleu">></span> De développer la notoriété et la visibilité de l’entreprise,</li>
                            <li><span className="text-bleu">></span> D’attirer le maximum de clients potentiels et</li>
                            <li><span className="text-bleu">></span> De fidéliser les clients existants.</li>
                        </ul>
                        <br/>
                        <p>Pour atteindre ces objectifs, le social media manager doit mettre en place une stratégie efficace sur les différents réseaux sociaux. Il doit concevoir des contenus attrayants et pertinents, interagir avec les internautes, répondre aux questions et commentaires, organiser des jeux-concours...</p>
                        <p>En définitive, il doit être au fait des dernières tendances en matière de marketing digital pour pouvoir adapter sa stratégie en conséquence.</p>
                        <br/>
                        <h2>Comment un social media manager intervient-il dans un projet ?</h2>
                        <br/>
                        <p>Le responsable des médias sociaux est responsable de la gestion des comptes et des pages de médias sociaux de l'entreprise. Il crée du contenu, publie des mises à jour, surveille l'activité et interagissent avec les abonnés.</p>
                        <p>Le responsable des médias sociaux travaille également avec d'autres départements de l'entreprise pour s'assurer que tous les messages sont sur la marque. Le gestionnaire de médias sociaux est un poste relativement nouveau qui est né de la popularité des médias sociaux. Les entreprises se sont rendues compte qu'elles avaient besoin de quelqu'un pour gérer leurs comptes et leurs pages de médias sociaux à plein temps afin de rester pertinentes et compétitives.</p>
                        <p>Un responsable des médias sociaux relève généralement du service marketing ou communication. Il travaille en étroite collaboration avec d'autres membres de l'équipe marketing, ainsi qu'avec des designers, des rédacteurs et des vidéastes. Il est important pour un gestionnaire de médias sociaux d'être capable de comprendre et d'interpréter les données afin de prendre des décisions sur le contenu à produire et quand le publier. Il a un rôle de conseil en communication, au même titre qu'un <Link to="/social-media/consultant-social-media/" className="text-bleu hover:text-black font-bold">consultant social media</Link>.</p>
                        <p>Plus important encore, un gestionnaire de médias sociaux doit être capable d'établir des relations avec les clients et les abonnés.</p>
                        <p>Une grande partie de leur travail consiste à interagir avec les gens en ligne, à répondre aux questions, à répondre aux commentaires et, dans l'ensemble, à être simplement disponibles 24h/24 et 7j/7.</p>
                        <p>Bien que cela puisse sembler être un travail de rêve pour certaines personnes, il est important de se rappeler qu'être un gestionnaire de médias sociaux nécessite beaucoup de travail acharné, de dévouement et une vigilance constante.</p>
                        <br/>
                        <h2>Comment devenir social média manager ?</h2>
                        <br/>
                        <p>Le social media manager est un métier en vogue, notamment auprès des jeunes. Pour devenir social media manager, il n'y a pas de diplôme spécifique requis mais il est important d'être à l'aise avec les outils numériques et les réseaux sociaux. Les compétences en community management, en web marketing et en communication sont également très utiles.</p>
                        <p>Pour se lancer dans la profession, le social media manager peut créer son propre site internet ou blog pour mettre en avant ses compétences et démarcher directement des entreprises. Il existe également des formations dispensées par des écoles de communication ou de web marketing qui permettent d'acquérir les connaissances théoriques nécessaires à exercer ce métier via des masters en communications ou encore par l'intermédiaire d'un bachelor.</p>
                        <p>Le social media manager est chargé de la gestion quotidienne des réseaux sociaux d'une entreprise ou d'une marque dans le cadre de la stratégie de communication digitale. Il doit concevoir une stratégie adaptée à chaque plateforme (Facebook, Twitter, Instagram...) et assurer sa mise en œuvre pour atteindre les objectifs fixés (faire connaître une marque, générer du trafic sur un site internet...) par le chef de projet de communication web.</p>
                        <p>Pour cela, il doit être capable de produire du contenu original et attrayant tout en respectant les consignes de l'entreprise. Il doit également savoir gérer les interactions avec les internautes et veiller à ce que la e-réputation de l'entreprise soit positive. En bref, le social media manager est un professionnel polyvalent qui doit maîtriser plusieurs domaines : le web, les outils numériques, la communication et le marketing digital dans le cadre du webmarketing et de l'application d'une stratégie digitale.</p>
                        <br/>
                        <h2>Quel est le salaire d’un social media manager ?</h2>
                        <p>En termes de salaire, il n’y a pas encore vraiment de consensus sur ce qu’est un bon salaire pour un social media manager. Tout dépend du type d'entreprise (agence de communication ou annonceur) pour laquelle il travaille, de sa taille, mais aussi de son profil : junior ou senior.</p>
                        <br/>
                        <h2>En bref : le métier de social media manager</h2>
                        <br/>
                        <h3 className="intertitre3">Compétences :</h3>
                        <br/>
                        <ul>
                            <li><span className="text-bleu">></span> Éditoriale,</li>
                            <li><span className="text-bleu">></span> Affiliation,</li>
                            <li><span className="text-bleu">></span> Stratégie marketing,</li>
                            <li><span className="text-bleu">></span> Brand content,</li>
                            <li><span className="text-bleu">></span> Rédactionnelle,</li>
                            <li><span className="text-bleu">></span> Relation-client,</li>
                            <li><span className="text-bleu">></span> Modération,</li>
                            <li><span className="text-bleu">></span> Veille concurrentielle,</li>
                            <li><span className="text-bleu">></span> Etc.</li>
                        </ul>
                        <br/>
                        <h3 className="intertitre3">Formations :</h3>
                        <br/>
                        <ul>
                            <li><span className="text-bleu">></span> Bachelor,</li>
                            <li><span className="text-bleu">></span> Licences professionnelles,</li>
                            <li><span className="text-bleu">></span> Master professionnel,</li>
                            <li><span className="text-bleu">></span> Diplômes d'école spécialisée en communication,</li>
                            <li><span className="text-bleu">></span> Diplômes d'école de commerce,</li>
                            <li><span className="text-bleu">></span> Etc.</li>
                        </ul>
                        <br/>
                        <h3 className="intertitre3">Salaire :</h3>
                        <br/>
                        <p>Dépend du profil (junior ou senior), de la taille de l'entreprise, du secteur d'activité, etc.</p>
                    </div>
