    ...
    render() {
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    title="Linkweb fête ses 15 ans ! - Découvrez nos offres anniversaire - Linkweb"
                    description="Retrouvez nos offres exceptionnelles à l'occasion des 15 ans l'agence Linkweb, l'occasion idéale pour propulser votre projet digital."
                    url="https://linkweb.fr/offres-promotionnelles/"
                    nom="Linkweb fête ses 15 ans"
                ...
                <section className="annivban century">
                    <svg className="mx-auto w-3/4 sm:w-full sm:mt-0" width="419.561" height="493.293" viewBox="0 0 419.561 493.293">
                    ...
                    <br/>
                    <h1 className="text-lg text-black px-4 md:w-1/2 lg:w-1/3 w-full text-center -mt-10">En 2024, Linkweb fête ses 15 ans ! Profitez de nos offres exceptionnelles.</h1>
                    <RoundButton url="#offres" color="black" text="Découvrir les offres" />
                </section>
                ...
                <section className="bg-white mt-32 mb-10">
                    <section className="max-w-4xl w-full mx-auto px-4 py-0 my-0">
                        ...
                        <br/>
                        <hr style={{borderBottom:'1px solid #000000', width:'30%'}}/>
                            <br/>
                    ...
                    <section className="w-full flex flex-col lg:flex-row px-4 mt-24 century text-center">
                            <div className="w-full lg:w-1/3 flex flex-col justify-center items-center px-12 py-24 my-4 mx-4" style={{backgroundColor:'#f0ede7'}}>
