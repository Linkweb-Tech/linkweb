            ...
            <Layout location={this.props.location}>
                ...
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + siteinternet + ')' }}>
                        ...
                        <p className="text century lg:mt-0 text-lg lg:text-sm xl:text-lg z-50">Pour vous aider à atteindre vos objectifs, Linkweb fait partie des <strong className="font-normal"><a href="/agence-web-montpellier/" className="text-bleu hover:text-white font-bold">agences web à Montpellier</a></strong> qui activent tous les leviers nécessaires. Ainsi, notre <strong className="font-normal">agence digitale</strong> vous propose une création de site internet à partir de vos besoins. Disposer d’un <strong className="font-normal">support de communication web</strong> fonctionnel, à la charte graphique unique est un élément clef de la <strong className="font-normal">stratégie digitale</strong> qui est mise en place.<br/><br/>
                    ...
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + referencement + ')' }}>
                        ...
                        Notre <a href="/agence-web-nice/" className="text-bleu hover:text-white font-bold">agence web spécialisée à Nice</a>, comme Marseille, vous apporte son expertise pour référencer efficacement les <strong className="font-normal">pages de votre site internet</strong>. Du choix de votre nom de domaine au choix de la <strong className="font-normal">stratégie de référencement</strong> qui vous convient, le conseil en webmarketing dont vous bénéficiez est cohérent et adapté à vos objectifs. 
                        <br /><br />Grâce au référencement naturel proposé par <strong className="font-normal">Linkweb à Marseille</strong> comme partout ailleurs, hissez-vous en tête de la première page des suggestions de Google pour générer un maximum de trafic. Les <strong className="font-normal">solutions digitales</strong> apportées par notre <a href="/agence-web-strasbourg/" className="text-bleu hover:text-white font-bold">agence web à Strasbourg</a> sont pertinentes pour dynamiser l’activité de votre entreprise sur le long terme.
                        </p>
                    </div>
