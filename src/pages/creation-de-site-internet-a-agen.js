                ...
                >
                    ...
                    <section className="max-w-full w-full mx-auto px-4 py-6 my-4 flex">
                        ...
                        <div className="w-1/2" style={{marginTop:'auto', marginBottom:'auto'}}>
                            <p>Malgré tout, vous restez septique sur l’importance de créer un site internet de nos jours ? Vous pensez que le bouche à oreille suffit pour pérenniser votre entreprise ? Les dépenses occasionnées par la création d’un site internet vous semble inutile ?</p><br/>
                            <p>Sachez alors que la création d’un site web n’est pas une dépense. Il s’agit d’un réel investissement pour assurer le développement de votre société.</p>
                        ...
                        <section className="max-w-full w-full flex">
                            <div className="w-1/3" style={{display:'inherit'}}>
                                ...
                                <div className="w-11/12">
                                    ...
                                    Une entreprise possédant un site internet professionnel, design, moderne et ergonomique apporte une crédibilité indispensable à votre entreprise. Il permet également d’améliorer votre notoriété auprès des internautes.</p>
                                </div>
                            </div>
                            <div className="w-1/3" style={{display:'inherit'}}>
                                <div className="w-1/12">
                                ...
                                <div className="w-11/12">
                                    ...
                                    <p style={{textAlign:'left'}}>
                                    Un site web professionnel vous permet d’être visible 24h/24, 7j/7 ! Pas d’horaires, pas de jours de fermeture, pas d’imprévus… un site internet reste visible et accessible à tout moment, où que vous soyez.</p>
                                </div>
                            </div>
                            <div className="w-1/3" style={{display:'inherit'}}>
                                <div className="w-1/12">
                                    <img src={trois} alt="" /><br/>
                                </div>
                                <div className="w-11/12">
                                    <h3 style={{fontWeight:'bold', fontSize:'20px', textAlign:'left'}}>Reflète l’image de votre entreprise</h3>
                                    <p style={{textAlign:'left'}}>
                                    Un site internet doit être réalisé à votre image. Il doit refléter vos valeurs, vos services, vos prestations, mais aussi l’identité visuelle de votre société. Nous nous attachons à définir un cahier des charges pour vous permettre la solution de votre choix.</p>
                                </div>
                            </div>
                        </section>
                    </section>
                    <section className="flex w-full  mx-auto px-0 my-4" style={{marginTop:'0px', marginBottom:'0px'}}>
                        <div className="w-1/2 bg-bleu" style={{backgroundColor: '#37c5ee', padding:'130px', color:'white', fontSize:'1.5em'}} data-aos="zoom-in">
                            ...
                            <p style={{fontSize:'15px', color:'black'}}>Pour une entreprise local, avoir un site internet est incontournable. Non seulement vous vous démarquerez de la concurrence, mais vous aurez également la possibilité de toucher une clientèle beaucoup plus large. En mettant en avant vos services et vos prestations sur votre site vitrine, vous laissez la possibilité à vos prospects d’avoir accès à toutes les informations importantes concernant votre entreprise, et cela à tout moment.</p>
                            <br/> 
                            <p style={{fontSize:'15px', color:'black'}}>Les avantages de créer votre site web ne s’arrête pas là. En effet, un site professionnel, design et moderne vous permettra de concrétiser vos contacts en mettant en avant vos réalisations, vos travaux. Distinguez vous de vos concurrents avec la mise en place de votre propre site internet ergonomique, intuitif, et adapté pour améliorer l’expérience utilisateur.</p>
                            <section className="flex w-full flex mx-auto px-0 my-4" style={{textAlign:'justify', textAlignLast:'center'}}>
                                <div className="w-1/3">
                                    ...
                                    <br/>
                                    <p style={{fontSize:'15px', color:'white', marginRight:'30px'}}>des utilisateurs recherchent le site internet d’une entreprise afin de la contacter ou de la localiser (selon un rapport d’avril 2017 de Local Search Association).</p>
                                </div>
                                <div className="w-1/3">
                                    <p style={{fontSize:'50px'}}>46%</p>
                                    <br/>
                                    <p style={{fontSize:'15px', color:'white', marginRight:'30px'}}>des utilisateurs détermine la confiance d’une entreprise en fonction de la crédibilité du site internet (source : recherche effectuée par Standford en 2002).</p>
                                </div>
                                <div className="w-1/3">
                                    <p style={{fontSize:'50px'}}>68%</p>
                                    <br/>
                                    <p style={{fontSize:'15px', color:'white', marginRight:'30px'}}>des entreprises en France possèdent un site web (source : Observatoire du numérique).</p>
                                </div>
                            </section>
                        </div>
                        <div className="w-1/2 bg-black" style={{backgroundColor: 'black', padding:'130px', color:'white', fontSize:'1.5em'}} data-aos="zoom-in">
                            ...
                            <p style={{fontSize:'15px', color:'white'}}>En 2017, 85% des internautes ont effectués des achats en ligne. Ces chiffres sont en constante évolution. Pour cause, les bénéfices sont nombreux à se lancer dans le e-commerce. Cependant, pour qu’un projet web tel que la création d’une boutique e-commerce soit pérenne, il est indispensable de faire appel à des professionnels qualifiés pour mettre en place une réelle stratégie digitale et obtenir une conception de site de qualité.</p>
                            <br/> 
                            <section className="flex w-full flex mx-auto px-0 my-4" style={{textAlign:'justify', textAlignLast:'center'}}>
                                <div className="w-1/3">
                                    <img src={un} alt="" style={{width:'75px'}}/><br/>
                                    <p style={{fontSize:'30px', marginRight:'30px', textAlign:'center'}}>Développer le chiffre d’affaires</p>
                                    <br/>
                                    <p style={{fontSize:'15px', color:'white', marginRight:'30px'}}>Créer une boutique en ligne permet non seulement de développer son chiffre d’affaire grâce à la vente de produits en ligne, mais permet également de développer celui de votre magasin physique !</p>
                                </div>
                                <div className="w-1/3">
                                    <img src={deux} alt="" style={{width:'75px'}}/><br/>
                                    <p style={{fontSize:'30px', marginRight:'30px', textAlign:'center'}}>Supprimer les contraintes de localité</p>
                                    <br/>
                                    <p style={{fontSize:'15px', color:'white', marginRight:'30px'}}>Un site de vente en ligne permet de toucher une clientèle beaucoup plus large en supprimant les contraintes de localité. Vous pouvez ainsi toucher une clientèle au niveau national, voir international !</p>
                                </div>
                                <div className="w-1/3">
                                    <img src={trois} alt="" style={{width:'75px'}}/><br/>
                                    <p style={{fontSize:'30px', marginRight:'30px', textAlign:'center'}}>Proposer des articles sans limite</p>
                                    <br/>
                                    <p style={{fontSize:'15px', color:'white', marginRight:'30px'}}>Contrairement à un local physique, un site e-commerce vous permet de vendre en ligne autant d’articles que vous souhaitez, rapidement et simplement. Aucune contrainte d’espaces ou de réaménagement !</p>
                                </div>
                            </section>
                        </div>
                    </section>
                    <section style={{backgroundColor:`rgb(255, 255, 255, 0.8`, backgroundImage: 'url(' + fondblanc + ')', backgroundRepeat:'no-repeat', backgroundSize:'cover', backgroundPosition:'center', backgroundBlendMode: `overlay`, marginTop:'50px', padding:`130px`, color:'black'}}>
                        ...
                        <section className="max-w-full w-full mx-auto px-4 px-6 py-6 my-4 ">
                            <section style={{backgroundColor:'black', padding:'3%'}} className="w-full">
                                    ...
                                    <br />
                                    <p style={{fontSize:'15px', textAlign:'justify', textAlignLast:'center', color:'white'}}>Créer son site internet (ou bien réaliser une refonte de site internet) est une opération bien plus complexe que ce que l’on peut imaginer. Bien sûr, vous pouvez tout à fait créer votre site internet à l’aide d’un éditeur de site internet et outils de gestion de contenu gratuits tel que Wix, Jimdo, E Monsite ou Weebly, pour ne citer que les plus connus. Vous aurez ainsi la possibilité de créer un site facilement, sans aucune connaissance, en mettant en place des templates basiques, une description rapide de votre entreprise et en ajoutant quelques-unes de vos photos pour correspondre à la charte graphique de votre entreprise.</p>
                                    <br/>
                                    <p style={{fontSize:'15px', textAlign:'justify', textAlignLast:'center', color:'white'}}>Mais alors, que faites-vous de la stratégie de communication ? De l’analyse de votre cible et de vos objectifs ? De la stratégie de référencement d’un site, naturel ou payant, à mettre en place pour rendre votre site visible dans les moteurs de recherche ?</p>
                                    <br/>
                                    <p style={{fontSize:'15px', textAlign:'justify', textAlignLast:'center', color:'white'}}>C’est là que votre entreprise de création de site internet Linkweb intervient. Nous vous accompagnons tout au long de votre projet, de la création d’un site internet sur mesure au référencement de celui-ci sur les moteurs de recherche. Chaque étape pour créer un site professionnel sera effectuée avec professionnalisme et rigueur :</p>
                            </section>
                        </section>
                        <section className="max-w-full w-full flex">
                            <div className="w-1/3" style={{display:'inherit'}}>
                            ...
                            <div className="w-1/3" style={{display:'inherit'}}>
                                ...
                                <div className="w-11/12">
                                    ...
                                    <p style={{textAlign:'left'}}>
                                        <ul>
                                            <li style={{listStyle:'inside'}}>Création d’un site responsive design adaptatif (navigation optimale sur PC (desktop), smartphones (mobiles) et tablettes en fonction de la taille de l’écran)</li>
                                            <li style={{listStyle:'inside'}}>Mise en page des informations</li>
                                            <li style={{listStyle:'inside'}}>Création de logo si nécessaire</li>
                                            <li style={{listStyle:'inside'}}>Achat du nom de domaine</li>
                                            <li style={{listStyle:'inside'}}>Hébergement du site internet</li>
                                            <li style={{listStyle:'inside'}}>Rédaction de contenu optimisé pour le référencement web</li>
                                        </ul>
                                    </p>
                                </div>
                            </div>
                    ...
                    <section className="flex w-full  mx-auto px-0 my-4" style={{marginTop:'0px', marginBottom:'0px'}}>
                        <div className="w-1/2 bg-black" style={{backgroundColor: 'black', padding:'130px', color:'white', fontSize:'1.5em'}} data-aos="zoom-in">
                            ...
                            <p style={{fontSize:'15px', color:'white'}}>Les entreprises de création et de référencement naturel se font de plus en plus nombreuses ces dernières années, même sur le secteur d’Agen. De plus, vous devez forcément connaître dans votre entourage une personne vous ayant proposé de vous faire un site internet. Plus encore, vous avez sans nul doute reçu de nombreux appel de la part d’entreprises vous proposant de créer un site internet gratuit. Vous n’avez donc que l’embarras du choix. Mais alors, comment choisir ? Pourquoi choisir Linkweb pour créer un site web ?</p>
                            <br/> 
                            <section className="flex w-full flex mx-auto px-0 my-4" style={{textAlign:'justify', textAlignLast:'center'}}>
                                <div className="w-1/3">
                        ...
                        <div className="w-1/2 bg-black" style={{backgroundColor: '#37c5ee', padding:'130px', color:'white', fontSize:'1.5em'}} data-aos="zoom-in">
                            ...
                            <p style={{fontSize:'15px', color:'black'}}>Depuis plus de 10 ans, l’agence de communication web Linkweb fait partie des agences web qui travaillent en collaboration avec l’ensemble de ses clients pour répondre au mieux aux attentes de chacun. Chaque projet, de la conception du site à la stratégie de communication digitale, est réalisé avec rigueur et professionnalisme. Notre seul objectif est d’aider les entreprises locales à developper leurs activités grâce à la mise en place d’une stratégie digitale, et une utilisation du webmarketing efficace. Nous nous engageons ainsi à réaliser pour vous des sites web responsive web design à travers le développement web et l’utilisation d’outils adaptés (système de gestion de contenu) avec une interface intuitive et des contenus optimisés au référencement SEO.</p>
                            <br/> 
                            <p style={{fontSize:'15px', color:'black'}}>L’équipe technique de Linkweb possède les connaissances techniques et les outils nécessaires pour concevoir un site sur mesure, quel que soit le type de site web qu’il vous faut : site internet vitrine, site ecommerce ou bien site administrable. Pour cela, les développeurs web de Linkweb maîtrise les langages web (html css, js, php), les gestionnaires de base de données (MySql, PostgreSQL) et certains CMS (Content Management System), à savoir, WordPress, Joomla, Prestashop, Drupal etc.</p>
                            <br/>
                    ...
                    <section>
                        <section className="max-w-5xl w-full mx-auto px-4 pt-12 pb-0 my-2">
                            <br/>
                            <Link to="https://linkweb.fr/agence-de-communication-agen-47-toulouse-31/"><h2 data-aos='fade-right' className="text-center text-3xl century">
