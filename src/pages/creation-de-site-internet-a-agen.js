...
class CreationSiteInternetAgenPage extends Component {
            ...
            <Layout location={this.props.location}>
                ...
                <section className="flex bg-creationagen items-center w-full mx-auto pb-0 mt-40 mb-0 px-4 pt-6 bg-black flex flex-col justify-center items-center">
                    <div className="max-w-6xl mx-auto lg:mx-56 pt-2 lg:w-2/5 w-full flex-col items-end">
                        ...
                        <div className="w-full lg:w-full flex justify-center lg:justify-center">
                            <h1 className="text-4xl md:text-6xl my-10 font-bold text-center text-white century leading-none">Création site internet Agen</h1>
                        </div>
                        <br />
                        <h2 className="flex full lg:w-full text-white justify-center lg:justify-center mx-auto lg:mx-0 text-xl  century text-center p-1 -mt-12">Linkweb, entreprise de création de site internet à Agen en Lot-et-Garonne (47)</h2>
                    ...
                    <nav aria-label="breadcrumbs" className="w-full bg-bleu century py-2 pl-0 md:pl-48">
                        <Link to="/" className="px-3 md:px-4 text-md lg:text-lg text-white hover:text-black">Agence web</Link> <span className=" text-lg text-black"> / </span>
                        <span className="px-3 md:px-4 text-md lg:text-lg text-white"> Création site internet Agen</span>
                    </nav>
                    ...
                    <section className="flex flex-col items-center justify-center text-center font-bold text-2xl mx-auto lg:mx-0 century mt-16 mb-10">
                        ...
                        <h2 className="flex flex-col items-center justify-center text-center font-bold text-3xl md:text-4xl mx-auto lg:mx-0 century mt-16 mb-10">Vous recherchez un webmaster pour la <br/><span className="text-bleu font-bold text-3xl md:text-5xl uppercase">création de votre site internet à Agen ?</span></h2>
                        <hr className="border-solid w-1/6 border-bleu"></hr>
                        <br />
                        <h3 /*data-aos='fade-left'*/ className="max-w-5xl flex justify-center items-center text-xl text-center century px-4 pb-0"><span className="font-bold">Notre entreprise de création de site web est spécialisée dans le développement de projet web sur-mesure à Agen et partout en Lot-et-Garonne (47). Découvrez ce que notre agence de création de site internet peut faire pour vous.</span></h3>
                    ...
                    <section className="blocprestaagen pb-6">
                    <ModalcreationAgen/>
                    <section className="flex flex-col xl:flex-row mx-8 lg:mx-24 my-0 items-center lg:justify-center">
                        <section className="flex flex-col justify-center md:flex-row w-full mx-auto py-0 mt-2 ">
                            <div className="blocliens w-full lg:w-1/2 xl:w-6/12 my-4 border mx-auto md:mx-4 hover:shadow-xl py-6 century" style={{ border: '2px solid #ffffff' }}>
                                ...
                                <hr />
                                <p className="text-sm px-2 text-white text-center"><span className="font-bold">Un support adapté à votre <strong className="font-normal">communication online</strong>.</span><br />
                                    <ul className="text-bold text-center py-2">
                                        <li className="py-2 flex flex-row justify-center">
                                            <div className="check">✔</div>
                                            <div className="w-9/12 text-left">Plateforme ergonomique</div>
                                        </li>
                                        <li className="py-2 flex flex-row justify-center">
                                            <div className="check">✔</div>
                                            <div className="w-9/12 text-left">Site internet adapté tous supports</div>
                                        </li>
                                        <li className="py-2 flex flex-row justify-center">
                                            <div className="check">✔</div>
                                            <div className="w-9/12 text-left">Création de contenus optimisés</div>
                                        </li>
                                        <li className="py-2 flex flex-row justify-center">
                                            <div className="check">✔</div>
                                        ...
                                        <li className="py-2 flex flex-row justify-center">
                                            <div className="check">✔</div>
                                            <div className="w-9/12 text-left">Conformité et respect RGPD</div>
                                        </li>
                                        <li className="py-2 flex flex-row justify-center">
                                            <div className="check">✔</div>
                                    ...
                                    <br />La création de ce type d'interface est idéale pour les TPE et PME, elle permet de <strong className="font-normal">faire connaître leurs offres et leurs activités</strong> en valorisant les différentes prestations que ces entreprises proposent. Ces projets aident les professionnels à capter des cibles de clientèles locales.</p>
                                <br />
                            ...
                            <div className="blocliens w-full lg:w-1/2 xl:w-6/12 my-4 border mx-auto md:mx-4 hover:shadow-xl py-6 century" style={{ border: '2px solid #ffffff' }}>
                                ...
                                <h3 className="text-center text-white text-xl px-4 font-bold century">Site E-commerce</h3>
                                <hr />
                                <p className="text-sm px-4 text-white text-center"><span className="font-bold">Une boutique <strong className="font-normal">e-commerce</strong> donne l'opportunité de développer ses <strong className="font-normal">ventes en ligne</strong>.</span><br />
                                    <ul className="text-bold text-center py-2">
                                        <li className="py-2 flex flex-row justify-center">
                                            <div className="check">✔</div>
                                            <div className="w-9/12 text-left">Plateforme ergonomique</div>
                                        ...
                                        <li className="py-2 flex flex-row justify-center">
                                            <div className="check">✔</div>
                                            <div className="w-9/12 text-left">Création des fiches produits</div>
                                        </li>
                                        <li className="py-2 flex flex-row justify-center">
                                            <div className="check">✔</div>
                                            <div className="w-9/12 text-left">Gestion des stocks et des ventes</div>
                                        </li>
                                        <li className="py-2 flex flex-row justify-center">
                                            <div className="check">✔</div>
                                            <div className="w-9/12 text-left">Navigation sécurisée (protocole HTTPS)</div>
                                    ...
                                    <br />Ce type de prestation est destiné aux commerçants et gestionnaires de boutiques qui ont pour objectif de <strong className="font-normal">faire grandir leur chiffre d'affaires sur le Web</strong> en s'adressant à une toute nouvelle clientèle.</p>
                                <br />
                        ...
                        <section className="flex flex-col justify-center md:flex-row w-full mx-auto py-0 mt-2 ">
                            <div className="blocliens w-full lg:w-1/2 xl:w-6/12 my-4 border mx-auto md:mx-4 hover:shadow-xl py-6 century" style={{ border: '2px solid #ffffff' }}>
                                ...
                                <h3 className="text-center text-white text-xl px-4 font-bold century">Site Catalogue</h3>
                                <hr />
                                <p className="text-sm px-4 text-white text-center"><span className="font-bold">Ce <strong className="font-normal">type de site internet</strong> permet de proposer des articles et valoriser des produits sans offre de vente directement sur le web.</span> <br />
                                    <ul className="text-bold text-center py-2">
                                        <li className="py-2 flex flex-row justify-center">
                                            <div className="check">✔</div>
                                        ...
                                        <li className="py-2 flex flex-row justify-center">
                                            <div className="check">✔</div>
                                            <div className="w-9/12 text-left">Optimisation SEO des contenus</div>
                                        </li>
                                        <li className="py-2 flex flex-row justify-center">
                                            <div className="check">✔</div>
                                            <div className="w-9/12 text-left">Navigation sécurisée (protocole HTTPS)</div>
                                    ...
                                    <br />Le <strong className="font-normal">site catalogue</strong> permet de bénéficier des avantages du e-commerce pour présenter votre offre dans le moindre détail au sein de <strong>pages web</strong> dédiées, sans vente directe en ligne.</p>
                                <br />
                            ...
                            <div className="blocliens w-full lg:w-1/2 xl:w-6/12 my-4 border mx-auto md:mx-4 hover:shadow-xl py-6 century" style={{ border: '2px solid #ffffff' }}>
                                ...
                                <hr />
                                <p className="text-sm px-4 text-white text-center"><span className="font-bold">Ce type de réalisation multifonctions s'adapte parfaite à vos besoins spécifiques : module de réservation, configurateur et plus encore.</span><br />
                                    <ul className="text-bold text-center py-2">
                                        <li className="py-2 flex flex-row justify-center">
                                            <div className="check">✔</div>
                                            <div className="w-9/12 text-left">Plateforme ergonomique personnalisée</div>
                                    ...
                                    <br />Grâce à la <strong className="font-normal">solution sur-mesure</strong> pour votre activité, vous choisissez une formule optimisée qui s'appuie sur un support numérique commercial accessible à tous, comme sur un intranet ou CRM selon les objectifs qui vous motivent.</p>
                                <br />
                                <div className="w-2/3 mx-auto block">
                                    <br />
                ...
                <section className="max-w-6xl w-full mx-auto px-4 pt-12 pb-0 my-2">
                    <h2 /*data-aos='fade-right'*/ className="text-center text-3xl md:text-5xl century">
                       Création site internet Agen : faites connaître votre entreprise dans le 47 et au-delà !
                    </h2>
                    <br />
                    <hr className="border-solid w-1/2 border-bleu"></hr>
                    <br />
                    <h3 /*data-aos="fade-in"*/ className="text-center uppercase text-darkgrey font-normal italic century text-sm">Création site internet Agen</h3>
                </section>
                ...
                <section className="mt-0">
                    ...
                    <section className="flex flex-col items-center justify-center text-center font-bold text-2xl mx-auto lg:mx-0 century mt-16 mb-10">
                        {/* <h2 className="century font-bold leading-none">Linkweb, entreprise de création de site internet à Agen en <br/><span className="text-5xl lg:text-6xl uppercase text-bleu font-bold">Lot-et-Garonne (47)</span></h2> */}
                        <h2 className="flex flex-col items-center justify-center text-center font-bold text-4xl mx-auto lg:mx-0 century mt-16 mb-10">Création de site internet Agen : <br/><span className="text-bleu font-bold text-5xl uppercase">UN SITE INTERNET SUR-MESURE</span></h2>
                        <hr className="border-solid w-1/6 border-white"></hr>
                        <br />
                        <h3 /*data-aos='fade-left'*/ className="max-w-5xl flex justify-center items-center text-xl text-center century px-4 pb-0"><span className="font-bold">La création d'un site web pour une entreprise est un véritable vecteur de développement. Quel que soit votre secteur d’activité, un site internet doit être conçu pour être un générateur de croissance.</span></h3>
                        {/* <h3 /*data-aos='fade-left' className="max-w-5xl flex justify-center items-center text-xl text-center century px-4 pb-0"><span className="font-bold">La création d'un site web pour une entreprise est un véritable vecteur de développement. Notre entreprise de création de site web est spécialisée dans le développement de projet web en Lot-et-Garonne (47). Découvrez comment nous menons votre projet de création web.</span></h3> */}
                    </section>
                        ...
                        <div className="w-full lg:w-1/2 my-10  flex flex-col">
                            ...
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full px-12 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <br />
                                    <p className="century pb-6 text-justify">Les <strong className="font-normal">moteurs de recherche</strong> comme Google constituent la première source de trafic pour un site internet. Profiter de la visibilité offerte au sein des moteurs de recherche (Google) est un bon moyen pour attirer de nouveaux utilisateurs et atteindre des prospects qualifiés. Notre <strong className="font-normal">agence de création de site internet à Agen</strong> est spécialisée dans le référencement naturel sur Google pour définir la stratégie adaptée à votre site.
                                    </p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                                </div>
                            </div>
                    ...
                    <section className="w-full lg:w-3/4 flex flex-col justify-center century my-10 px-4 lg:px-32 md:mx-6 sm:mx-12 mt-2 lg:mx-64">
                        <h2 className="century text-center lg:text-left text-white text-3xl md:text-5xl leading-none">Création site internet Agen : un accompagnement personnalisé dès la réalisation de votre site web</h2>
                        <br />
                    ...
                    <section className="flex justify-center flex-col items-center">
                        <div className="w-full px-12 lg:px-0 flex justify-center flex-col md:flex-row lg:w-3/4 mt-5">
                            <div className="w-full svgtransform md:w-1/4 mx-auto px-2 mb-10 md:mb-0 text-white century text-center lg:text-left">
                                ...
                                <h4 className="font-bold century"><span className="font-bold">Hébergement du site internet</span></h4>
                                <p>Votre site est hébergé sur des serveurs sécurisés. Nous nous chargeons de l’infogérance ainsi que de l’enregistrement de votre <strong className="font-normal">nom de domaine</strong>.</p>
                            </div>
                            <div className="w-full svgtransform text-white md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                ...
                                <h4 className="font-bold century"><span className="font-bold">Maintenance du site internet</span></h4>
                                <p>Une maintenance technique est effectuée pour garantir l’accessibilité ainsi que la disponibilité de <strong className="font-normal">votre site internet</strong> en permanence.</p>
                            </div>
                            <div className="w-full svgtransform text-white md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                ...
                                <h4 className="font-bold century -mt-4"><span className="font-bold">Site adapté pour mobile et tablette</span></h4>
                                <p>Les sites que nous créons sont parfaitement adaptés pour tous les supports pour une <strong className="font-normal">expérience utilisateur</strong> irréprochable.</p>
                            </div>
                        </div>
                        <div className="w-full text-white flex flex-col md:flex-row justify-center lg:w-3/4 mt-5 md:mt-10 mb-12">
                            ...
                            <div className="w-full svgtransform md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                ...
                                <p>Les <strong className="font-normal">contenus de votre site internet</strong> sont optimisés pour une visibilité maximale sur Google grâce au référencement naturel (SEO).</p>
                            </div>
                            <div className="w-full svgtransform md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                ...
                                <p>Les sites que nous créons disposent d’un certificat de sécurité pour une navigation en toute confiance.</p>
                            </div>
                        </div>
                    </section>
                </section>
                ...
                <br/>
                    ...
                    <h2 className="century text-center lg:text-left text-black text-3xl md:text-5xl leading-none">Ce que Linkweb réalise pour <span className="text-bleu">créer votre site internet à Agen</span></h2>
                    <br />
                    <div className="line-title my-4">
                ...
                <section className="w-full flex my-12 flex-col items-center lg:flex-row text-white bg-bleu century text-center mx-auto lg:text-justify px-16 xl:px-48 py-16">
                    <div className="w-full lg:w-8/12 text-2xl">
                        <h3>Vous souhaitez travailler avec <span className="font-bold">notre agence</span> de création de site internet ?</h3>
                ...
                <section className="max-w-3xl w-full mx-auto px-4 py-0 my-0">
                    <h2 /*data-aos='fade-right'*/ className="text-center text-black text-4xl century">
                        Création site internet à Agen :<br /><span className="font-bold">Nos clients sont satisfaits</span>
                    </h2>
                    <br />
                    <hr className="border-solid w-1/6 border-bleu"></hr>
                    <br />
                ...
                <section className="max-w-4xl w-full mx-auto px-4 py-0 my-0">
                    <h2 /*data-aos='fade-right'*/ className="text-center text-black text-4xl century">
                        Création site internet Agen :<br /><span className="font-bold">dynamiser votre communication d’entreprise</span>
                    </h2>
                    <br />
                    <hr className="border-solid w-1/6 border-bleu"></hr>
                    <br />
                ...
                <section className="tabPanel flex flex-1 w-full justify-end ml-0 mb-24">
                    <div className="w-full md:w-3/4 py-0 flex justify-end">
                        <Accordion>
                            <div className="w-full" label="LE SITE INTERNET VOUS APPORTE DE LA CRÉDIBILITÉ">
                                <p>Une entreprise possédant un <strong className="font-normal">site internet professionnel</strong>, au webdesign moderne et ergonomique, dispose d'une crédibilité indispensable. Opter pour une solution personnalisée en agence web permet aux professionnels de tous les horizons souhaitant se faire connaître, de rendre leurs offres accessibles et de transmettre des informations importantes sur Agen mais aussi sur toute la France.<br /><br />
                                Parmi les agences présentent sur le marché, Linkweb fait partie de celles qui mettent le client au coeur des processus. Faire le choix de la collaboration avec les <strong className="font-normal">équipes de notre agence Linkweb à Agen</strong>, c'est opter pour une création ou une refonte entièrement personnalisée qui permet à votre société de se démarquer et de témoigner de son professionnalisme. Cet outil de communication digitale permet également d’améliorer votre notoriété auprès des internautes et des mobinautes (utilisateur naviguant sur mobile) notamment à travers le responsive design et l'application web accessible sur mobile.<br /><br />
                                La création d’un site internet est nécessaire pour communiquer de manière efficace avec ses clients et ne pas brouiller le message. Dans le cas contraire, le risque de ne pas être trouvé en ligne contribue à décrédibiliser une enseigne. Cela s’explique par le fait qu’un utilisateur à la recherche d’une information à propos d’une entreprise doit être en capacité d’y accéder de façon rapide et efficace. Également, cela laisse place à des contenus à votre sujet qui n’émanent pas de vous.<br /><br />
                                Ne pas être <strong className="font-normal">présent en ligne</strong>, c’est prendre le risque de laisser d’autres entreprises, d'autres acteurs parler de vous à votre place et de véhiculer un message et des informations qui ne vous correspondent pas.</p>
                            </div>
                            <div label="LE SITE INTERNET REFLÈTE L'IMAGE DE VOTRE ENTREPRISE">
                                <p>Un site internet doit être réalisé à l'image de votre entreprise, il reprend votre logo, vos couleurs mais pas que. Il doit refléter vos valeurs, vos prestations, mais aussi l’<strong className="font-normal">identité visuelle de votre société</strong> pour capter vos cibles de clientèle sur toute la France. En somme, ce choix est un <strong className="font-normal">moteur de la communication digitale</strong> d’une entreprise aujourd'hui. <br /><br />

                                De plus, un site aux couleurs de votre entreprise, identifiable grâce à son logo, est le meilleur outil pour déployer votre visibilité auprès d'un public élargi, celui-ci permet de se démarquer des autres entreprises, au sein même de votre zone de chalandise dans le but d’attirer de nouveaux clients, mais aussi de faire connaître votre marque.<br /><br />
                                Avec le choix d'un outil professionnel performant pensé en fonction de vos objectifs, tel que le site web, travailler votre image devient accessible pour déployer votre marque au-delà de vos locaux d’entreprise.<br /><br />
                                </p>
                            </div>
                            <div label="LE SITE INTERNET EST LE MEILLEUR OUTIL DE COMMUNICATION DIGITALE">
                                <p>Un site web professionnel vous permet d’<strong className="font-normal">être visible 24h/24, 7j/7</strong> ! Pas d’horaires, pas de jours de fermeture, pas d’imprévus… un site internet reste visible et accessible à tout moment, où que vous soyez. Les équipes Linkweb chargées du référencement (naturel ou Ads) et de la <strong className="font-normal">création de votre site personnalisé à Agen</strong> vous proposent une maintenance technique sur votre site. Cette prestation vous permet de garder un support accessible depuis n'importe où pour les utilisateurs.<br/><br/>
                                De plus, le site internet vous permettra également de développer une <strong className="font-normal">communication directe avec vos clients et prospects</strong>. Ils pourront consulter vos produits et services sur tous les types de navigateurs (mobile, tablette, smart TV…) et tous les types de supports, qu'il s'agisse d'une interface créée avec le CMS Wordpress ou d'une boutique e-commerce accessible sur mobile, tablette ou ordinateur (responsive design).<br/><br/>
                                En maîtrisant votre communication, vous pouvez promouvoir votre entreprise auprès d’un public élargi. De plus, les possibilités d’amplifier <strong className="font-normal">la visibilité et la notoriété de votre entreprise</strong> avec votre site web sont multiples.</p>
                            </div>
                            <div label="LE SITE INTERNET EST UN MOTEUR POUR VOTRE CHIFFRE D'AFFAIRES">
                                <p>Pour une entreprise locale, <strong className="font-normal">avoir un site internet</strong> est incontournable. Non seulement vous vous démarquerez de la concurrence, mais vous aurez également la possibilité de toucher une clientèle beaucoup plus large.<br/><br/>
                                En mettant en avant <strong className="font-normal">vos services et vos prestations sur votre site vitrine</strong>, vous laissez la possibilité à vos prospects d’avoir accès à toutes les informations importantes concernant votre entreprise, et cela à tout moment.<br/><br/>
                                Les avantages à <strong className="font-normal">créer votre site web</strong> ne s’arrêtent pas là. En effet, un site professionnel, design et moderne vous permettra de concrétiser vos contacts en mettant en avant vos réalisations, vos travaux.<br/><br/>
                                Distinguez vous de vos concurrents, démarquez vous des interfaces des entreprises concurrentes avec la <strong className="font-normal">mise en place de votre propre site internet ergonomique, intuitif</strong>, et adapté pour apporter une expérience utilisateur de qualité.</p>
                            </div>
                            <div label="CRÉATION DE SITE INTERNET EN AGENCE : UNE SÉCURITÉ">
                                <p>L’<strong className="font-normal">équipe technique de Linkweb</strong> possède les connaissances techniques et les outils nécessaires pour concevoir un site entièrement personnalisé, quel que soit le <strong className="font-normal">type de site web</strong> qu’il vous faut : site internet vitrine, site ecommerce ou bien site administrable. Pour cela, les développeurs web de Linkweb maîtrisent les <strong className="font-normal">langages du web (HTML, CSS, JS, PHP)</strong>, les gestionnaires de base de données (MySql, PostgreSQL), des outils comme les CMS (Content Management System), comme Drupal, <strong className="font-normal">Wordpress</strong>, ou encore l'extension de Wordpress : Woocommerce ou encore Prestashop.<br/><br/>
                                Les offres que proposent <strong className="font-normal">les équipes de notre agence</strong> peuvent comprendre une prestation de maintenance technique, de renouvellement de nom de domaine, ainsi qu'un accompagnement pour choisir le meilleur hébergement web et déployer un <strong className="font-normal">travail de référencement SEO</strong> voire de campagne Ads quand cela semble nécessaire.<br/><br/>
                                Linkweb s'inscrit parmi les agences qui placent ses clients au coeur de la <strong className="font-normal">démarche de création ou de refonte</strong>. Notre agence et ses <strong className="font-normal">spécialistes de la communication web</strong> vous apportent des résultats concrets en toute transparence et dans le respect des utilisateurs. Présente sur les secteurs d'<strong className="font-normal">Agen</strong>, Toulouse et partout en France, l'agence Linkweb intervient pour vous permettre d'<strong className="font-normal">être visible sur toute la France</strong>.</p>
                            </div>
                        </Accordion>
                    </div>
                </section>
                <section className="w-full bg-black flex flex-col md:flex-row">
                    ...
                    <div className="w-full order-first md:order-last md:w-3/4 my-6 text-white p-6 lg:px-24">
                        <h2 className="century text-center md:text-right text-2xl lg:text-3xl xl:text-4xl tracking-wider pb-3 leading-tight">Vous portez un projet de création de site internet à Toulouse ?</h2>
                        <br />
...
query lastsThreePostsCreationSiteInternetAgenPage {
    allWpPost(limit: 3) {
      edges {
        node {
          id
...
`
export default CreationSiteInternetAgenPage;
