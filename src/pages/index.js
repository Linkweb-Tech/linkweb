        ...
        <div className="w-full md:w-3/4 py-0 flex justify-end">
          <Accordion>
            <div className="w-full" label="UNE AUGMENTATION DE VOS CONTACTS PROSPECTS ?">
              <p>Vous souhaitez développer la <strong>stratégie de communication digitale</strong> de votre entreprise ?<br /> Développer la vente de vos produits ?<br /> Le <strong>retour sur investissement</strong> fait partie des objectifs communs à tous chefs d’entreprise.<br /> Pour trouver des nouveaux clients potentiels, il est nécessaire d’avoir une visibilité pertinente qui permet à chacun de consulter <strong>votre site internet</strong> et de leur donner envie de travailler avec vous.<br /> Un <strong>webdesign</strong> adapté, une <strong>expérience utilisateur</strong> et des outils digitaux bien construits vous permettront de <strong>créer un site internet</strong> performant.<br /> Dynamiser sa communication d’entreprise tout en la maîtrisant vous permettra de gagner en visibilité, mais également de toucher vos cibles afin d’obtenir des contacts qualifiés grâce à des <strong>projets web</strong> efficaces.<br /> Notre <strong>agence de création</strong> vous propose, grâce à nos compétences, un <strong>conseil en communication</strong> afin de parvenir aux objectifs fixés lors de la <strong>création de votre site internet</strong> vitrine ou <strong>site marchand</strong>.</p>
            </div>
