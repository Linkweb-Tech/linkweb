  ...
  render() {
    ...
    return (
      <Layout location="home">
        <SEO
          title="Agence Web Toulouse et Agen - Linkweb"
          description="Création de site internet sur-mesure près d’Agen et Toulouse - Définition stratégique - Accompagnement professionnel - Devis rapide et gratuit - 05 33 95 00 30."
        ...
        <section
          id="x"
          className="w-full md:w-6/12 bg-white flex mt-0 sm:mt-8 mb-8 flex-col md:flex-row items-center mx-auto justify-center"
        >
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-start items-start">
            ...
            <h2
              /*data-aos='fade-right'*/ className="text-center text-black text-4xl md:text-2xl lg:text-3xl xl:text-4xl century"
            >
              Choisissez bien{" "}
              <span className="text-bleu font-bold">la formule</span> qui vous
              correspond avec notre agence web à Toulouse
            </h2>
          </div>
        </section>
        <section className="flex flex-col lg:flex-row mx-8 lg:mx-24 my-0 items-center lg:justify-center">
          ...
          >
            <svg
              width="40px"
              className="svgtransform mx-auto block"
            ...
            <h3 className="text-center text-2xl text-black font-bold century">
              Création de site internet
            </h3>
            <hr className="blue"></hr>
            <p className="text-center px-6 text-md">
              <strong>Site internet</strong>
              <strong>
                {/*<Link className="text-bleu hover:text-black" to="/creation-site-internet-vitrine/">*/}{" "}
                vitrine{/*</Link>*/}
              </strong>
              ,{" "}
              <strong>
                {/*<Link className="text-bleu hover:text-black" to="/creer-une-boutique-en-ligne/">*/}
                e-commerce{/*</Link>*/}
              </strong>{" "}
              ou <strong>administrable</strong>, Linkweb{" "}
              <strong>crée votre site</strong> selon vos besoins.
            </p>
            <br />
            <ul className="text-bold text-center py-2">
              <li className="py-2 flex flex-row justify-center">
                ...
                <div className="w-9/12 text-left">
                  Design ergonomique et personnalisé
                </div>
              </li>
              <li className="py-2 flex flex-row justify-center">
                <div className="w-3/12 text-center text-bleu">✔</div>
                <div className="w-9/12 text-left">
                  Site adapté tous supports
                </div>
              </li>
              <li className="py-2 flex flex-row justify-center">
                <div className="w-3/12 text-center text-bleu">✔</div>
              ...
              <li className="py-2 flex flex-row justify-center">
                <div className="w-3/12 text-center text-bleu">✔</div>
                <div className="w-9/12 text-left">
                  Navigation sécurisée (protocole HTTPS)
                </div>
              </li>
              <li className="py-2 flex flex-row justify-center">
                <div className="w-3/12 text-center text-bleu">✔</div>
              ...
              <li className="py-2 flex flex-row justify-center">
                <div className="w-3/12 text-center font-extrabold text-bleu">
                  +
                </div>
                <div className="w-9/12 text-left">
                  <a
                    href="#creation-site-web"
                    className="text-bleu hover:text-black"
                  >
                    Plus d'informations
                  </a>
                </div>
            ...
            <div className="w-1/2 mx-auto block">
              ...
              <ButtonBlog
                url="/creation-site-internet-toulouse/"
                text="Créer votre site"
                color="darkgrey"
              />
            </div>
          </div>
          ...
          >
            ...
            >
              <g>
                <polygon
                  fill="#37cfee"
                  points="47,47 1,47 1,1 3,1 3,45 47,45  "
                />
                <g>
                  <path
                    fill="#37cfee"
                    d="M15.9,47H7.4V33h8.4V47z M9.4,45h4.4V35H9.4V45z"
                  />
                  <path
                    fill="#37cfee"
                    d="M28.7,47h-8.4V23h8.4V47z M22.3,45h4.4V25h-4.4V45z"
                  />
                  <path
                    fill="#37cfee"
                    d="M41.6,47h-8.4V13h8.4V47z M35.1,45h4.4V15h-4.4V45z"
                  />
                </g>
                <g>
                  <path
                  ...
                  <g>
                    <polygon
                      fill="#37cfee"
                      points="24.4,6 32.8,10.9 31,4.2    "
                    />
                  </g>
                </g>
              </g>
            </svg>
            <h3 className="text-center text-black text-2xl font-bold century">
              Référencement
            </h3>
            <hr className="blue"></hr>
            <p className="text-center px-6">
              Nous définissons et appliquons une{" "}
              <strong>
                stratégie de{" "}
                {/*<Link className="text-bleu hover:text-black" to="/referencement-toulouse/">*/}
                référencement web (SEO comme SEA){/*</Link>*/}
              </strong>{" "}
              adaptée à vos besoins et à la concurrence.
            </p>
            <br />
            <ul className="text-bold text-center py-2">
              <li className="py-2 flex flex-row justify-center">
              ...
              <li className="py-2 flex flex-row justify-center">
                ...
                <div className="w-9/12 text-left">
                  Campagne Ads{" "}
                  <a href="#referencement-ads">
                    <span className="cursor-pointer text-bleu hover:text-black">
                      (optionnel +)
                    </span>
                  </a>
                </div>
          ...
          >
            ...
            <hr className="blue"></hr>
            <p className="text-center px-6">
              Linkweb est à votre écoute pour la définition de votre{" "}
              {/*<Link className="text-bleu hover:text-black" to="/creation-site-internet-sur-mesure/">*/}
              <strong>solution</strong>
              {/*</Link>*/} à partir de vos besoins.
            </p>
            <br />
            <ul className="text-bold text-center py-2">
              <li className="py-2 flex flex-row justify-center">
                <div className="w-3/12 text-center text-bleu">✔</div>
                <div className="w-9/12 text-left">
                  Applications Métiers et Intranet
                </div>
              </li>
              <li className="py-2 flex flex-row justify-center">
                <div className="w-3/12 text-center text-bleu">✔</div>
              ...
              <li className="py-2 flex flex-row justify-center">
                <div className="w-3/12 text-center text-bleu">✔</div>
                <div className="w-9/12 text-left">
                  Création module de réservation
                </div>
              </li>
              <li className="py-2 flex flex-row justify-center">
                <div className="w-3/12 text-center text-bleu">✔</div>
                <div className="w-9/12 text-left">
                  Outil de personnalisation des produits
                </div>
              </li>
              <li className="py-2 flex flex-row justify-center">
                <div className="w-3/12 text-center text-bleu">✔</div>
        ...
        <section
          className="flex flex-col items-center my-24 century text-center lg:text-left"
          style={{
        ...
        >
          <div className="w-full lg:w-3/4 flex justify-around px-12 lg:px-24 mb-8 pt-24 lg:flex-row flex-col">
            <div className="max-w-3xl w-full lg:w-1/2 flex pr-0 lg:pr-32 flex-col mb-12">
              <span className="text-6xl text-bleu font-bold">+15 ans</span>
              <span className="text-4xl text-white mt-0 lg:-mt-5">
                d'expérience
              </span>

              <p className="text-white font-normal">
                Depuis 2008, notre <strong>agence web à Toulouse</strong> et{" "}
                <strong>Agen</strong> accompagne les professionnels pour
                développer leur <strong>visibilité sur le Web</strong>.
              </p>
            </div>
            <div className="max-w-3xl w-full lg:w-1/2 flex flex-col pl-0 lg:pl-32">
              <span className="text-6xl text-bleu font-bold">+20</span>
              <span className="text-4xl text-white mt-0 lg:-mt-5">
                techniciens
              </span>
              <p className="text-white font-normal">
                Chaque jour, ce sont plus de 20 techniciens qui officient au
                sein de notre{" "}
                <Link
                  to="/agence-web-agen/"
                  className="text-bleu hover:text-white font-bold"
                >
                  agence web à Agen
                </Link>{" "}
                pour rendre nos <strong>sites performants</strong>.
              </p>
            </div>
          </div>
          <div className="w-full lg:w-3/4 flex justify-around px-12 lg:px-24 pb-24 lg:flex-row flex-col">
            <div className="max-w-3xl w-full lg:w-1/2 flex pr-0 lg:pr-32 flex-col mb-12">
              <span className="text-6xl text-bleu font-bold">+300</span>
              <span className="text-4xl text-white mt-0 lg:-mt-5">
                sites en gestion
              </span>
              <p className="text-white font-normal">
                Notre agence <strong>crée des sites web</strong> pour des
                professionnels d'horizons parfois très différents : TPE, PME,
                indépendants, etc.
              </p>
            </div>
            <div className="max-w-3xl w-full lg:w-1/2 pl-0 lg:pl-32 flex flex-col mb-12">
              <span className="text-6xl text-bleu font-bold">4.6/5</span>
              <span className="text-4xl text-white mt-0 lg:-mt-5">
                sur Google
              </span>
              <p className="text-white font-normal">
                Nos clients sont satisfaits du travail engagé sur leur{" "}
                <strong>site</strong> par notre agence web. Note basée sur 117
                avis.
              </p>
            </div>
          </div>
        ...
        <section className=" w-full mx-auto px-4 py-0 my-0">
          ...
          >
            Conduire votre{" "}
            <span className="font-bold text-bleu">projet professionnel</span>{" "}
            avec notre agence web à Toulouse
          </h2>
          <hr className="blue"></hr>
          <h3
        ...
        <section className="bloctextimg w-full md:w-10/12 mx-auto lg:block lg:mx-auto xl:w-full flex flex-col lg:flex-row justify-center mt-10 mb-16">
          ...
          <div
            className="text century w-full text-justify mr-16 lg:w-3/5 xl:w-2/5 md:p-20 lg:pl-32 p-10 lg:py-10 text-black xl:text-md"
            style={{ backgroundColor: "#d3d3d352" }}
          >
            <h4 className="century text-lg">
              <span className="font-bold">
                Nos spécialistes s'attachent à développer une collaboration de
                qualité pour un projet qui vous ressemble grâce aux services
                professionnels de notre agence web à Toulouse.
              </span>
            </h4>
            <br />
            <p className="font-normal" style={{ fontSize: "16px" }}>
              Notre{" "}
              <strong className="font-normal">agence web toulousaine</strong>{" "}
              met tout en oeuvre pour vous accompagner dans le choix des{" "}
              <strong className="font-normal">stratégies web</strong> les plus
              pertinentes pour vous. Nous veillons à entretenir une relation
              régulière avec vous pour déterminer vos priorités ainsi que les
              nouvelles perspectives de{" "}
              <strong className="font-normal">développement</strong>. Le
              webmarketing est une discipline en perpétuel mouvement. C'est
              pourquoi, nos <strong className="font-normal">experts</strong>{" "}
              font le maximum pour vous développer une solution optimale et
              durable dans le temps.
              <br />
              <br />
              Les professionnels de Linkweb,{" "}
              <strong className="font-normal">
                agence web à Agen et Toulouse
              </strong>
              , vous accompagnent pour définir votre clientèle cible ainsi que
              des objectifs réalistes grâce à l'expertise de nos consultants à
              Toulouse. Nous possédons tous les{" "}
              <strong className="font-normal">outils professionnels</strong>{" "}
              pour mener à bien une stratégie qui répond à vos attentes. En
              étudiant le{" "}
              <strong className="font-normal">
                comportement des utilisateurs sur votre site
              </strong>
              , nous sommes en mesure d'identifier les actions à mettre en
              oeuvre pour atteindre les objectifs fixés pour votre{" "}
              <strong className="font-normal">entreprise</strong> dans toute la
              France.
              <br />
              <br />
              Notre objectif consiste à{" "}
              <strong className="font-normal">
                développer votre présence sur Internet
              </strong>{" "}
              en vue de tirer un profit maximal à partir de l'ensemble des
              opportunités qui pourront s'offrir à vous par le biais du{" "}
              <strong className="font-normal">web marketing</strong> :{" "}
              <strong className="font-normal">visibilité</strong>,{" "}
              <strong className="font-normal">notoriété</strong>,{" "}
              <strong className="font-normal">réputation</strong>,{" "}
              <strong className="font-normal">vente en ligne</strong> et prises
              de contact.
              <br />
            </p>
          </div>
        ...
        <h2
          /*data-aos='fade-right'*/ className="text-center text-black px-4 text-4xl century"
        >
          Développer votre solution web en{" "}
          <span className="font-bold text-bleu">partenariat</span> avec notre
        ...
        <section className="flex flex-col lg:flex-row flex-1 home-step my-3 px-4 xl:my-12 xl:px-24">
          <div className="w-full xl:w-1/3 one my-24 md:my-2 px-auto">
            <div className="flex items-center xl:items-start flex-col xl:flex-row flex-1">
              <div
                className="chiffres century text-bleu -mt-64 mb-6" /*data-aos="fade-up"*/
              >
                1
              </div>
              <section className="w-full lg:w-1/3 absolute z-10 px-auto lg:w-1/3 absolute px-12 lg:px-6 xl:px-24 pt-24">
                <h3
                  className="century capitalize text-2xl tracking-wider pb-3 leading-tight text-center" /*data-aos="zoom-in"*/
                >
                  <span className="text-bleu">/</span>JE SOUHAITE DYNAMISER MA
                  COMMUNICATION AVEC L'AGENCE LINKWEB À TOULOUSE
                </h3>
                <br />
                <div className="century content pb-6 text-center md:text-left ">
                  Faire appel à une{" "}
                  <strong>
                    {/*<Link to="agence-creation-site-web-toulouse/"
                                                    className="text-bleu font-bold hover:text-black">*/}
                    agence de création web{/*</Link>*/}
                  </strong>{" "}
                  est une étape à franchir pour{" "}
                  <strong>dynamiser sa communication</strong> et définir une{" "}
                  <strong>stratégie digitale</strong>.<br />
                  <br />
                  <strong>Propulser sa communication en ligne</strong> par{" "}
                  {/*<Link to="/agence-marketing-toulouse/"
                                             className="text-bleu hover:text-black font-bold">*/}
                  le <strong>webmarketing (marketing digital)</strong>
                  {/*</Link>*/} peut constituer un véritable moteur pour une
                  société. Les agences comme Linkweb constituent un partenaire
                  essentiel pour cela.
                </div>
            ...
            <div className="flex items-center xl:items-start flex-col xl:flex-row flex-1">
              ...
              <section className="w-full lg:w-1/3 absolute z-10 px-auto lg:w-1/3 absolute px-12 lg:px-6 xl:px-24 pt-24">
                <h3
                  className="century capitalize text-2xl tracking-wider pb-3 leading-tight text-center" /*data-aos="zoom-in"*/
                >
                  <span className="text-bleu">/</span>JE SUIS ACCOMPAGNÉ PAR UNE
                  AGENCE WEB À TOULOUSE POUR DÉFINIR MA SOLUTION
                </h3>
                <br />
                <div className="century content pb-6 text-center md:text-left">
                  <strong>Être visible</strong>, booster sa{" "}
                  <strong>notoriété</strong> ou bien son <strong>image</strong>{" "}
                  (<strong>e-réputation</strong> et{" "}
                  <strong>identité de marque</strong>) : il existe des solutions
                  web pour chaque professionnel.
                  <br />
                  <br /> Grâce à nos <strong>expertises</strong>, nous vous
                  accompagnons pour déterminer les{" "}
                  <strong>contours de votre stratégie</strong> selon votre{" "}
                  <strong>activité</strong> et{" "}
                  <strong>vos besoins en termes de communication</strong>.<br />
                  Une <strong>étude concurrentielle</strong> sera également
                  réalisée.
                </div>
            ...
            <div className="flex items-center xl:items-start flex-col xl:flex-row flex-1">
              ...
              <section className="w-full lg:w-1/3 absolute z-10 px-auto lg:w-1/3 absolute px-12 lg:px-6 xl:px-24 pt-24">
                <h3
                  className="century capitalize text-2xl tracking-wider pb-3 leading-tight text-center" /*data-aos="zoom-in"*/
                >
                  <span className="text-bleu">/</span>JE FAIS LE CHOIX D'EXPERTS
                  POUR MENER MON PROJET AVEC L'AGENCE LINKWEB À TOULOUSE
                </h3>
                <br />
                <div className="century content pb-6 text-center md:text-left">
                  Nos <strong>consultants en communication web</strong>{" "}
                  définissent les contours de votre projet, du choix de l'
                  <strong>hébergement</strong> jusqu'à l’
                  <strong>application de votre stratégie marketing</strong>.
                  <br />
                  <br /> Notre équipe est composée de spécialistes de la{" "}
                  <strong>conception de sites internet</strong>, de{" "}
                  <strong>référencement naturel (SEO)</strong> et{" "}
                  <strong>Ads</strong> qui font preuve de{" "}
                  <strong>réactivité</strong> dans le but de répondre à vos
                  attentes.
                </div>
        ...
        <section className="w-full mx-auto px-4 py-4 xl:px-48 mt-24 mb-0">
          ...
          >
            Un échantillon des{" "}
            <span className="text-bleu font-bold">réalisations</span> de notre
            agence web à Toulouse
          </h2>
        ...
        <section className=" century w-full mx-auto mt-12 lg:mt-24 px-4 py-0 pt-12 lg:pt-6 my-0">
          ...
          >
            ...
            {/*</Link>*/}
            <span className="text-center text-black text-4xl">
              Atteignez vos objectifs avec une stratégie digitale sur-mesure
            </span>
          </h2>
          <hr className="blue"></hr>
          <h3
            /*data-aos='fade-left'*/ className="text-xl text-grey text-center century italic pb-0"
          >
        ...
        <section className="tabPanel resp flex flex-1 w-full justify-end ml-0">
          <div className="w-full md:w-3/4 py-0 flex justify-end">
            <Accordion>
              <div
                className="w-full"
                label="UNE AUGMENTATION DE VOS CONTACTS PROSPECTS ?"
              >
                <p>
                  <span className="font-bold">
                    Vous souhaitez développer la{" "}
                    <strong>
                      <Link
                        to="/agence-de-communication-digitale/"
                        className="text-bleu hover:text-black font-bold"
                      >
                        stratégie de communication digitale
                      </Link>
                    </strong>{" "}
                    de votre société ? Développer la vente de vos produits ?
                  </span>
                  <br />
                  <br /> Le <strong>retour sur investissement</strong> fait
                  partie des objectifs communs à tous chefs d’entreprise.
                  Trouver de nouveaux prospects potentiels nécessite de pouvoir
                  être trouvé en ligne grâce au web marketing. C'est votre
                  présence en ligne et sur les moteurs de recherche qui
                  permettra de propulser <strong>votre site</strong> au premier
                  plan. Le contenu que vous allez proposer sur{" "}
                  <strong>votre site</strong> doit donner envie aux divers
                  acteurs (entreprises, associations, organismes) de travailler
                  avec vous.
                  <br />
                  <br /> Par ailleurs, le contenu n'est pas la seule clé pour
                  rendre votre site performant. En effet, un{" "}
                  <span className="font-bold">
                    <strong>webdesign</strong> adapté
                  </span>
                  , une{" "}
                  <span className="font-bold">
                    <strong>expérience utilisateur</strong> (
                    <strong>UX Design</strong>) et des{" "}
                    <strong>outils digitaux</strong> bien construits
                  </span>{" "}
                  vous permettront de <strong>créer un site internet</strong>{" "}
                  efficace.
                  <br />
                  <br /> Le <strong>site internet</strong> est un parfait outil
                  pour <strong>dynamiser sa communication d’entreprise</strong>{" "}
                  tout en la maîtrisant. Au-delà des objectifs d'image, le site
                  internet vous permettra de gagner en visibilité pour atteindre
                  vos cibles et obtenir des contacts qualifiés. De ce point de
                  vue, notre{" "}
                  <strong>
                    <Link
                      ...
                      className="text-bleu font-bold hover:text-black"
                    >
                      agence web à Montpellier
                    </Link>
                  </strong>{" "}
                  vous apporte toute l'expertise dont vous avez besoin pour
                  mener votre stratégie digitale en France. La méthode de
                  travail de nos professionnels (webmaster, consultant,
                  développeur, etc.) vous permettra d'atteindre vos objectifs
                  grâce à la mise en place et la mise en application de{" "}
                  <strong>projets en ligne</strong> efficaces.
                  <br />
                  <br />{" "}
                  <span className="font-bold">
                    En faisant le choix de <strong>nos solutions</strong>, notre{" "}
                    <strong>
                      <Link
                        to="/agence-creation-site-web-toulouse/"
                        className="text-bleu font-bold hover:text-black"
                      >
                        agence de création de sites web
                      </Link>
                    </strong>{" "}
                    vous propose, de part nos compétences en{" "}
                    <strong>référencement et développement web</strong>, un{" "}
                    <strong>conseil en communication</strong> afin de parvenir
                    aux objectifs fixés lors de la <strong>refonte</strong> ou
                    de la <strong>création de votre site</strong> vitrine ou{" "}
                    <strong>site marchand</strong>. Enfin, les agences SEO comme
                    Linkweb sont en mesure de vous fournir une solution
                    sur-mesure répondant aux besoins de votre société, mais
                    aussi du marché sur lequel vous souhaitez vous inscrire.
                  </span>
                </p>
              </div>
              <div label="UNE PRÉSENCE EN PREMIÈRE PAGE DE RÉSULTATS DES MOTEURS ?">
                <p>
                  ...
                  , nous accordons une importance toute particulière la{" "}
                  <strong>qualité de vos contenus</strong> et de chaque média
                  présents sur votre site. <strong>Être visible</strong> ne se
                  limite pas uniquement compte du critère quantitatif. Pour les{" "}
                  <Link
                    to="/agence-marketing-toulouse/"
                    className="text-bleu font-bold hover:text-black"
                  >
                    agences de marketing à Toulouse
                  </Link>{" "}
                  comme Linkweb, il s'agit de vous rendre accessible auprès{" "}
                  <span className="font-bold">
                    d'<strong>utilisateurs qualifiés</strong> qui seront plus à
                    même de répondre à vos attentes
                  </span>
                  . <br />
                  <br />
                  Dès la <strong>conception du site</strong>, nous élaborons une{" "}
                  <strong>stratégie de référencement naturel SEO</strong> qui,
                  grâce au travail de nos référenceurs certifiés Google,
                  répondra aux <strong>critères de qualité</strong> pour vous
                  permettre d'obtenir une{" "}
                  <span className="font-bold">
                    présence pérenne en{" "}
                    <strong>première page sur des requêtes pertinentes</strong>
                  </span>
                  .<br />
                  <br />
                  Pour des résultats rapides, nous collaborons pour définir
                  votre <strong>campagne Adwords</strong> : nous planifions
                  votre <strong>plan publicitaire</strong> pour une{" "}
                  <span className="font-bold">
                    <strong>
                      visibilité immédiate sur les mots clés les plus recherchés
                    </strong>
                  </span>{" "}
                  dans le but de vous apporter un{" "}
                  <strong>retour concret sur votre investissement</strong> grâce
                  au référencement. Bien sûr, nous travaillons pour vous
                  proposer une interface intuitive (compatible pour le mobile,
                  comme pour chaque taille d'écran), adaptée à{" "}
                  <strong>votre identité graphique et visuelle</strong> ainsi
                  qu'à votre vision.
                </p>
              </div>
              <div label="UN ACCROISSEMENT DE VOTRE CHIFFRE D'AFFAIRES ?">
                <p>
                  <span className="font-bold">
                    Accroître le chiffre d'affaires de son entreprise en France
                    grâce au Web ? C'est possible !
                  </span>
                  <br />
                  <br />
                  En mettant en place une <strong>
                    stratégie digitale
                  </strong>{" "}
                  cohérente et pertinente vous aurez l'occasion de développer la{" "}
                  <strong>communication en ligne</strong> de votre société via
                  le canal le plus consulté en France et dans le monde :
                  Internet.
                  <br />
                  <br />
                  Un plan de communication construit pour convertir vous
                  permettra de{" "}
                  <span className="font-bold">
                    développer le chiffre d’affaires de votre société
                  </span>{" "}
                  avec un <strong>projet web</strong> marketing personnalisé :
                  référencement naturel, Google Ads, etc.
                  <br />
                  <br />
                  <strong>Avoir un site</strong> professionnel est un{" "}
                  <span className="font-bold">
                    gage de confiance vis-à-vis de vos prospects
                  </span>{" "}
                  (entreprises et organismes ciblés). Faire appel à une{" "}
                  <strong>
                    <Link
                      to="/agence-web-marseille/"
                      className="text-bleu hover:text-black font-bold"
                    >
                      agence web comme Linkweb à Marseille
                    </Link>
                    ,
                  </strong>{" "}
                  spécialisée dans la <strong>création de site internet</strong>{" "}
                  pour développer un outil rentable est conseillé : ce choix
                  vous permettra d'accéder à{" "}
                  <span className="font-bold">
                    une solution construite à partir de vos besoins, mais aussi
              ...
              <div label="LA CRÉATION DE VOTRE IMAGE DE MARQUE ?">
                <p>
                  Linkweb fait partie des <strong>agences en France</strong> qui
                  définissent des{" "}
                  <span className="font-bold">
                    stratégies en parfait accord avec les projets des
                    professionnels
                  </span>
                  . Nous mettons le{" "}
                  <strong>digital au coeur de votre stratégie</strong> pour vous
                  permettre de poursuivre des objectifs de positionnement, mais
                  également de branding.
                  <br />
                  <br />
                  En effet, la{" "}
                  <span className="font-bold">
                    <strong>formation de votre image de marque</strong>
                  </span>{" "}
                  passe avant tout par une interconnexion entre chaque media
                  (réseaux sociaux, site internet, newsletter, etc.) dont vous
                  disposez. Notre entreprise est{" "}
                  <span className="font-bold">
                    spécialisée dans les{" "}
                    <strong>problématiques du digital</strong>
                  </span>{" "}
                  (de la mise en place d'interface mobile au développement du
                  web design de vos sites internet) et vous apporte un conseil
                  pertinent ainsi qu'un accompagnement personnalisé en fonction
                  de vos besoins et de votre activité.
                  <br />
                  <br />
                  Les{" "}
                  <strong>
                    agences comme Linkweb en France (d'Auch à Saint-Etienne, en
                    passant par Albi, etc.)
                  </strong>{" "}
                  ont pour ambition de{" "}
                  <span className="font-bold">
                    conduire vos projets jusqu'au succès
                  </span>
                  , que ce soit en termes d’<strong>image</strong>, de{" "}
                  <strong>visibilité</strong>, mais également de{" "}
                  <strong>conversion</strong>. Enfin, notre agence met tout en
                  oeuvre pour produire un site web en parfaite harmonie avec
                  votre identité visuelle (logo, typographie, couleurs,
                  illustration, vidéo, etc.)
                </p>
              </div>
            </Accordion>
          </div>
        ...
        <section className="w-full flex my-12 flex-col lg:flex-row text-white bg-bleu century items-center text-center lg:text-justify px-4 lg:px-16 xl:px-48 py-16">
          <div className="w-full lg:w-8/12 text-xl lg:text-2xl">
            <h3>
              Vous désirez mener un{" "}
              <span className="font-bold">projet similaire</span> avec notre
              agence web à Toulouse ?
            </h3>
            <h4>
              Linkweb définit votre projet digital en accord avec vos{" "}
              <span className="font-bold">ambitions</span>.
            </h4>
          </div>
        ...
        <section className=" w-full bg-white mx-auto century px-4  md:px-24  py-2 mt-6 mb-6">
          <h2 className="mx-auto  text-center text-black text-4xl century">
            Vous souhaitez contacter l'agence digitale Linkweb <br />à Toulouse
            ?
          </h2>
          <hr className="blue"></hr>
          <br />
          <section className="flex flex-wrap flex-column md:flex-row justify-center items-center ">
              ...
              <div className="w-full flex flex-col items-end pt-10 bg-white   text-center text-black text-4xl century relative">
                <div className="w-2/3 flex flex-row justify-start mx-auto">
                  <div className="w-2/12 flex items-center">
                    <svg width="25px" viewBox="0 0 1152.7139 1440.550375">
                      <g transform="translate(27692.221,9619.4771)">
                        <path d="" fill="#37cfee" />
                        <path
                  ...
                  <div className="w10/12">
                    <h3 className="lg:text-xl text-lg">
                      10 rue Albert Ferrasse, 47550 Boé (près d'Agen)
                    </h3>
                    <hr className="blue" />
                    <h3 className="lg:text-xl text-lg">
                      44 rue de Bayard, 31000 Toulouse
                    </h3>
                  </div>
                </div>
                <div className="w-2/3 flex flex-row my-8 justify-start mx-auto">
                  <div className="w-2/12">
                    <svg width="30px" viewBox="0 0 333 416.25">
                      <g>
                        <path
                          fill="#37cfee"
                          className="fil0"
                          d="M167 33c73,0 133,60 133,134 0,73 -60,133 -133,133 -74,0 -134,-60 -134,-133 0,-74 60,-134 134,-134zm58 212l22 -22c0,0 3,-7 -2,-13 -5,-5 -32,-19 -32,-19 0,0 -6,-4 -13,4 -8,7 -7,7 -7,7 0,0 -4,3 -9,1 -19,-10 -44,-35 -54,-54 -2,-4 1,-8 1,-8 0,0 0,0 8,-7 7,-8 3,-14 3,-14 0,0 -13,-27 -19,-32 -6,-5 -13,-1 -13,-1l-21 21c-24,49 88,161 136,137z"
                        />
                      </g>
                    </svg>
                  </div>
                  <div className="w-10/12">
                    <h3 className="text-lg lg:text-xl lg:text-left text-center">
                      <a
                        className="text-bleu hover:text-black"
                        href="tel:0533950030"
                      >
                ...
                <div className="w-2/3 flex flex-row my-8 justify-start mx-auto">
                  <div className="w-2/12">
                    <svg width="30px" viewBox="0 0 100 125">
                      <path
                        fill="#37cfee"
                        d="M91.462,32.483c-2.267-5.358-5.511-10.17-9.644-14.303c-4.132-4.132-8.943-7.376-14.303-9.643  C61.967,6.191,56.074,5.001,50,5.001s-11.968,1.19-17.516,3.537c-5.358,2.267-10.171,5.511-14.303,9.643  c-4.133,4.132-7.377,8.944-9.644,14.303C6.191,38.032,5.002,43.925,5.002,50c0,6.075,1.189,11.967,3.536,17.516  c2.267,5.357,5.511,10.17,9.644,14.303c4.132,4.131,8.944,7.375,14.303,9.643c5.548,2.346,11.441,3.537,17.516,3.537  s11.967-1.191,17.516-3.537c5.359-2.268,10.171-5.512,14.303-9.643c4.133-4.133,7.377-8.945,9.644-14.303  c2.347-5.549,3.536-11.441,3.536-17.516C94.998,43.925,93.809,38.032,91.462,32.483z M77.414,66.063  c0,0.201-0.164,0.363-0.365,0.363H22.951c-0.201,0-0.364-0.162-0.364-0.363v-20.91c0-0.131,0.069-0.25,0.182-0.316  c0.112-0.064,0.251-0.064,0.364,0L50,60.295l26.867-15.458c0.113-0.064,0.252-0.064,0.364,0c0.112,0.066,0.183,0.186,0.183,0.316  V66.063z M77.414,38.708c0,0.13-0.07,0.251-0.184,0.315L50.182,54.588c-0.057,0.031-0.119,0.049-0.182,0.049  s-0.125-0.018-0.182-0.049L22.77,39.023c-0.113-0.064-0.183-0.186-0.183-0.315v-4.771c0-0.201,0.163-0.364,0.364-0.364h54.098  c0.201,0,0.365,0.163,0.365,0.364V38.708z"
                      />
                    </svg>
                  </div>
                  <div className="w-10/12">
                    <h3 className="text-lg lg:text-xl lg:text-left text-center">
                      <a
                        className="text-bleu hover:text-black"
                        href="mailto:contact@linkweb.fr"
                      >
                        contact@linkweb.fr
                      </a>
                    </h3>
            ...
            <div
              className="w-full xl:w-1/3 order-2 xl:order-3 px-4"
              style={{ height: "500px" }}
            >
              <GoogleMapReact
                bootstrapURLKeys={{
                  key: "AIzaSyCPh6TRRONtNAdF-ZTswCzJIgXjWoK7VTQ",
                }}
