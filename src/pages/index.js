    ...
    <Layout location="home">
        ...
        />
          ...
          > */}
                        ...
                        <section id="creation-site-web" className="popup flex flex-col xl:flex-row w-full justify-center mx-auto py-6 my-4">
                          <div className="popup-inner">
                          <div className="w-full flex justify-end xl:w-1/2 py-12">
                          ...
                          <div className="blocrea w-3/4 xl:w-1/3 px-12 pt-8 lg:pt-16 lg:my-0 -my-64 shadow-xl max-h-auto mx-10 lg:mx-0 py-6 lg:py-12 xl:px-12 text-white flex flex-col justify-center" style={{backgroundColor:'rgba(62, 62, 62, 0.95)'}}>
                              <Link to="/creation-de-site-internet-a-agen/"><h2 className="century text-xl lg:text-3xl tracking-wider">
                      ...
                      <section id="referencement-web" className="popup flex flex-col xl:flex-row w-full justify-center mx-auto py-6 my-4">
                          <div className="popup-inner blocref">
                          ...
                          <div className="blocref w-3/4 xl:w-1/3 px-12 pt-8 lg:pt-16 lg:my-0 -my-64 shadow-xl max-h-auto mx-10 lg:mx-0 py-6 lg:py-12 xl:px-12 text-white flex flex-col justify-center bg-grey" /*data-aos="fade-left"*/>
                              <Link to="/referencement-de-site-internet-47-31/"><h2 className="century text-xl lg:text-3xl tracking-wider" /*data-aos="zoom-in"*/>
                              ...
                              <Button url="/referencement-de-site-internet-47-31/" text="En savoir plus sur le référencement naturel SEO" color="white" position="start" />
                          </div>
                              <a class="popup__close" href="#x">X</a>
                            </div>
                      </section>
                      <section id="solution-sur-mesure" className="popup flex flex-col xl:flex-row w-full justify-center mx-auto py-6 my-4">
                          <div className="popup-inner blocref">
                          <div /*data-aos="fade-right"*/ className="w-full flex justify-end xl:w-1/2 py-12">
                              <img width="850px" className="h-full justify-end order-last lg:order-first" src={sitesurmesure} alt="Agence Adwords Toulouse"/>
                          </div>
                          <div className="blocref w-3/4 xl:w-1/3 px-12 pt-8 lg:pt-16 lg:my-0 -my-64 shadow-xl max-h-auto mx-10 lg:mx-0 py-6 lg:py-12 xl:px-12 text-black flex flex-col justify-center" /*data-aos="fade-left"*/ style={{backgroundColor:'rgb(211, 211, 211,0.80)'}}>
                              ...
                              <Button url="/creation-de-site-internet-47-31/" text="En savoir plus sur les solutions web sur-mesure" position="start" />
                              </div>
                              <a class="popup__close" href="#x">X</a>
                            </div>
                      </section>
                      <section id="referencement-ads" className="popup flex flex-col xl:flex-row w-full justify-center mx-auto py-6 my-4">
                      <div className="popup-inner blocref">
                      <div /*data-aos="fade-left"*/ className="w-full lg:mt-0 mt-48 xl:w-1/2 py-10">
                            ...
                            <div className="blocref w-3/4 xl:w-1/3 px-12 pt-8 lg:pt-16 lg:mt-0 -mt-64 lg:my-0 order-last lg:order-first shadow-xl max-h-auto mx-10 lg:mx-0 py-6 lg:py-12 xl:px-12 text-white bg-grey flex flex-col justify-center" /*data-aos="fade-right"*/>
                              <Link to="/agence-adwords-47-31/"><h2 className="century text-xl lg:text-4xl tracking-wider" /*data-aos="zoom-in"*/>
                              ...
                              <br/>
                              <Button url="/agence-adwords-47-31/" color="white" text="En savoir plus sur les campagnes Adwords SEA" position="start" />
                              </p>
                            </div>
                              <a class="popup__close" href="#x">X</a>
                            </div>
        ...
        <section id="x" className="max-w-md w-full mx-auto mt-12 px-4 py-0 my-0">
          <h2 /*data-aos='fade-right'*/ className="text-center">
            <Link to="/agence-web-toulouse/" className="text-center text-black text-4xl century hover:text-bleu">
          ...
          <section className="flex flex-col lg:flex-row mx-8 lg:mx-24 my-0 items-center lg:justify-center">
                         <div data-aos="fade-in" className=" w-full lg:w-3/12 bg-white my-4 border border-darkgrey mx-10 hover:shadow-xl py-6 century" style={{borderRadius:'15px', borderColor:'#d4d4d4',transform: 'translateZ(0) scale(1)', transition:'0.3s'}}>
                              ...
                              <a href="#creation-site-web"><h3 className="text-center text-2xl font-bold century">Création de site internet</h3></a>
                             <hr className="blue"></hr>
                         ...
                         <div data-aos="fade-in" data-aos-delay="300"  className=" w-full lg:w-3/12 bg-white my-12 border border-darkgrey mx-8 hover:shadow-xl py-6 century" style={{borderRadius:'15px', borderColor:'#d4d4d4',transform: 'translateZ(0) scale(1)', transition:'0.3s'}}>
                         ...
                         <a href="#referencement-web"><h3 className="text-center text-2xl font-bold century">Référencement Web</h3></a>
                             <hr className="blue"></hr>
                             <p className="text-center px-6">Nous définissons et appliquons une stratégie de <Link className="text-bleu hover:text-black" to="/agence-referencement-toulouse/">référencement web</Link> adaptée à vos besoins et à la concurrence.</p>
                             <br/>
                             <ul className="text-bold text-center py-2">
                                 <li className="py-2 flex flex-row justify-center">
                                     <div className="w-3/12 text-center text-bleu">✔</div> 
                                 ...
                                 <li className="py-2 flex flex-row justify-center">
                                  ...
                                  <li className="py-2 flex flex-row justify-center">
                                     <div className="w-3/12 text-center text-bleu">✔</div> 
                                     <div className="w-9/12 text-left">Campagne Google Ads <a href="#referencement-ads"><span className="cursor-pointer text-bleu hover:text-black">(optionnel +)</span></a></div>
                                  </li>
                             </ul>
                             <div className="w-1/2 mx-auto block">
                             <br/>
                         ...
                         <div data-aos="fade-in" data-aos-delay="700" className=" w-full lg:w-3/12 bg-white my-12 border border-grey mx-8 hover:shadow-xl py-6 century" style={{borderRadius:'15px', borderColor:'#d4d4d4', transform: 'translateZ(0) scale(1)', transition:'0.3s'}}>
                             ...
                             <a href="#solution-sur-mesure"><h3 className="text-center text-2xl font-bold century">Solution sur-mesure</h3></a>
                             <hr className="blue"></hr>
                             <p className="text-center px-6">Linkweb est à votre écoute pour la définition de votre <Link className="text-bleu hover:text-black" to="/creation-de-site-internet-47-31/">projet sur-mesure</Link> en fonction de vos besoins.</p>
                             <br/>
                             <ul className="text-bold text-center py-2">
                                 <li className="py-2 flex flex-row justify-center">
                                     <div className="w-3/12 text-center text-bleu">✔</div> 
        ...
        <div className="w-full lg:w-3/4 flex justify-around px-12 lg:px-24 mb-8 pt-24 lg:flex-row flex-col">
          <div className="max-w-3xl w-full lg:w-1/2 flex pr-0 lg:pr-32 flex-col mb-12">
            ...
            <p className="text-white font-normal">
              Depuis 2008, nous accompagnons nos clients pour développer leur visibilité sur le Web.
            </p>
          </div>
          <div className="max-w-3xl w-full lg:w-1/2 flex flex-col pl-0 lg:pl-32">
            ...
            <p className="text-white font-normal">
              Chaque jour, ce sont plus de 20 techniciens qui officient pour rendre nos sites web performants.
            </p>
          </div>
          </div>
          ...
          <div className="max-w-3xl w-full lg:w-1/2 flex pr-0 lg:pr-32 flex-col mb-12">
            ...
            <p className="text-white font-normal">
              Nous créons des sites web pour des clients d'horizons parfois très différents : TPE, PME, indépendants, etc.
            </p>
          </div>
          <div className="max-w-3xl w-full lg:w-1/2 pl-0 lg:pl-32 flex flex-col mb-12">
            ...
            <p className="text-white font-normal">
              Nos clients sont satisfaits du travail engagé sur leur site web.<br/>Note basée sur 65 avis de clients.
            </p>
          </div>
        </div>
        <div className="w-2/3 -mt-16 mb-12">
          <Button url="/agence-web-toulouse/" color="white" text="Découvrir notre agence web à Toulouse" position="center" />
        </div>
        </section>
          ...
          <div className="w-full xl:w-1/3 two px-auto">
            ...
            <div className="chiffres century text-bleu -mt-64 mb-6" /*data-aos="fade-up"*/>2</div>
              <section className="w-full lg:w-1/3 absolute z-10 px-auto lg:w-1/3 absolute px-12 lg:px-24 pt-24">
                ...
                <div className="century content pb-6 text-justify" style={{textAlignLast:'center'}}>
                  Besoins en termes de <strong>visibilité</strong>, <strong>notoriété</strong> ou bien d’<strong>image</strong> (<strong>e-réputation</strong>) : il existe des solutions pour chaque entreprise. Grâce à nos <strong>expertises</strong>, nous vous accompagnons pour déterminer les <strong>contours de votre projet</strong> selon votre <strong>activité</strong> et <strong>vos besoins en termes de communication</strong>. Une <strong>étude concurrentielle</strong> sera également réalisée.
                </div>
        ...
        <section className="max-w-2xl w-full mx-auto px-4 py-0 mt-12 mb-0">
          <h2 /*data-aos='fade-right'*/ className="text-center text-black text-4xl century">
              Création de site internet à Toulouse :<span className="font-bold text-black text-center text-4xl century"> Ils ont fait <span className="font-bold">confiance</span> à <span className="font-bold">Linkweb</span></span>
          </h2>
          <hr className="blue"></hr>
          <br/>
        </section>
        ...
        <section className="max-w-6xl mx-auto flex flex-col md:flex-row align-center justify-center century text-center mt-3 px-6 mb-12">
                          <div className="w-full md:w-1/3 px-3 flex flex-col align-center justify-center" /*data-aos="fade-up"*/>
                              ...
                              <div className="italic text-sm">« L'agence Linkweb Agen est toujours disponible et a l'écoute. Elle contribue à notre développement, et nous accorde du temps et de l'énergie pour nous assurer une bonne visibilité sur internet. Nous sommes très satisfaits de leur travail et souhaitions les en remercier via ce commentaire ! Équipe agréable et bienveillante ! »</div>
                          </div>
                          <br/>
                          <div className="w-full md:w-1/3 px-3 flex flex-col align-center justify-center" /*data-aos="fade-up" data-aos-delay="300"*/>
                              ...
                              <div className="italic text-sm">« L'équipe Linkweb répond toujours à l'attente de nos demandes et fait vivre le site de façon très dynamique. [...] Depuis le début de notre collaboration, en 2015, nous trouvons des interlocuteurs à notre écoute, compétents et, cerise sur le gâteau , très sympathiques. Cette culture d'entreprise rejaillit de façon positive sur la qualité du travail. Rejoignez les. »</div>
                          </div><br/>
                      ...
                      <section className="max-w-2xl century w-full mx-auto mt-12 lg:mt-12 px-4 py-0 pt-12 lg:pt-6 my-0">
                        ...
                        <Link to="/creation-site-internet-toulouse/" className="text-center text-black text-4xl century hover:text-bleu">
                          Création de site internet à Toulouse :</Link><br/>
