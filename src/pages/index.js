    ...
    <Layout location="home">
      ...
      <section className="flex flex-col lg:flex-row mx-8 lg:mx-24 my-0 items-center lg:justify-center">
        ...
        <div data-aos="fade-in" data-aos-delay="300" className=" w-full md:w-1/2 lg:w-3/12 bg-white my-12 border border-darkgrey mx-8 hover:shadow-xl py-6 century" style={{ borderRadius: '15px', borderColor: '#d4d4d4', transform: 'translateZ(0) scale(1)', transition: '0.3s' }}>
          ...
          <hr className="blue"></hr>
          <p className="text-center px-6">Nous définissons et appliquons une <strong>stratégie de {/*<Link className="text-bleu hover:text-black" to="/referencement-toulouse/">*/}référencement web (SEO comme SEA){/*</Link>*/}</strong> adaptée à vos besoins et à la concurrence.</p>
          <br />
          <ul className="text-bold text-center py-2">
            <li className="py-2 flex flex-row justify-center">
              <div className="w-3/12 text-center text-bleu">✔</div>
          ...
          <div className="flex items-center xl:items-start flex-col xl:flex-row flex-1">
            ...
            <section className="w-full lg:w-1/3 absolute z-10 px-auto lg:w-1/3 absolute px-12 lg:px-6 xl:px-24 pt-24">
              ...
              <div className="century content pb-6 text-justify" style={{ textAlignLast: 'center' }}>
                Faire appel à une <strong><Link to="agence-creation-site-web-toulouse/" className="text-bleu font-bold hover:text-black">agence de création web</Link></strong> est une étape à franchir pour <strong>dynamiser sa communication</strong> et définir une <strong>stratégie digitale</strong>. En effet, il est recommandé de bénéficier d'une expertise pour poursuivre des objectifs bien précis. <strong>Propulser sa communication en ligne</strong> par <Link to="/agence-marketing-toulouse/" className="text-bleu hover:text-black font-bold">le <strong>webmarketing (marketing digital)</strong></Link> peut constituer un véritable moteur pour une société. Les agences comme Linkweb constituent un partenaire essentiel pour cela.
                </div>
        ...
        <div className="w-full xl:w-1/3 three px-auto">
          <div className="flex items-center xl:items-start flex-col xl:flex-row flex-1">
            ...
            <section className="w-full lg:w-1/3 absolute z-10 px-auto lg:w-1/3 absolute px-12 lg:px-6 xl:px-24 pt-24">
              ...
              <div className="century content pb-6 text-justify" style={{ textAlignLast: 'center' }}>
                Nos <strong>consultants en communication web</strong> définissent les contours de votre projet, du choix de l'<strong>hébergement</strong> jusqu'à l’<strong>application de votre stratégie marketing</strong> à travers les différents axes définis. Notre équipe est composée de spécialistes de la <strong>conception de sites internet</strong>, de <strong>référencement naturel (SEO)</strong> et <strong>Ads</strong> qui font preuve de <strong>réactivité</strong> dans le but de répondre à vos attentes.
                </div>
        ...
        <div className="w-full md:w-3/4 py-0 flex justify-end">
          <Accordion>
            <div className="w-full" label="UNE AUGMENTATION DE VOS CONTACTS PROSPECTS ?">
              <p><span className="font-bold">Vous souhaitez développer la <strong><Link to="/agence-de-communication-digitale/" className="text-bleu hover:text-black font-bold">stratégie de communication digitale</Link></strong> de votre société ? Développer la vente de vos produits ?</span><br /><br /> Le <strong>retour sur investissement</strong> fait partie des objectifs communs à tous chefs d’entreprise. Trouver de nouveaux prospects potentiels nécessite de pouvoir être trouvé en ligne grâce au web marketing. C'est votre présence en ligne et sur les moteurs de recherche qui permettra de propulser <strong>votre site</strong> au premier plan. Le contenu que vous allez proposer sur <strong>votre site</strong> doit donner envie aux divers acteurs (entreprises, associations, organismes) de travailler avec vous.<br /><br /> Par ailleurs, le contenu n'est pas la seule clé pour rendre votre site performant. En effet, un <span className="font-bold"><strong>webdesign</strong> adapté</span>, une <span className="font-bold"><strong>expérience utilisateur</strong> (<strong>UX Design</strong>) et des <strong>outils digitaux</strong> bien construits</span> vous permettront de <strong>créer un site internet</strong> efficace.<br /><br /> Le <strong>site internet</strong> est un parfait outil pour <strong>dynamiser sa communication d’entreprise</strong> tout en la maîtrisant. Au-delà des objectifs d'image, le site internet vous permettra de gagner en visibilité pour atteindre vos cibles et obtenir des contacts qualifiés. De ce point de vue, notre <strong>agence web</strong> vous apporte toute l'expertise dont vous avez besoin pour mener votre stratégie digitale en France. Notre méthode de travail vous permettra d'atteindre vos objectifs grâce à la mise en place et la mise en application de <strong>projets en ligne</strong> efficaces.<br /><br /> <span className="font-bold">En faisant le choix de <strong>nos solutions</strong>, notre <strong>agence de création</strong> vous propose, de part nos compétences en <strong>référencement et développement web</strong>, un <strong>conseil en communication</strong> afin de parvenir aux objectifs fixés lors de la <strong>refonte</strong> ou de la <strong>création de votre site</strong> vitrine ou <strong>site marchand</strong>. Enfin, les agences SEO comme Linkweb sont en mesure de vous fournir une solution sur-mesure répondant aux besoins de votre société, mais aussi du marché sur lequel vous souhaitez vous inscrire.</span></p>
            </div>
            ...
            <div label="LA CRÉATION DE VOTRE IMAGE DE MARQUE ?">
              <p>Linkweb fait partie des <strong>agences en France</strong> qui définissent des <span className="font-bold">stratégies en parfait accord avec les projets des professionnels</span>. Nous mettons le <strong>digital au coeur de votre stratégie</strong> pour vous permettre de poursuivre des objectifs de positionnement, mais également de branding.
               ...
               <br/><br/>En effet, la <span className="font-bold"><strong>formation de votre image de marque</strong></span> passe avant tout par une interconnexion entre chaque media (réseaux sociaux, site internet, newsletter, etc.) dont vous disposez. Notre entreprise est <span className="font-bold">spécialisée dans les <strong>problématiques du digital</strong></span> (de la mise en place d'interface mobile au développement du web design de vos sites internet) et vous apporte un conseil pertinent ainsi qu'un accompagnement personnalisé en fonction de vos besoins et de votre activité.

               <br/><br/>Les <strong>agences comme Linkweb en France</strong> ont pour ambition de <span className="font-bold">conduire vos projets jusqu'au succès</span>, que ce soit en termes d’<strong>image</strong>, de <strong>visibilité</strong>, mais également de <strong>conversion</strong>.</p>
            </div>
          </Accordion>
        </div>
      </section>
