                ...
                <section>
                    ...
                    <section className=" w-full lg:h-screen flex flex-col justify-center items-end px-4 pt-12 pb-0 my-2 bg-cover my-24" style={{ background: '#6a6a6a url( ' + bgDev + ')', backgroundBlendMode: 'multiply', backgroundSize: 'cover' }}>
                        ...
                        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start text-center my-12">
                            ...
                            <div className="w-full my-4 md:w-1/3 px-12 flex flex-col items-center justify-center sm:my-0 my-6" data-aos='zoom-in' data-aos-delay="400">
