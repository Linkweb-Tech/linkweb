    ...
    render() {
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    title="Agence Web Agen - Création site internet - Linkweb"
                ...
                <section className="flex items-center justify-start w-full mx-auto pb-0 my-32 md:my-42 lg:my-42 xl:my-48 px-4 py-6 bg-black flex flex-col justify-center items-center" style={{ background: '#000000ad url(' + arriereplan + ')', backgroundBlendMode: 'overlay', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    <div className="max-w-6xl mx-auto lg:mx-56 py-2 w-full flex-col items-end">
                        <div className="w-full lg:w-2/3 flex justify-center lg:justify-start">
                            <h1 className="text-5xl my-10 font-bold text-center lg:text-left text-white century leading-tight">Agence web Agen - Création site internet</h1>
                        </div>
                        <br />
                        <h2 className="flex mb-16 full lg:w-3/5 text-white justify-center lg:justify-start mx-auto lg:mx-0 text-xl  century text-center lg:text-left p-1 uppercase -mt-12">Refonte, création et référencement de site internet à Agen.</h2>
                ...
                <section className="w-full lg:w-3/5 px-10 mt-16 lg:-mt-48 mb-16 lg:mb-48">
                    ...
                    Les équipes de Linkweb sont composées d'experts dans leurs domaines de prédilection pour dynamiser votre communication et faire de votre projet une réussite. 
                    </h3>
                </section>
                ...
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    ...
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + webdesign + ')' }}>
                        ...
                        <p className="text century text-lg lg:text-sm xl:text-lg z-50">
                        La <strong className="font-normal">création de campagnes Adwords</strong> est une alternative pour pallier aux délais engendrés par le référencement naturel, mais elle peut être aussi complémentaire. En effet, se lancer dans la <strong className="font-normal">publicité ciblée en ligne</strong> est une manière pertinente d’obtenir de la visibilité très rapidement. Si ces campagnes ont un coût, notre <strong className="font-normal"><a href="/agence-web-strasbourg/" className="text-bleu hover:text-white font-bold">agence web présente à Strasbourg</a></strong> vous accompagne pour maximiser au mieux vos chances d’obtenir un retour sur investissement.
                        <br /><br />Investir dans la publicité en ligne demande d’obtenir une certaine rentabilité. C’est pourquoi, un <strong className="font-normal">expert Adwords</strong> vous accompagne pour paramétrer vos annonces et groupes d’annonces en vue de maximiser vos profits en attirant des utilisateurs prêts à interagir avec votre site internet et à faire appel à vos services.</p>
                    </div>
                </section>
                        ...
                        <div className="w-full lg:w-1/2 my-10  flex flex-col">
                            ...
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full px-12 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <p className="w-full century pb-6 text-lg md:text-xl text-justify">Nos clients sont satisfaits du travail engagé sur leur site. Note basée sur 117 avis.
                                    </p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                                </div>
                            </div>
