...
import Bg from "../images/creation-site-internet-bordeaux.jpg";
...
class CreationSiteInternetBordeauxPage extends React.Component {
    ...
    render(){
        ...
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    title="Création de Site Internet à Bordeaux - Agence Web Linkweb"
                    description="Création de site internet à Bordeaux. Devis gratuit – Accompagnement professionnel - Suivi régulier et personnalisé."
                    keywords={[`Création site internet Bordeaux`, `Création site internet Bordeaux`, `Création site web Bordeaux`, `Création site web Bordeaux`]}
                    url="https://linkweb.fr/creation-site-internet-bordeaux/"
                    nom="Création de site internet à Bordeaux"
                ...
                > */}
                    ...
                    <section className="w-full bloctitrescreen mx-auto px-10 sm:px-4 py-6 bg-no-repeat bg-cover flex flex-col justify-center items-center" style={{ background:'#000000b3 url(' + Bg + ')', backgroundBlendMode:'multiply', backgroundPosition:'bottom', backgroundSize:'cover' }}>
                        <h1 /*data-aos="fade-up" data-aos-delay="500"*/ className="century text-4xl sm:text-6xl text-center text-white">
                        Création de site internet à Bordeaux
                        </h1>
                    ...
                    <section className="max-w-5xl w-full mx-auto px-12 py-6 my-4 century">
                        <h2 className="text-justify text-xl font-bold" style={{textAlignLast:'center'}}>
                            Depuis 2008, Linkweb est à l'origine de la création de sites internet pour des entreprises de Gironde (33) issues d'horizons différents. Notre rôle est de vous accompagner pour atteindre vos objectifs de visibilité sur le Web.
                        </h2>
                    ...
                    <section className="flex w-full flex-col lg:flex-row mx-auto px-4 py-6 my-4">
                        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center">
                            <img src={imac} className="mx-auto flex my-6" alt="Création site internet Bordeaux"/>
                        </div>
                    ...
                    <section className="max-w-5xl w-full mx-auto px-4 pt-12 pb-0 my-2">
                        ...
                        <hr className="blue"></hr>
                        <h3 /*data-aos="fade-in"*/ className="text-center font-normal italic century text-sm">Création de site internet à Bordeaux</h3>
                    </section>
                    ...
                    <section className="max-w-5xl w-full mx-auto px-4 pt-4 pb-0 mt-2">
                        <h2 /*data-aos='fade-right'*/ className="text-center text-3xl century">
                        Création de site internet à Bordeaux : Linkweb, votre solution web professionnelle
                        </h2>
                        <hr className="blue"></hr>
                    </section>
                    ...
                    <section className="flex w-full flex-col lg:flex-row mx-auto px-4 md:py-6 md:my-4">
                        <div className="w-full lg:w-1/2 pt-6">
                            <img 
                                src={mac}
                                alt="Création site internet Bordeaux"
                                /*data-aos="fade-right"*/
                            />
                        </div>
                    ...
                    <section className="max-w-6xl mx-auto flex flex-col align-center justify-center text-center mt-12 mb-3">
                        <h2 className="century text-center text-2xl tracking-wider pb-3 leading-tight" /*data-aos="zoom-in"*/>
                            <span className="text-bleu">/</span>Vous souhaitez en savoir plus sur la création de site internet à Bordeaux ?
                        </h2>
                        <hr className="blue"></hr>
                    ...
                    <section  className="tabPanel flex flex-1 w-full justify-end ml-0 mb-12">
                        <div className="w-full md:w-3/4 py-0 flex justify-end">
                            <Accordion>
                                ...
                                <div label="COMMENT CRÉER UN SITE WEB DESTINÉ À LA POPULATION BORDELAISE (GIRONDE) ?">
...
`
export default CreationSiteInternetBordeauxPage;
