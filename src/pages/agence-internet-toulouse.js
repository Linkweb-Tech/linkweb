            ...
            <Layout location={this.props.location}>
                ...
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + siteinternet + ')' }}>
                        ...
                        <p className="text century z-50 lg:mt-0 text-lg lg:text-sm xl:text-lg">Un site internet adaptée à votre activité (e-commerce avec le CMS prestashop, vitrine ou catalogue avec le CMS Wordpress) peut-être un support de communication fort pour une <strong className="font-normal">entreprise</strong>.
                            En France, Linkweb fait partie des agences digitales méticuleuses et attentives aux moindres détails dès la <strong className="font-normal">conception du site internet</strong> de chacun de ses clients.<br /><br />
                            L’objectif de notre <strong className="font-normal"><Link to="/agence-web-haute-garonne/" className="text-bleu hover:text-white font-bold">agence web en Haute-Garonne</Link></strong> est de fournir à chaque entreprise un <strong className="font-normal">outil digital</strong> pertinent qui se démarque, de par son <strong className="font-normal">identité visuelle</strong> comme de son contenu optimisé. Un site internet ergonomique et adapté aux besoins de chaque client est nécessaire pour une <strong className="font-normal"><Link to="/strategie-digitale-toulouse/" className="text-bleu hover:text-white font-bold">stratégie digitale</Link></strong> performante et complète : il est la vitrine de chaque entreprise sur le net.</p>
                    </div>
                    ...
                    <section className="flex justify-center flex-col items-center">
                        <div className="w-full px-12 lg:px-0 flex justify-center flex-col md:flex-row lg:w-3/4 mt-5">
                            ...
                            <div className="w-full svgtransform text-white md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                                ...
                                <p>Notre <strong className="font-normal"><Link to="/agence-web-design-toulouse/" className="text-black hover:text-white font-bold">agence de web design</Link></strong> développe un projet performant grâce à l'<strong className="font-normal">UI et UX design</strong>. Les supports de communication réalisés sont responsives pour une accessibilité sur ordinateur, mobile ou tablette.</p>
                            </div>
                            <div className="w-full svgtransform text-white md:w-1/4 mx-auto px-2 mb-10 md:mb-0 century text-center lg:text-left">
                ...
                <section className="sidetitle w-10/12 text-center text-black text-2xl justify-center flex flex-col century mt-10 mb-10 mx-auto">
                    ...
                    <div className="line-title my-4">
                        <hr className="border-solid w-1/2 lg:w-1/12 border-bleu"></hr>
                        <br />
                        <h3 /*data-aos='fade-left'*/ className="max-w-6xl text-xl text-black text-center lg:text-justify century pb-0">Notre méthodologie de création de site internet est adaptée pour vous fournir une prestation complète et en totale conformité avec les acteurs du Web.</h3>
                    </div>
                </section>
                        ...
                        <div className="w-full lg:w-1/2 my-10  flex flex-col">
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full px-6 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <br />
                                    <p className="w-full century pb-4 text-justify"><p  /*data-aos='fade-left'*/ className="text-justify" >La prise de contact est un moment important pour que l'équipe de notre <Link to="/agence-developpement-web-toulouse/" className="text-bleu hover:text-black font-bold">agence de développement web à Toulouse</Link> comprenne les attentes de votre <strong className="font-normal">entreprise</strong>. Ceci est fondamental pour vous proposer la solution la plus pertinente et la plus efficace. Nous devons connaître vos objectifs, vos ambitions et clients cibles pour <strong className="font-normal">créer le site internet</strong> à l’image de votre société.</p>
                                    </p>
                            ...
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full px-12 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <br />
                                    <p  /*data-aos='fade-left'*/ className="w-full century pb-4 text-justify">Cette étape est essentielle pour comprendre vos critères en termes réalisation, de besoins et d'ambitions. C’est à partir de là que notre <Link to="/agence-marketing-toulouse/" className="text-bleu hover:text-black font-bold">agence de marketing à Toulouse</Link> peut établir une méthode opérationnelle adaptée et ainsi que des <strong className="font-normal">stratégies d’optimisation de contenu viables</strong> et pertinentes.</p>
                                    {/*<Button url="/contact-agence-web-toulouse/" text="EN SAVOIR PLUS" position="left" />*/}
                                </div>
                            </div>
                            <div className="w-full flex-col md:flex-row flex px-auto">
