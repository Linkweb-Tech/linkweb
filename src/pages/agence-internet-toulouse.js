...
class AgenceInternetToulouse extends React.Component {
            ...
            <Layout location={this.props.location}>
                ...
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + siteinternet + ')' }}>
                        ...
                        <p className="text century lg:mt-0 text-lg lg:text-sm xl:text-lg">Un site internet adaptée à votre activité (e-commerce avec le CMS prestashop, vitrine ou catalogue avec le CMS Wordpress) peut-être un support de communication fort pour une <strong className="font-normal">entreprise</strong>.
                            En France, Linkweb fait partie des <Link to="/agence-communication-web-toulouse/" className="font-bold text-bleu hover:text-black">agences web</Link> méticuleuses et attentives aux moindres détails dès la <strong className="font-normal">conception du site internet</strong> de chacun de ses clients.<br/><br/>
