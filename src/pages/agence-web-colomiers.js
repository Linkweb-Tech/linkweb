...
import Bg from "../images/agence-web-colomiers.jpg";
...
class AgenceWebColomiers extends Component {
    ...
    render() {
        return (
            <Layout location={this.props.location}>
                ...
                <SEO
                    title="Agence Web Colomiers - Projets Web sur-mesure - Linkweb"
                    description="L'agence web Linkweb à Colomiers vous accompagne dans le développements de vos projets web sur-mesure : création de site internet, référencement SEO, campagnes sponsorisées Ads."
                    keywords={[`Agence Web Colomiers`, `Agence Web Toulouse`, `Agence digitale Toulouse`, `Agence digitale Colomiers`]}
                    url="https://linkweb.fr/agence-web-colomiers/"
                    nom="Agence Web Colomiers"
                    slug="agence-web-colomiers/"
                />
                {/* <PageTransition
                    defaultStyle={{
                ...
                <section className="flex flex-col lg:flex-row mx-8 lg:mx-24 my-0 items-center lg:justify-center">
                    ...
                    <div data-aos="fade-in" data-aos-delay="700" className=" w-full md:w-1/2 lg:w-3/12 bg-white my-12 border border-grey mx-8 hover:shadow-xl py-6 century" style={{ borderRadius: '15px', borderColor: '#d4d4d4', transform: 'translateZ(0) scale(1)', transition: '0.3s' }}>
                        ...
                        <hr className="blue"></hr>
                        <p className="text-center px-6">Linkweb est à votre écoute pour la définition de votre <Link className="text-bleu hover:text-black" to="/creation-site-internet-sur-mesure/">projet sur-mesure</Link> en fonction de vos besoins.</p>
                        <br />
                        <ul className="text-bold text-center py-2">
                            <li className="py-2 flex flex-row justify-center">
                                <div className="w-3/12 text-center text-bleu">✔</div>
                ...
                <section className="max-w-5xl w-full mx-auto px-4 pt-12 pb-0 my-2">
                    ...
                    <div className="w-full" /*data-aos='zoom-in'*/>
                        <p className="text-md text-center py-12 century">
                            Vous êtes un organisme public ou privé à la recherche d’une <strong>agence web à Colomiers</strong> pour la mise en place d’une stratégie digitale ? <strong>Linkweb</strong> est à l’écoute de vos besoins pour vos proposer une solution taillée pour vous.</p>
                    </div>
                </section>
                ...
                <section className="flex w-full flex-col lg:flex-row mx-auto px-0 py-6 my-4">
                    <div className="w-full lg:w-1/2 ">
                        <img src={imac} alt="Agence Web Colomiers" />
                    </div>
                    <div className="w-full lg:w-1/2 max-w-3xl px-12 py-12" >
                        <h2 className="century capitalize text-2xl tracking-wider pb-6" /*data-aos="zoom-in"*/>
                            <span className="text-bleu">/</span>AGENCE WEB À COLOMIERS : NOTRE CRÉATIVITÉ AU SERVICE DE VOTRE EFFICACITÉ
                            </h2>
                ...
                <section className=" w-full lg:h-screen flex flex-col justify-center items-end px-4 pt-12 pb-0 my-2 bg-cover my-24" style={{ background: '#6a6a6a url( ' + bgDev + ')', backgroundBlendMode: 'multiply', backgroundSize: 'cover' }}>
                    ...
                    <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-start text-center my-12">
                        ...
                        <div className="w-full my-6 sm:w-1/3 px-6 sm:px-12 flex flex-col items-center justify-center" /*data-aos='zoom-in' data-aos-delay="400"*/>
                            ...
                            <img src={web} alt="Agence Web Colomiers" width="80px" />
                        ...
                        <div className="w-full my-6 sm:w-1/3 px-6 sm:px-12 flex flex-col items-center justify-center" /*data-aos='zoom-in' data-aos-delay="600"*/>
                            <img src={bullhorn} alt="Agence Web Colomiers" width="80px" />
                ...
                <section className="max-w-5xl w-full mx-auto px-4 pt-12 lg:pt-2 pb-0 my-2">
                    <h2 /*data-aos='fade-right'*/ className="text-center text-3xl century">
                        <span className="text-bleu">/</span>AGENCE WEB À COLOMIERS : QUI SOMMES-NOUS ?
                        </h2>
                    <hr className="blue"></hr>
                    <h3 /*data-aos="fade-in"*/ className="text-center font-normal italic century text-sm">Agence Web Colomiers</h3>
                </section>
                ...
                <section className="max-w-6xl mx-auto flex flex-col align-center justify-center text-center mt-12 mb-3">
                    <h2 className="century text-center text-xl md:text-2xl tracking-wider pb-3 leading-tight" /*data-aos="zoom-in"*/>
                        <span className="text-bleu">/</span>Agence Web Colomiers : que gagner à se lancer dans un projet web ?
                        </h2>
                    <hr className="blue"></hr>
...
query lastsThreePostsAgenceColomiers {
    allWpPost(limit: 3) {
      edges {
        node {
          id
...
`
export default AgenceWebColomiers;
