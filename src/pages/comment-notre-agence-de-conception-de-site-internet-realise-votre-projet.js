            ...
            <Layout location={this.props.location}>
                ...
                <section className="w-full my-10 flex flex-col lg:flex-row">
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + siteinternet + ')' }}>
                        ...
                        <p className="text century lg:mt-0 text-lg lg:text-sm xl:text-lg z-50">Avec l’usage de <strong className="font-normal">CMS</strong> comme <strong className="font-normal">Wordpress</strong> ou <strong className="font-normal">Prestashop</strong> ou purement de <strong className="font-normal">code HTML</strong>, le type de site internet que notre agence conçoit pour vous est adapté aux <strong className="font-normal">services de votre entreprise</strong>. Nos solutions sont sur-mesure : que ce soit pour la conception de votre <strong className="font-normal">boutique en ligne</strong>, <strong className="font-normal">site vitrine</strong> ou catalogue, nous sélectionnons la meilleure solution en fonction de vos priorités (afficher un contact, lister les produits avec ou sans option d’achat depuis vos <strong className="font-normal">pages web</strong>).
                        <br /><br />Nos réalisations mettent en avant votre professionnalisme dans le but de <strong className="font-normal">développer votre image de marque</strong> et faire en sorte que votre <strong className="font-normal">stratégie de communication en ligne</strong> soit pertinente. C'est pour cela que <Link to="/pourquoi-travailler-dans-une-agence-web/" className="text-bleu hover:text-white font-bold">travailler dans une agence web</Link> demande une maîtrise parfaite de l'ensemble des critères qui entrent dans votre projet.</p>
                    </div>
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + referencement + ')' }}>
                        ...
                        <p className="text century text-lg lg:text-sm xl:text-lg z-50">Grâce à une méthodologie soignée, chaque site est parfaitement <strong className="font-normal">fonctionnel, intuitif et taillé pour vous</strong>. Pour toute <strong className="font-normal">création de site internet</strong>, qu'il s'agisse d'un <strong className="font-normal">site vitrine</strong>, ou d'un <strong className="font-normal">site catalogue</strong>, Linkweb maîtrise des outils parfaitement adaptés (<strong className="font-normal">CMS comme Wordpress</strong>).
                        Notre savoir-faire et nos compétences vous procurent des <strong className="font-normal">solutions marketing judicieuses</strong>, un <strong className="font-normal">suivi de qualité</strong> en parfaite adéquation avec votre <strong className="font-normal">identité visuelle</strong>.
                        <br /><br />Nos compétences en <strong className="font-normal">développement web</strong> vous permettent d’<strong className="font-normal">obtenir un site de qualité</strong> puisque notre <strong className="font-normal">équipe de développeurs</strong> définit une <strong className="font-normal">un webdesign professionnel</strong>. Notre entreprise soigne le visuel de votre site pour apporter aux internautes une <strong className="font-normal">expérience utilisateur</strong> irréprochable. Connaître les méthodologies employées est important avant de <Link to="/quelle-agence-web-choisir/" className="font-bold text-bleu hover:text-white">choisir votre agence partenaire</Link>.
                        </p>
                    </div>
                    <div className="blochover mx-0 lg:mx-6 w-full lg:w-1/3 text-white" style={{ backgroundImage: 'url(' + webdesign + ')' }}>
                        ...
                        <p className="text century text-lg lg:text-sm xl:text-lg z-50">Les <strong className="font-normal">standards du Web</strong> ne cessent d’évoluer, il existe un nombre considérable de critères imposés par des <strong className="font-normal">moteurs comme Google</strong>. Parmi eux, la qualité de l’<strong className="font-normal">expérience des utilisateurs</strong> (rapidité et la réactivité du site) ou encore le <strong className="font-normal">responsive design</strong> qui permet d’<strong className="font-normal">accéder au site sur mobile</strong>, sont des éléments clés.
                            ...
                            <br /><br />En développant votre <strong className="font-normal">site internet</strong>, notre <strong className="font-normal">agence</strong> travaille aussi bien son <strong className="font-normal">ergonomie</strong> que sa <strong className="font-normal">sécurisation de la navigation</strong> (protocole HTTPS). Nous concevons, pour nos <strong className="font-normal">clients</strong>, des pages fonctionnelles (respect des critères W3C qui régissent la compatibilité sur les <strong className="font-normal">navigateurs web</strong>) et soignées.
                            Cela contribue à générer du trafic pour atteindre à une conversion intéressante.</p>
                    </div>
                </section>
                <section className="bg-bleu sidetitle py-10">
                    <section className="w-full lg:w-2/3 flex flex-col justify-center century my-10 px-4 lg:px-32 md:mx-6 sm:mx-12 mt-2 lg:mx-64">
                        ...
                        <div className="line-title my-4 ">
                            ...
                            <br />
                            <h3 /*data-aos='fade-left'*/ className="text-xl text-white century pb-0">En faisant appel à notre agence de conception de site internet, vous faites le choix d'une solution pérenne et qualitative. </h3>
                        </div>
                    </section>
                    <section className="flex justify-center flex-col items-center">
                        <div className="w-full px-12 lg:px-0 flex justify-center flex-col md:flex-row lg:w-3/4 mt-5">
                            <div className="w-full svgtransform md:w-1/4 mx-auto px-2 mb-10 md:mb-0 text-white century text-center lg:text-left">
                                ...
                                <p>Notre <Link to="/agence-web-cahors/" className="text-white hover:text-black font-bold">agence web à Cahors</Link> vous garantit l’utilisation d’un <strong className="font-normal">certificat de sécurité pour vos sites</strong> afin de proposer une navigation protégée à l’utilisateur.</p>
                            </div>
                        ...
                        <div className="w-full lg:w-1/2 my-10  flex flex-col">
                            <div className="w-full flex-col md:flex-row flex px-auto">
                                ...
                                <div className="w-full century px-6 lg:px-6 flex flex-col justify-center">
                                    ...
                                    <br />
                                    <p className="w-full century pb-4 text-justify"><p  /*data-aos='fade-left'*/ className="text-justify" >N’hésitez pas à nous fournir un maximum d’informations, de cette façon nous vous apportons une solution précise et en adéquation avec vos besoins. Parmi les détails importants, vos <strong className="font-normal">objectifs</strong>, vos <strong className="font-normal">cibles de clientèle</strong> et motivations à <strong className="font-normal">créer un site internet</strong> nous importent tout particulièrement. Ce travail doit être anticipé dès le <Link to="/comment-choisir-son-agence-de-communication-web/" className="text-bleu hover:text-black font-bold">choix de votre agence partenaire</Link>.</p>
                                    </p>
