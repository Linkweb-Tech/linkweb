        ...
        return (
            <Layout location={this.props.location}>
                ...
                {/* <PageTransition
                    ...
                    transitionTime={200}
                > */}
                <section className="w-full bloctitrescreen mx-auto px-4 py-6 bg-no-repeat bg-bottom bg-cover flex flex-row justify-center items-center" style={{ background: '#00000086 url(' + Bg + ')', backgroundRepeat: 'no-repeat', backgroundBlendMode: 'multiply', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    <div>
                        ...
                        <h3 data-aos="fade-up" className="font-normal italic text-center px-6 lg:px-32 text-lg sm:text-2xl text-white sm:my-24">La convention Atouts Pour Tous menées par l’Université Fédérale de Toulouse Midi-Pyrénées fait du numérique un instrument central pour favoriser l’insertion professionnelle des personnes en situation de handicap.</h3>
                        <a data-aos="fade-down" href="/realisations/atpt/#start"><svg className="zoombtn mx-auto block" width="60px" viewBox="0 0 100 125"><g><g><path fill="#FFFFFF" d="M59.3,46.5l-8.7,8.7l-8.7-8.7c-0.8-0.8-2-0.8-2.8,0c-0.8,0.8-0.8,2,0,2.8l10.1,10.1c0.4,0.4,0.9,0.6,1.4,0.6    s1-0.2,1.4-0.6l10.1-10.1c0.8-0.8,0.8-2,0-2.8C61.4,45.7,60.1,45.7,59.3,46.5z M50.8,5c-24.9,0-45,20.1-45,45    c0,24.9,20.1,45,45,45c24.9,0,45-20.1,45-45C95.8,25.1,75.6,5,50.8,5z M50.8,91c-22.6,0-41-18.4-41-41s18.4-41,41-41    s41,18.4,41,41S73.4,91,50.8,91z" /></g></g></svg></a>
                    </div>
                    ...
                    <div className="w-full lg:w-2/3 bg-orange text-white px-12 md:px-24 py-12" data-aos="fade-right" data-aos-delay="100">
                        ...
                        <ul className="font-normal flex flex-col text-justify">
                            <li className="flex flex-row">
                                ...
                                <p>la création d’un site internet vitrine visant à promouvoir l’action de la convention.</p>
                            </li>
                            <br />
                            <li className="flex flex-row">
                                ...
                                <p>la création d’un outil collaboratif pour mettre en relation les étudiants en situation de handicap avec les professionnels.</p>
                            </li>
                        </ul>
                        <br />
